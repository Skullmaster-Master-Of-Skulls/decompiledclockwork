...
namespace WCFExtrasPlus.Soap
{
	...
	internal class SoapHeadersClientHook : IClientMessageInspector, IChannelInitializer, IExtension<IContextChannel>
	{
		...
		void IClientMessageInspector.AfterReceiveReply(ref Message reply, object correlationState)
		{
			...
			if (this.headersFromAction.TryGetValue((string)correlationState, out operationHeaders) && operationHeaders.Out.Count > 0)
			{
		...
		{
			SoapHeadersClientHook.OperationHeaders operationHeaders;
			if (this.headersFromAction.TryGetValue(request.Headers.Action, out operationHeaders) && operationHeaders.In.Count > 0)
			{
		...
		// Token: 0x06000032 RID: 50 RVA: 0x00002B34 File Offset: 0x00000D34
		void IChannelInitializer.Initialize(IClientChannel channel)
		{
			channel.Extensions.Add(this);
		}

		// Token: 0x06000033 RID: 51 RVA: 0x00002B42 File Offset: 0x00000D42
