...
namespace Microsoft.Internal.Web.Utils
{
	...
	{
		// Token: 0x060001D8 RID: 472 RVA: 0x000064D4 File Offset: 0x000046D4
		internal static string GetMimeMapping(string fileName)
		{
			...
			if (MimeMapping._mimeMappings.TryGetValue(extension, out result))
			{
				return result;
			}
			return MimeMapping._mimeMappings[".*"];
		}

		// Token: 0x060001D9 RID: 473 RVA: 0x00006518 File Offset: 0x00004718
		internal static void AddMimeMapping(string extension, string mimeType)
		{
			MimeMapping._mimeMappings.Add(extension, mimeType);
		}
