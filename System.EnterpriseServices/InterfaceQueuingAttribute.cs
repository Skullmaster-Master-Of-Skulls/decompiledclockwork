	...
	public sealed class InterfaceQueuingAttribute : Attribute, IConfigurationAttribute
	{
		...
		bool IConfigurationAttribute.AfterSaveChanges(Hashtable info)
		{
			if (this._interface != null)
			{
				...
				ICatalogObject obj;
				Type ifc;
				this.FindInterfaceByKey(this._interface, catalogCollection2, comp, out obj, out ifc);
				this.ConfigureInterface(obj);
				catalogCollection2.SaveChanges();
				this.StashModification(info, comp, ifc);
			}
			return false;
		}
