	...
	internal class ServicedComponentProxyAttribute : ProxyAttribute, ICustomFactory
	{
		...
		public override MarshalByRefObject CreateInstance(Type serverType)
		{
			...
			else
			{
				...
				IntPtr intPtr = Proxy.CoCreateObject(serverType, !flag2, ref flag, ref uri);
		...
		MarshalByRefObject ICustomFactory.CreateInstance(Type serverType)
		{
			...
			bool flag = (num & 8) != 0;
			bool fIsPooled = (num & 16) != 0;
			bool fAreMethodsSecure = (num & 32) != 0;
			if (flag)
			{
			...
			if (realProxy == null)
			{
				realProxy = new ServicedComponentProxy(serverType, flag, fIsPooled, fAreMethodsSecure, true);
			}
