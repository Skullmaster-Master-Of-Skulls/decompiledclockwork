...
namespace System.EnterpriseServices
{
	...
	public sealed class SecurityCallContext
	{
		...
		public SecurityIdentity DirectCaller
		{
			get
			{
				ISecurityIdentityColl ifc = (ISecurityIdentityColl)this._ex.GetItem("DirectCaller");
		...
		public SecurityIdentity OriginalCaller
		{
			get
			{
				ISecurityIdentityColl ifc = (ISecurityIdentityColl)this._ex.GetItem("OriginalCaller");
				return new SecurityIdentity(ifc);
			}
		}
		...
		public SecurityCallers Callers
		{
			get
			{
				ISecurityCallersColl ifc = (ISecurityCallersColl)this._ex.GetItem("Callers");
