...
namespace System.IO
{
	...
	{
		// Token: 0x060035B5 RID: 13749 RVA: 0x000B302D File Offset: 0x000B202D
		...
		// Token: 0x060035B6 RID: 13750 RVA: 0x000B3043 File Offset: 0x000B2043
		...
		// Token: 0x060035B7 RID: 13751 RVA: 0x000B305A File Offset: 0x000B205A
		...
		// Token: 0x060035B8 RID: 13752 RVA: 0x000B3071 File Offset: 0x000B2071
		public static void Copy(string sourceFileName, string destFileName)
		{
			File.Copy(sourceFileName, destFileName, false);
		}

		// Token: 0x060035B9 RID: 13753 RVA: 0x000B307B File Offset: 0x000B207B
		public static void Copy(string sourceFileName, string destFileName, bool overwrite)
		{
			File.InternalCopy(sourceFileName, destFileName, overwrite);
		}

		// Token: 0x060035BA RID: 13754 RVA: 0x000B3088 File Offset: 0x000B2088
		...
		// Token: 0x060035BC RID: 13756 RVA: 0x000B31E2 File Offset: 0x000B21E2
		public static FileStream Create(string path, int bufferSize)
		{
			return File.Create(path, bufferSize, FileOptions.None);
		}

		// Token: 0x060035BD RID: 13757 RVA: 0x000B31EC File Offset: 0x000B21EC
		public static FileStream Create(string path, int bufferSize, FileOptions options)
		{
			return new FileStream(path, FileMode.Create, FileAccess.ReadWrite, FileShare.None, bufferSize, options);
		}

		// Token: 0x060035BE RID: 13758 RVA: 0x000B31F9 File Offset: 0x000B21F9
		...
		// Token: 0x060035BF RID: 13759 RVA: 0x000B320C File Offset: 0x000B220C
		...
		// Token: 0x060035C0 RID: 13760 RVA: 0x000B329C File Offset: 0x000B229C
		...
		// Token: 0x060035C1 RID: 13761 RVA: 0x000B333C File Offset: 0x000B233C
		...
		// Token: 0x060035C2 RID: 13762 RVA: 0x000B33DC File Offset: 0x000B23DC
		...
		// Token: 0x060035C3 RID: 13763 RVA: 0x000B3478 File Offset: 0x000B2478
		...
		// Token: 0x060035C5 RID: 13765 RVA: 0x000B34C6 File Offset: 0x000B24C6
		public static FileStream Open(string path, FileMode mode, FileAccess access)
		{
			return File.Open(path, mode, access, FileShare.None);
		}

		// Token: 0x060035C6 RID: 13766 RVA: 0x000B34D1 File Offset: 0x000B24D1
		public static FileStream Open(string path, FileMode mode, FileAccess access, FileShare share)
		{
			return new FileStream(path, mode, access, share);
		}

		// Token: 0x060035C7 RID: 13767 RVA: 0x000B34DC File Offset: 0x000B24DC
		public static void SetCreationTime(string path, DateTime creationTime)
		{
			File.SetCreationTimeUtc(path, creationTime.ToUniversalTime());
		}

		// Token: 0x060035C8 RID: 13768 RVA: 0x000B34EC File Offset: 0x000B24EC
		...
		// Token: 0x060035C9 RID: 13769 RVA: 0x000B3554 File Offset: 0x000B2554
		public static DateTime GetCreationTime(string path)
		{
			return File.GetCreationTimeUtc(path).ToLocalTime();
		}

		// Token: 0x060035CA RID: 13770 RVA: 0x000B3570 File Offset: 0x000B2570
		...
		// Token: 0x060035CB RID: 13771 RVA: 0x000B35D8 File Offset: 0x000B25D8
		public static void SetLastAccessTime(string path, DateTime lastAccessTime)
		{
			File.SetLastAccessTimeUtc(path, lastAccessTime.ToUniversalTime());
		}

		// Token: 0x060035CC RID: 13772 RVA: 0x000B35E8 File Offset: 0x000B25E8
		...
		// Token: 0x060035CD RID: 13773 RVA: 0x000B3650 File Offset: 0x000B2650
		public static DateTime GetLastAccessTime(string path)
		{
			return File.GetLastAccessTimeUtc(path).ToLocalTime();
		}

		// Token: 0x060035CE RID: 13774 RVA: 0x000B366C File Offset: 0x000B266C
		...
		// Token: 0x060035CF RID: 13775 RVA: 0x000B36D4 File Offset: 0x000B26D4
		public static void SetLastWriteTime(string path, DateTime lastWriteTime)
		{
			File.SetLastWriteTimeUtc(path, lastWriteTime.ToUniversalTime());
		}

		// Token: 0x060035D0 RID: 13776 RVA: 0x000B36E4 File Offset: 0x000B26E4
		...
		// Token: 0x060035D1 RID: 13777 RVA: 0x000B374C File Offset: 0x000B274C
		public static DateTime GetLastWriteTime(string path)
		{
			return File.GetLastWriteTimeUtc(path).ToLocalTime();
		}

		// Token: 0x060035D2 RID: 13778 RVA: 0x000B3768 File Offset: 0x000B2768
		...
		// Token: 0x060035D3 RID: 13779 RVA: 0x000B37D0 File Offset: 0x000B27D0
		...
		// Token: 0x060035D4 RID: 13780 RVA: 0x000B3824 File Offset: 0x000B2824
		...
		// Token: 0x060035D5 RID: 13781 RVA: 0x000B3889 File Offset: 0x000B2889
		...
		// Token: 0x060035D6 RID: 13782 RVA: 0x000B3893 File Offset: 0x000B2893
		public static FileSecurity GetAccessControl(string path, AccessControlSections includeSections)
		{
			return new FileSecurity(path, includeSections);
		}

		// Token: 0x060035D7 RID: 13783 RVA: 0x000B389C File Offset: 0x000B289C
		...
		// Token: 0x060035D8 RID: 13784 RVA: 0x000B38C5 File Offset: 0x000B28C5
		public static FileStream OpenRead(string path)
		{
			return new FileStream(path, FileMode.Open, FileAccess.Read, FileShare.Read);
		}

		// Token: 0x060035D9 RID: 13785 RVA: 0x000B38D0 File Offset: 0x000B28D0
		public static FileStream OpenWrite(string path)
		{
			return new FileStream(path, FileMode.OpenOrCreate, FileAccess.Write, FileShare.None);
		}

		// Token: 0x060035DA RID: 13786 RVA: 0x000B38DB File Offset: 0x000B28DB
		public static string ReadAllText(string path)
		{
			return File.ReadAllText(path, Encoding.UTF8);
		}

		// Token: 0x060035DB RID: 13787 RVA: 0x000B38E8 File Offset: 0x000B28E8
		...
		// Token: 0x060035DC RID: 13788 RVA: 0x000B3924 File Offset: 0x000B2924
		public static void WriteAllText(string path, string contents)
		{
			File.WriteAllText(path, contents, StreamWriter.UTF8NoBOM);
		}

		// Token: 0x060035DD RID: 13789 RVA: 0x000B3934 File Offset: 0x000B2934
		...
		// Token: 0x060035DE RID: 13790 RVA: 0x000B3970 File Offset: 0x000B2970
		...
		// Token: 0x060035DF RID: 13791 RVA: 0x000B39FC File Offset: 0x000B29FC
		...
		// Token: 0x060035E0 RID: 13792 RVA: 0x000B3A48 File Offset: 0x000B2A48
		public static string[] ReadAllLines(string path)
		{
			return File.ReadAllLines(path, Encoding.UTF8);
		}

		// Token: 0x060035E1 RID: 13793 RVA: 0x000B3A58 File Offset: 0x000B2A58
		...
		// Token: 0x060035E2 RID: 13794 RVA: 0x000B3AB8 File Offset: 0x000B2AB8
		public static void WriteAllLines(string path, string[] contents)
		{
			File.WriteAllLines(path, contents, StreamWriter.UTF8NoBOM);
		}

		// Token: 0x060035E3 RID: 13795 RVA: 0x000B3AC8 File Offset: 0x000B2AC8
		...
		// Token: 0x060035E4 RID: 13796 RVA: 0x000B3B24 File Offset: 0x000B2B24
		public static void AppendAllText(string path, string contents)
		{
			File.AppendAllText(path, contents, StreamWriter.UTF8NoBOM);
		}

		// Token: 0x060035E5 RID: 13797 RVA: 0x000B3B34 File Offset: 0x000B2B34
		...
		// Token: 0x060035E6 RID: 13798 RVA: 0x000B3B70 File Offset: 0x000B2B70
		...
		// Token: 0x060035E7 RID: 13799 RVA: 0x000B3C33 File Offset: 0x000B2C33
		public static void Replace(string sourceFileName, string destinationFileName, string destinationBackupFileName)
		{
			File.Replace(sourceFileName, destinationFileName, destinationBackupFileName, false);
		}

		// Token: 0x060035E8 RID: 13800 RVA: 0x000B3C40 File Offset: 0x000B2C40
		...
		// Token: 0x060035E9 RID: 13801 RVA: 0x000B3CF8 File Offset: 0x000B2CF8
		...
		// Token: 0x060035EA RID: 13802 RVA: 0x000B3E9C File Offset: 0x000B2E9C
