...
namespace System.Security
{
	...
	{
		// Token: 0x06003B70 RID: 15216 RVA: 0x000C955D File Offset: 0x000C855D
		[Conditional("_DEBUG")]
		private static void DEBUG_WRITE(string str)
		{
		}

		// Token: 0x06003B71 RID: 15217 RVA: 0x000C955F File Offset: 0x000C855F
		[Conditional("_DEBUG")]
		private static void DEBUG_COND_WRITE(bool exp, string str)
		{
		}

		// Token: 0x06003B72 RID: 15218 RVA: 0x000C9561 File Offset: 0x000C8561
		[Conditional("_DEBUG")]
		private static void DEBUG_PRINTSTACK(Exception e)
		{
		}

		// Token: 0x06003B73 RID: 15219 RVA: 0x000C9563 File Offset: 0x000C8563
		[OnDeserializing]
		...
		// Token: 0x06003B74 RID: 15220 RVA: 0x000C956C File Offset: 0x000C856C
		[OnDeserialized]
		...
		// Token: 0x06003B75 RID: 15221 RVA: 0x000C95F8 File Offset: 0x000C85F8
		[OnSerializing]
		...
		// Token: 0x06003B76 RID: 15222 RVA: 0x000C9658 File Offset: 0x000C8658
		[OnSerialized]
		...
		// Token: 0x06003B77 RID: 15223 RVA: 0x000C9691 File Offset: 0x000C8691
		...
		// Token: 0x06003B78 RID: 15224 RVA: 0x000C96A6 File Offset: 0x000C86A6
		internal PermissionSet(bool fUnrestricted) : this()
		{
			this.SetUnrestricted(fUnrestricted);
		}

		// Token: 0x06003B79 RID: 15225 RVA: 0x000C96B5 File Offset: 0x000C86B5
		...
		// Token: 0x06003B7A RID: 15226 RVA: 0x000C96E4 File Offset: 0x000C86E4
		...
		// Token: 0x06003B7B RID: 15227 RVA: 0x000C97CC File Offset: 0x000C87CC
		...
		// Token: 0x06003B7C RID: 15228 RVA: 0x000C980D File Offset: 0x000C880D
		...
		// (get) Token: 0x06003B7D RID: 15229 RVA: 0x000C981C File Offset: 0x000C881C
		...
		// (get) Token: 0x06003B7E RID: 15230 RVA: 0x000C981F File Offset: 0x000C881F
		...
		// (get) Token: 0x06003B7F RID: 15231 RVA: 0x000C9822 File Offset: 0x000C8822
		...
		// Token: 0x06003B80 RID: 15232 RVA: 0x000C9828 File Offset: 0x000C8828
		internal void Reset()
		{
			this.m_Unrestricted = false;
		...
		// Token: 0x06003B81 RID: 15233 RVA: 0x000C9874 File Offset: 0x000C8874
		...
		// Token: 0x06003B82 RID: 15234 RVA: 0x000C988C File Offset: 0x000C888C
		public bool IsEmpty()
		{
		...
		// Token: 0x06003B83 RID: 15235 RVA: 0x000C98E6 File Offset: 0x000C88E6
		...
		// (get) Token: 0x06003B84 RID: 15236 RVA: 0x000C990C File Offset: 0x000C890C
		...
		// Token: 0x06003B85 RID: 15237 RVA: 0x000C9934 File Offset: 0x000C8934
		...
		// Token: 0x06003B86 RID: 15238 RVA: 0x000C9978 File Offset: 0x000C8978
		...
		// Token: 0x06003B87 RID: 15239 RVA: 0x000C998B File Offset: 0x000C898B
		...
		// Token: 0x06003B88 RID: 15240 RVA: 0x000C999E File Offset: 0x000C899E
		...
		// Token: 0x06003B89 RID: 15241 RVA: 0x000C99B1 File Offset: 0x000C89B1
		public IPermission SetPermission(IPermission perm)
		{
			return this.SetPermission(perm, true);
		}

		// Token: 0x06003B8A RID: 15242 RVA: 0x000C99BC File Offset: 0x000C89BC
		...
		// Token: 0x06003B8B RID: 15243 RVA: 0x000C9A2C File Offset: 0x000C8A2C
		...
		// Token: 0x06003B8C RID: 15244 RVA: 0x000C9AE0 File Offset: 0x000C8AE0
		...
		// Token: 0x06003B8D RID: 15245 RVA: 0x000C9B0B File Offset: 0x000C8B0B
		...
		// Token: 0x06003B8E RID: 15246 RVA: 0x000C9B1E File Offset: 0x000C8B1E
		...
		// Token: 0x06003B8F RID: 15247 RVA: 0x000C9B31 File Offset: 0x000C8B31
		internal void SetUnrestricted(bool unrestricted)
		{
			this.m_Unrestricted = unrestricted;
		}

		// Token: 0x06003B90 RID: 15248 RVA: 0x000C9B3A File Offset: 0x000C8B3A
		public bool IsUnrestricted()
		{
			return this.m_Unrestricted;
		}

		// Token: 0x06003B91 RID: 15249 RVA: 0x000C9B42 File Offset: 0x000C8B42
		internal bool CanUnrestrictedOverride()
		{
			return this.m_canUnrestrictedOverride;
		}

		// Token: 0x06003B92 RID: 15250 RVA: 0x000C9B4C File Offset: 0x000C8B4C
		...
		// Token: 0x06003B93 RID: 15251 RVA: 0x000C9C70 File Offset: 0x000C8C70
		...
		// Token: 0x06003B94 RID: 15252 RVA: 0x000C9C88 File Offset: 0x000C8C88
		...
		// Token: 0x06003B95 RID: 15253 RVA: 0x000C9C94 File Offset: 0x000C8C94
		...
		// Token: 0x06003B96 RID: 15254 RVA: 0x000C9CA0 File Offset: 0x000C8CA0
		...
		// Token: 0x06003B97 RID: 15255 RVA: 0x000C9CB8 File Offset: 0x000C8CB8
		...
		// Token: 0x06003B98 RID: 15256 RVA: 0x000C9D90 File Offset: 0x000C8D90
		...
		// Token: 0x06003B99 RID: 15257 RVA: 0x000C9DBA File Offset: 0x000C8DBA
		...
		// Token: 0x06003B9A RID: 15258 RVA: 0x000C9DD8 File Offset: 0x000C8DD8
		...
		// Token: 0x06003B9B RID: 15259 RVA: 0x000C9E18 File Offset: 0x000C8E18
		...
		// Token: 0x06003B9C RID: 15260 RVA: 0x000C9EB8 File Offset: 0x000C8EB8
		...
		// Token: 0x06003B9D RID: 15261 RVA: 0x000CA24C File Offset: 0x000C924C
		...
		// Token: 0x06003B9E RID: 15262 RVA: 0x000CA5C0 File Offset: 0x000C95C0
		...
		// Token: 0x06003B9F RID: 15263 RVA: 0x000CA82C File Offset: 0x000C982C
		...
		// Token: 0x06003BA0 RID: 15264 RVA: 0x000CAAE8 File Offset: 0x000C9AE8
		...
		// Token: 0x06003BA1 RID: 15265 RVA: 0x000CABC8 File Offset: 0x000C9BC8
		...
		// Token: 0x06003BA2 RID: 15266 RVA: 0x000CAC3C File Offset: 0x000C9C3C
		[ComVisible(false)]
		...
		// Token: 0x06003BA3 RID: 15267 RVA: 0x000CACFC File Offset: 0x000C9CFC
		[ComVisible(false)]
		...
		// Token: 0x06003BA4 RID: 15268 RVA: 0x000CAD68 File Offset: 0x000C9D68
		...
		// Token: 0x06003BA5 RID: 15269 RVA: 0x000CADAC File Offset: 0x000C9DAC
		...
		// Token: 0x06003BA6 RID: 15270 RVA: 0x000CAE10 File Offset: 0x000C9E10
		[MethodImpl(MethodImplOptions.NoInlining)]
		public void Assert()
		{
		...
		// Token: 0x06003BA7 RID: 15271 RVA: 0x000CAE28 File Offset: 0x000C9E28
		[MethodImpl(MethodImplOptions.NoInlining)]
		public void Deny()
		{
			StackCrawlMark stackCrawlMark = StackCrawlMark.LookForMyCaller;
		...
		// Token: 0x06003BA8 RID: 15272 RVA: 0x000CAE40 File Offset: 0x000C9E40
		[MethodImpl(MethodImplOptions.NoInlining)]
		...
		// Token: 0x06003BA9 RID: 15273 RVA: 0x000CAE58 File Offset: 0x000C9E58
		...
		// Token: 0x06003BAA RID: 15274 RVA: 0x000CAE81 File Offset: 0x000C9E81
		public virtual PermissionSet Copy()
		{
			return new PermissionSet(this);
		}

		// Token: 0x06003BAB RID: 15275 RVA: 0x000CAE8C File Offset: 0x000C9E8C
		...
		// Token: 0x06003BAC RID: 15276 RVA: 0x000CAEF6 File Offset: 0x000C9EF6
		public IEnumerator GetEnumerator()
		{
			return new PermissionSetEnumerator(this);
		}

		// Token: 0x06003BAD RID: 15277 RVA: 0x000CAEFE File Offset: 0x000C9EFE
		internal PermissionSetEnumeratorInternal GetEnumeratorInternal()
		{
			return new PermissionSetEnumeratorInternal(this);
		}

		// Token: 0x06003BAE RID: 15278 RVA: 0x000CAF06 File Offset: 0x000C9F06
		public override string ToString()
		{
			return this.ToXml().ToString();
		}

		// Token: 0x06003BAF RID: 15279 RVA: 0x000CAF14 File Offset: 0x000C9F14
		...
		// Token: 0x06003BB0 RID: 15280 RVA: 0x000CAF9C File Offset: 0x000C9F9C
		...
		// Token: 0x06003BB1 RID: 15281 RVA: 0x000CAFC8 File Offset: 0x000C9FC8
		...
		// Token: 0x06003BB2 RID: 15282 RVA: 0x000CB030 File Offset: 0x000CA030
		...
		// Token: 0x06003BB3 RID: 15283 RVA: 0x000CB098 File Offset: 0x000CA098
		...
		// Token: 0x06003BB4 RID: 15284 RVA: 0x000CB0E8 File Offset: 0x000CA0E8
		public virtual void FromXml(SecurityElement et)
		{
			this.FromXml(et, false, false);
		}

		// Token: 0x06003BB5 RID: 15285 RVA: 0x000CB0F4 File Offset: 0x000CA0F4
		...
		// Token: 0x06003BB6 RID: 15286 RVA: 0x000CB158 File Offset: 0x000CA158
		...
		// Token: 0x06003BB7 RID: 15287 RVA: 0x000CB37C File Offset: 0x000CA37C
		...
		// Token: 0x06003BB8 RID: 15288 RVA: 0x000CB618 File Offset: 0x000CA618
		private IPermission CreatePerm(object obj)
		{
			return PermissionSet.CreatePerm(obj, this.m_ignoreTypeLoadFailures);
		}

		// Token: 0x06003BB9 RID: 15289 RVA: 0x000CB628 File Offset: 0x000CA628
		...
		// Token: 0x06003BBA RID: 15290 RVA: 0x000CB860 File Offset: 0x000CA860
		...
		// Token: 0x06003BBB RID: 15291 RVA: 0x000CB8C8 File Offset: 0x000CA8C8
		...
		// Token: 0x06003BBC RID: 15292 RVA: 0x000CB924 File Offset: 0x000CA924
		...
		// Token: 0x06003BBD RID: 15293 RVA: 0x000CB960 File Offset: 0x000CA960
		...
		// Token: 0x06003BBE RID: 15294 RVA: 0x000CB9EC File Offset: 0x000CA9EC
		...
		// Token: 0x06003BBF RID: 15295 RVA: 0x000CBAB9 File Offset: 0x000CAAB9
		public virtual SecurityElement ToXml()
		{
			return this.ToXml("System.Security.PermissionSet");
		}

		// Token: 0x06003BC0 RID: 15296 RVA: 0x000CBAC8 File Offset: 0x000CAAC8
		...
		// Token: 0x06003BC1 RID: 15297 RVA: 0x000CBAF0 File Offset: 0x000CAAF0
		...
		// Token: 0x06003BC2 RID: 15298 RVA: 0x000CBB4C File Offset: 0x000CAB4C
		...
		// Token: 0x06003BC3 RID: 15299 RVA: 0x000CBCC0 File Offset: 0x000CACC0
		...
		// Token: 0x06003BC4 RID: 15300 RVA: 0x000CBD90 File Offset: 0x000CAD90
		...
		// Token: 0x06003BC5 RID: 15301 RVA: 0x000CBE08 File Offset: 0x000CAE08
		...
		// Token: 0x06003BC6 RID: 15302 RVA: 0x000CBED4 File Offset: 0x000CAED4
		...
		// Token: 0x06003BC7 RID: 15303 RVA: 0x000CBF64 File Offset: 0x000CAF64
		...
		// Token: 0x06003BC8 RID: 15304 RVA: 0x000CC065 File Offset: 0x000CB065
		...
		// Token: 0x06003BC9 RID: 15305 RVA: 0x000CC074 File Offset: 0x000CB074
		[MethodImpl(MethodImplOptions.NoInlining)]
		...
		// Token: 0x06003BCA RID: 15306 RVA: 0x000CC08C File Offset: 0x000CB08C
		...
		// Token: 0x06003BCB RID: 15307 RVA: 0x000CC14C File Offset: 0x000CB14C
		...
		// Token: 0x06003BCC RID: 15308 RVA: 0x000CC1C8 File Offset: 0x000CB1C8
		...
		// (set) Token: 0x06003BCD RID: 15309 RVA: 0x000CC240 File Offset: 0x000CB240
