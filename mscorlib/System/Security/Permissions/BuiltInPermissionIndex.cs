...
namespace System.Security.Permissions
{
	...
	internal static class BuiltInPermissionIndex
	{
		...
		internal const int PublisherIdentityPermissionIndex = 10;

		// Token: 0x04001DC0 RID: 7616
		internal const int SiteIdentityPermissionIndex = 11;

		// Token: 0x04001DC1 RID: 7617
		internal const int StrongNameIdentityPermissionIndex = 12;

		// Token: 0x04001DC2 RID: 7618
		internal const int UrlIdentityPermissionIndex = 13;

		// Token: 0x04001DC3 RID: 7619
		internal const int ZoneIdentityPermissionIndex = 14;

		// Token: 0x04001DC4 RID: 7620
		internal const int GacIdentityPermissionIndex = 15;

		// Token: 0x04001DC5 RID: 7621
		internal const int KeyContainerPermissionIndex = 16;
	}
}
