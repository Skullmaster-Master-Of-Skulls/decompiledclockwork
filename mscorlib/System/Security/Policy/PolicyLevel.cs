...
namespace System.Security.Policy
{
	...
	public sealed class PolicyLevel
	{
		...
		// (get) Token: 0x06002F8B RID: 12171 RVA: 0x000A16F0 File Offset: 0x000A06F0
		...
		// Token: 0x06002F8C RID: 12172 RVA: 0x000A171C File Offset: 0x000A071C
		[OnDeserialized]
		...
		// Token: 0x06002F8D RID: 12173 RVA: 0x000A172C File Offset: 0x000A072C
		...
		// Token: 0x06002F8E RID: 12174 RVA: 0x000A17C4 File Offset: 0x000A07C4
		...
		// Token: 0x06002F8F RID: 12175 RVA: 0x000A184B File Offset: 0x000A084B
		private PolicyLevel()
		{
		}

		// Token: 0x06002F90 RID: 12176 RVA: 0x000A1853 File Offset: 0x000A0853
		internal PolicyLevel(PolicyLevelType type) : this(type, PolicyLevel.GetLocationFromType(type))
		{
		}

		// Token: 0x06002F91 RID: 12177 RVA: 0x000A1862 File Offset: 0x000A0862
		internal PolicyLevel(PolicyLevelType type, string path) : this(type, path, ConfigId.None)
		{
		}

		// Token: 0x06002F92 RID: 12178 RVA: 0x000A1870 File Offset: 0x000A0870
		...
		// Token: 0x06002F93 RID: 12179 RVA: 0x000A18C4 File Offset: 0x000A08C4
		...
		// Token: 0x06002F94 RID: 12180 RVA: 0x000A1918 File Offset: 0x000A0918
		...
		// (get) Token: 0x06002F95 RID: 12181 RVA: 0x000A1920 File Offset: 0x000A0920
		public string Label
		{
			get
			{
		...
		// (get) Token: 0x06002F96 RID: 12182 RVA: 0x000A193C File Offset: 0x000A093C
		[ComVisible(false)]
		...
		// (get) Token: 0x06002F97 RID: 12183 RVA: 0x000A1944 File Offset: 0x000A0944
		...
		// (get) Token: 0x06002F98 RID: 12184 RVA: 0x000A194C File Offset: 0x000A094C
		...
		// (get) Token: 0x06002F99 RID: 12185 RVA: 0x000A1954 File Offset: 0x000A0954
		...
		// (get) Token: 0x06002F9A RID: 12186 RVA: 0x000A1961 File Offset: 0x000A0961
		// (set) Token: 0x06002F9B RID: 12187 RVA: 0x000A196F File Offset: 0x000A096F
		...
		// (get) Token: 0x06002F9C RID: 12188 RVA: 0x000A1994 File Offset: 0x000A0994
		...
		// Token: 0x06002F9D RID: 12189 RVA: 0x000A19EC File Offset: 0x000A09EC
		...
		// Token: 0x06002F9E RID: 12190 RVA: 0x000A1A08 File Offset: 0x000A0A08
		...
		// Token: 0x06002F9F RID: 12191 RVA: 0x000A1A38 File Offset: 0x000A0A38
		[Obsolete("Because all GAC assemblies always get full trust, the full trust list is no longer meaningful. You should install any assemblies that are used in security policy in the GAC to ensure they are trusted.")]
		...
		// Token: 0x06002FA0 RID: 12192 RVA: 0x000A1AC8 File Offset: 0x000A0AC8
		[Obsolete("Because all GAC assemblies always get full trust, the full trust list is no longer meaningful. You should install any assemblies that are used in security policy in the GAC to ensure they are trusted.")]
		...
		// Token: 0x06002FA1 RID: 12193 RVA: 0x000A1AF8 File Offset: 0x000A0AF8
		[Obsolete("Because all GAC assemblies always get full trust, the full trust list is no longer meaningful. You should install any assemblies that are used in security policy in the GAC to ensure they are trusted.")]
		...
		// (get) Token: 0x06002FA2 RID: 12194 RVA: 0x000A1B94 File Offset: 0x000A0B94
		[Obsolete("Because all GAC assemblies always get full trust, the full trust list is no longer meaningful. You should install any assemblies that are used in security policy in the GAC to ensure they are trusted.")]
		...
		// Token: 0x06002FA3 RID: 12195 RVA: 0x000A1BA8 File Offset: 0x000A0BA8
		...
		// Token: 0x06002FA4 RID: 12196 RVA: 0x000A1C54 File Offset: 0x000A0C54
		...
		// Token: 0x06002FA5 RID: 12197 RVA: 0x000A1C70 File Offset: 0x000A0C70
		...
		// Token: 0x06002FA6 RID: 12198 RVA: 0x000A1DF4 File Offset: 0x000A0DF4
		...
		// Token: 0x06002FA7 RID: 12199 RVA: 0x000A1EE4 File Offset: 0x000A0EE4
		...
		// Token: 0x06002FA8 RID: 12200 RVA: 0x000A1F14 File Offset: 0x000A0F14
		public void Recover()
		{
		...
		// Token: 0x06002FA9 RID: 12201 RVA: 0x000A1F98 File Offset: 0x000A0F98
		public void Reset()
		{
			this.SetDefault();
		}

		// Token: 0x06002FAA RID: 12202 RVA: 0x000A1FA0 File Offset: 0x000A0FA0
		public PolicyStatement Resolve(Evidence evidence)
		{
			return this.Resolve(evidence, 0, null);
		}

		// Token: 0x06002FAB RID: 12203 RVA: 0x000A1FAC File Offset: 0x000A0FAC
		...
		// Token: 0x06002FAC RID: 12204 RVA: 0x000A212C File Offset: 0x000A112C
		...
		// Token: 0x06002FAD RID: 12205 RVA: 0x000A2460 File Offset: 0x000A1460
		...
		// Token: 0x06002FAE RID: 12206 RVA: 0x000A24E8 File Offset: 0x000A14E8
		...
		// Token: 0x06002FAF RID: 12207 RVA: 0x000A25D0 File Offset: 0x000A15D0
		...
		// Token: 0x06002FB0 RID: 12208 RVA: 0x000A2708 File Offset: 0x000A1708
		...
		// Token: 0x06002FB1 RID: 12209 RVA: 0x000A2750 File Offset: 0x000A1750
		...
		// Token: 0x06002FB2 RID: 12210 RVA: 0x000A27A4 File Offset: 0x000A17A4
		...
		// Token: 0x06002FB3 RID: 12211 RVA: 0x000A2A0C File Offset: 0x000A1A0C
		...
		// Token: 0x06002FB4 RID: 12212 RVA: 0x000A2A38 File Offset: 0x000A1A38
		...
		// Token: 0x06002FB5 RID: 12213 RVA: 0x000A2A70 File Offset: 0x000A1A70
		...
		// Token: 0x06002FB6 RID: 12214 RVA: 0x000A2AB4 File Offset: 0x000A1AB4
		...
		// Token: 0x06002FB7 RID: 12215 RVA: 0x000A2ADC File Offset: 0x000A1ADC
		...
		// Token: 0x06002FB8 RID: 12216 RVA: 0x000A2B04 File Offset: 0x000A1B04
		...
		// Token: 0x06002FB9 RID: 12217 RVA: 0x000A2B38 File Offset: 0x000A1B38
		...
		// Token: 0x06002FBA RID: 12218 RVA: 0x000A2B6C File Offset: 0x000A1B6C
		...
		// Token: 0x06002FBB RID: 12219 RVA: 0x000A2B8C File Offset: 0x000A1B8C
		...
		// Token: 0x06002FBC RID: 12220 RVA: 0x000A2BAC File Offset: 0x000A1BAC
		...
		// Token: 0x06002FBD RID: 12221 RVA: 0x000A2C3C File Offset: 0x000A1C3C
		...
		// Token: 0x06002FBE RID: 12222 RVA: 0x000A2C84 File Offset: 0x000A1C84
		...
		// Token: 0x06002FBF RID: 12223 RVA: 0x000A2CCC File Offset: 0x000A1CCC
		...
		// Token: 0x06002FC0 RID: 12224 RVA: 0x000A2D20 File Offset: 0x000A1D20
		...
		// Token: 0x06002FC1 RID: 12225 RVA: 0x000A30A8 File Offset: 0x000A20A8
		...
		// Token: 0x06002FC2 RID: 12226 RVA: 0x000A3100 File Offset: 0x000A2100
		...
		// Token: 0x06002FC3 RID: 12227 RVA: 0x000A319C File Offset: 0x000A219C
		...
		// Token: 0x06002FC4 RID: 12228 RVA: 0x000A3274 File Offset: 0x000A2274
		...
		// Token: 0x06002FC5 RID: 12229 RVA: 0x000A3340 File Offset: 0x000A2340
		...
		// Token: 0x06002FC6 RID: 12230 RVA: 0x000A3378 File Offset: 0x000A2378
		...
		// Token: 0x06002FC7 RID: 12231 RVA: 0x000A33E0 File Offset: 0x000A23E0
		...
		// Token: 0x06002FC8 RID: 12232 RVA: 0x000A3514 File Offset: 0x000A2514
		...
		// Token: 0x06002FC9 RID: 12233 RVA: 0x000A36E4 File Offset: 0x000A26E4
		...
		// Token: 0x06002FCA RID: 12234 RVA: 0x000A376C File Offset: 0x000A276C
		...
		// Token: 0x06002FCB RID: 12235 RVA: 0x000A37D4 File Offset: 0x000A27D4
		...
		// Token: 0x06002FCC RID: 12236 RVA: 0x000A3874 File Offset: 0x000A2874
		...
		// Token: 0x06002FCD RID: 12237 RVA: 0x000A3A60 File Offset: 0x000A2A60
		...
		// Token: 0x06002FCE RID: 12238 RVA: 0x000A3AF8 File Offset: 0x000A2AF8
		...
		// Token: 0x06002FCF RID: 12239 RVA: 0x000A3B50 File Offset: 0x000A2B50
		...
		// Token: 0x06002FD0 RID: 12240 RVA: 0x000A3BD8 File Offset: 0x000A2BD8
		...
		// Token: 0x06002FD1 RID: 12241 RVA: 0x000A3C30 File Offset: 0x000A2C30
