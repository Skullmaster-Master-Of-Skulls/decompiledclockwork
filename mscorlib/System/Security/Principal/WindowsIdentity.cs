...
namespace System.Security.Principal
{
	...
	{
		// Token: 0x060030F2 RID: 12530 RVA: 0x000A7C87 File Offset: 0x000A6C87
		private WindowsIdentity()
		{
		}

		// Token: 0x060030F3 RID: 12531 RVA: 0x000A7CA1 File Offset: 0x000A6CA1
		...
		// Token: 0x060030F4 RID: 12532 RVA: 0x000A7CB5 File Offset: 0x000A6CB5
		...
		// Token: 0x060030F5 RID: 12533 RVA: 0x000A7CC0 File Offset: 0x000A6CC0
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x060030F6 RID: 12534 RVA: 0x000A7CCB File Offset: 0x000A6CCB
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x060030F7 RID: 12535 RVA: 0x000A7CD6 File Offset: 0x000A6CD6
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.UnmanagedCode)]
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x060030F8 RID: 12536 RVA: 0x000A7CE8 File Offset: 0x000A6CE8
		...
		// Token: 0x060030F9 RID: 12537 RVA: 0x000A7D18 File Offset: 0x000A6D18
		...
		// Token: 0x060030FA RID: 12538 RVA: 0x000A7DA5 File Offset: 0x000A6DA5
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		public WindowsIdentity(string sUserPrincipalName) : this(sUserPrincipalName, null)
		{
		}

		// Token: 0x060030FB RID: 12539 RVA: 0x000A7DAF File Offset: 0x000A6DAF
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x060030FC RID: 12540 RVA: 0x000A7DD5 File Offset: 0x000A6DD5
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		public WindowsIdentity(SerializationInfo info, StreamingContext context) : this(info)
		{
		}

		// Token: 0x060030FD RID: 12541 RVA: 0x000A7DE0 File Offset: 0x000A6DE0
		...
		// Token: 0x060030FE RID: 12542 RVA: 0x000A7E34 File Offset: 0x000A6E34
		...
		// Token: 0x060030FF RID: 12543 RVA: 0x000A7E51 File Offset: 0x000A6E51
		void IDeserializationCallback.OnDeserialization(object sender)
		{
		}

		// Token: 0x06003100 RID: 12544 RVA: 0x000A7E53 File Offset: 0x000A6E53
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x06003101 RID: 12545 RVA: 0x000A7E60 File Offset: 0x000A6E60
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x06003102 RID: 12546 RVA: 0x000A7E6D File Offset: 0x000A6E6D
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x06003103 RID: 12547 RVA: 0x000A7E76 File Offset: 0x000A6E76
		...
		// (get) Token: 0x06003104 RID: 12548 RVA: 0x000A7E80 File Offset: 0x000A6E80
		...
		// (get) Token: 0x06003105 RID: 12549 RVA: 0x000A7F20 File Offset: 0x000A6F20
		[ComVisible(false)]
		...
		// (get) Token: 0x06003106 RID: 12550 RVA: 0x000A7F8C File Offset: 0x000A6F8C
		...
		// (get) Token: 0x06003107 RID: 12551 RVA: 0x000A7FE4 File Offset: 0x000A6FE4
		...
		// (get) Token: 0x06003108 RID: 12552 RVA: 0x000A802C File Offset: 0x000A702C
		...
		// (get) Token: 0x06003109 RID: 12553 RVA: 0x000A806C File Offset: 0x000A706C
		...
		// (get) Token: 0x0600310A RID: 12554 RVA: 0x000A80A8 File Offset: 0x000A70A8
		...
		// Token: 0x0600310B RID: 12555 RVA: 0x000A80B0 File Offset: 0x000A70B0
		...
		// (get) Token: 0x0600310C RID: 12556 RVA: 0x000A8134 File Offset: 0x000A7134
		[ComVisible(false)]
		...
		// (get) Token: 0x0600310D RID: 12557 RVA: 0x000A8194 File Offset: 0x000A7194
		[ComVisible(false)]
		...
		// (get) Token: 0x0600310E RID: 12558 RVA: 0x000A81F4 File Offset: 0x000A71F4
		...
		// (get) Token: 0x0600310F RID: 12559 RVA: 0x000A8310 File Offset: 0x000A7310
		...
		// Token: 0x06003110 RID: 12560 RVA: 0x000A8320 File Offset: 0x000A7320
		[MethodImpl(MethodImplOptions.NoInlining)]
		...
		// Token: 0x06003111 RID: 12561 RVA: 0x000A8338 File Offset: 0x000A7338
		[SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
		[MethodImpl(MethodImplOptions.NoInlining)]
		...
		// Token: 0x06003112 RID: 12562 RVA: 0x000A8374 File Offset: 0x000A7374
		...
		// Token: 0x06003113 RID: 12563 RVA: 0x000A83C4 File Offset: 0x000A73C4
		[ComVisible(false)]
		...
		// Token: 0x06003114 RID: 12564 RVA: 0x000A83FE File Offset: 0x000A73FE
		[ComVisible(false)]
		public void Dispose()
		{
			this.Dispose(true);
		...
		// (get) Token: 0x06003115 RID: 12565 RVA: 0x000A8407 File Offset: 0x000A7407
		...
		// Token: 0x06003116 RID: 12566 RVA: 0x000A8410 File Offset: 0x000A7410
		...
		// Token: 0x06003117 RID: 12567 RVA: 0x000A851C File Offset: 0x000A751C
		...
		// Token: 0x06003118 RID: 12568 RVA: 0x000A8530 File Offset: 0x000A7530
		...
		// Token: 0x06003119 RID: 12569 RVA: 0x000A856C File Offset: 0x000A756C
		...
		// (get) Token: 0x0600311A RID: 12570 RVA: 0x000A85E0 File Offset: 0x000A75E0
		...
		// Token: 0x0600311B RID: 12571 RVA: 0x000A8628 File Offset: 0x000A7628
		...
		// Token: 0x0600311C RID: 12572 RVA: 0x000A864C File Offset: 0x000A764C
		...
		// Token: 0x0600311D RID: 12573 RVA: 0x000A8690 File Offset: 0x000A7690
		...
		// Token: 0x0600311E RID: 12574 RVA: 0x000A86C8 File Offset: 0x000A76C8
		...
		// Token: 0x0600311F RID: 12575 RVA: 0x000A86FC File Offset: 0x000A76FC
		...
		// Token: 0x06003120 RID: 12576 RVA: 0x000A8718 File Offset: 0x000A7718
		...
		// Token: 0x06003121 RID: 12577 RVA: 0x000A875C File Offset: 0x000A775C
		...
		// Token: 0x06003122 RID: 12578 RVA: 0x000A8814 File Offset: 0x000A7814
