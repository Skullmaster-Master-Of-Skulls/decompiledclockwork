...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x060050C4 RID: 20676 RVA: 0x00120FC8 File Offset: 0x0011FFC8
		...
		// Token: 0x060050C5 RID: 20677 RVA: 0x00121022 File Offset: 0x00120022
		...
		// Token: 0x060050C6 RID: 20678 RVA: 0x00121052 File Offset: 0x00120052
		protected override void HashCore(byte[] rgb, int ibStart, int cbSize)
		{
			this._HashData(rgb, ibStart, cbSize);
		}

		// Token: 0x060050C7 RID: 20679 RVA: 0x0012105D File Offset: 0x0012005D
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x060050C8 RID: 20680 RVA: 0x00121068 File Offset: 0x00120068
		...
		// Token: 0x060050C9 RID: 20681 RVA: 0x00121108 File Offset: 0x00120108
		...
		// Token: 0x060050CA RID: 20682 RVA: 0x00121234 File Offset: 0x00120234
		...
		// Token: 0x060050CB RID: 20683 RVA: 0x00121328 File Offset: 0x00120328
		...
		// Token: 0x060050CC RID: 20684 RVA: 0x0012163B File Offset: 0x0012063B
		private static ulong RotateRight(ulong x, int n)
		{
			return x >> n | x << 64 - n;
		}

		// Token: 0x060050CD RID: 20685 RVA: 0x0012164D File Offset: 0x0012064D
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x060050CE RID: 20686 RVA: 0x00121659 File Offset: 0x00120659
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x060050CF RID: 20687 RVA: 0x00121666 File Offset: 0x00120666
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x060050D0 RID: 20688 RVA: 0x00121682 File Offset: 0x00120682
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x060050D1 RID: 20689 RVA: 0x0012169E File Offset: 0x0012069E
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ x >> 7;
		}

		// Token: 0x060050D2 RID: 20690 RVA: 0x001216B3 File Offset: 0x001206B3
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ x >> 6;
		}

		// Token: 0x060050D3 RID: 20691 RVA: 0x001216CC File Offset: 0x001206CC
