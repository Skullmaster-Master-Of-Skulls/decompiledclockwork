...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x06005078 RID: 20600 RVA: 0x00119F83 File Offset: 0x00118F83
		private RijndaelManagedTransform()
		{
		}

		// Token: 0x06005079 RID: 20601 RVA: 0x00119F8C File Offset: 0x00118F8C
		...
		// Token: 0x0600507A RID: 20602 RVA: 0x0011A314 File Offset: 0x00119314
		...
		// Token: 0x0600507B RID: 20603 RVA: 0x0011A323 File Offset: 0x00119323
		public void Clear()
		{
			((IDisposable)this).Dispose();
		}

		// Token: 0x0600507C RID: 20604 RVA: 0x0011A32C File Offset: 0x0011932C
		...
		// (get) Token: 0x0600507D RID: 20605 RVA: 0x0011A411 File Offset: 0x00119411
		...
		// (get) Token: 0x0600507E RID: 20606 RVA: 0x0011A419 File Offset: 0x00119419
		...
		// (get) Token: 0x0600507F RID: 20607 RVA: 0x0011A421 File Offset: 0x00119421
		...
		// (get) Token: 0x06005080 RID: 20608 RVA: 0x0011A429 File Offset: 0x00119429
		...
		// (get) Token: 0x06005081 RID: 20609 RVA: 0x0011A42C File Offset: 0x0011942C
		...
		// Token: 0x06005082 RID: 20610 RVA: 0x0011A430 File Offset: 0x00119430
		...
		// Token: 0x06005083 RID: 20611 RVA: 0x0011A5A8 File Offset: 0x001195A8
		...
		// Token: 0x06005084 RID: 20612 RVA: 0x0011A6CC File Offset: 0x001196CC
		public void Reset()
		{
			this.m_depadBuffer = null;
			if (this.m_cipherMode == CipherMode.CBC)
		...
		// Token: 0x06005085 RID: 20613 RVA: 0x0011A728 File Offset: 0x00119728
		private unsafe int EncryptData(byte[] inputBuffer, int inputOffset, int inputCount, ref byte[] outputBuffer, int outputOffset, PaddingMode paddingMode, bool fLast)
		{
			...
			fixed (int* encryptindex = this.m_encryptindex)
			{
				fixed (int* encryptKeyExpansion = this.m_encryptKeyExpansion)
				{
					fixed (int* ptr = RijndaelManagedTransform.s_T)
					{
						fixed (int* ptr2 = RijndaelManagedTransform.s_TF)
						{
							int* ptr3 = stackalloc int[4 * this.m_Nb];
							int* ptr4 = stackalloc int[4 * this.m_Nb];
							...
							for (int j = 0; j < num4; j++)
							{
								if (this.m_cipherMode == CipherMode.CFB)
								{
									Utils.BlockCopy(this.m_shiftRegister, 0, ptr3, 0, this.m_blockSizeBytes);
								}
								else if (j != num4 - 1 || num == 0)
								{
									Utils.BlockCopy(inputBuffer, num3, ptr3, 0, this.m_blockSizeBytes);
								}
								else
								{
									int num6 = 0;
									...
									for (int k = 0; k < this.m_Nb; k++)
									{
										...
										ptr3[k] = (num10 << 24 | num9 << 16 | num8 << 8 | num7);
									}
								}
								if (this.m_cipherMode == CipherMode.CBC)
								{
									...
									{
										ptr3[l] ^= this.m_lastBlockBuffer[l];
									}
								}
								this.Enc(encryptindex, encryptKeyExpansion, ptr, ptr2, ptr3, ptr4);
								if (this.m_cipherMode == CipherMode.CFB)
								{
									int i = num3;
									if (j != num4 - 1 || num == 0)
									{
										for (int m = 0; m < this.m_Nb; m++)
										{
											...
											outputBuffer[num5++] = (byte)((ptr4[m] & 255) ^ (int)inputBuffer[i++]);
											if (i >= num3 + this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[m] >> 8 & 255) ^ (int)inputBuffer[i++]);
											if (i >= num3 + this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[m] >> 16 & 255) ^ (int)inputBuffer[i++]);
											if (i >= num3 + this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[m] >> 24 & 255) ^ (int)inputBuffer[i++]);
										}
									}
									else
									{
										byte[] array2 = new byte[this.m_inputBlockSize];
										...
										{
											outputBuffer[num5++] = (byte)((ptr4[num11] & 255) ^ (int)array2[i++]);
											if (i >= this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[num11] >> 8 & 255) ^ (int)array2[i++]);
											if (i >= this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[num11] >> 16 & 255) ^ (int)array2[i++]);
											if (i >= this.m_inputBlockSize)
											{
												break;
											}
											outputBuffer[num5++] = (byte)((ptr4[num11] >> 24 & 255) ^ (int)array2[i++]);
											num11++;
										}
									}
								...
								else
								{
									...
									{
										outputBuffer[num5++] = (byte)(ptr4[n] & 255);
										outputBuffer[num5++] = (byte)(ptr4[n] >> 8 & 255);
										outputBuffer[num5++] = (byte)(ptr4[n] >> 16 & 255);
										outputBuffer[num5++] = (byte)(ptr4[n] >> 24 & 255);
									}
									if (this.m_cipherMode == CipherMode.CBC)
									{
										Utils.BlockCopy(ptr4, 0, this.m_lastBlockBuffer, 0, this.m_blockSizeBytes);
									}
								}
		...
		// Token: 0x06005086 RID: 20614 RVA: 0x0011ADA8 File Offset: 0x00119DA8
		private unsafe int DecryptData(byte[] inputBuffer, int inputOffset, int inputCount, ref byte[] outputBuffer, int outputOffset, PaddingMode paddingMode, bool fLast)
		{
			...
			fixed (int* encryptindex = this.m_encryptindex)
			{
				fixed (int* encryptKeyExpansion = this.m_encryptKeyExpansion)
				{
					fixed (int* decryptindex = this.m_decryptindex)
					{
						fixed (int* decryptKeyExpansion = this.m_decryptKeyExpansion)
						{
							fixed (int* ptr = RijndaelManagedTransform.s_T)
							{
								fixed (int* ptr2 = RijndaelManagedTransform.s_TF)
								{
									fixed (int* ptr3 = RijndaelManagedTransform.s_iT)
									{
										fixed (int* ptr4 = RijndaelManagedTransform.s_iTF)
										{
											int* ptr5 = stackalloc int[4 * this.m_Nb];
											int* ptr6 = stackalloc int[4 * this.m_Nb];
											int num = inputCount / this.m_inputBlockSize;
											int num2 = inputOffset;
											int num3 = outputOffset;
											for (int i = 0; i < num; i++)
											{
												if (this.m_cipherMode == CipherMode.CFB)
												{
													...
													for (int k = 0; k < this.m_Nb; k++)
													{
														...
														ptr5[k] = (num7 << 24 | num6 << 16 | num5 << 8 | num4);
													}
												}
												else
												{
													...
													for (int l = 0; l < this.m_Nb; l++)
													{
														...
														ptr5[l] = (num11 << 24 | num10 << 16 | num9 << 8 | num8);
													}
												}
												if (this.m_cipherMode == CipherMode.CFB)
												{
													this.Enc(encryptindex, encryptKeyExpansion, ptr, ptr2, ptr5, ptr6);
													int j = num2;
													int num12 = 0;
													while (num12 < this.m_Nb && j < num2 + this.m_inputBlockSize)
													{
														outputBuffer[num3++] = (byte)((ptr6[num12] & 255) ^ (int)inputBuffer[j++]);
														if (j >= num2 + this.m_inputBlockSize)
														{
															break;
														}
														outputBuffer[num3++] = (byte)((ptr6[num12] >> 8 & 255) ^ (int)inputBuffer[j++]);
														if (j >= num2 + this.m_inputBlockSize)
														{
															break;
														}
														outputBuffer[num3++] = (byte)((ptr6[num12] >> 16 & 255) ^ (int)inputBuffer[j++]);
														if (j >= num2 + this.m_inputBlockSize)
														{
															break;
														}
														outputBuffer[num3++] = (byte)((ptr6[num12] >> 24 & 255) ^ (int)inputBuffer[j++]);
														num12++;
													}
												...
												{
													this.Dec(decryptindex, decryptKeyExpansion, ptr3, ptr4, ptr5, ptr6);
													if (this.m_cipherMode == CipherMode.CBC)
													{
														int j = num2;
														for (int m = 0; m < this.m_Nb; m++)
														{
															ptr6[m] ^= this.m_lastBlockBuffer[m];
													...
													for (int n = 0; n < this.m_Nb; n++)
													{
														outputBuffer[num3++] = (byte)(ptr6[n] & 255);
														outputBuffer[num3++] = (byte)(ptr6[n] >> 8 & 255);
														outputBuffer[num3++] = (byte)(ptr6[n] >> 16 & 255);
														outputBuffer[num3++] = (byte)(ptr6[n] >> 24 & 255);
													}
												}
		...
		// Token: 0x06005087 RID: 20615 RVA: 0x0011B458 File Offset: 0x0011A458
		...
		// Token: 0x06005088 RID: 20616 RVA: 0x0011B64C File Offset: 0x0011A64C
		...
		// Token: 0x06005089 RID: 20617 RVA: 0x0011B86C File Offset: 0x0011A86C
		...
		// Token: 0x0600508A RID: 20618 RVA: 0x0011BB43 File Offset: 0x0011AB43
		private static int rot1(int val)
		{
			return (val << 8 & -256) | (val >> 24 & 255);
		}

		// Token: 0x0600508B RID: 20619 RVA: 0x0011BB59 File Offset: 0x0011AB59
		private static int rot2(int val)
		{
			return (val << 16 & -65536) | (val >> 16 & 65535);
		}

		// Token: 0x0600508C RID: 20620 RVA: 0x0011BB70 File Offset: 0x0011AB70
		private static int rot3(int val)
		{
			return (val << 24 & -16777216) | (val >> 8 & 16777215);
		}

		// Token: 0x0600508D RID: 20621 RVA: 0x0011BB88 File Offset: 0x0011AB88
		...
		// Token: 0x0600508E RID: 20622 RVA: 0x0011BBDC File Offset: 0x0011ABDC
