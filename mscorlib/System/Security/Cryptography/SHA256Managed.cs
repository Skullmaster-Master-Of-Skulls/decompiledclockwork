...
namespace System.Security.Cryptography
{
	...
	{
		// Token: 0x060050B0 RID: 20656 RVA: 0x00120768 File Offset: 0x0011F768
		...
		// Token: 0x060050B1 RID: 20657 RVA: 0x001207BF File Offset: 0x0011F7BF
		...
		// Token: 0x060050B2 RID: 20658 RVA: 0x001207EF File Offset: 0x0011F7EF
		protected override void HashCore(byte[] rgb, int ibStart, int cbSize)
		{
			this._HashData(rgb, ibStart, cbSize);
		}

		// Token: 0x060050B3 RID: 20659 RVA: 0x001207FA File Offset: 0x0011F7FA
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x060050B4 RID: 20660 RVA: 0x00120804 File Offset: 0x0011F804
		...
		// Token: 0x060050B5 RID: 20661 RVA: 0x00120884 File Offset: 0x0011F884
		...
		// Token: 0x060050B6 RID: 20662 RVA: 0x00120998 File Offset: 0x0011F998
		...
		// Token: 0x060050B7 RID: 20663 RVA: 0x00120A84 File Offset: 0x0011FA84
		...
		// Token: 0x060050B8 RID: 20664 RVA: 0x00120D95 File Offset: 0x0011FD95
		private static uint RotateRight(uint x, int n)
		{
			return x >> n | x << 32 - n;
		}

		// Token: 0x060050B9 RID: 20665 RVA: 0x00120DA7 File Offset: 0x0011FDA7
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x060050BA RID: 20666 RVA: 0x00120DB2 File Offset: 0x0011FDB2
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x060050BB RID: 20667 RVA: 0x00120DBF File Offset: 0x0011FDBF
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ x >> 3;
		}

		// Token: 0x060050BC RID: 20668 RVA: 0x00120DD5 File Offset: 0x0011FDD5
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ x >> 10;
		}

		// Token: 0x060050BD RID: 20669 RVA: 0x00120DED File Offset: 0x0011FDED
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x060050BE RID: 20670 RVA: 0x00120E08 File Offset: 0x0011FE08
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x060050BF RID: 20671 RVA: 0x00120E24 File Offset: 0x0011FE24
