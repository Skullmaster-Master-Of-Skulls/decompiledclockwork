...
namespace System.Security.Cryptography
{
	...
	internal static class Utils
	{
		...
		// (get) Token: 0x06005108 RID: 20744 RVA: 0x001229D0 File Offset: 0x001219D0
		private static object InternalSyncObject
		{
			get
			{
				if (Utils.s_InternalSyncObject == null)
				{
					...
					Interlocked.CompareExchange(ref Utils.s_InternalSyncObject, value, null);
				}
		...
		// (get) Token: 0x06005109 RID: 20745 RVA: 0x001229FC File Offset: 0x001219FC
		...
		// (get) Token: 0x0600510A RID: 20746 RVA: 0x00122A64 File Offset: 0x00121A64
		...
		// (get) Token: 0x0600510B RID: 20747 RVA: 0x00122AC4 File Offset: 0x00121AC4
			...
			get
			{
				if (Utils._safeDssProvHandle == null)
				{
					lock (Utils.InternalSyncObject)
					{
						if (Utils._safeDssProvHandle == null)
						{
							SafeProvHandle safeDssProvHandle = Utils.AcquireProvHandle(new CspParameters(13));
							Thread.MemoryBarrier();
							Utils._safeDssProvHandle = safeDssProvHandle;
						}
					}
				}
		...
		// Token: 0x0600510C RID: 20748 RVA: 0x00122B24 File Offset: 0x00121B24
		internal static SafeProvHandle AcquireProvHandle(CspParameters parameters)
		{
			...
			SafeProvHandle result = SafeProvHandle.InvalidHandle;
			if (Utils.Win2KCrypto == 1)
			{
				Utils._AcquireCSP(parameters, ref result);
			}
			else
			{
				...
				result = Utils.CreateProvHandle(parameters, true);
			}
			return result;
		}

		// Token: 0x0600510D RID: 20749 RVA: 0x00122B80 File Offset: 0x00121B80
		...
		// Token: 0x0600510E RID: 20750 RVA: 0x00122C14 File Offset: 0x00121C14
		...
		// Token: 0x0600510F RID: 20751 RVA: 0x00122D04 File Offset: 0x00121D04
		...
		// Token: 0x06005110 RID: 20752 RVA: 0x00122E28 File Offset: 0x00121E28
		...
		// Token: 0x06005111 RID: 20753 RVA: 0x00122E68 File Offset: 0x00121E68
		...
		// Token: 0x06005112 RID: 20754 RVA: 0x00122FEC File Offset: 0x00121FEC
		...
		// Token: 0x06005113 RID: 20755 RVA: 0x0012308C File Offset: 0x0012208C
		...
		// Token: 0x06005114 RID: 20756 RVA: 0x0012313C File Offset: 0x0012213C
		...
		// (get) Token: 0x06005115 RID: 20757 RVA: 0x00123190 File Offset: 0x00122190
		...
		// Token: 0x06005116 RID: 20758 RVA: 0x001231A8 File Offset: 0x001221A8
		...
		// Token: 0x06005117 RID: 20759 RVA: 0x001231C8 File Offset: 0x001221C8
		internal static bool HasAlgorithm(int dwCalg, int dwKeySize)
		{
			bool result = false;
			lock (Utils.InternalSyncObject)
			{
				result = Utils._SearchForAlgorithm(Utils.StaticProvHandle, dwCalg, dwKeySize);
			}
			return result;
		}

		// Token: 0x17000E1D RID: 3613
		// (get) Token: 0x06005118 RID: 20760 RVA: 0x0012320C File Offset: 0x0012220C
		...
		// (get) Token: 0x06005119 RID: 20761 RVA: 0x00123238 File Offset: 0x00122238
		...
		// (get) Token: 0x0600511A RID: 20762 RVA: 0x001232F0 File Offset: 0x001222F0
		...
		// Token: 0x0600511B RID: 20763 RVA: 0x00123338 File Offset: 0x00122338
		...
		// Token: 0x0600511C RID: 20764 RVA: 0x001233B8 File Offset: 0x001223B8
		...
		// Token: 0x0600511D RID: 20765 RVA: 0x0012344C File Offset: 0x0012244C
		internal static string DiscardWhiteSpaces(string inputBuffer)
		{
			return Utils.DiscardWhiteSpaces(inputBuffer, 0, inputBuffer.Length);
		}

		// Token: 0x0600511E RID: 20766 RVA: 0x0012345C File Offset: 0x0012245C
		...
		// Token: 0x0600511F RID: 20767 RVA: 0x001234C8 File Offset: 0x001224C8
		...
		// Token: 0x06005120 RID: 20768 RVA: 0x001234F4 File Offset: 0x001224F4
		...
		// Token: 0x06005121 RID: 20769 RVA: 0x00123560 File Offset: 0x00122560
		...
		// Token: 0x06005122 RID: 20770 RVA: 0x001235A4 File Offset: 0x001225A4
		...
		// Token: 0x06005123 RID: 20771 RVA: 0x00123610 File Offset: 0x00122610
		...
		// Token: 0x06005124 RID: 20772 RVA: 0x00123658 File Offset: 0x00122658
		...
		// Token: 0x06005125 RID: 20773 RVA: 0x001236BC File Offset: 0x001226BC
		...
		// Token: 0x06005126 RID: 20774 RVA: 0x00123704 File Offset: 0x00122704
		...
		// Token: 0x06005127 RID: 20775 RVA: 0x00123768 File Offset: 0x00122768
		...
		// Token: 0x06005128 RID: 20776 RVA: 0x001237E0 File Offset: 0x001227E0
		...
		// Token: 0x06005129 RID: 20777 RVA: 0x00123898 File Offset: 0x00122898
		...
		// Token: 0x0600512A RID: 20778 RVA: 0x001238D8 File Offset: 0x001228D8
		...
		// Token: 0x0600512B RID: 20779 RVA: 0x00123900 File Offset: 0x00122900
		...
		// Token: 0x0600512C RID: 20780 RVA: 0x00123934 File Offset: 0x00122934
		...
		// Token: 0x0600512D RID: 20781 RVA: 0x00123960 File Offset: 0x00122960
		internal static byte[] RsaOaepEncrypt(RSA rsa, HashAlgorithm hash, PKCS1MaskGenerationMethod mgf, RandomNumberGenerator rng, byte[] data)
		{
			...
			{
				throw new CryptographicException(string.Format(null, Environment.GetResourceString("Cryptography_Padding_EncDataTooBig"), new object[]
				{
					num - 2 - 2 * num2
				}));
			}
		...
		// Token: 0x0600512E RID: 20782 RVA: 0x00123AA0 File Offset: 0x00122AA0
		...
		// Token: 0x0600512F RID: 20783 RVA: 0x00123C68 File Offset: 0x00122C68
		...
		// Token: 0x06005130 RID: 20784 RVA: 0x00123D50 File Offset: 0x00122D50
