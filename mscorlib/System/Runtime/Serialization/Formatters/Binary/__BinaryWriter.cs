...
namespace System.Runtime.Serialization.Formatters.Binary
{
	...
	{
		// Token: 0x060046EB RID: 18155 RVA: 0x000F2A5C File Offset: 0x000F1A5C
		...
		// Token: 0x060046EC RID: 18156 RVA: 0x000F2A9C File Offset: 0x000F1A9C
		internal void WriteBegin()
		{
		}

		// Token: 0x060046ED RID: 18157 RVA: 0x000F2A9E File Offset: 0x000F1A9E
		internal void WriteEnd()
		{
			this.dataWriter.Flush();
		}

		// Token: 0x060046EE RID: 18158 RVA: 0x000F2AAB File Offset: 0x000F1AAB
		internal void WriteBoolean(bool value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046EF RID: 18159 RVA: 0x000F2AB9 File Offset: 0x000F1AB9
		internal void WriteByte(byte value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F0 RID: 18160 RVA: 0x000F2AC7 File Offset: 0x000F1AC7
		private void WriteBytes(byte[] value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F1 RID: 18161 RVA: 0x000F2AD5 File Offset: 0x000F1AD5
		private void WriteBytes(byte[] byteA, int offset, int size)
		{
			this.dataWriter.Write(byteA, offset, size);
		}

		// Token: 0x060046F2 RID: 18162 RVA: 0x000F2AE5 File Offset: 0x000F1AE5
		internal void WriteChar(char value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F3 RID: 18163 RVA: 0x000F2AF3 File Offset: 0x000F1AF3
		internal void WriteChars(char[] value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F4 RID: 18164 RVA: 0x000F2B01 File Offset: 0x000F1B01
		internal void WriteDecimal(decimal value)
		{
			this.WriteString(value.ToString(CultureInfo.InvariantCulture));
		}

		// Token: 0x060046F5 RID: 18165 RVA: 0x000F2B15 File Offset: 0x000F1B15
		internal void WriteSingle(float value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F6 RID: 18166 RVA: 0x000F2B23 File Offset: 0x000F1B23
		internal void WriteDouble(double value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F7 RID: 18167 RVA: 0x000F2B31 File Offset: 0x000F1B31
		internal void WriteInt16(short value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F8 RID: 18168 RVA: 0x000F2B3F File Offset: 0x000F1B3F
		internal void WriteInt32(int value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046F9 RID: 18169 RVA: 0x000F2B4D File Offset: 0x000F1B4D
		internal void WriteInt64(long value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046FA RID: 18170 RVA: 0x000F2B5B File Offset: 0x000F1B5B
		internal void WriteSByte(sbyte value)
		{
			this.WriteByte((byte)value);
		}

		// Token: 0x060046FB RID: 18171 RVA: 0x000F2B65 File Offset: 0x000F1B65
		internal void WriteString(string value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046FC RID: 18172 RVA: 0x000F2B73 File Offset: 0x000F1B73
		internal void WriteTimeSpan(TimeSpan value)
		{
			this.WriteInt64(value.Ticks);
		}

		// Token: 0x060046FD RID: 18173 RVA: 0x000F2B82 File Offset: 0x000F1B82
		internal void WriteDateTime(DateTime value)
		{
			this.WriteInt64(value.ToBinaryRaw());
		}

		// Token: 0x060046FE RID: 18174 RVA: 0x000F2B91 File Offset: 0x000F1B91
		internal void WriteUInt16(ushort value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x060046FF RID: 18175 RVA: 0x000F2B9F File Offset: 0x000F1B9F
		internal void WriteUInt32(uint value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x06004700 RID: 18176 RVA: 0x000F2BAD File Offset: 0x000F1BAD
		internal void WriteUInt64(ulong value)
		{
			this.dataWriter.Write(value);
		}

		// Token: 0x06004701 RID: 18177 RVA: 0x000F2BBB File Offset: 0x000F1BBB
		internal void WriteObjectEnd(NameInfo memberNameInfo, NameInfo typeNameInfo)
		{
		}

		// Token: 0x06004702 RID: 18178 RVA: 0x000F2BC0 File Offset: 0x000F1BC0
		...
		// Token: 0x06004703 RID: 18179 RVA: 0x000F2BE8 File Offset: 0x000F1BE8
		...
		// Token: 0x06004704 RID: 18180 RVA: 0x000F2C0E File Offset: 0x000F1C0E
		...
		// Token: 0x06004705 RID: 18181 RVA: 0x000F2C3C File Offset: 0x000F1C3C
		...
		// Token: 0x06004706 RID: 18182 RVA: 0x000F2C74 File Offset: 0x000F1C74
		...
		// Token: 0x06004707 RID: 18183 RVA: 0x000F2CA0 File Offset: 0x000F1CA0
		...
		// Token: 0x06004708 RID: 18184 RVA: 0x000F2CC8 File Offset: 0x000F1CC8
		...
		// Token: 0x06004709 RID: 18185 RVA: 0x000F2E7C File Offset: 0x000F1E7C
		...
		// Token: 0x0600470A RID: 18186 RVA: 0x000F2EB0 File Offset: 0x000F1EB0
		...
		// Token: 0x0600470B RID: 18187 RVA: 0x000F2FA4 File Offset: 0x000F1FA4
		...
		// Token: 0x0600470C RID: 18188 RVA: 0x000F3024 File Offset: 0x000F2024
		...
		// Token: 0x0600470D RID: 18189 RVA: 0x000F30C4 File Offset: 0x000F20C4
		...
		// Token: 0x0600470E RID: 18190 RVA: 0x000F315D File Offset: 0x000F215D
		...
		// Token: 0x0600470F RID: 18191 RVA: 0x000F3178 File Offset: 0x000F2178
		...
		// Token: 0x06004710 RID: 18192 RVA: 0x000F3218 File Offset: 0x000F2218
		...
		// Token: 0x06004711 RID: 18193 RVA: 0x000F3274 File Offset: 0x000F2274
		...
		// Token: 0x06004712 RID: 18194 RVA: 0x000F32C4 File Offset: 0x000F22C4
		...
		// Token: 0x06004713 RID: 18195 RVA: 0x000F32D4 File Offset: 0x000F22D4
		...
		// Token: 0x06004714 RID: 18196 RVA: 0x000F32F1 File Offset: 0x000F22F1
		...
		// Token: 0x06004715 RID: 18197 RVA: 0x000F3302 File Offset: 0x000F2302
		...
		// Token: 0x06004716 RID: 18198 RVA: 0x000F3318 File Offset: 0x000F2318
		internal void WriteDelayedNullItem()
		{
			this.nullCount++;
		}

		// Token: 0x06004717 RID: 18199 RVA: 0x000F3328 File Offset: 0x000F2328
		internal void WriteItemEnd()
		{
			this.InternalWriteItemNull();
		}

		// Token: 0x06004718 RID: 18200 RVA: 0x000F3330 File Offset: 0x000F2330
		...
		// Token: 0x06004719 RID: 18201 RVA: 0x000F3388 File Offset: 0x000F2388
		...
		// Token: 0x0600471A RID: 18202 RVA: 0x000F3398 File Offset: 0x000F2398
		...
		// Token: 0x0600471B RID: 18203 RVA: 0x000F33F4 File Offset: 0x000F23F4
