...
namespace TechnoPro.Common.UI.Web.Notetaking.Controls
{
	...
	[ToolboxData("<{0}:CtrlNotetakerCourseListFromDataSync runat=server></{0}:CtrlNotetakerCourseListFromDataSync>")]
	public class CtrlNotetakerCourseListFromDataSync : WebControl, INamingContainer
	{
