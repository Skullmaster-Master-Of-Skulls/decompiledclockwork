...
namespace System.DirectoryServices
{
	...
	public class DirectoryEntry : System.ComponentModel.Component
	{
		...
		internal void InitADsObjectOptions()
		{
			...
			{
				object obj = null;
				int option = ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions2)this.adsObject).GetOption(8, out obj);
				if (option != 0)
				{
				...
				else
				{
					...
					value.varType = 11;
					value.boolvalue = -1;
					((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions2)this.adsObject).SetOption(8, value);
		...
		internal void Bind(bool throwIfFail)
		{
			...
			if (this.adsObject == null)
			{
				...
				object obj = null;
				int num = System.DirectoryServices.Interop.UnsafeNativeMethods.ADsOpenObject(text, this.GetUsername(), this.GetPassword(), (int)this.authenticationType, ref guid, out obj);
				if (num != 0)
				{
					if (throwIfFail)
					{
				...
				{
					this.adsObject = (System.DirectoryServices.Interop.UnsafeNativeMethods.IAds)obj;
				}
				this.InitADsObjectOptions();
			}
		}
		...
		public DirectoryEntry CopyTo(DirectoryEntry newParent, string newName)
		{
			...
			{
				throw new InvalidOperationException(Res.GetString("DSNotAContainer", new object[]
				{
					newParent.Path
				}));
			}
		...
		public void DeleteTree()
		{
			...
			System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsDeleteOps adsDeleteOps = (System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsDeleteOps)this.AdsObject;
			try
			{
		...
		internal void FillCache(string propertyName)
		{
			if (!this.UsePropertyCache)
			{
				...
				try
				{
					...
					{
						this.adsObject.GetInfoEx(new object[]
						{
							propertyName
						}, 0);
					}
		...
		public object InvokeGet(string propertyName)
		{
			...
			try
			{
				result = type.InvokeMember(propertyName, BindingFlags.GetProperty, null, nativeObject, null, CultureInfo.InvariantCulture);
				GC.KeepAlive(this);
			}
			catch (COMException e)
			{
		...
		private ActiveDirectorySecurity GetObjectSecurityFromCache()
		{
			...
			try
			{
				if (!this.JustCreated)
				{
					...
					this.RefreshCache(new string[]
					{
						DirectoryEntry.securityDescriptorProperty
					});
					...
					System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsPropertyList adsPropertyList = (System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsPropertyList)this.NativeObject;
					System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsPropertyEntry adsPropertyEntry = (System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsPropertyEntry)adsPropertyList.GetPropertyItem(DirectoryEntry.securityDescriptorProperty, 8);
					GC.KeepAlive(this);
					...
					result = new ActiveDirectorySecurity((byte[])adsPropertyValue.OctetString, securityMasks);
				}
				else
				{
					result = null;
		...
		private void SetObjectSecurityInCache()
		{
			if (this.objectSecurity != null && (this.objectSecurityModified || this.objectSecurity.IsModified()))
			{
				...
				adsPropertyEntry.Values = new object[]
				{
					adsPropertyValue
				};
				((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsPropertyList)this.NativeObject).PutPropertyItem(adsPropertyEntry);
			}
		}
