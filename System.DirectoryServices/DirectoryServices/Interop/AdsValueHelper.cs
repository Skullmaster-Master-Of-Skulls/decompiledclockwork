...
namespace System.DirectoryServices.Interop
{
	...
	internal class AdsValueHelper
	{
		...
		public object GetValue()
		{
			...
			case 24:
			case 26:
				return new NotImplementedException(Res.GetString("DSAdsvalueTypeNYI", new object[]
				{
		...
		private void SetValue(object managedValue, AdsType adsType)
		{
			...
			throw new NotImplementedException(Res.GetString("DSAdsvalueTypeNYI", new object[]
			{
				"0x" + Convert.ToString((int)adsType, 16)
			}));
		}
