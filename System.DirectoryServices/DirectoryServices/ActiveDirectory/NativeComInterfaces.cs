...
namespace System.DirectoryServices.ActiveDirectory
{
	...
	internal sealed class NativeComInterfaces
	{
		...
		internal interface IAdsProperty
		{
			...
			string OID { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.BStr)] get; [param: MarshalAs(UnmanagedType.BStr)] set; }
			...
			int MaxRange { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.U4)] get; [param: MarshalAs(UnmanagedType.U4)] set; }

			// Token: 0x17000170 RID: 368
			// (get) Token: 0x06000647 RID: 1607
			// (set) Token: 0x06000648 RID: 1608
			int MinRange { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.U4)] get; [param: MarshalAs(UnmanagedType.U4)] set; }

			// Token: 0x17000171 RID: 369
			// (get) Token: 0x06000649 RID: 1609
			// (set) Token: 0x0600064A RID: 1610
			bool MultiValued { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.VariantBool)] get; [param: MarshalAs(UnmanagedType.VariantBool)] set; }
		...
		internal interface IAdsClass
		{
			...
			object MandatoryProperties { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.Struct)] get; [param: MarshalAs(UnmanagedType.Struct)] set; }

			// Token: 0x1700017E RID: 382
			// (get) Token: 0x06000664 RID: 1636
			// (set) Token: 0x06000665 RID: 1637
			object OptionalProperties { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.Struct)] get; [param: MarshalAs(UnmanagedType.Struct)] set; }
			...
			object AuxDerivedFrom { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.Struct)] get; [param: MarshalAs(UnmanagedType.Struct)] set; }

			// Token: 0x17000182 RID: 386
			// (get) Token: 0x0600066C RID: 1644
			// (set) Token: 0x0600066D RID: 1645
			object PossibleSuperiors { [SuppressUnmanagedCodeSecurity] [return: MarshalAs(UnmanagedType.Struct)] get; [param: MarshalAs(UnmanagedType.Struct)] set; }
