...
namespace System.DirectoryServices.ActiveDirectory
{
	...
	public class ReplicationFailureCollection : ReadOnlyCollectionBase
	{
		...
		internal void AddHelper(DS_REPL_KCC_DSA_FAILURES failures, IntPtr info)
		{
			...
			{
				addr = Utils.AddToIntPtr(info, Marshal.SizeOf(typeof(int)) * 2 + i * Marshal.SizeOf(typeof(DS_REPL_KCC_DSA_FAILURE)));
				ReplicationFailure replicationFailure = new ReplicationFailure(addr, this.server, this.nameTable);
