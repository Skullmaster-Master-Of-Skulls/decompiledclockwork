...
namespace System.DirectoryServices.ActiveDirectory
{
	...
	public class ReplicationNeighborCollection : ReadOnlyCollectionBase
	{
		...
		internal void AddHelper(DS_REPL_NEIGHBORS neighbors, IntPtr info)
		{
			...
			{
				addr = Utils.AddToIntPtr(info, Marshal.SizeOf(typeof(int)) * 2 + i * Marshal.SizeOf(typeof(DS_REPL_NEIGHBOR)));
				ReplicationNeighbor neighbor = new ReplicationNeighbor(addr, this.server, this.nameTable);
				this.Add(neighbor);
			}
		}
