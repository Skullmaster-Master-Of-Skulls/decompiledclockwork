	...
	public class AttributeMetadata
	{
		...
		internal AttributeMetadata(IntPtr info, bool advanced, DirectoryServer server, Hashtable table)
		{
			if (advanced)
			{
				...
				long fileTime = (long)((ulong)ds_REPL_ATTR_META_DATA_.ftimeLastOriginatingChange1 + (ulong)((ulong)((long)ds_REPL_ATTR_META_DATA_.ftimeLastOriginatingChange2) << 32));
			...
			else
			{
				...
				long fileTime2 = (long)((ulong)ds_REPL_ATTR_META_DATA.ftimeLastOriginatingChange1 + (ulong)((ulong)((long)ds_REPL_ATTR_META_DATA.ftimeLastOriginatingChange2) << 32));
				this.ftimeLastOriginatingChange = DateTime.FromFileTime(fileTime2);
