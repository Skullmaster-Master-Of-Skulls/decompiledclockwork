...
namespace System.DirectoryServices.ActiveDirectory
{
	...
	public class DirectoryServerCollection : CollectionBase
	{
		...
		internal DirectoryServerCollection(DirectoryContext context, DirectoryEntry crossRefEntry, bool isADAM, ReadOnlyDirectoryServerCollection servers)
		{
			...
			{
				DirectoryServer value = (DirectoryServer)obj;
		...
		public int Add(DirectoryServer server)
		{
			...
			else
			{
				...
				if (Utils.Compare(this.siteDN, s) != 0)
				{
		...
		protected override void OnInsertComplete(int index, object value)
		{
			if (this.isForNC)
			{
				...
				try
				{
					...
					this.crossRefEntry.Properties[PropertyManager.MsDSNCReplicaLocations].Add(value2);
					return;
				}
				catch (COMException e)
				{
			...
			if (this.isForNC)
			{
				try
				{
					if (this.crossRefEntry != null)
					{
						...
						this.crossRefEntry.Properties[PropertyManager.MsDSNCReplicaLocations].Remove(value2);
					}
					return;
				}
				catch (COMException e)
