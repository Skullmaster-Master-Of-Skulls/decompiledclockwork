	...
	public class DomainController : DirectoryServer
	{
		...
		public static DomainController GetDomainController(DirectoryContext context)
		{
			...
			if (!context.isServer())
			{
				...
				{
					context.Name
				}), typeof(DomainController), context.Name);
			}
			...
			return new DomainController(context, domainControllerName, directoryEntryManager);
		}
		...
		public void SeizeRoleOwnership(ActiveDirectoryRole role)
		{
			...
			case ActiveDirectoryRole.SchemaRole:
				dn = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.SchemaNamingContext);
				break;
			case ActiveDirectoryRole.NamingRole:
				dn = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.PartitionsContainer);
				break;
			case ActiveDirectoryRole.PdcRole:
				dn = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.DefaultNamingContext);
				break;
			case ActiveDirectoryRole.RidRole:
				dn = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.RidManager);
				break;
			case ActiveDirectoryRole.InfrastructureRole:
				dn = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.Infrastructure);
				break;
			default:
				throw new InvalidEnumArgumentException("role", (int)role, typeof(ActiveDirectoryRole));
			}
		...
		public override ReplicationCursorCollection GetReplicationCursors(string partition)
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, 8, 1, partition, ref advanced, context, DirectoryContext.ADHandle);
			return base.ConstructReplicationCursors(this.dsHandle, advanced, info, partition, this, DirectoryContext.ADHandle);
		}
		...
		public override ReplicationOperationInformation GetReplicationOperationInformation()
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, 5, 5, null, ref flag, 0, DirectoryContext.ADHandle);
			return base.ConstructPendingOperations(info, this, DirectoryContext.ADHandle);
		}
		...
		public override ReplicationNeighborCollection GetReplicationNeighbors(string partition)
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, 0, 0, partition, ref flag, 0, DirectoryContext.ADHandle);
			return base.ConstructNeighbors(info, this, DirectoryContext.ADHandle);
		}
		...
		public override ReplicationNeighborCollection GetAllReplicationNeighbors()
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, 0, 0, null, ref flag, 0, DirectoryContext.ADHandle);
			return base.ConstructNeighbors(info, this, DirectoryContext.ADHandle);
		}
		...
		public override ActiveDirectoryReplicationMetadata GetReplicationMetadata(string objectPath)
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, 9, 2, objectPath, ref advanced, 0, DirectoryContext.ADHandle);
			return base.ConstructMetaData(advanced, info, this, DirectoryContext.ADHandle);
		}
		...
		public DateTime CurrentTime
		{
			get
			{
				...
				try
				{
					dateTime = (string)PropertyManager.GetPropertyValue(this.context, directoryEntry, PropertyManager.CurrentTime);
				}
				finally
				{
					directoryEntry.Dispose();
		...
		public long HighestCommittedUsn
		{
			get
			{
				...
				try
				{
					s = (string)PropertyManager.GetPropertyValue(this.context, directoryEntry, PropertyManager.HighestCommittedUSN);
				}
				finally
				{
					directoryEntry.Dispose();
		...
		public Domain Domain
		{
			get
			{
				...
				if (this.cachedDomain == null)
				{
					...
					try
					{
						string distinguishedName = this.directoryEntryMgr.ExpandWellKnownDN(WellKnownDN.DefaultNamingContext);
						domainName = Utils.GetDnsNameFromDN(distinguishedName);
					}
					catch (COMException e)
					{
						throw ExceptionHelper.GetExceptionFromCOMException(this.context, e);
					...
					DirectoryContext newDirectoryContext = Utils.GetNewDirectoryContext(base.Name, DirectoryContextType.DirectoryServer, this.context);
					this.cachedDomain = new Domain(newDirectoryContext, domainName);
				}
		...
		public override string SiteName
		{
			...
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("SiteNameNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal string SiteObjectName
		{
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("SiteObjectNameNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal string ComputerObjectName
		{
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("ComputerObjectNameNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal string ServerObjectName
		{
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("ServerObjectNameNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal string NtdsaObjectName
		{
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("NtdsaObjectNameNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal Guid NtdsaObjectGuid
		{
			get
			{
				...
				{
					throw new ActiveDirectoryOperationException(Res.GetString("NtdsaObjectGuidNotFound", new object[]
					{
						base.Name
					}));
				}
		...
		internal static DomainController FindOneWithCredentialValidation(DirectoryContext context, string siteName, LocatorOptions flag)
		{
			...
			catch (COMException ex)
			{
				...
				{
					throw new ActiveDirectoryObjectNotFoundException(Res.GetString("DCNotFoundInDomain", new object[]
					{
						context.Name
		...
		internal ReplicationFailureCollection GetReplicationFailures(DS_REPL_INFO_TYPE type)
		{
			...
			this.GetDSHandle();
			info = base.GetReplicationInfoHelper(this.dsHandle, (int)type, (int)type, null, ref flag, 0, DirectoryContext.ADHandle);
			return base.ConstructFailures(info, this, DirectoryContext.ADHandle);
		}
