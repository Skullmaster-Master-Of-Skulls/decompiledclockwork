...
namespace System.DirectoryServices.ActiveDirectory
{
	...
	public class ReplicationOperationCollection : ReadOnlyCollectionBase
	{
		...
		internal void AddHelper(DS_REPL_PENDING_OPS operations, IntPtr info)
		{
			...
			{
				addr = Utils.AddToIntPtr(info, Marshal.SizeOf(typeof(DS_REPL_PENDING_OPS)) + i * Marshal.SizeOf(typeof(DS_REPL_OP)));
				ReplicationOperation operation = new ReplicationOperation(addr, this.server, this.nameTable);
				this.Add(operation);
			}
		}
