...
namespace System.Runtime.Remoting.MetadataServices
{
	...
	public class MetaData
	{
		...
		public static void ConvertCodeSourceStreamToAssemblyFile(ArrayList outCodeStreamList, string assemblyPath, string strongNameFilename)
		{
			...
			try
			{
				...
				if (array.Length > 0)
				{
					...
					compilerResults = codeDomProvider.CompileAssemblyFromSource(new CompilerParameters(assemblyNames, assemblyPath, true)
					{
		...
		{
			MetaData.ConvertCodeSourceStreamToAssemblyFile(new ArrayList
			{
				codePath
			}, assemblyPath, strongNameFilename);
		}
