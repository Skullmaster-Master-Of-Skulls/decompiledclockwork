...
namespace System.Runtime.Remoting.Channels.Ipc
{
	...
	internal class IpcClientTransportSink : BaseChannelSinkWithProperties, IClientChannelSink, IChannelSinkBase
	{
		...
		public void AsyncProcessRequest(IClientChannelSinkStack sinkStack, IMessage msg, ITransportHeaders headers, Stream requestStream)
		{
			...
			Stream stream;
			asyncMessageDelegate.BeginInvoke(msg, headers, requestStream, out transportHeaders, out stream, sinkStack, callback, null);
		}
		...
		private void AsyncFinishedCallback(IAsyncResult ar)
		{
			...
			try
			{
				...
				Stream stream;
				clientChannelSinkStack = asyncMessageDelegate.EndInvoke(out headers, out stream, ar);
		...
		public override object this[object key]
		{
			get
			{
				...
				string a;
				if ((a = text.ToLower(CultureInfo.InvariantCulture)) != null)
				{
					if (a == "tokenimpersonationlevel")
					{
