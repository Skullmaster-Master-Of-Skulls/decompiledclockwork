...
namespace System.Runtime.Remoting.Channels.Tcp
{
	...
	internal class TcpClientSocketHandler : TcpSocketHandler
	{
		...
		public BaseTransportHeaders ReadHeaders()
		{
			...
			if (num != 2)
			{
				throw new RemotingException(string.Format(CultureInfo.CurrentCulture, CoreChannel.GetResourceString("Remoting_Tcp_ExpectingReplyOp"), new object[]
				{
		...
		public void SendRequest(IMessage msg, ITransportHeaders headers, Stream contentStream)
		{
			...
			this.GetRequestStream(msg, contentLength, headers);
