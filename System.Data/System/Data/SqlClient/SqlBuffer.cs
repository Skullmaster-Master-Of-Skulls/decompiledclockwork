...
namespace System.Data.SqlClient
{
	...
	{
		// Token: 0x060022B0 RID: 8880 RVA: 0x0028C738 File Offset: 0x0028BB38
		internal SqlBuffer()
		{
		}

		// Token: 0x060022B1 RID: 8881 RVA: 0x0028C758 File Offset: 0x0028BB58
		...
		// (get) Token: 0x060022B2 RID: 8882 RVA: 0x0028C7A8 File Offset: 0x0028BBA8
		...
		// (get) Token: 0x060022B3 RID: 8883 RVA: 0x0028C7C8 File Offset: 0x0028BBC8
		...
		// (get) Token: 0x060022B4 RID: 8884 RVA: 0x0028C7E8 File Offset: 0x0028BBE8
		// (set) Token: 0x060022B5 RID: 8885 RVA: 0x0028C828 File Offset: 0x0028BC28
		...
		// (get) Token: 0x060022B6 RID: 8886 RVA: 0x0028C858 File Offset: 0x0028BC58
		// (set) Token: 0x060022B7 RID: 8887 RVA: 0x0028C898 File Offset: 0x0028BC98
		internal byte Byte
		{
			get
			{
		...
		// (get) Token: 0x060022B8 RID: 8888 RVA: 0x0028C8C8 File Offset: 0x0028BCC8
		...
		// (get) Token: 0x060022B9 RID: 8889 RVA: 0x0028C8F8 File Offset: 0x0028BCF8
		...
		// (get) Token: 0x060022BA RID: 8890 RVA: 0x0028C998 File Offset: 0x0028BD98
		...
		// (get) Token: 0x060022BB RID: 8891 RVA: 0x0028CA88 File Offset: 0x0028BE88
		// (set) Token: 0x060022BC RID: 8892 RVA: 0x0028CAC8 File Offset: 0x0028BEC8
		...
		// (get) Token: 0x060022BD RID: 8893 RVA: 0x0028CAF8 File Offset: 0x0028BEF8
		internal Guid Guid
		{
			get
			{
		...
		// (get) Token: 0x060022BE RID: 8894 RVA: 0x0028CB28 File Offset: 0x0028BF28
		// (set) Token: 0x060022BF RID: 8895 RVA: 0x0028CB68 File Offset: 0x0028BF68
		...
		// (get) Token: 0x060022C0 RID: 8896 RVA: 0x0028CB98 File Offset: 0x0028BF98
		// (set) Token: 0x060022C1 RID: 8897 RVA: 0x0028CBD8 File Offset: 0x0028BFD8
		internal int Int32
		{
			get
			{
		...
		// (get) Token: 0x060022C2 RID: 8898 RVA: 0x0028CC08 File Offset: 0x0028C008
		// (set) Token: 0x060022C3 RID: 8899 RVA: 0x0028CC48 File Offset: 0x0028C048
		internal long Int64
		{
			get
			{
		...
		// (get) Token: 0x060022C4 RID: 8900 RVA: 0x0028CC78 File Offset: 0x0028C078
		// (set) Token: 0x060022C5 RID: 8901 RVA: 0x0028CCB8 File Offset: 0x0028C0B8
		...
		// (get) Token: 0x060022C6 RID: 8902 RVA: 0x0028CCE8 File Offset: 0x0028C0E8
		...
		// (get) Token: 0x060022C7 RID: 8903 RVA: 0x0028CD38 File Offset: 0x0028C138
		...
		// (get) Token: 0x060022C8 RID: 8904 RVA: 0x0028CE48 File Offset: 0x0028C248
		...
		// (get) Token: 0x060022C9 RID: 8905 RVA: 0x0028CEA8 File Offset: 0x0028C2A8
		...
		// (get) Token: 0x060022CA RID: 8906 RVA: 0x0028CEE8 File Offset: 0x0028C2E8
		...
		// Token: 0x060022CB RID: 8907 RVA: 0x0028CF58 File Offset: 0x0028C358
		...
		// (get) Token: 0x060022CC RID: 8908 RVA: 0x0028CF88 File Offset: 0x0028C388
		// (set) Token: 0x060022CD RID: 8909 RVA: 0x0028CFB8 File Offset: 0x0028C3B8
		...
		// (get) Token: 0x060022CE RID: 8910 RVA: 0x0028CFE8 File Offset: 0x0028C3E8
		...
		// (get) Token: 0x060022CF RID: 8911 RVA: 0x0028D028 File Offset: 0x0028C428
		...
		// (get) Token: 0x060022D0 RID: 8912 RVA: 0x0028D068 File Offset: 0x0028C468
		// (set) Token: 0x060022D1 RID: 8913 RVA: 0x0028D0A8 File Offset: 0x0028C4A8
		...
		// (get) Token: 0x060022D2 RID: 8914 RVA: 0x0028D0D8 File Offset: 0x0028C4D8
		// (set) Token: 0x060022D3 RID: 8915 RVA: 0x0028D118 File Offset: 0x0028C518
		...
		// (get) Token: 0x060022D4 RID: 8916 RVA: 0x0028D148 File Offset: 0x0028C548
		...
		// (get) Token: 0x060022D5 RID: 8917 RVA: 0x0028D1A8 File Offset: 0x0028C5A8
		...
		// (get) Token: 0x060022D6 RID: 8918 RVA: 0x0028D258 File Offset: 0x0028C658
		...
		// (get) Token: 0x060022D7 RID: 8919 RVA: 0x0028D298 File Offset: 0x0028C698
		// (set) Token: 0x060022D8 RID: 8920 RVA: 0x0028D2C8 File Offset: 0x0028C6C8
		...
		// (get) Token: 0x060022D9 RID: 8921 RVA: 0x0028D2F8 File Offset: 0x0028C6F8
		...
		// (get) Token: 0x060022DA RID: 8922 RVA: 0x0028D338 File Offset: 0x0028C738
		...
		// (get) Token: 0x060022DB RID: 8923 RVA: 0x0028D378 File Offset: 0x0028C778
		...
		// (get) Token: 0x060022DC RID: 8924 RVA: 0x0028D3B8 File Offset: 0x0028C7B8
		...
		// (get) Token: 0x060022DD RID: 8925 RVA: 0x0028D408 File Offset: 0x0028C808
		...
		// (get) Token: 0x060022DE RID: 8926 RVA: 0x0028D458 File Offset: 0x0028C858
		...
		// (get) Token: 0x060022DF RID: 8927 RVA: 0x0028D4C8 File Offset: 0x0028C8C8
		...
		// (get) Token: 0x060022E0 RID: 8928 RVA: 0x0028D658 File Offset: 0x0028CA58
		...
		// Token: 0x060022E1 RID: 8929 RVA: 0x0028D7C8 File Offset: 0x0028CBC8
		...
		// Token: 0x060022E2 RID: 8930 RVA: 0x0028D9D8 File Offset: 0x0028CDD8
		...
		// Token: 0x060022E3 RID: 8931 RVA: 0x0028DA08 File Offset: 0x0028CE08
		...
		// Token: 0x060022E4 RID: 8932 RVA: 0x0028DA38 File Offset: 0x0028CE38
		...
		// Token: 0x060022E5 RID: 8933 RVA: 0x0028DA68 File Offset: 0x0028CE68
		internal void Clear()
		{
			this._isNull = false;
		...
		// Token: 0x060022E6 RID: 8934 RVA: 0x0028DA98 File Offset: 0x0028CE98
		...
		// Token: 0x060022E7 RID: 8935 RVA: 0x0028DAD8 File Offset: 0x0028CED8
		...
		// Token: 0x060022E8 RID: 8936 RVA: 0x0028DB78 File Offset: 0x0028CF78
		...
		// Token: 0x060022E9 RID: 8937 RVA: 0x0028DBA8 File Offset: 0x0028CFA8
		...
		// Token: 0x060022EA RID: 8938 RVA: 0x0028DBD8 File Offset: 0x0028CFD8
		...
		// Token: 0x060022EB RID: 8939 RVA: 0x0028DC08 File Offset: 0x0028D008
		...
		// Token: 0x060022EC RID: 8940 RVA: 0x0028DC38 File Offset: 0x0028D038
		...
		// Token: 0x060022ED RID: 8941 RVA: 0x0028DC78 File Offset: 0x0028D078
		...
		// Token: 0x060022EE RID: 8942 RVA: 0x0028DCA8 File Offset: 0x0028D0A8
		...
		// Token: 0x060022EF RID: 8943 RVA: 0x0028DCF8 File Offset: 0x0028D0F8
		...
		// Token: 0x060022F0 RID: 8944 RVA: 0x0028DD48 File Offset: 0x0028D148
		...
		// Token: 0x060022F1 RID: 8945 RVA: 0x0028DDC8 File Offset: 0x0028D1C8
		...
		// Token: 0x060022F2 RID: 8946 RVA: 0x0028DE48 File Offset: 0x0028D248
		...
		// Token: 0x060022F3 RID: 8947 RVA: 0x0028DF08 File Offset: 0x0028D308
		...
		// Token: 0x060022F4 RID: 8948 RVA: 0x0028DF68 File Offset: 0x0028D368
		private static int GetDateFromByteArray(byte[] buf, int offset)
		{
			return (int)buf[offset] + ((int)buf[offset + 1] << 8) + ((int)buf[offset + 2] << 16);
		}

		// Token: 0x060022F5 RID: 8949 RVA: 0x0028DF98 File Offset: 0x0028D398
