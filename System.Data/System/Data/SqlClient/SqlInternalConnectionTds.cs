...
namespace System.Data.SqlClient
{
	...
	{
		// Token: 0x060027A2 RID: 10146 RVA: 0x002ABBA8 File Offset: 0x002AAFA8
		...
		// (get) Token: 0x060027A3 RID: 10147 RVA: 0x002ABCB8 File Offset: 0x002AB0B8
		...
		// (get) Token: 0x060027A4 RID: 10148 RVA: 0x002ABCD8 File Offset: 0x002AB0D8
		...
		// (get) Token: 0x060027A5 RID: 10149 RVA: 0x002ABD08 File Offset: 0x002AB108
		...
		// (get) Token: 0x060027A6 RID: 10150 RVA: 0x002ABD28 File Offset: 0x002AB128
		...
		// (get) Token: 0x060027A7 RID: 10151 RVA: 0x002ABD48 File Offset: 0x002AB148
		...
		// (get) Token: 0x060027A8 RID: 10152 RVA: 0x002ABD68 File Offset: 0x002AB168
		...
		// (get) Token: 0x060027A9 RID: 10153 RVA: 0x002ABD98 File Offset: 0x002AB198
		...
		// (get) Token: 0x060027AA RID: 10154 RVA: 0x002ABDC8 File Offset: 0x002AB1C8
		...
		// (get) Token: 0x060027AB RID: 10155 RVA: 0x002ABDE8 File Offset: 0x002AB1E8
		...
		// (get) Token: 0x060027AC RID: 10156 RVA: 0x002ABE08 File Offset: 0x002AB208
		...
		// (get) Token: 0x060027AD RID: 10157 RVA: 0x002ABE28 File Offset: 0x002AB228
		...
		// (get) Token: 0x060027AE RID: 10158 RVA: 0x002ABE48 File Offset: 0x002AB248
		...
		// (get) Token: 0x060027AF RID: 10159 RVA: 0x002ABE68 File Offset: 0x002AB268
		...
		// (get) Token: 0x060027B0 RID: 10160 RVA: 0x002ABE88 File Offset: 0x002AB288
		...
		// (get) Token: 0x060027B1 RID: 10161 RVA: 0x002ABEA8 File Offset: 0x002AB2A8
		...
		// (get) Token: 0x060027B2 RID: 10162 RVA: 0x002ABEC8 File Offset: 0x002AB2C8
		...
		// Token: 0x060027B3 RID: 10163 RVA: 0x002ABF28 File Offset: 0x002AB328
		...
		// Token: 0x060027B4 RID: 10164 RVA: 0x002ABF88 File Offset: 0x002AB388
		...
		// Token: 0x060027B5 RID: 10165 RVA: 0x002ABFF8 File Offset: 0x002AB3F8
		...
		// Token: 0x060027B6 RID: 10166 RVA: 0x002AC078 File Offset: 0x002AB478
		...
		// Token: 0x060027B7 RID: 10167 RVA: 0x002AC0B8 File Offset: 0x002AB4B8
		...
		// Token: 0x060027B8 RID: 10168 RVA: 0x002AC108 File Offset: 0x002AB508
		...
		// Token: 0x060027B9 RID: 10169 RVA: 0x002AC1E8 File Offset: 0x002AB5E8
		internal void DecrementAsyncCount()
		{
			Interlocked.Decrement(ref this._asyncCommandCount);
		}

		// Token: 0x060027BA RID: 10170 RVA: 0x002AC208 File Offset: 0x002AB608
		internal void IncrementAsyncCount()
		{
			Interlocked.Increment(ref this._asyncCommandCount);
		}

		// Token: 0x060027BB RID: 10171 RVA: 0x002AC228 File Offset: 0x002AB628
		...
		// Token: 0x060027BC RID: 10172 RVA: 0x002AC248 File Offset: 0x002AB648
		...
		// Token: 0x060027BD RID: 10173 RVA: 0x002AC268 File Offset: 0x002AB668
		...
		// Token: 0x060027BE RID: 10174 RVA: 0x002AC2F8 File Offset: 0x002AB6F8
		...
		// Token: 0x060027BF RID: 10175 RVA: 0x002AC4E8 File Offset: 0x002AB8E8
		...
		// Token: 0x060027C0 RID: 10176 RVA: 0x002AC668 File Offset: 0x002ABA68
		internal override void DelegatedTransactionEnded()
		{
			base.DelegatedTransactionEnded();
		}

		// Token: 0x060027C1 RID: 10177 RVA: 0x002AC688 File Offset: 0x002ABA88
		...
		// Token: 0x060027C2 RID: 10178 RVA: 0x002AC6B8 File Offset: 0x002ABAB8
		...
		// Token: 0x060027C3 RID: 10179 RVA: 0x002AC6E8 File Offset: 0x002ABAE8
		...
		// Token: 0x060027C4 RID: 10180 RVA: 0x002AC788 File Offset: 0x002ABB88
		...
		// Token: 0x060027C5 RID: 10181 RVA: 0x002AC8E8 File Offset: 0x002ABCE8
		...
		// Token: 0x060027C6 RID: 10182 RVA: 0x002AC918 File Offset: 0x002ABD18
		private void OpenLoginEnlist(SqlConnection owningObject, SqlConnectionString connectionOptions, string newPassword, bool redirectedUserInstance)
		{
			...
			{
				useFailoverHost = this.PoolGroupProviderInfo.UseFailoverPartner;
				failoverPartner = this.PoolGroupProviderInfo.FailoverPartner;
			}
			else
			{
				useFailoverHost = false;
				failoverPartner = base.ConnectionOptions.FailoverPartner;
			}
			bool flag = !ADP.IsEmpty(failoverPartner);
			try
			{
				if (flag)
				{
					this.LoginWithFailover(useFailoverHost, dataSource, failoverPartner, newPassword, redirectedUserInstance, owningObject, connectionOptions, timerStart);
				}
				else
				{
		...
		// Token: 0x060027C7 RID: 10183 RVA: 0x002AC9C8 File Offset: 0x002ABDC8
		private bool IsDoNotRetryConnectError(SqlException exc)
		{
			return 18456 == exc.Number || 18488 == exc.Number || exc._doNotReconnect;
		}

		// Token: 0x060027C8 RID: 10184 RVA: 0x002AC9F8 File Offset: 0x002ABDF8
		private void LoginNoFailover(string host, string newPassword, bool redirectedUserInstance, SqlConnection owningObject, SqlConnectionString connectionOptions, long timerStart)
		{
			...
			for (;;)
			{
				...
				{
					if (this._parser == null || this._parser.State != TdsParserState.Closed || this.IsDoNotRetryConnectError(exc) || ADP.TimerHasExpired(num4))
					{
						throw;
					}
		...
		// Token: 0x060027C9 RID: 10185 RVA: 0x002ACCF8 File Offset: 0x002AC0F8
		private void LoginWithFailover(bool useFailoverHost, string primaryHost, string failoverHost, string newPassword, bool redirectedUserInstance, SqlConnection owningObject, SqlConnectionString connectionOptions, long timerStart)
		{
			...
			for (;;)
			{
				...
				{
					if (this.IsDoNotRetryConnectError(exc) || ADP.TimerHasExpired(num2))
					{
						throw;
					}
					if (base.IsConnectionDoomed)
				...
				num7++;
				num6 = checked(ADP.TimerCurrent() + num4 * unchecked((long)(checked(num7 / 2 + 1))));
				if (num6 > num2)
				{
					num6 = num2;
				}
		...
		// Token: 0x060027CA RID: 10186 RVA: 0x002ACFA8 File Offset: 0x002AC3A8
		...
		// Token: 0x060027CB RID: 10187 RVA: 0x002AD008 File Offset: 0x002AC408
		...
		// Token: 0x060027CC RID: 10188 RVA: 0x002AD0C8 File Offset: 0x002AC4C8
		...
		// Token: 0x060027CD RID: 10189 RVA: 0x002AD0E8 File Offset: 0x002AC4E8
		...
		// Token: 0x060027CE RID: 10190 RVA: 0x002AD158 File Offset: 0x002AC558
		...
		// Token: 0x060027CF RID: 10191 RVA: 0x002AD1C8 File Offset: 0x002AC5C8
		...
		// Token: 0x060027D0 RID: 10192 RVA: 0x002AD228 File Offset: 0x002AC628
		...
		// (get) Token: 0x060027D1 RID: 10193 RVA: 0x002AD268 File Offset: 0x002AC668
		...
		// Token: 0x060027D2 RID: 10194 RVA: 0x002AD288 File Offset: 0x002AC688
		...
		// Token: 0x060027D3 RID: 10195 RVA: 0x002AD3C8 File Offset: 0x002AC7C8
