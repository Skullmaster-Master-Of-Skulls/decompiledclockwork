...
namespace System.Data.SqlClient
{
	...
	{
		// Token: 0x06002802 RID: 10242 RVA: 0x002ADF68 File Offset: 0x002AD368
		...
		// Token: 0x06002803 RID: 10243 RVA: 0x002ADF88 File Offset: 0x002AD388
				...
				while (dataReader.Read())
				{
					...
					if (array[0] != DBNull.Value && array[1] != DBNull.Value && array[2] != DBNull.Value && array[3] != DBNull.Value && array[4] != DBNull.Value && array[5] != DBNull.Value)
					{
						...
						if (array[7] != DBNull.Value)
						{
							...
							{
								stringBuilder2.Append(string.Format(null, "{0,-2:x2}", new object[]
								{
									b
								}));
							}
		...
		// Token: 0x06002804 RID: 10244 RVA: 0x002AE2D8 File Offset: 0x002AD6D8
		...
		// Token: 0x06002805 RID: 10245 RVA: 0x002AE468 File Offset: 0x002AD868
		...
		// Token: 0x06002806 RID: 10246 RVA: 0x002AE4D8 File Offset: 0x002AD8D8
		protected override DataTable PrepareCollection(string collectionName, string[] restrictions, DbConnection connection)
		{
			...
			if (collectionName == DbMetaDataCollectionNames.DataTypes)
			{
				...
				dataTable = this.GetDataTypesTable(connection2);
			}
			if (dataTable == null)
			{
