...
namespace System.Data.Entity.Core.Mapping.Update.Internal
{
	...
	{
		// Token: 0x06002666 RID: 9830 RVA: 0x000B6F8C File Offset: 0x000B518C
		internal UpdateCompiler(UpdateTranslator translator)
		{
			this.m_translator = translator;
		}

		// Token: 0x06002667 RID: 9831 RVA: 0x000B6F9C File Offset: 0x000B519C
		...
		// Token: 0x06002668 RID: 9832 RVA: 0x000B6FF4 File Offset: 0x000B51F4
		internal UpdateCommand BuildUpdateCommand(PropagatorResult oldRow, PropagatorResult newRow, TableChangeProcessor processor)
		{
			...
			DbUpdateCommandTree tree = new DbUpdateCommandTree(this.m_translator.MetadataWorkspace, DataSpace.SSpace, target, predicate, new ReadOnlyCollection<DbModificationClause>(list), returning);
		...
		// Token: 0x06002669 RID: 9833 RVA: 0x000B7118 File Offset: 0x000B5318
		internal UpdateCommand BuildInsertCommand(PropagatorResult newRow, TableChangeProcessor processor)
		{
			...
			DbInsertCommandTree tree = new DbInsertCommandTree(this.m_translator.MetadataWorkspace, DataSpace.SSpace, target, new ReadOnlyCollection<DbModificationClause>(list), returning);
		...
		// Token: 0x0600266A RID: 9834 RVA: 0x000B71BC File Offset: 0x000B53BC
		private IEnumerable<DbModificationClause> BuildSetClauses(DbExpressionBinding target, PropagatorResult row, PropagatorResult originalRow, TableChangeProcessor processor, bool insertMode, out Dictionary<int, string> outputIdentifiers, out DbExpression returning, ref bool rowMustBeTouched)
		{
			...
			for (int i = 0; i < processor.Table.ElementType.Properties.Count; i++)
			{
				...
				if ((byte)(propagatorFlags2 & propagatorFlags) != 0)
				{
					flag = true;
				}
				else if (flag3)
		...
		// Token: 0x0600266B RID: 9835 RVA: 0x000B7480 File Offset: 0x000B5680
		...
		// Token: 0x0600266C RID: 9836 RVA: 0x000B75A8 File Offset: 0x000B57A8
		...
		// Token: 0x0600266D RID: 9837 RVA: 0x000B75DE File Offset: 0x000B57DE
		...
		// Token: 0x0600266E RID: 9838 RVA: 0x000B75EC File Offset: 0x000B57EC
		...
		// Token: 0x0600266F RID: 9839 RVA: 0x000B7689 File Offset: 0x000B5889
		private static bool HasFlag(PropagatorResult input, PropagatorFlags flags)
		{
			return input != null && 0 != (byte)(flags & input.PropagatorFlags);
		}

		// Token: 0x06002670 RID: 9840 RVA: 0x000B769F File Offset: 0x000B589F
