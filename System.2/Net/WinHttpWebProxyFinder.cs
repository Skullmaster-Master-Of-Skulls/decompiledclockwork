...
namespace System.Net
{
	...
	{
		// Token: 0x06000F4F RID: 3919 RVA: 0x0004F3CC File Offset: 0x0004D5CC
		public WinHttpWebProxyFinder(AutoWebProxyScriptEngine engine) : base(engine)
		{
			...
			if (this.session == null || this.session.IsInvalid)
			{
				...
				if (Logging.On)
				{
					Logging.PrintError(Logging.Web, SR.GetString("net_log_proxy_winhttp_cant_open_session", new object[]
					{
						lastWin32Error
					}));
					return;
			...
			else
			{
				...
				if (!UnsafeNclNativeMethods.WinHttp.WinHttpSetTimeouts(this.session, downloadTimeout, downloadTimeout, downloadTimeout, downloadTimeout))
				{
					...
					if (Logging.On)
					{
						Logging.PrintError(Logging.Web, SR.GetString("net_log_proxy_winhttp_timeout_error", new object[]
						{
							lastWin32Error2
						}));
					}
		...
		// Token: 0x06000F50 RID: 3920 RVA: 0x0004F484 File Offset: 0x0004D684
		...
		// Token: 0x06000F51 RID: 3921 RVA: 0x0004F56F File Offset: 0x0004D76F
		public override void Abort()
		{
		}

		// Token: 0x06000F52 RID: 3922 RVA: 0x0004F571 File Offset: 0x0004D771
		...
		// Token: 0x06000F53 RID: 3923 RVA: 0x0004F580 File Offset: 0x0004D780
		...
		// Token: 0x06000F54 RID: 3924 RVA: 0x0004F5A8 File Offset: 0x0004D7A8
		private int GetProxies(Uri destination, Uri scriptLocation, out string proxyListString)
		{
			...
			if (!this.WinHttpGetProxyForUrl(destination.ToString(), ref winhttp_AUTOPROXY_OPTIONS, out proxyListString))
			{
				...
				if (Logging.On)
				{
					Logging.PrintError(Logging.Web, SR.GetString("net_log_proxy_winhttp_getproxy_failed", new object[]
					{
						destination,
						num
					}));
		...
		// Token: 0x06000F55 RID: 3925 RVA: 0x0004F684 File Offset: 0x0004D884
		...
		// Token: 0x06000F56 RID: 3926 RVA: 0x0004F6F0 File Offset: 0x0004D8F0
		...
		// Token: 0x06000F57 RID: 3927 RVA: 0x0004F710 File Offset: 0x0004D910
		...
		// Token: 0x06000F58 RID: 3928 RVA: 0x0004F770 File Offset: 0x0004D970
		...
		// Token: 0x06000F59 RID: 3929 RVA: 0x0004F7C8 File Offset: 0x0004D9C8
		...
		// Token: 0x06000F5A RID: 3930 RVA: 0x0004F80C File Offset: 0x0004DA0C
