...
namespace System.Net
{
	...
	internal class FtpControlStream : CommandStream
	{
		...
		// (get) Token: 0x060010FB RID: 4347 RVA: 0x0005BBF1 File Offset: 0x00059DF1
		// (set) Token: 0x060010FC RID: 4348 RVA: 0x0005BC1A File Offset: 0x00059E1A
		...
		// Token: 0x060010FD RID: 4349 RVA: 0x0005BC3C File Offset: 0x00059E3C
		...
		// Token: 0x060010FE RID: 4350 RVA: 0x0005BC5C File Offset: 0x00059E5C
		...
		// Token: 0x060010FF RID: 4351 RVA: 0x0005BC90 File Offset: 0x00059E90
		...
		// Token: 0x06001100 RID: 4352 RVA: 0x0005BD44 File Offset: 0x00059F44
		...
		// Token: 0x06001101 RID: 4353 RVA: 0x0005BDA0 File Offset: 0x00059FA0
		...
		// Token: 0x06001102 RID: 4354 RVA: 0x0005BDE4 File Offset: 0x00059FE4
		...
		// Token: 0x06001103 RID: 4355 RVA: 0x0005BEE0 File Offset: 0x0005A0E0
		...
		// Token: 0x06001104 RID: 4356 RVA: 0x0005BF38 File Offset: 0x0005A138
			...
			else
			{
				...
				else
				{
					...
					else if (status == FtpStatusCode.ServerWantsSecureSession)
					{
						...
						TlsStream networkStream = new TlsStream(ftpWebRequest2.RequestUri.Host, base.NetworkStream, ServicePointManager.CheckCertificateRevocationList, (SslProtocols)ServicePointManager.SecurityProtocol, ftpWebRequest2.ClientCertificates, base.Pool.ServicePoint, ftpWebRequest2, this.m_Async ? ftpWebRequest2.GetWritingContext().ContextCopy : null);
		...
		// Token: 0x06001105 RID: 4357 RVA: 0x0005C300 File Offset: 0x0005A500
		protected override CommandStream.PipelineEntry[] BuildCommandsList(WebRequest req)
		{
			...
			if (ftpWebRequest.MethodInfo.HasFlag(FtpMethodFlags.MustChangeWorkingDirectoryToPath) && text3.Length > 0)
			{
				...
				this.m_RequestedServerDirectory = text3;
			}
			...
			{
				arrayList.Add(new CommandStream.PipelineEntry(this.FormatFtpCommand("MDTM", parameter)));
			}
			if (!ftpWebRequest.MethodInfo.IsCommandOnly)
			{
				...
				{
					arrayList.Add(new CommandStream.PipelineEntry(this.FormatFtpCommand("SIZE", parameter)));
					arrayList.Add(new CommandStream.PipelineEntry(this.FormatFtpCommand("MDTM", parameter)));
				}
			}
			if (ftpWebRequest.CacheProtocol == null || ftpWebRequest.CacheProtocol.ProtocolStatus != CacheValidationStatus.Continue)
		...
		// Token: 0x06001106 RID: 4358 RVA: 0x0005C94C File Offset: 0x0005AB4C
		...
		// Token: 0x06001107 RID: 4359 RVA: 0x0005CB94 File Offset: 0x0005AD94
		internal void Quit()
		{
			base.CloseSocket();
		}

		// Token: 0x06001108 RID: 4360 RVA: 0x0005CB9C File Offset: 0x0005AD9C
		...
		// Token: 0x06001109 RID: 4361 RVA: 0x0005CC58 File Offset: 0x0005AE58
		...
		// Token: 0x0600110A RID: 4362 RVA: 0x0005CCC8 File Offset: 0x0005AEC8
		...
		// (get) Token: 0x0600110B RID: 4363 RVA: 0x0005CD23 File Offset: 0x0005AF23
		...
		// (get) Token: 0x0600110C RID: 4364 RVA: 0x0005CD2B File Offset: 0x0005AF2B
		...
		// (get) Token: 0x0600110D RID: 4365 RVA: 0x0005CD33 File Offset: 0x0005AF33
		...
		// (get) Token: 0x0600110E RID: 4366 RVA: 0x0005CD3B File Offset: 0x0005AF3B
		...
		// (get) Token: 0x0600110F RID: 4367 RVA: 0x0005CD52 File Offset: 0x0005AF52
		...
		// (get) Token: 0x06001110 RID: 4368 RVA: 0x0005CD69 File Offset: 0x0005AF69
		...
		// Token: 0x06001111 RID: 4369 RVA: 0x0005CD80 File Offset: 0x0005AF80
		...
		// Token: 0x06001112 RID: 4370 RVA: 0x0005CDCC File Offset: 0x0005AFCC
		...
		// Token: 0x06001113 RID: 4371 RVA: 0x0005CEE4 File Offset: 0x0005B0E4
		...
		// Token: 0x06001114 RID: 4372 RVA: 0x0005D020 File Offset: 0x0005B220
		...
		// Token: 0x06001115 RID: 4373 RVA: 0x0005D078 File Offset: 0x0005B278
		...
		// Token: 0x06001116 RID: 4374 RVA: 0x0005D0B8 File Offset: 0x0005B2B8
		...
		// Token: 0x06001117 RID: 4375 RVA: 0x0005D13C File Offset: 0x0005B33C
		...
		// Token: 0x06001118 RID: 4376 RVA: 0x0005D1D4 File Offset: 0x0005B3D4
		...
		// Token: 0x06001119 RID: 4377 RVA: 0x0005D260 File Offset: 0x0005B460
		...
		// Token: 0x0600111A RID: 4378 RVA: 0x0005D2E8 File Offset: 0x0005B4E8
		...
		// Token: 0x0600111B RID: 4379 RVA: 0x0005D368 File Offset: 0x0005B568
		...
		// Token: 0x0600111C RID: 4380 RVA: 0x0005D390 File Offset: 0x0005B590
		...
		// Token: 0x0600111D RID: 4381 RVA: 0x0005D49C File Offset: 0x0005B69C
