...
namespace Microsoft.Win32
{
	...
	internal static class NativeMethods
	{
		...
		// Token: 0x06000164 RID: 356 RVA: 0x0000D418 File Offset: 0x0000B618
		private static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current, int sizeOf)
		{
			if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData)
			{
				int num = checked((int)((long)current - (long)bufferStart));
				if (num < 0 || sizeOf > bufferSize - num)
				{
					NativeMethods.ThrowArgumentOutOfRangeException();
				}
			}
		}
		...
		// Token: 0x06000167 RID: 359 RVA: 0x0000D44A File Offset: 0x0000B64A
		internal static void ThrowArgumentOutOfRangeException()
		{
			throw new ArgumentOutOfRangeException("length");
		}

		// Token: 0x06000168 RID: 360 RVA: 0x0000D456 File Offset: 0x0000B656
		internal static void ThrowInvalidOperationException(Type type)
		{
			throw new InvalidOperationException(SR.GetString("InvalidPerfData", new object[]
			{
				type.Name
			}));
		}
		...
		{
			// Token: 0x06003FE9 RID: 16361 RVA: 0x0010CD64 File Offset: 0x0010AF64
			public STARTUPINFO()
			{
				this.cb = Marshal.SizeOf(this);
			}

			// Token: 0x06003FEA RID: 16362 RVA: 0x0010CDE4 File Offset: 0x0010AFE4
			public void Dispose()
			{
		...
		{
			// Token: 0x06003FF8 RID: 16376 RVA: 0x0010CF21 File Offset: 0x0010B121
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_COUNTER_BLOCK.SizeOf);
			}

			// Token: 0x06003FF9 RID: 16377 RVA: 0x0010CF30 File Offset: 0x0010B130
			public void Validate(int bufferSize)
			{
				if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData && (this.ByteLength < NativeMethods.PERF_COUNTER_BLOCK.SizeOf || this.ByteLength > bufferSize))
				{
					NativeMethods.ThrowInvalidOperationException(typeof(NativeMethods.PERF_COUNTER_BLOCK));
				}
			}
			...
			internal static readonly int SizeOf = Marshal.SizeOf(typeof(NativeMethods.PERF_COUNTER_BLOCK));
		}
		...
		{
			// Token: 0x06003FFC RID: 16380 RVA: 0x0010CF7C File Offset: 0x0010B17C
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_COUNTER_DEFINITION.SizeOf);
			}

			// Token: 0x06003FFD RID: 16381 RVA: 0x0010CF8C File Offset: 0x0010B18C
			public void Validate(int bufferSize)
			{
				if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData && (this.ByteLength < NativeMethods.PERF_COUNTER_DEFINITION.SizeOf || this.ByteLength > bufferSize || this.CounterSize < 0 || this.CounterOffset < 0 || this.CounterOffset > bufferSize))
				{
					NativeMethods.ThrowInvalidOperationException(typeof(NativeMethods.PERF_COUNTER_DEFINITION));
				}
			}
			...
			internal static readonly int SizeOf = Marshal.SizeOf(typeof(NativeMethods.PERF_COUNTER_DEFINITION));
		}
		...
		{
			// Token: 0x06004000 RID: 16384 RVA: 0x0010CFFE File Offset: 0x0010B1FE
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_DATA_BLOCK.SizeOf);
			}

			// Token: 0x06004001 RID: 16385 RVA: 0x0010D010 File Offset: 0x0010B210
			public void Validate(int bufferSize)
			{
				if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData && (this.TotalByteLength < NativeMethods.PERF_DATA_BLOCK.SizeOf || this.TotalByteLength > bufferSize || this.HeaderLength < NativeMethods.PERF_DATA_BLOCK.SizeOf || this.HeaderLength > this.TotalByteLength))
				{
					NativeMethods.ThrowInvalidOperationException(typeof(NativeMethods.PERF_DATA_BLOCK));
				}
			}
			...
			internal static readonly int SizeOf = Marshal.SizeOf(typeof(NativeMethods.PERF_DATA_BLOCK));
		}
		...
		{
			// Token: 0x06004004 RID: 16388 RVA: 0x0010D082 File Offset: 0x0010B282
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_INSTANCE_DEFINITION.SizeOf);
			}

			// Token: 0x06004005 RID: 16389 RVA: 0x0010D094 File Offset: 0x0010B294
			public void Validate(int bufferSize)
			{
				if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData && (this.ByteLength < NativeMethods.PERF_INSTANCE_DEFINITION.SizeOf || this.ByteLength > bufferSize || this.NameOffset < 0 || this.NameLength < 0 || checked(this.NameOffset + this.NameLength) > this.ByteLength))
				{
					NativeMethods.ThrowInvalidOperationException(typeof(NativeMethods.PERF_INSTANCE_DEFINITION));
				}
			}
			...
			internal static readonly int SizeOf = Marshal.SizeOf(typeof(NativeMethods.PERF_INSTANCE_DEFINITION));
		}
		...
		{
			// Token: 0x06004008 RID: 16392 RVA: 0x0010D112 File Offset: 0x0010B312
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_OBJECT_TYPE.SizeOf);
			}

			// Token: 0x06004009 RID: 16393 RVA: 0x0010D124 File Offset: 0x0010B324
			public void Validate(int bufferSize)
			{
				if (!LocalAppContextSwitches.DoNotValidatePerformanceCounterData && (this.HeaderLength < NativeMethods.PERF_OBJECT_TYPE.SizeOf || this.HeaderLength > this.TotalByteLength || this.HeaderLength > this.DefinitionLength || this.DefinitionLength < NativeMethods.PERF_OBJECT_TYPE.SizeOf || this.DefinitionLength > this.TotalByteLength || this.TotalByteLength > bufferSize || this.NumCounters < 0 || checked(((this.NumInstances <= 0) ? 0 : (this.NumInstances * NativeMethods.PERF_INSTANCE_DEFINITION.SizeOf)) + this.NumCounters * NativeMethods.PERF_COUNTER_DEFINITION.SizeOf) > bufferSize))
				{
					NativeMethods.ThrowInvalidOperationException(typeof(NativeMethods.PERF_OBJECT_TYPE));
				}
			}
			...
			internal static readonly int SizeOf = Marshal.SizeOf(typeof(NativeMethods.PERF_OBJECT_TYPE));
		}
		...
		{
			// Token: 0x06004010 RID: 16400 RVA: 0x0010D244 File Offset: 0x0010B444
		...
		// (Invoke) Token: 0x06004014 RID: 16404
		...
		{
			// Token: 0x06004017 RID: 16407 RVA: 0x0010D330 File Offset: 0x0010B530
		...
		{
			// Token: 0x0600401B RID: 16411 RVA: 0x0010D40F File Offset: 0x0010B60F
			public static int HIWORD(int n)
			{
				return n >> 16 & 65535;
			}

			// Token: 0x0600401C RID: 16412 RVA: 0x0010D41B File Offset: 0x0010B61B
