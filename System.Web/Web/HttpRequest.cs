	...
	public sealed class HttpRequest
	{
			...
			get
			{
				if (this._logonUserIdentity == null && this._wr != null)
				{
					...
					if (userToken != IntPtr.Zero)
					{
						...
						this._logonUserIdentity = HttpRequest.CreateWindowsIdentityWithAssert(userToken, (serverVariable2 == null) ? "" : serverVariable2, WindowsAccountType.Normal, isAuthenticated);
					}
				}
		...
		internal void SynchronizeHeader(string name, string value)
		{
			...
			if (httpServerVarsCollection != null)
			{
				...
				httpServerVarsCollection.SynchronizeServerVariable(name2, value);
			}
		}
