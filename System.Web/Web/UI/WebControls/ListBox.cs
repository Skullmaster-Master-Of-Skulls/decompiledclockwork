...
namespace System.Web.UI.WebControls
{
	...
	public class ListBox : ListControl, IPostBackDataHandler
	{
		...
		// (get) Token: 0x06004822 RID: 18466 RVA: 0x00126B59 File Offset: 0x00125B59
		// (set) Token: 0x06004823 RID: 18467 RVA: 0x00126B61 File Offset: 0x00125B61
		[Browsable(false)]
		...
		// (get) Token: 0x06004824 RID: 18468 RVA: 0x00126B6A File Offset: 0x00125B6A
		// (set) Token: 0x06004825 RID: 18469 RVA: 0x00126B72 File Offset: 0x00125B72
		[Browsable(false)]
		...
		// (get) Token: 0x06004826 RID: 18470 RVA: 0x00126B7B File Offset: 0x00125B7B
		// (set) Token: 0x06004827 RID: 18471 RVA: 0x00126B83 File Offset: 0x00125B83
		[Browsable(false)]
		...
		// (get) Token: 0x06004828 RID: 18472 RVA: 0x00126B8C File Offset: 0x00125B8C
		...
		// (get) Token: 0x06004829 RID: 18473 RVA: 0x00126B98 File Offset: 0x00125B98
		// (set) Token: 0x0600482A RID: 18474 RVA: 0x00126BC1 File Offset: 0x00125BC1
		...
		// (get) Token: 0x0600482B RID: 18475 RVA: 0x00126BE8 File Offset: 0x00125BE8
		// (set) Token: 0x0600482C RID: 18476 RVA: 0x00126C11 File Offset: 0x00125C11
		...
		// Token: 0x0600482D RID: 18477 RVA: 0x00126C3C File Offset: 0x00125C3C
		...
		// Token: 0x0600482E RID: 18478 RVA: 0x00126C7E File Offset: 0x00125C7E
		public virtual int[] GetSelectedIndices()
		{
			return (int[])this.SelectedIndicesInternal.ToArray(typeof(int));
		}

		// Token: 0x0600482F RID: 18479 RVA: 0x00126C9A File Offset: 0x00125C9A
		...
		// Token: 0x06004830 RID: 18480 RVA: 0x00126CC8 File Offset: 0x00125CC8
		bool IPostBackDataHandler.LoadPostData(string postDataKey, NameValueCollection postCollection)
		{
			return this.LoadPostData(postDataKey, postCollection);
		}

		// Token: 0x06004831 RID: 18481 RVA: 0x00126CD4 File Offset: 0x00125CD4
		...
		// Token: 0x06004832 RID: 18482 RVA: 0x00126DF4 File Offset: 0x00125DF4
		void IPostBackDataHandler.RaisePostDataChangedEvent()
		{
			this.RaisePostDataChangedEvent();
		}

		// Token: 0x06004833 RID: 18483 RVA: 0x00126DFC File Offset: 0x00125DFC
