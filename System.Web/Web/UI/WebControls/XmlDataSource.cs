...
namespace System.Web.UI.WebControls
{
	...
	public class XmlDataSource : HierarchicalDataSourceControl, IDataSource, IListSource
	{
		...
		// (get) Token: 0x06005233 RID: 21043 RVA: 0x0014C26E File Offset: 0x0014B26E
		...
		// (get) Token: 0x06005234 RID: 21044 RVA: 0x0014C295 File Offset: 0x0014B295
		// (set) Token: 0x06005235 RID: 21045 RVA: 0x0014C2A2 File Offset: 0x0014B2A2
		[WebCategory("Cache")]
		[DefaultValue(0)]
		...
		// (get) Token: 0x06005236 RID: 21046 RVA: 0x0014C2B0 File Offset: 0x0014B2B0
		// (set) Token: 0x06005237 RID: 21047 RVA: 0x0014C2BD File Offset: 0x0014B2BD
		...
		// (get) Token: 0x06005238 RID: 21048 RVA: 0x0014C2CB File Offset: 0x0014B2CB
		// (set) Token: 0x06005239 RID: 21049 RVA: 0x0014C2D8 File Offset: 0x0014B2D8
		...
		// (get) Token: 0x0600523A RID: 21050 RVA: 0x0014C2E6 File Offset: 0x0014B2E6
		// (set) Token: 0x0600523B RID: 21051 RVA: 0x0014C2FC File Offset: 0x0014B2FC
		...
		// (get) Token: 0x0600523C RID: 21052 RVA: 0x0014C36C File Offset: 0x0014B36C
		// (set) Token: 0x0600523D RID: 21053 RVA: 0x0014C384 File Offset: 0x0014B384
		[DefaultValue("")]
		...
		// (get) Token: 0x0600523E RID: 21054 RVA: 0x0014C3F0 File Offset: 0x0014B3F0
		// (set) Token: 0x0600523F RID: 21055 RVA: 0x0014C3FD File Offset: 0x0014B3FD
		...
		// (get) Token: 0x06005240 RID: 21056 RVA: 0x0014C40B File Offset: 0x0014B40B
		...
		// (get) Token: 0x06005241 RID: 21057 RVA: 0x0014C437 File Offset: 0x0014B437
		// (set) Token: 0x06005242 RID: 21058 RVA: 0x0014C450 File Offset: 0x0014B450
		[WebCategory("Data")]
		[DefaultValue("")]
		[Editor("System.ComponentModel.Design.MultilineStringEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
		[PersistenceMode(PersistenceMode.InnerProperty)]
		...
		// (get) Token: 0x06005243 RID: 21059 RVA: 0x0014C4C0 File Offset: 0x0014B4C0
		// (set) Token: 0x06005244 RID: 21060 RVA: 0x0014C4C8 File Offset: 0x0014B4C8
		[Browsable(false)]
		...
		// (get) Token: 0x06005245 RID: 21061 RVA: 0x0014C4D1 File Offset: 0x0014B4D1
		// (set) Token: 0x06005246 RID: 21062 RVA: 0x0014C4E8 File Offset: 0x0014B4E8
		[WebCategory("Data")]
		...
		// (get) Token: 0x06005247 RID: 21063 RVA: 0x0014C54D File Offset: 0x0014B54D
		...
		// (get) Token: 0x06005248 RID: 21064 RVA: 0x0014C569 File Offset: 0x0014B569
		// (set) Token: 0x06005249 RID: 21065 RVA: 0x0014C580 File Offset: 0x0014B580
		...
		// (add) Token: 0x0600524A RID: 21066 RVA: 0x0014C5DE File Offset: 0x0014B5DE
		// (remove) Token: 0x0600524B RID: 21067 RVA: 0x0014C5F1 File Offset: 0x0014B5F1
		[WebCategory("Data")]
		...
		// Token: 0x0600524C RID: 21068 RVA: 0x0014C604 File Offset: 0x0014B604
		...
		// Token: 0x0600524D RID: 21069 RVA: 0x0014C74E File Offset: 0x0014B74E
		protected override HierarchicalDataSourceView GetHierarchicalView(string viewPath)
		{
			return new XmlHierarchicalDataSourceView(this, viewPath);
		}

		// Token: 0x0600524E RID: 21070 RVA: 0x0014C758 File Offset: 0x0014B758
		private XmlReader GetReader(string path, string content, out CacheDependency cacheDependency)
		{
			if (path.Length != 0)
			{
				...
				else
				{
					...
					Stream stream = base.OpenFileAndGetDependency(virtualPath, physicalPath, out cacheDependency);
					if (AppSettings.RestrictXmlControls)
					{
		...
		// Token: 0x0600524F RID: 21071 RVA: 0x0014C874 File Offset: 0x0014B874
		...
		// Token: 0x06005250 RID: 21072 RVA: 0x0014C8E4 File Offset: 0x0014B8E4
		...
		// Token: 0x06005251 RID: 21073 RVA: 0x0014C9A0 File Offset: 0x0014B9A0
		...
		// Token: 0x06005252 RID: 21074 RVA: 0x0014CAE4 File Offset: 0x0014BAE4
		...
		// Token: 0x06005253 RID: 21075 RVA: 0x0014CB14 File Offset: 0x0014BB14
		public void Save()
		{
		...
		// (add) Token: 0x06005254 RID: 21076 RVA: 0x0014CB64 File Offset: 0x0014BB64
		// (remove) Token: 0x06005255 RID: 21077 RVA: 0x0014CB6D File Offset: 0x0014BB6D
		...
		// Token: 0x06005256 RID: 21078 RVA: 0x0014CB76 File Offset: 0x0014BB76
		...
		// Token: 0x06005257 RID: 21079 RVA: 0x0014CB90 File Offset: 0x0014BB90
		...
		// (get) Token: 0x06005258 RID: 21080 RVA: 0x0014CBC1 File Offset: 0x0014BBC1
		...
		// Token: 0x06005259 RID: 21081 RVA: 0x0014CBD3 File Offset: 0x0014BBD3
