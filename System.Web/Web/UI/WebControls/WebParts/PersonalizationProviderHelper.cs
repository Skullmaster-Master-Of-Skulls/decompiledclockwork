...
namespace System.Web.UI.WebControls.WebParts
{
	...
	{
		// Token: 0x0600567D RID: 22141 RVA: 0x0015D118 File Offset: 0x0015C118
		internal static string[] CheckAndTrimNonEmptyStringEntries(string[] array, string paramName, bool throwIfArrayIsNull, bool checkCommas, int lengthToCheck)
		{
			...
			else
			{
				if (array.Length == 0)
				{
					throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_Empty_Collection", new object[]
					{
						paramName
					}));
				}
				...
				for (int i = 0; i < array.Length; i++)
				{
					...
					{
						throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_Null_Or_Empty_String_Entries", new object[]
						{
							paramName
						}));
					}
					...
					{
						throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_CannotHaveCommaInString", new object[]
						{
							paramName,
							text
						}));
		...
		// Token: 0x0600567E RID: 22142 RVA: 0x0015D24C File Offset: 0x0015C24C
		...
		// Token: 0x0600567F RID: 22143 RVA: 0x0015D290 File Offset: 0x0015C290
		internal static void CheckOnlyOnePathWithUsers(string[] paths, string[] usernames)
		{
			...
			{
				throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_More_Than_One_Path", new object[]
				{
					"paths",
					"usernames"
				}));
		...
		// Token: 0x06005680 RID: 22144 RVA: 0x0015D2D7 File Offset: 0x0015C2D7
		...
		// Token: 0x06005681 RID: 22145 RVA: 0x0015D2F0 File Offset: 0x0015C2F0
		...
		// Token: 0x06005682 RID: 22146 RVA: 0x0015D32C File Offset: 0x0015C32C
		internal static void CheckNullEntries(ICollection array, string paramName)
		{
			...
			using (IEnumerator enumerator = array.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					{
						throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_Null_Entries", new object[]
						{
							paramName
						}));
					}
		...
		// Token: 0x06005683 RID: 22147 RVA: 0x0015D3C4 File Offset: 0x0015C3C4
		internal static void CheckPageIndexAndSize(int pageIndex, int pageSize)
		{
			if (pageIndex < 0)
			{
				throw new ArgumentException(SR.GetString("PersonalizationProviderHelper_Invalid_Less_Than_Parameter", new object[]
				{
					"pageIndex",
					"0"
				}));
		...
		// Token: 0x06005684 RID: 22148 RVA: 0x0015D44E File Offset: 0x0015C44E
		...
		// Token: 0x06005685 RID: 22149 RVA: 0x0015D464 File Offset: 0x0015C464
