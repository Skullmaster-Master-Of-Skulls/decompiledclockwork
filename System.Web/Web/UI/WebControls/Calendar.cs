...
namespace System.Web.UI.WebControls
{
	...
	{
		// Token: 0x06003BBF RID: 15295 RVA: 0x000FB252 File Offset: 0x000FA252
		public Calendar() : base(HtmlTextWriterTag.Table)
		{
		}

		// Token: 0x17000DBB RID: 3515
		// (get) Token: 0x06003BC0 RID: 15296 RVA: 0x000FB25C File Offset: 0x000FA25C
		// (set) Token: 0x06003BC1 RID: 15297 RVA: 0x000FB289 File Offset: 0x000FA289
		[Localizable(true)]
		...
		// (get) Token: 0x06003BC2 RID: 15298 RVA: 0x000FB29C File Offset: 0x000FA29C
		// (set) Token: 0x06003BC3 RID: 15299 RVA: 0x000FB2C5 File Offset: 0x000FA2C5
		...
		// (get) Token: 0x06003BC4 RID: 15300 RVA: 0x000FB2F0 File Offset: 0x000FA2F0
		// (set) Token: 0x06003BC5 RID: 15301 RVA: 0x000FB319 File Offset: 0x000FA319
		[WebCategory("Layout")]
		...
		// (get) Token: 0x06003BC6 RID: 15302 RVA: 0x000FB340 File Offset: 0x000FA340
		// (set) Token: 0x06003BC7 RID: 15303 RVA: 0x000FB369 File Offset: 0x000FA369
		...
		// (get) Token: 0x06003BC8 RID: 15304 RVA: 0x000FB390 File Offset: 0x000FA390
		...
		// (get) Token: 0x06003BC9 RID: 15305 RVA: 0x000FB3C0 File Offset: 0x000FA3C0
		// (set) Token: 0x06003BCA RID: 15306 RVA: 0x000FB3E9 File Offset: 0x000FA3E9
		...
		// (get) Token: 0x06003BCB RID: 15307 RVA: 0x000FB414 File Offset: 0x000FA414
		[WebCategory("Styles")]
		[DefaultValue(null)]
		[PersistenceMode(PersistenceMode.InnerProperty)]
		...
		// (get) Token: 0x06003BCC RID: 15308 RVA: 0x000FB444 File Offset: 0x000FA444
		// (set) Token: 0x06003BCD RID: 15309 RVA: 0x000FB46D File Offset: 0x000FA46D
		[WebCategory("Appearance")]
		...
		// (get) Token: 0x06003BCE RID: 15310 RVA: 0x000FB498 File Offset: 0x000FA498
		// (set) Token: 0x06003BCF RID: 15311 RVA: 0x000FB4C5 File Offset: 0x000FA4C5
		[Localizable(true)]
		[WebCategory("Appearance")]
		[DefaultValue("&gt;")]
		...
		// (get) Token: 0x06003BD0 RID: 15312 RVA: 0x000FB4D8 File Offset: 0x000FA4D8
		// (set) Token: 0x06003BD1 RID: 15313 RVA: 0x000FB501 File Offset: 0x000FA501
		...
		// (get) Token: 0x06003BD2 RID: 15314 RVA: 0x000FB52C File Offset: 0x000FA52C
		[WebCategory("Styles")]
		[PersistenceMode(PersistenceMode.InnerProperty)]
		...
		// (get) Token: 0x06003BD3 RID: 15315 RVA: 0x000FB55A File Offset: 0x000FA55A
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		[WebCategory("Styles")]
		...
		// (get) Token: 0x06003BD4 RID: 15316 RVA: 0x000FB588 File Offset: 0x000FA588
		// (set) Token: 0x06003BD5 RID: 15317 RVA: 0x000FB5B5 File Offset: 0x000FA5B5
		[DefaultValue("&lt;")]
		...
		// (get) Token: 0x06003BD6 RID: 15318 RVA: 0x000FB5C8 File Offset: 0x000FA5C8
		// (set) Token: 0x06003BD7 RID: 15319 RVA: 0x000FB5E9 File Offset: 0x000FA5E9
		...
		// (get) Token: 0x06003BD8 RID: 15320 RVA: 0x000FB611 File Offset: 0x000FA611
		...
		// (get) Token: 0x06003BD9 RID: 15321 RVA: 0x000FB645 File Offset: 0x000FA645
		[DefaultValue(null)]
		[PersistenceMode(PersistenceMode.InnerProperty)]
		...
		// (get) Token: 0x06003BDA RID: 15322 RVA: 0x000FB674 File Offset: 0x000FA674
		// (set) Token: 0x06003BDB RID: 15323 RVA: 0x000FB69D File Offset: 0x000FA69D
		...
		// (get) Token: 0x06003BDC RID: 15324 RVA: 0x000FB6C8 File Offset: 0x000FA6C8
		// (set) Token: 0x06003BDD RID: 15325 RVA: 0x000FB6F5 File Offset: 0x000FA6F5
		[Localizable(true)]
		[WebCategory("Appearance")]
		...
		// (get) Token: 0x06003BDE RID: 15326 RVA: 0x000FB708 File Offset: 0x000FA708
		...
		// (get) Token: 0x06003BDF RID: 15327 RVA: 0x000FB738 File Offset: 0x000FA738
		// (set) Token: 0x06003BE0 RID: 15328 RVA: 0x000FB765 File Offset: 0x000FA765
		[DefaultValue("&gt;")]
		...
		// (get) Token: 0x06003BE1 RID: 15329 RVA: 0x000FB778 File Offset: 0x000FA778
		// (set) Token: 0x06003BE2 RID: 15330 RVA: 0x000FB7A1 File Offset: 0x000FA7A1
		[WebCategory("Appearance")]
		...
		// (get) Token: 0x06003BE3 RID: 15331 RVA: 0x000FB7BC File Offset: 0x000FA7BC
		// (set) Token: 0x06003BE4 RID: 15332 RVA: 0x000FB7E5 File Offset: 0x000FA7E5
		[WebCategory("Appearance")]
		[DefaultValue(false)]
		...
		// (get) Token: 0x06003BE5 RID: 15333 RVA: 0x000FB800 File Offset: 0x000FA800
		// (set) Token: 0x06003BE6 RID: 15334 RVA: 0x000FB829 File Offset: 0x000FA829
		[DefaultValue(true)]
		...
		// (get) Token: 0x06003BE7 RID: 15335 RVA: 0x000FB844 File Offset: 0x000FA844
		// (set) Token: 0x06003BE8 RID: 15336 RVA: 0x000FB86D File Offset: 0x000FA86D
		...
		// (get) Token: 0x06003BE9 RID: 15337 RVA: 0x000FB888 File Offset: 0x000FA888
		// (set) Token: 0x06003BEA RID: 15338 RVA: 0x000FB8B1 File Offset: 0x000FA8B1
		[WebCategory("Appearance")]
		...
		// (get) Token: 0x06003BEB RID: 15339 RVA: 0x000FB8DC File Offset: 0x000FA8DC
		[PersistenceMode(PersistenceMode.InnerProperty)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
		...
		// (get) Token: 0x06003BEC RID: 15340 RVA: 0x000FB90A File Offset: 0x000FA90A
		[NotifyParentProperty(true)]
		...
		// (get) Token: 0x06003BED RID: 15341 RVA: 0x000FB938 File Offset: 0x000FA938
		// (set) Token: 0x06003BEE RID: 15342 RVA: 0x000FB965 File Offset: 0x000FA965
		[Browsable(false)]
		...
		// (get) Token: 0x06003BEF RID: 15343 RVA: 0x000FB984 File Offset: 0x000FA984
		// (set) Token: 0x06003BF0 RID: 15344 RVA: 0x000FB9AD File Offset: 0x000FA9AD
		[WebCategory("Accessibility")]
		...
		// (get) Token: 0x06003BF1 RID: 15345 RVA: 0x000FB9C8 File Offset: 0x000FA9C8
		// (set) Token: 0x06003BF2 RID: 15346 RVA: 0x000FB9F5 File Offset: 0x000FA9F5
		...
		// (get) Token: 0x06003BF3 RID: 15347 RVA: 0x000FBA13 File Offset: 0x000FAA13
		...
		// (add) Token: 0x06003BF4 RID: 15348 RVA: 0x000FBA41 File Offset: 0x000FAA41
		// (remove) Token: 0x06003BF5 RID: 15349 RVA: 0x000FBA54 File Offset: 0x000FAA54
		[WebCategory("Action")]
		...
		// (add) Token: 0x06003BF6 RID: 15350 RVA: 0x000FBA67 File Offset: 0x000FAA67
		// (remove) Token: 0x06003BF7 RID: 15351 RVA: 0x000FBA7A File Offset: 0x000FAA7A
		[WebCategory("Action")]
		...
		// (add) Token: 0x06003BF8 RID: 15352 RVA: 0x000FBA8D File Offset: 0x000FAA8D
		// (remove) Token: 0x06003BF9 RID: 15353 RVA: 0x000FBAA0 File Offset: 0x000FAAA0
		[WebCategory("Action")]
		...
		// Token: 0x06003BFA RID: 15354 RVA: 0x000FBAB4 File Offset: 0x000FAAB4
		...
		// Token: 0x06003BFB RID: 15355 RVA: 0x000FBBF7 File Offset: 0x000FABF7
		protected override ControlCollection CreateControlCollection()
		{
			return new InternalControlCollection(this);
		}

		// Token: 0x06003BFC RID: 15356 RVA: 0x000FBC00 File Offset: 0x000FAC00
		...
		// Token: 0x06003BFD RID: 15357 RVA: 0x000FBC54 File Offset: 0x000FAC54
		...
		// Token: 0x06003BFE RID: 15358 RVA: 0x000FBC98 File Offset: 0x000FAC98
		...
		// Token: 0x06003BFF RID: 15359 RVA: 0x000FBD48 File Offset: 0x000FAD48
		...
		// Token: 0x06003C00 RID: 15360 RVA: 0x000FBDBD File Offset: 0x000FADBD
		...
		// Token: 0x06003C01 RID: 15361 RVA: 0x000FBDD9 File Offset: 0x000FADD9
		...
		// Token: 0x06003C02 RID: 15362 RVA: 0x000FBDE8 File Offset: 0x000FADE8
		...
		// Token: 0x06003C06 RID: 15366 RVA: 0x000FBF60 File Offset: 0x000FAF60
		...
		// Token: 0x06003C07 RID: 15367 RVA: 0x000FC01E File Offset: 0x000FB01E
		...
		// Token: 0x06003C08 RID: 15368 RVA: 0x000FC03C File Offset: 0x000FB03C
		...
		// Token: 0x06003C09 RID: 15369 RVA: 0x000FC0C0 File Offset: 0x000FB0C0
		...
		// Token: 0x06003C0A RID: 15370 RVA: 0x000FC0F4 File Offset: 0x000FB0F4
		...
		// Token: 0x06003C0B RID: 15371 RVA: 0x000FC128 File Offset: 0x000FB128
		...
		// Token: 0x06003C0C RID: 15372 RVA: 0x000FC2A3 File Offset: 0x000FB2A3
		void IPostBackEventHandler.RaisePostBackEvent(string eventArgument)
		{
			this.RaisePostBackEvent(eventArgument);
		}

		// Token: 0x06003C0D RID: 15373 RVA: 0x000FC2AC File Offset: 0x000FB2AC
		...
		// Token: 0x06003C0E RID: 15374 RVA: 0x000FC2C8 File Offset: 0x000FB2C8
		...
		// Token: 0x06003C0F RID: 15375 RVA: 0x000FC500 File Offset: 0x000FB500
		...
		// Token: 0x06003C10 RID: 15376 RVA: 0x000FC5C0 File Offset: 0x000FB5C0
		...
		// Token: 0x06003C11 RID: 15377 RVA: 0x000FC5FC File Offset: 0x000FB5FC
		...
		// Token: 0x06003C12 RID: 15378 RVA: 0x000FC814 File Offset: 0x000FB814
		private void RenderDays(HtmlTextWriter writer, DateTime firstDay, DateTime visibleDate, CalendarSelectionMode selectionMode, bool buttonsActive, bool useAccessibleHeader)
		{
			...
			for (int j = 0; j < 6; j++)
			{
				...
				if (flag)
				{
					...
					string eventArgument = "R" + num2.ToString(CultureInfo.InvariantCulture);
					string title = null;
					if (useAccessibleHeader)
					{
				...
				for (int k = 0; k < 7; k++)
				{
					...
					if (tableItemStyle2 == null)
					{
						...
						this.SetDayStyles(tableItemStyle2, num4, defaultWidth);
		...
		// Token: 0x06003C13 RID: 15379 RVA: 0x000FCCD4 File Offset: 0x000FBCD4
		private void RenderTitle(HtmlTextWriter writer, DateTime visibleDate, CalendarSelectionMode selectionMode, bool buttonsActive, bool useAccessibleHeader)
		{
			...
			case TitleFormat.Month:
				text2 = visibleDate.ToString("MMMM", CultureInfo.CurrentCulture);
				goto IL_241;
			}
			string text3 = DateTimeFormatInfo.CurrentInfo.YearMonthPattern;
			if (text3.IndexOf(',') >= 0)
			{
				text3 = "MMMM yyyy";
			}
			text2 = visibleDate.ToString(text3, CultureInfo.CurrentCulture);
			IL_241:
			this.RenderCalendarCell(writer, tableItemStyle3, text2, null, false, null);
			if (this.ShowNextPrevMonth)
			{
		...
		// Token: 0x06003C14 RID: 15380 RVA: 0x000FD020 File Offset: 0x000FC020
		...
		// Token: 0x06003C15 RID: 15381 RVA: 0x000FD15C File Offset: 0x000FC15C
		...
		// Token: 0x06003C16 RID: 15382 RVA: 0x000FD1D0 File Offset: 0x000FC1D0
