...
namespace System.Web.UI.WebControls
{
	...
	public class AdRotator : DataBoundControl
	{
		...
		// (get) Token: 0x060039A5 RID: 14757 RVA: 0x000F3CF9 File Offset: 0x000F2CF9
		// (set) Token: 0x060039A6 RID: 14758 RVA: 0x000F3D0F File Offset: 0x000F2D0F
		[Bindable(true)]
		[UrlProperty]
		...
		// (get) Token: 0x060039A7 RID: 14759 RVA: 0x000F3D18 File Offset: 0x000F2D18
		// (set) Token: 0x060039A8 RID: 14760 RVA: 0x000F3D45 File Offset: 0x000F2D45
		[WebCategory("Behavior")]
		...
		// (get) Token: 0x060039A9 RID: 14761 RVA: 0x000F3D58 File Offset: 0x000F2D58
		...
		// (get) Token: 0x060039AA RID: 14762 RVA: 0x000F3DCD File Offset: 0x000F2DCD
		[Browsable(false)]
		...
		// (get) Token: 0x060039AB RID: 14763 RVA: 0x000F3DD8 File Offset: 0x000F2DD8
		// (set) Token: 0x060039AC RID: 14764 RVA: 0x000F3E05 File Offset: 0x000F2E05
		...
		// (get) Token: 0x060039AD RID: 14765 RVA: 0x000F3E18 File Offset: 0x000F2E18
		...
		// (get) Token: 0x060039AE RID: 14766 RVA: 0x000F3E30 File Offset: 0x000F2E30
		// (set) Token: 0x060039AF RID: 14767 RVA: 0x000F3E38 File Offset: 0x000F2E38
		...
		// (get) Token: 0x060039B0 RID: 14768 RVA: 0x000F3E44 File Offset: 0x000F2E44
		// (set) Token: 0x060039B1 RID: 14769 RVA: 0x000F3E71 File Offset: 0x000F2E71
		[Bindable(true)]
		[DefaultValue("")]
		[WebCategory("Behavior")]
		...
		// (get) Token: 0x060039B2 RID: 14770 RVA: 0x000F3EA4 File Offset: 0x000F2EA4
		// (set) Token: 0x060039B3 RID: 14771 RVA: 0x000F3ED1 File Offset: 0x000F2ED1
		...
		// (get) Token: 0x060039B4 RID: 14772 RVA: 0x000F3EE4 File Offset: 0x000F2EE4
		// (set) Token: 0x060039B5 RID: 14773 RVA: 0x000F3EEC File Offset: 0x000F2EEC
		...
		// (get) Token: 0x060039B6 RID: 14774 RVA: 0x000F3EF8 File Offset: 0x000F2EF8
		// (set) Token: 0x060039B7 RID: 14775 RVA: 0x000F3F25 File Offset: 0x000F2F25
		[WebCategory("Behavior")]
		...
		// (get) Token: 0x060039B8 RID: 14776 RVA: 0x000F3F38 File Offset: 0x000F2F38
		...
		// (get) Token: 0x060039B9 RID: 14777 RVA: 0x000F3F3B File Offset: 0x000F2F3B
		...
		// (add) Token: 0x060039BA RID: 14778 RVA: 0x000F3F57 File Offset: 0x000F2F57
		// (remove) Token: 0x060039BB RID: 14779 RVA: 0x000F3F6A File Offset: 0x000F2F6A
		...
		// Token: 0x060039BC RID: 14780 RVA: 0x000F3F80 File Offset: 0x000F2F80
		...
		// Token: 0x060039BD RID: 14781 RVA: 0x000F3FEC File Offset: 0x000F2FEC
		...
		// Token: 0x060039BE RID: 14782 RVA: 0x000F411C File Offset: 0x000F311C
		...
		// Token: 0x060039BF RID: 14783 RVA: 0x000F4220 File Offset: 0x000F3220
		...
		// Token: 0x060039C0 RID: 14784 RVA: 0x000F4284 File Offset: 0x000F3284
		...
		// Token: 0x060039C1 RID: 14785 RVA: 0x000F42B4 File Offset: 0x000F32B4
		...
		// Token: 0x060039C2 RID: 14786 RVA: 0x000F435C File Offset: 0x000F335C
		private AdRotator.AdRec[] GetFileData(string fileName)
		{
			...
			AdRotator.AdRec[] array = cacheInternal[key] as AdRotator.AdRec[];
			if (array == null)
			{
				...
				if (cacheDependency != null)
				{
					...
					{
						cacheInternal.UtcInsert(key, array, cacheDependency);
					}
				}
			}
			return array;
		...
		// Token: 0x060039C3 RID: 14787 RVA: 0x000F4484 File Offset: 0x000F3484
		...
		// Token: 0x060039C4 RID: 14788 RVA: 0x000F44A4 File Offset: 0x000F34A4
		...
		// Token: 0x060039C5 RID: 14789 RVA: 0x000F44C4 File Offset: 0x000F34C4
		private bool IsBindableType(Type type)
		{
			return type.IsPrimitive || type == typeof(string) || type == typeof(DateTime) || type == typeof(decimal);
		}

		// Token: 0x060039C6 RID: 14790 RVA: 0x000F44F8 File Offset: 0x000F34F8
		...
		// Token: 0x060039C7 RID: 14791 RVA: 0x000F453C File Offset: 0x000F353C
		...
		// Token: 0x060039C8 RID: 14792 RVA: 0x000F4604 File Offset: 0x000F3604
		...
		// Token: 0x060039C9 RID: 14793 RVA: 0x000F4694 File Offset: 0x000F3694
		...
		// Token: 0x060039CA RID: 14794 RVA: 0x000F4742 File Offset: 0x000F3742
		...
		// Token: 0x060039CB RID: 14795 RVA: 0x000F4754 File Offset: 0x000F3754
		...
		// Token: 0x060039CC RID: 14796 RVA: 0x000F4782 File Offset: 0x000F3782
		...
		// Token: 0x060039CD RID: 14797 RVA: 0x000F4794 File Offset: 0x000F3794
		...
		// Token: 0x060039CE RID: 14798 RVA: 0x000F47F6 File Offset: 0x000F37F6
		...
		// Token: 0x060039CF RID: 14799 RVA: 0x000F4820 File Offset: 0x000F3820
		...
		// Token: 0x060039D0 RID: 14800 RVA: 0x000F486F File Offset: 0x000F386F
		...
		// Token: 0x060039D1 RID: 14801 RVA: 0x000F4894 File Offset: 0x000F3894
		...
		// Token: 0x060039D2 RID: 14802 RVA: 0x000F48E4 File Offset: 0x000F38E4
		...
		// Token: 0x060039D3 RID: 14803 RVA: 0x000F491C File Offset: 0x000F391C
		...
		// Token: 0x060039D4 RID: 14804 RVA: 0x000F4B50 File Offset: 0x000F3B50
		...
		// Token: 0x060039D5 RID: 14805 RVA: 0x000F4B7C File Offset: 0x000F3B7C
		...
		// Token: 0x060039D6 RID: 14806 RVA: 0x000F4C80 File Offset: 0x000F3C80
		...
		{
			// Token: 0x060039D8 RID: 14808 RVA: 0x000F4D20 File Offset: 0x000F3D20
