...
namespace System.Web.UI.WebControls
{
	...
	public class BoundField : DataControlField
	{
		...
		// (get) Token: 0x06003A16 RID: 14870 RVA: 0x000F5790 File Offset: 0x000F4790
		// (set) Token: 0x06003A17 RID: 14871 RVA: 0x000F57B9 File Offset: 0x000F47B9
		...
		// (get) Token: 0x06003A18 RID: 14872 RVA: 0x000F57D4 File Offset: 0x000F47D4
		// (set) Token: 0x06003A19 RID: 14873 RVA: 0x000F57FD File Offset: 0x000F47FD
		...
		// (get) Token: 0x06003A1A RID: 14874 RVA: 0x000F5818 File Offset: 0x000F4818
		// (set) Token: 0x06003A1B RID: 14875 RVA: 0x000F5860 File Offset: 0x000F4860
		...
		// (get) Token: 0x06003A1C RID: 14876 RVA: 0x000F5898 File Offset: 0x000F4898
		// (set) Token: 0x06003A1D RID: 14877 RVA: 0x000F58E0 File Offset: 0x000F48E0
		[DefaultValue("")]
		[WebCategory("Data")]
		...
		// (get) Token: 0x06003A1E RID: 14878 RVA: 0x000F5918 File Offset: 0x000F4918
		// (set) Token: 0x06003A1F RID: 14879 RVA: 0x000F5920 File Offset: 0x000F4920
		...
		// (get) Token: 0x06003A20 RID: 14880 RVA: 0x000F595C File Offset: 0x000F495C
		// (set) Token: 0x06003A21 RID: 14881 RVA: 0x000F59A8 File Offset: 0x000F49A8
		...
		// (get) Token: 0x06003A22 RID: 14882 RVA: 0x000F59FC File Offset: 0x000F49FC
		// (set) Token: 0x06003A23 RID: 14883 RVA: 0x000F5A48 File Offset: 0x000F4A48
		[DefaultValue(true)]
		[WebCategory("Behavior")]
		...
		// (get) Token: 0x06003A24 RID: 14884 RVA: 0x000F5A9C File Offset: 0x000F4A9C
		// (set) Token: 0x06003A25 RID: 14885 RVA: 0x000F5AC9 File Offset: 0x000F4AC9
		[DefaultValue("")]
		...
		// (get) Token: 0x06003A26 RID: 14886 RVA: 0x000F5AFC File Offset: 0x000F4AFC
		// (set) Token: 0x06003A27 RID: 14887 RVA: 0x000F5B28 File Offset: 0x000F4B28
		...
		// (get) Token: 0x06003A28 RID: 14888 RVA: 0x000F5B6E File Offset: 0x000F4B6E
		...
		// Token: 0x06003A29 RID: 14889 RVA: 0x000F5B74 File Offset: 0x000F4B74
		...
		// Token: 0x06003A2A RID: 14890 RVA: 0x000F5C10 File Offset: 0x000F4C10
		protected override DataControlField CreateField()
		{
			return new BoundField();
		}

		// Token: 0x06003A2B RID: 14891 RVA: 0x000F5C18 File Offset: 0x000F4C18
		...
		// Token: 0x06003A2C RID: 14892 RVA: 0x000F5D14 File Offset: 0x000F4D14
		...
		// Token: 0x06003A2D RID: 14893 RVA: 0x000F5E15 File Offset: 0x000F4E15
		protected virtual object GetDesignTimeValue()
		{
			return SR.GetString("Sample_Databound_Text");
		}

		// Token: 0x06003A2E RID: 14894 RVA: 0x000F5E24 File Offset: 0x000F4E24
		protected virtual object GetValue(Control controlContainer)
		{
			...
			{
				result = this._boundFieldDesc.GetValue(dataItem);
			}
			else if (base.DesignMode)
			{
				result = this.GetDesignTimeValue();
			}
			else
			{
				result = dataItem;
		...
		// Token: 0x06003A2F RID: 14895 RVA: 0x000F5EF3 File Offset: 0x000F4EF3
		...
		// Token: 0x06003A30 RID: 14896 RVA: 0x000F5F08 File Offset: 0x000F4F08
		...
		// Token: 0x06003A31 RID: 14897 RVA: 0x000F5F84 File Offset: 0x000F4F84
		...
		// Token: 0x06003A32 RID: 14898 RVA: 0x000F6010 File Offset: 0x000F5010
		...
		// Token: 0x06003A33 RID: 14899 RVA: 0x000F60F3 File Offset: 0x000F50F3
		...
		// Token: 0x06003A34 RID: 14900 RVA: 0x000F6118 File Offset: 0x000F5118
