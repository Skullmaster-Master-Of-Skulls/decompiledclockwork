...
namespace System.Web.UI.WebControls
{
	...
	{
		// Token: 0x060044E8 RID: 17640 RVA: 0x0011B190 File Offset: 0x0011A190
		...
		// Token: 0x060044E9 RID: 17641 RVA: 0x0011B1CF File Offset: 0x0011A1CF
		...
		// Token: 0x060044EA RID: 17642 RVA: 0x0011B1FB File Offset: 0x0011A1FB
		...
		// Token: 0x060044EB RID: 17643 RVA: 0x0011B210 File Offset: 0x0011A210
		public FontUnit(double value)
		{
			this = new FontUnit(new Unit(value, UnitType.Point));
		}

		// Token: 0x060044EC RID: 17644 RVA: 0x0011B21F File Offset: 0x0011A21F
		public FontUnit(double value, UnitType type)
		{
			this = new FontUnit(new Unit(value, type));
		}

		// Token: 0x060044ED RID: 17645 RVA: 0x0011B22E File Offset: 0x0011A22E
		public FontUnit(string value)
		{
			this = new FontUnit(value, CultureInfo.CurrentCulture);
		}

		// Token: 0x060044EE RID: 17646 RVA: 0x0011B23C File Offset: 0x0011A23C
		...
		// (get) Token: 0x060044EF RID: 17647 RVA: 0x0011B3A7 File Offset: 0x0011A3A7
		public bool IsEmpty
		{
			get
			{
		...
		// (get) Token: 0x060044F0 RID: 17648 RVA: 0x0011B3B2 File Offset: 0x0011A3B2
		...
		// (get) Token: 0x060044F1 RID: 17649 RVA: 0x0011B3BA File Offset: 0x0011A3BA
		public Unit Unit
		{
			get
			{
		...
		// Token: 0x060044F2 RID: 17650 RVA: 0x0011B3C4 File Offset: 0x0011A3C4
		public override int GetHashCode()
		{
			return HashCodeCombiner.CombineHashCodes(this.type.GetHashCode(), this.value.GetHashCode());
		}

		// Token: 0x060044F3 RID: 17651 RVA: 0x0011B3FC File Offset: 0x0011A3FC
		...
		// Token: 0x060044F4 RID: 17652 RVA: 0x0011B443 File Offset: 0x0011A443
		public static bool operator ==(FontUnit left, FontUnit right)
		{
			return left.type == right.type && left.value == right.value;
		}

		// Token: 0x060044F5 RID: 17653 RVA: 0x0011B46A File Offset: 0x0011A46A
		public static bool operator !=(FontUnit left, FontUnit right)
		{
			return left.type != right.type || left.value != right.value;
		}

		// Token: 0x060044F6 RID: 17654 RVA: 0x0011B491 File Offset: 0x0011A491
		public static FontUnit Parse(string s)
		{
			return new FontUnit(s, CultureInfo.InvariantCulture);
		}

		// Token: 0x060044F7 RID: 17655 RVA: 0x0011B49E File Offset: 0x0011A49E
		public static FontUnit Parse(string s, CultureInfo culture)
		{
			return new FontUnit(s, culture);
		}

		// Token: 0x060044F8 RID: 17656 RVA: 0x0011B4A7 File Offset: 0x0011A4A7
		public static FontUnit Point(int n)
		{
			return new FontUnit(n);
		}

		// Token: 0x060044F9 RID: 17657 RVA: 0x0011B4AF File Offset: 0x0011A4AF
		public override string ToString()
		{
			return this.ToString(CultureInfo.CurrentCulture);
		}

		// Token: 0x060044FA RID: 17658 RVA: 0x0011B4BC File Offset: 0x0011A4BC
		public string ToString(CultureInfo culture)
		{
			return this.ToString(culture);
		}

		// Token: 0x060044FB RID: 17659 RVA: 0x0011B4C8 File Offset: 0x0011A4C8
		...
		// Token: 0x060044FC RID: 17660 RVA: 0x0011B569 File Offset: 0x0011A569
