...
namespace System.Web.UI.WebControls
{
	...
	public abstract class BaseDataList : WebControl
	{
		...
		// (get) Token: 0x06003AA6 RID: 15014 RVA: 0x000F7D1C File Offset: 0x000F6D1C
		// (set) Token: 0x06003AA7 RID: 15015 RVA: 0x000F7D49 File Offset: 0x000F6D49
		...
		// (get) Token: 0x06003AA8 RID: 15016 RVA: 0x000F7D5C File Offset: 0x000F6D5C
		// (set) Token: 0x06003AA9 RID: 15017 RVA: 0x000F7D85 File Offset: 0x000F6D85
		[WebCategory("Accessibility")]
		...
		// (get) Token: 0x06003AAA RID: 15018 RVA: 0x000F7DB0 File Offset: 0x000F6DB0
		// (set) Token: 0x06003AAB RID: 15019 RVA: 0x000F7DCC File Offset: 0x000F6DCC
		[WebCategory("Layout")]
		...
		// (get) Token: 0x06003AAC RID: 15020 RVA: 0x000F7DDF File Offset: 0x000F6DDF
		// (set) Token: 0x06003AAD RID: 15021 RVA: 0x000F7DFB File Offset: 0x000F6DFB
		[DefaultValue(0)]
		...
		// (get) Token: 0x06003AAE RID: 15022 RVA: 0x000F7E0E File Offset: 0x000F6E0E
		...
		// (get) Token: 0x06003AAF RID: 15023 RVA: 0x000F7E1C File Offset: 0x000F6E1C
		[Browsable(false)]
		...
		// (get) Token: 0x06003AB0 RID: 15024 RVA: 0x000F7E40 File Offset: 0x000F6E40
		...
		// (get) Token: 0x06003AB1 RID: 15025 RVA: 0x000F7E80 File Offset: 0x000F6E80
		// (set) Token: 0x06003AB2 RID: 15026 RVA: 0x000F7EAD File Offset: 0x000F6EAD
		...
		// (get) Token: 0x06003AB3 RID: 15027 RVA: 0x000F7EC0 File Offset: 0x000F6EC0
		// (set) Token: 0x06003AB4 RID: 15028 RVA: 0x000F7EED File Offset: 0x000F6EED
		[WebCategory("Data")]
		[Themeable(false)]
		[DefaultValue("")]
		...
		// (get) Token: 0x06003AB5 RID: 15029 RVA: 0x000F7F06 File Offset: 0x000F6F06
		// (set) Token: 0x06003AB6 RID: 15030 RVA: 0x000F7F10 File Offset: 0x000F6F10
		[WebCategory("Data")]
		...
		// (get) Token: 0x06003AB7 RID: 15031 RVA: 0x000F7F60 File Offset: 0x000F6F60
		// (set) Token: 0x06003AB8 RID: 15032 RVA: 0x000F7F8D File Offset: 0x000F6F8D
		...
		// (get) Token: 0x06003AB9 RID: 15033 RVA: 0x000F7FA6 File Offset: 0x000F6FA6
		// (set) Token: 0x06003ABA RID: 15034 RVA: 0x000F7FC2 File Offset: 0x000F6FC2
		...
		// (get) Token: 0x06003ABB RID: 15035 RVA: 0x000F7FD5 File Offset: 0x000F6FD5
		// (set) Token: 0x06003ABC RID: 15036 RVA: 0x000F7FF1 File Offset: 0x000F6FF1
		...
		// (get) Token: 0x06003ABD RID: 15037 RVA: 0x000F8004 File Offset: 0x000F7004
		...
		// (get) Token: 0x06003ABE RID: 15038 RVA: 0x000F800C File Offset: 0x000F700C
		...
		// (get) Token: 0x06003ABF RID: 15039 RVA: 0x000F801C File Offset: 0x000F701C
		// (set) Token: 0x06003AC0 RID: 15040 RVA: 0x000F8024 File Offset: 0x000F7024
		...
		// (get) Token: 0x06003AC1 RID: 15041 RVA: 0x000F802D File Offset: 0x000F702D
		...
		// (get) Token: 0x06003AC2 RID: 15042 RVA: 0x000F804C File Offset: 0x000F704C
		// (set) Token: 0x06003AC3 RID: 15043 RVA: 0x000F8075 File Offset: 0x000F7075
		[DefaultValue(false)]
		[WebCategory("Accessibility")]
		...
		// (add) Token: 0x06003AC4 RID: 15044 RVA: 0x000F808D File Offset: 0x000F708D
		// (remove) Token: 0x06003AC5 RID: 15045 RVA: 0x000F80A0 File Offset: 0x000F70A0
		...
		// Token: 0x06003AC6 RID: 15046 RVA: 0x000F80B3 File Offset: 0x000F70B3
		protected override void AddParsedSubObject(object obj)
		{
		}

		// Token: 0x06003AC7 RID: 15047 RVA: 0x000F80B8 File Offset: 0x000F70B8
		...
		// Token: 0x06003AC8 RID: 15048 RVA: 0x000F823B File Offset: 0x000F723B
		...
		// Token: 0x06003ACA RID: 15050 RVA: 0x000F8276 File Offset: 0x000F7276
		...
		// Token: 0x06003ACB RID: 15051 RVA: 0x000F82A3 File Offset: 0x000F72A3
		protected virtual DataSourceSelectArguments CreateDataSourceSelectArguments()
		{
			return DataSourceSelectArguments.Empty;
		}

		// Token: 0x06003ACC RID: 15052 RVA: 0x000F82AC File Offset: 0x000F72AC
		...
		// Token: 0x06003ACD RID: 15053 RVA: 0x000F82F8 File Offset: 0x000F72F8
		...
		// Token: 0x06003ACE RID: 15054 RVA: 0x000F831C File Offset: 0x000F731C
		public static bool IsBindableType(Type type)
		{
			return type.IsPrimitive || type == typeof(string) || type == typeof(DateTime) || type == typeof(decimal);
		}

		// Token: 0x06003ACF RID: 15055 RVA: 0x000F834F File Offset: 0x000F734F
		...
		// Token: 0x06003AD0 RID: 15056 RVA: 0x000F8384 File Offset: 0x000F7384
		...
		// Token: 0x06003AD1 RID: 15057 RVA: 0x000F83D0 File Offset: 0x000F73D0
		protected virtual void OnDataSourceViewChanged(object sender, EventArgs e)
		{
			this.RequiresDataBinding = true;
		}

		// Token: 0x06003AD2 RID: 15058 RVA: 0x000F83DC File Offset: 0x000F73DC
		...
		// Token: 0x06003AD3 RID: 15059 RVA: 0x000F842C File Offset: 0x000F742C
		...
		// Token: 0x06003AD4 RID: 15060 RVA: 0x000F8498 File Offset: 0x000F7498
		...
		// Token: 0x06003AD5 RID: 15061 RVA: 0x000F8514 File Offset: 0x000F7514
		...
		// Token: 0x06003AD6 RID: 15062 RVA: 0x000F8524 File Offset: 0x000F7524
		...
		// Token: 0x06003AD8 RID: 15064 RVA: 0x000F8552 File Offset: 0x000F7552
