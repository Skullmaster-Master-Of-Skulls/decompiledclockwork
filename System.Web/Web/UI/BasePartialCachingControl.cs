...
namespace System.Web.UI
{
	...
	{
		// Token: 0x06003494 RID: 13460 RVA: 0x000E3C74 File Offset: 0x000E2C74
		internal override void InitRecursive(Control namingContainer)
		{
			...
			if (obj != null)
			{
				...
				if (controlCachedVary != null)
				{
					...
					partialCachingCacheEntry = (BasePartialCachingControl.PartialCachingCacheEntry)HttpRuntime.CacheInternal.Get(key);
				}
				else
				{
		...
		// Token: 0x06003495 RID: 13461 RVA: 0x000E3F04 File Offset: 0x000E2F04
		...
		// Token: 0x06003496 RID: 13462 RVA: 0x000E3F34 File Offset: 0x000E2F34
		...
		// Token: 0x06003497 RID: 13463 RVA: 0x000E3F98 File Offset: 0x000E2F98
		...
		// (get) Token: 0x06003499 RID: 13465 RVA: 0x000E3FBA File Offset: 0x000E2FBA
		// (set) Token: 0x0600349A RID: 13466 RVA: 0x000E3FC2 File Offset: 0x000E2FC2
		...
		// (get) Token: 0x0600349B RID: 13467 RVA: 0x000E3FCB File Offset: 0x000E2FCB
		...
		// (get) Token: 0x0600349C RID: 13468 RVA: 0x000E3FE7 File Offset: 0x000E2FE7
		...
		// (get) Token: 0x0600349D RID: 13469 RVA: 0x000E400E File Offset: 0x000E300E
		// (set) Token: 0x0600349E RID: 13470 RVA: 0x000E4030 File Offset: 0x000E3030
		...
		// (get) Token: 0x0600349F RID: 13471 RVA: 0x000E4066 File Offset: 0x000E3066
		// (set) Token: 0x060034A0 RID: 13472 RVA: 0x000E4090 File Offset: 0x000E3090
		...
		// Token: 0x060034A1 RID: 13473 RVA: 0x000E40CC File Offset: 0x000E30CC
		...
		// Token: 0x060034A2 RID: 13474 RVA: 0x000E4144 File Offset: 0x000E3144
		...
		// Token: 0x060034A3 RID: 13475 RVA: 0x000E4168 File Offset: 0x000E3168
		protected internal override void Render(HtmlTextWriter output)
		{
			...
			else
			{
				...
				ControlCachedVary controlCachedVary = new ControlCachedVary(varyByParams, this._varyByControlsCollection, this._varyByCustom);
				HashCodeCombiner combinedHashCode = new HashCodeCombiner(this._nonVaryHashCode);
				key = this.ComputeVaryCacheKey(combinedHashCode, controlCachedVary);
				...
				CacheDependency cacheDependency3 = new CacheDependency(0, null, new string[]
				{
					this._cacheKey
				});
				if (cacheDependency2 == null)
				...
				else
				{
					...
					aggregateCacheDependency2.Add(new CacheDependency[]
					{
						cacheDependency2,
						cacheDependency3
					});
			...
			{
				utcAbsoluteExpiration = Cache.NoAbsoluteExpiration;
				slidingExpiration = this._utcExpirationTime - DateTime.UtcNow;
			}
			else
			{
				utcAbsoluteExpiration = this._utcExpirationTime;
				slidingExpiration = Cache.NoSlidingExpiration;
			}
			cacheInternal.UtcInsert(key, this._cacheEntry, cacheDependency2, utcAbsoluteExpiration, slidingExpiration);
		}

		// Token: 0x060034A4 RID: 13476 RVA: 0x000E4400 File Offset: 0x000E3400
		...
		// Token: 0x060034A5 RID: 13477 RVA: 0x000E444C File Offset: 0x000E344C
		...
		// Token: 0x060034A6 RID: 13478 RVA: 0x000E4604 File Offset: 0x000E3604
		...
		// Token: 0x060034A7 RID: 13479 RVA: 0x000E46A0 File Offset: 0x000E36A0
		...
		// Token: 0x060034AC RID: 13484 RVA: 0x000E4763 File Offset: 0x000E3763
		...
		// Token: 0x060034AD RID: 13485 RVA: 0x000E4770 File Offset: 0x000E3770
		...
		// Token: 0x060034AE RID: 13486 RVA: 0x000E47CF File Offset: 0x000E37CF
		...
		// Token: 0x060034AF RID: 13487 RVA: 0x000E47DA File Offset: 0x000E37DA
		...
		// Token: 0x060034B0 RID: 13488 RVA: 0x000E47E5 File Offset: 0x000E37E5
		...
		// Token: 0x060034B1 RID: 13489 RVA: 0x000E47F0 File Offset: 0x000E37F0
		...
		// Token: 0x060034B2 RID: 13490 RVA: 0x000E47FC File Offset: 0x000E37FC
		...
		// Token: 0x060034B3 RID: 13491 RVA: 0x000E4809 File Offset: 0x000E3809
