...
namespace System.Web.UI
{
	...
	internal class DataSourceCache : IStateManager
	{
		...
		// (get) Token: 0x06002FE3 RID: 12259 RVA: 0x000D4794 File Offset: 0x000D3794
		// (set) Token: 0x06002FE4 RID: 12260 RVA: 0x000D47BD File Offset: 0x000D37BD
		...
		// (get) Token: 0x06002FE5 RID: 12261 RVA: 0x000D47F0 File Offset: 0x000D37F0
		// (set) Token: 0x06002FE6 RID: 12262 RVA: 0x000D4819 File Offset: 0x000D3819
		...
		// (get) Token: 0x06002FE7 RID: 12263 RVA: 0x000D4834 File Offset: 0x000D3834
		// (set) Token: 0x06002FE8 RID: 12264 RVA: 0x000D485D File Offset: 0x000D385D
		...
		// (get) Token: 0x06002FE9 RID: 12265 RVA: 0x000D4890 File Offset: 0x000D3890
		// (set) Token: 0x06002FEA RID: 12266 RVA: 0x000D48BD File Offset: 0x000D38BD
		[DefaultValue("")]
		...
		// (get) Token: 0x06002FEB RID: 12267 RVA: 0x000D48D0 File Offset: 0x000D38D0
		...
		// Token: 0x06002FEC RID: 12268 RVA: 0x000D48FE File Offset: 0x000D38FE
		...
		// Token: 0x06002FED RID: 12269 RVA: 0x000D4937 File Offset: 0x000D3937
		...
		// Token: 0x06002FEE RID: 12270 RVA: 0x000D496F File Offset: 0x000D396F
		...
		// Token: 0x06002FEF RID: 12271 RVA: 0x000D4980 File Offset: 0x000D3980
		public void SaveDataToCache(string key, object data)
		{
			this.SaveDataToCache(key, data, null);
		}

		// Token: 0x06002FF0 RID: 12272 RVA: 0x000D498B File Offset: 0x000D398B
		...
		// Token: 0x06002FF1 RID: 12273 RVA: 0x000D4998 File Offset: 0x000D3998
		protected virtual void SaveDataToCacheInternal(string key, object data, CacheDependency dependency)
		{
			...
			DateTime utcAbsoluteExpiration = Cache.NoAbsoluteExpiration;
			TimeSpan slidingExpiration = Cache.NoSlidingExpiration;
			switch (this.ExpirationPolicy)
			{
			case DataSourceCacheExpiry.Absolute:
				utcAbsoluteExpiration = DateTime.UtcNow.AddSeconds((double)((this.Duration == 0) ? int.MaxValue : this.Duration));
				break;
			...
			HttpRuntime.CacheInternal.UtcInsert(key, data, aggregateCacheDependency, utcAbsoluteExpiration, slidingExpiration);
		}

		// Token: 0x06002FF2 RID: 12274 RVA: 0x000D4A96 File Offset: 0x000D3A96
		...
		// Token: 0x06002FF3 RID: 12275 RVA: 0x000D4AAD File Offset: 0x000D3AAD
		...
		// (get) Token: 0x06002FF4 RID: 12276 RVA: 0x000D4AC9 File Offset: 0x000D3AC9
		...
		// Token: 0x06002FF5 RID: 12277 RVA: 0x000D4AD1 File Offset: 0x000D3AD1
		void IStateManager.LoadViewState(object savedState)
		{
			this.LoadViewState(savedState);
		}

		// Token: 0x06002FF6 RID: 12278 RVA: 0x000D4ADA File Offset: 0x000D3ADA
		object IStateManager.SaveViewState()
		{
			return this.SaveViewState();
		}

		// Token: 0x06002FF7 RID: 12279 RVA: 0x000D4AE2 File Offset: 0x000D3AE2
