...
namespace System.Web.UI.HtmlControls
{
	...
	{
		// Token: 0x060037A5 RID: 14245 RVA: 0x000EE536 File Offset: 0x000ED536
		...
		// (get) Token: 0x060037A6 RID: 14246 RVA: 0x000EE54C File Offset: 0x000ED54C
		// (set) Token: 0x060037A7 RID: 14247 RVA: 0x000EE579 File Offset: 0x000ED579
		...
		// (get) Token: 0x060037A8 RID: 14248 RVA: 0x000EE597 File Offset: 0x000ED597
		// (set) Token: 0x060037A9 RID: 14249 RVA: 0x000EE5A0 File Offset: 0x000ED5A0
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[DefaultValue(null)]
		...
		// (get) Token: 0x060037AA RID: 14250 RVA: 0x000EE5F0 File Offset: 0x000ED5F0
		// (set) Token: 0x060037AB RID: 14251 RVA: 0x000EE61D File Offset: 0x000ED61D
		...
		// (get) Token: 0x060037AC RID: 14252 RVA: 0x000EE638 File Offset: 0x000ED638
		// (set) Token: 0x060037AD RID: 14253 RVA: 0x000EE660 File Offset: 0x000ED660
		...
		// (get) Token: 0x060037AE RID: 14254 RVA: 0x000EE688 File Offset: 0x000ED688
		// (set) Token: 0x060037AF RID: 14255 RVA: 0x000EE6B0 File Offset: 0x000ED6B0
		[WebCategory("Data")]
		[DefaultValue("")]
		...
		// (get) Token: 0x060037B0 RID: 14256 RVA: 0x000EE6D8 File Offset: 0x000ED6D8
		// (set) Token: 0x060037B1 RID: 14257 RVA: 0x000EE70C File Offset: 0x000ED70C
		...
		// (get) Token: 0x060037B2 RID: 14258 RVA: 0x000EE740 File Offset: 0x000ED740
		// (set) Token: 0x060037B3 RID: 14259 RVA: 0x000EE774 File Offset: 0x000ED774
		...
		// (get) Token: 0x060037B4 RID: 14260 RVA: 0x000EE7A6 File Offset: 0x000ED7A6
		...
		// (get) Token: 0x060037B5 RID: 14261 RVA: 0x000EE7B6 File Offset: 0x000ED7B6
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		// (get) Token: 0x060037B6 RID: 14262 RVA: 0x000EE7E4 File Offset: 0x000ED7E4
		// (set) Token: 0x060037B7 RID: 14263 RVA: 0x000EE812 File Offset: 0x000ED812
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		// (get) Token: 0x060037B8 RID: 14264 RVA: 0x000EE83E File Offset: 0x000ED83E
		// (set) Token: 0x060037B9 RID: 14265 RVA: 0x000EE846 File Offset: 0x000ED846
		[WebCategory("Behavior")]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[DefaultValue("")]
		public string Name
		...
		// (get) Token: 0x060037BA RID: 14266 RVA: 0x000EE848 File Offset: 0x000ED848
		...
		// (get) Token: 0x060037BB RID: 14267 RVA: 0x000EE850 File Offset: 0x000ED850
		// (set) Token: 0x060037BC RID: 14268 RVA: 0x000EE858 File Offset: 0x000ED858
		...
		// (get) Token: 0x060037BD RID: 14269 RVA: 0x000EE864 File Offset: 0x000ED864
		// (set) Token: 0x060037BE RID: 14270 RVA: 0x000EE8D0 File Offset: 0x000ED8D0
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		// (get) Token: 0x060037BF RID: 14271 RVA: 0x000EE92C File Offset: 0x000ED92C
		...
		// (get) Token: 0x060037C0 RID: 14272 RVA: 0x000EE9A4 File Offset: 0x000ED9A4
		// (set) Token: 0x060037C1 RID: 14273 RVA: 0x000EE9D2 File Offset: 0x000ED9D2
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public int Size
		{
			get
		...
		// (get) Token: 0x060037C2 RID: 14274 RVA: 0x000EE9EC File Offset: 0x000ED9EC
		// (set) Token: 0x060037C3 RID: 14275 RVA: 0x000EEA2C File Offset: 0x000EDA2C
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public string Value
		{
			get
		...
		// (add) Token: 0x060037C4 RID: 14276 RVA: 0x000EEA52 File Offset: 0x000EDA52
		// (remove) Token: 0x060037C5 RID: 14277 RVA: 0x000EEA65 File Offset: 0x000EDA65
		...
		// Token: 0x060037C6 RID: 14278 RVA: 0x000EEA78 File Offset: 0x000EDA78
		...
		// Token: 0x060037C7 RID: 14279 RVA: 0x000EEACC File Offset: 0x000EDACC
		...
		// Token: 0x060037C8 RID: 14280 RVA: 0x000EEB04 File Offset: 0x000EDB04
		...
		// Token: 0x060037C9 RID: 14281 RVA: 0x000EEC87 File Offset: 0x000EDC87
		protected override ControlCollection CreateControlCollection()
		{
			return new EmptyControlCollection(this);
		}

		// Token: 0x060037CA RID: 14282 RVA: 0x000EEC90 File Offset: 0x000EDC90
		...
		// Token: 0x060037CB RID: 14283 RVA: 0x000EECDC File Offset: 0x000EDCDC
		...
		// Token: 0x060037CC RID: 14284 RVA: 0x000EED00 File Offset: 0x000EDD00
		...
		// Token: 0x060037CD RID: 14285 RVA: 0x000EED4C File Offset: 0x000EDD4C
		...
		// Token: 0x060037CE RID: 14286 RVA: 0x000EEE9C File Offset: 0x000EDE9C
		...
		// Token: 0x060037CF RID: 14287 RVA: 0x000EEEE8 File Offset: 0x000EDEE8
		protected virtual void OnDataSourceViewChanged(object sender, EventArgs e)
		{
			this.RequiresDataBinding = true;
		}

		// Token: 0x060037D0 RID: 14288 RVA: 0x000EEEF4 File Offset: 0x000EDEF4
		...
		// Token: 0x060037D1 RID: 14289 RVA: 0x000EEF44 File Offset: 0x000EDF44
		...
		// Token: 0x060037D2 RID: 14290 RVA: 0x000EEFB0 File Offset: 0x000EDFB0
		...
		// Token: 0x060037D3 RID: 14291 RVA: 0x000EF02C File Offset: 0x000EE02C
		...
		// Token: 0x060037D4 RID: 14292 RVA: 0x000EF06C File Offset: 0x000EE06C
		...
		// Token: 0x060037D5 RID: 14293 RVA: 0x000EF09C File Offset: 0x000EE09C
		...
		// Token: 0x060037D6 RID: 14294 RVA: 0x000EF130 File Offset: 0x000EE130
		...
		// Token: 0x060037D7 RID: 14295 RVA: 0x000EF258 File Offset: 0x000EE258
		...
		// Token: 0x060037D8 RID: 14296 RVA: 0x000EF2B8 File Offset: 0x000EE2B8
		...
		// Token: 0x060037D9 RID: 14297 RVA: 0x000EF301 File Offset: 0x000EE301
		...
		// Token: 0x060037DA RID: 14298 RVA: 0x000EF314 File Offset: 0x000EE314
		bool IPostBackDataHandler.LoadPostData(string postDataKey, NameValueCollection postCollection)
		{
			return this.LoadPostData(postDataKey, postCollection);
		}

		// Token: 0x060037DB RID: 14299 RVA: 0x000EF320 File Offset: 0x000EE320
		...
		// Token: 0x060037DC RID: 14300 RVA: 0x000EF3FD File Offset: 0x000EE3FD
		void IPostBackDataHandler.RaisePostDataChangedEvent()
		{
			this.RaisePostDataChangedEvent();
		}

		// Token: 0x060037DD RID: 14301 RVA: 0x000EF405 File Offset: 0x000EE405
