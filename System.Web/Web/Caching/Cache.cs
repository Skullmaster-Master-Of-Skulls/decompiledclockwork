...
namespace System.Web.Caching
{
	...
	public sealed class Cache : IEnumerable
	{
		...
		public void Insert(string key, object value, CacheDependency dependencies, DateTime absoluteExpiration, TimeSpan slidingExpiration, CacheItemUpdateCallback onUpdateCallback)
		{
			...
			this._cacheInternal.DoInsert(false, "w" + key, new Cache.SentinelEntry(key, cacheDependency, onUpdateCallback), dependencies, utcAbsoluteExpiration, slidingExpiration, CacheItemPriority.NotRemovable, Cache.s_sentinelRemovedCallback, true);
		}
		...
		private class SentinelEntry
		{
			...
			public static void OnCacheItemRemovedCallback(string key, object value, CacheItemRemovedReason reason)
			{
				...
				{
					CacheItemUpdateReason reason2 = CacheItemUpdateReason.Expired;
					goto IL_34;
				}
				...
				{
					CacheItemUpdateReason reason2 = CacheItemUpdateReason.DependencyChanged;
				...
				try
				{
					...
					cacheItemUpdateCallback(sentinelEntry.Key, reason2, out obj, out dependencies, out absoluteExpiration, out slidingExpiration);
					if (obj != null)
					{
						HttpRuntime.Cache.Insert(sentinelEntry.Key, obj, dependencies, absoluteExpiration, slidingExpiration, sentinelEntry.CacheItemUpdateCallback);
					}
					else
					{
