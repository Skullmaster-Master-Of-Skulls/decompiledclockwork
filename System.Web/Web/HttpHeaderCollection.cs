...
namespace System.Web
{
	...
	internal class HttpHeaderCollection : HttpValueCollection
	{
		...
		internal void SetHeader(string name, string value, bool replace)
		{
			...
			if (this._request != null)
			{
				string value2 = replace ? value : base.Get(name);
				...
				{
					httpServerVarsCollection.SynchronizeServerVariable("HTTP_" + name.ToUpper(CultureInfo.InvariantCulture).Replace('-', '_'), value2);
				}
