	...
	internal abstract class BaseCodeDomTreeGenerator
	{
		...
		private bool BuildSourceDataTree()
		{
			...
			if (this._sourceDataClass != null)
			{
				...
				CodeTypeReference type = new CodeTypeReference(typeName, CodeTypeReferenceOptions.GlobalReference);
		...
		protected CodeLinePragma CreateCodeLinePragma(ControlBuilder builder)
		{
			...
			return this.CreateCodeLinePragma(virtualPathString, line, num, generatedColumn, codeLength);
		}
