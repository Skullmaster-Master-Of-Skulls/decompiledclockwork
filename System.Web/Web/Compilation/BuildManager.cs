...
namespace System.Web.Compilation
{
	...
	public sealed class BuildManager
	{
		...
		private BuildResult GetVPathBuildResultFromCacheInternal(VirtualPath virtualPath)
		{
			...
			return this.GetBuildResultFromCacheInternal(cacheKeyFromVirtualPath, keyFromVPP, virtualPath, 0L);
		}
		...
		private void CopyStaticFilesRecursive(VirtualDirectory sourceVdir, string destPhysicalDir, bool topLevel)
		{
			...
			BuildManager.VerifyUnrelatedSourceAndDest(sourcePhysicalDir, destPhysicalDir);
			bool flag = false;
		...
		internal static void VerifyUnrelatedSourceAndDest(string sourcePhysicalDir, string destPhysicalDir)
		{
			...
			{
				throw new HttpException(SR.GetString("Illegal_precomp_dir", new object[]
				{
					destPhysicalDir,
					sourcePhysicalDir
				}));
