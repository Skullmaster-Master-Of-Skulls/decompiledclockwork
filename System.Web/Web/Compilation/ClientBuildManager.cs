	...
	public sealed class ClientBuildManager : MarshalByRefObject, IDisposable
	{
		...
		private void CreateHost()
		{
			...
			try
			{
				ApplicationManager applicationManager = ApplicationManager.GetApplicationManager();
				string appId;
				buildManagerHost = (BuildManagerHost)applicationManager.CreateObjectWithDefaultAppHostAndAppId(this._physicalPath, this._virtualPath, typeof(BuildManagerHost), false, this._hostingParameters, out appId);
