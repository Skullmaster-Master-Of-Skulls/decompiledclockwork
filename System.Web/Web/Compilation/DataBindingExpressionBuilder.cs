...
namespace System.Web.Compilation
{
	...
	internal class DataBindingExpressionBuilder : ExpressionBuilder
	{
		...
		internal static void BuildExpressionSetup(ControlBuilder controlBuilder, CodeStatementCollection methodStatements, CodeStatementCollection statements)
		{
			...
			CodeAssignStatement value = new CodeAssignStatement(codeVariableReferenceExpression, new CodeCastExpression(controlBuilder.ControlType, new CodeArgumentReferenceExpression("sender")));
			...
			CodeAssignStatement value2 = new CodeAssignStatement(new CodeVariableReferenceExpression(codeVariableDeclarationStatement2.Name), new CodeCastExpression(bindingContainerType, new CodePropertyReferenceExpression(codeVariableReferenceExpression, "BindingContainer")));
		...
		internal static void BuildExpressionStatic(BoundPropertyEntry bpe, ControlBuilder controlBuilder, CodeExpression controlReference, CodeStatementCollection methodStatements, CodeStatementCollection statements, CodeLinePragma linePragma, ref bool hasTempObject)
		{
			...
			DataBindingExpressionBuilder.BuildPropertySetExpression(expression, bpe.Name, bpe.Type, controlBuilder, methodStatements, statements, linePragma, ref hasTempObject);
		}
