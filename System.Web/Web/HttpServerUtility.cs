...
namespace System.Web
{
	...
	public sealed class HttpServerUtility
	{
		...
		public void TransferRequest(string path, bool preserveForm, string method, NameValueCollection headers)
		{
			...
			string filename = request.MapPath(path);
			InternalSecurityPermissions.FileReadAccess(filename).Demand();
			iis7WorkerRequest.ScheduleExecuteUrl(virtualPath.VirtualPathString, queryString, method, preserveForm, preserveForm ? request.EntityBody : null, headers);
