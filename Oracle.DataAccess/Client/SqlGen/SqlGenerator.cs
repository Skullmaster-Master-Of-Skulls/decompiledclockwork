...
namespace Oracle.DataAccess.Client.SqlGen
{
	...
	internal sealed class SqlGenerator : DbExpressionVisitor<ISqlFragment>
	{
		...
		// (get) Token: 0x0600099F RID: 2463 RVA: 0x0005C948 File Offset: 0x0005B948
		...
		// (get) Token: 0x060009A0 RID: 2464 RVA: 0x0005C955 File Offset: 0x0005B955
		...
		// (get) Token: 0x060009A1 RID: 2465 RVA: 0x0005C971 File Offset: 0x0005B971
		...
		// (get) Token: 0x060009A2 RID: 2466 RVA: 0x0005C979 File Offset: 0x0005B979
		...
		// Token: 0x060009A3 RID: 2467 RVA: 0x0005C984 File Offset: 0x0005B984
		...
		// (get) Token: 0x060009A4 RID: 2468 RVA: 0x0005CE62 File Offset: 0x0005BE62
		...
		// Token: 0x060009A5 RID: 2469 RVA: 0x0005CE6E File Offset: 0x0005BE6E
		...
		// Token: 0x060009A6 RID: 2470 RVA: 0x0005CE90 File Offset: 0x0005BE90
		...
		// Token: 0x060009A7 RID: 2471 RVA: 0x0005CF2C File Offset: 0x0005BF2C
		...
		// Token: 0x060009A8 RID: 2472 RVA: 0x0005CFFC File Offset: 0x0005BFFC
		...
		// Token: 0x060009A9 RID: 2473 RVA: 0x0005D0AC File Offset: 0x0005C0AC
		...
		// Token: 0x060009AA RID: 2474 RVA: 0x0005D0F8 File Offset: 0x0005C0F8
		...
		// Token: 0x060009AB RID: 2475 RVA: 0x0005D114 File Offset: 0x0005C114
		...
		// Token: 0x060009AC RID: 2476 RVA: 0x0005D174 File Offset: 0x0005C174
		...
		// Token: 0x060009AD RID: 2477 RVA: 0x0005D318 File Offset: 0x0005C318
		...
		// Token: 0x060009AE RID: 2478 RVA: 0x0005D3D0 File Offset: 0x0005C3D0
		...
		// Token: 0x060009AF RID: 2479 RVA: 0x0005D4E8 File Offset: 0x0005C4E8
		...
		// Token: 0x060009B0 RID: 2480 RVA: 0x0005D5E8 File Offset: 0x0005C5E8
		private ISqlFragment VisitConstant(DbConstantExpression e, bool isCastOptional)
		{
			...
			if (MetadataHelpers.TryGetPrimitiveTypeKind(e.ResultType, out primitiveTypeKind))
			{
				...
				case PrimitiveTypeKind.Double:
					...
					if (this.IsPre10g)
					{
						SqlGenerator.WrapWithCastIfNeeded(!isCastOptional, ((double)e.Value).ToString(), "number", sqlBuilder);
						return sqlBuilder;
					}
					SqlGenerator.WrapWithCastIfNeeded(!isCastOptional, ((double)e.Value).ToString(), "binary_double", sqlBuilder);
					return sqlBuilder;
				...
				case PrimitiveTypeKind.Single:
					...
					if (this.IsPre10g)
					{
						SqlGenerator.WrapWithCastIfNeeded(!isCastOptional, ((float)e.Value).ToString(), "number", sqlBuilder);
						return sqlBuilder;
					}
					SqlGenerator.WrapWithCastIfNeeded(!isCastOptional, ((float)e.Value).ToString(), "binary_float", sqlBuilder);
					return sqlBuilder;
		...
		// Token: 0x060009B1 RID: 2481 RVA: 0x0005D9D7 File Offset: 0x0005C9D7
		...
		// Token: 0x060009B2 RID: 2482 RVA: 0x0005DA13 File Offset: 0x0005CA13
		public override ISqlFragment Visit(DbConstantExpression e)
		{
			return this.VisitConstant(e, false);
		}

		// Token: 0x060009B3 RID: 2483 RVA: 0x0005DA1D File Offset: 0x0005CA1D
		public override ISqlFragment Visit(DbDerefExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009B4 RID: 2484 RVA: 0x0005DA24 File Offset: 0x0005CA24
		...
		// Token: 0x060009B5 RID: 2485 RVA: 0x0005DA84 File Offset: 0x0005CA84
		...
		// Token: 0x060009B6 RID: 2486 RVA: 0x0005DAC0 File Offset: 0x0005CAC0
		public override ISqlFragment Visit(DbExceptExpression e)
		{
			return this.VisitSetOpExpression(e.Left, e.Right, "MINUS");
		}

		// Token: 0x060009B7 RID: 2487 RVA: 0x0005DAD9 File Offset: 0x0005CAD9
		public override ISqlFragment Visit(DbExpression e)
		{
			throw new InvalidOperationException(string.Empty);
		}

		// Token: 0x060009B8 RID: 2488 RVA: 0x0005DAE8 File Offset: 0x0005CAE8
		...
		// Token: 0x060009B9 RID: 2489 RVA: 0x0005DB30 File Offset: 0x0005CB30
		...
		// Token: 0x060009BA RID: 2490 RVA: 0x0005DBCD File Offset: 0x0005CBCD
		public override ISqlFragment Visit(DbFilterExpression e)
		{
			return this.VisitFilterExpression(e.Input, e.Predicate, false);
		}

		// Token: 0x060009BB RID: 2491 RVA: 0x0005DBE2 File Offset: 0x0005CBE2
		...
		// Token: 0x060009BC RID: 2492 RVA: 0x0005DBFB File Offset: 0x0005CBFB
		public override ISqlFragment Visit(DbLambdaExpression expression)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009BD RID: 2493 RVA: 0x0005DC02 File Offset: 0x0005CC02
		public override ISqlFragment Visit(DbEntityRefExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009BE RID: 2494 RVA: 0x0005DC09 File Offset: 0x0005CC09
		public override ISqlFragment Visit(DbRefKeyExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009BF RID: 2495 RVA: 0x0005DC10 File Offset: 0x0005CC10
		...
		// Token: 0x060009C5 RID: 2501 RVA: 0x0005E0D0 File Offset: 0x0005D0D0
		...
		// Token: 0x060009C6 RID: 2502 RVA: 0x0005E144 File Offset: 0x0005D144
		...
		// Token: 0x060009C7 RID: 2503 RVA: 0x0005E204 File Offset: 0x0005D204
		...
		// Token: 0x060009C8 RID: 2504 RVA: 0x0005E27C File Offset: 0x0005D27C
		...
		// Token: 0x060009C9 RID: 2505 RVA: 0x0005E2A0 File Offset: 0x0005D2A0
		...
		// Token: 0x060009CA RID: 2506 RVA: 0x0005E360 File Offset: 0x0005D360
		...
		// Token: 0x060009CB RID: 2507 RVA: 0x0005E37F File Offset: 0x0005D37F
		public override ISqlFragment Visit(DbOfTypeExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009CC RID: 2508 RVA: 0x0005E386 File Offset: 0x0005D386
		public override ISqlFragment Visit(DbOrExpression e)
		{
			return this.VisitBinaryExpression(" OR ", e.ExpressionKind, e.Left, e.Right);
		}

		// Token: 0x060009CD RID: 2509 RVA: 0x0005E3A8 File Offset: 0x0005D3A8
		...
		// Token: 0x060009CE RID: 2510 RVA: 0x0005E3D4 File Offset: 0x0005D3D4
		...
		// Token: 0x060009CF RID: 2511 RVA: 0x0005E4CC File Offset: 0x0005D4CC
		...
		// Token: 0x060009D0 RID: 2512 RVA: 0x0005E648 File Offset: 0x0005D648
		...
		// Token: 0x060009D1 RID: 2513 RVA: 0x0005E6C2 File Offset: 0x0005D6C2
		public override ISqlFragment Visit(DbRefExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009D2 RID: 2514 RVA: 0x0005E6C9 File Offset: 0x0005D6C9
		public override ISqlFragment Visit(DbRelationshipNavigationExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009D3 RID: 2515 RVA: 0x0005E6D0 File Offset: 0x0005D6D0
		...
		// Token: 0x060009D4 RID: 2516 RVA: 0x0005E948 File Offset: 0x0005D948
		...
		// Token: 0x060009D5 RID: 2517 RVA: 0x0005EA01 File Offset: 0x0005DA01
		public override ISqlFragment Visit(DbTreatExpression e)
		{
			throw new NotSupportedException();
		}

		// Token: 0x060009D6 RID: 2518 RVA: 0x0005EA08 File Offset: 0x0005DA08
		public override ISqlFragment Visit(DbUnionAllExpression e)
		{
			return this.VisitSetOpExpression(e.Left, e.Right, "UNION ALL");
		}

		// Token: 0x060009D7 RID: 2519 RVA: 0x0005EA24 File Offset: 0x0005DA24
		...
		// Token: 0x060009D8 RID: 2520 RVA: 0x0005EA80 File Offset: 0x0005DA80
		...
		// Token: 0x060009D9 RID: 2521 RVA: 0x0005EAE5 File Offset: 0x0005DAE5
		...
		// Token: 0x060009DA RID: 2522 RVA: 0x0005EB20 File Offset: 0x0005DB20
		...
		// Token: 0x060009DB RID: 2523 RVA: 0x0005EB9C File Offset: 0x0005DB9C
		...
		// Token: 0x060009DC RID: 2524 RVA: 0x0005EC1C File Offset: 0x0005DC1C
		...
		// Token: 0x060009DD RID: 2525 RVA: 0x0005ECC0 File Offset: 0x0005DCC0
		...
		// Token: 0x060009DE RID: 2526 RVA: 0x0005ED10 File Offset: 0x0005DD10
		...
		// Token: 0x060009DF RID: 2527 RVA: 0x0005EE8C File Offset: 0x0005DE8C
		...
		// Token: 0x060009E0 RID: 2528 RVA: 0x0005EED0 File Offset: 0x0005DED0
		...
		// Token: 0x060009E1 RID: 2529 RVA: 0x0005F064 File Offset: 0x0005E064
		...
		// Token: 0x060009E2 RID: 2530 RVA: 0x0005F2A8 File Offset: 0x0005E2A8
		...
		// Token: 0x060009E3 RID: 2531 RVA: 0x0005F3E4 File Offset: 0x0005E3E4
		...
		// Token: 0x060009E4 RID: 2532 RVA: 0x0005F493 File Offset: 0x0005E493
		...
		// Token: 0x060009E5 RID: 2533 RVA: 0x0005F4BC File Offset: 0x0005E4BC
		...
		// Token: 0x060009E6 RID: 2534 RVA: 0x0005F4E4 File Offset: 0x0005E4E4
		...
		// Token: 0x060009E7 RID: 2535 RVA: 0x0005F508 File Offset: 0x0005E508
		private void HandleFunctionArgumentsDefault(DbFunctionExpression e, SqlBuilder result)
		{
			...
			{
				throw new MetadataException(OpoErrResManager.GetErrorMesg(ErrRes.EF_NILADIC_FUNCTION, new string[0]));
			}
			if (!metadataProperty)
			{
				result.Append("(");
		...
		// Token: 0x060009E8 RID: 2536 RVA: 0x0005F5C0 File Offset: 0x0005E5C0
		...
		// Token: 0x060009E9 RID: 2537 RVA: 0x0005F5CE File Offset: 0x0005E5CE
		...
		// Token: 0x060009EA RID: 2538 RVA: 0x0005F5E8 File Offset: 0x0005E5E8
		...
		// Token: 0x060009EB RID: 2539 RVA: 0x0005F5F8 File Offset: 0x0005E5F8
		...
		// Token: 0x060009EC RID: 2540 RVA: 0x0005F660 File Offset: 0x0005E660
		...
		// Token: 0x060009ED RID: 2541 RVA: 0x0005F768 File Offset: 0x0005E768
		...
		// Token: 0x060009EE RID: 2542 RVA: 0x0005F7D0 File Offset: 0x0005E7D0
		...
		// Token: 0x060009EF RID: 2543 RVA: 0x0005F9F4 File Offset: 0x0005E9F4
		...
		// Token: 0x060009F0 RID: 2544 RVA: 0x0005FB28 File Offset: 0x0005EB28
		...
		// Token: 0x060009F1 RID: 2545 RVA: 0x0005FE38 File Offset: 0x0005EE38
		...
		// Token: 0x060009F2 RID: 2546 RVA: 0x00061538 File Offset: 0x00060538
		...
		// Token: 0x060009F3 RID: 2547 RVA: 0x000615A0 File Offset: 0x000605A0
		...
		// Token: 0x060009F4 RID: 2548 RVA: 0x00061879 File Offset: 0x00060879
		...
		// Token: 0x060009F5 RID: 2549 RVA: 0x00061888 File Offset: 0x00060888
		...
		// Token: 0x060009F6 RID: 2550 RVA: 0x00061AB7 File Offset: 0x00060AB7
		...
		// Token: 0x060009F7 RID: 2551 RVA: 0x00061AC8 File Offset: 0x00060AC8
		...
		// Token: 0x060009F8 RID: 2552 RVA: 0x00061B0C File Offset: 0x00060B0C
		...
		// Token: 0x060009F9 RID: 2553 RVA: 0x00061B8C File Offset: 0x00060B8C
		...
		// Token: 0x060009FA RID: 2554 RVA: 0x00061BCE File Offset: 0x00060BCE
		...
		// Token: 0x060009FB RID: 2555 RVA: 0x00061BDC File Offset: 0x00060BDC
		...
		// Token: 0x060009FC RID: 2556 RVA: 0x00061BEA File Offset: 0x00060BEA
		...
		// Token: 0x060009FD RID: 2557 RVA: 0x00061BF8 File Offset: 0x00060BF8
		...
		// Token: 0x060009FE RID: 2558 RVA: 0x00061C08 File Offset: 0x00060C08
		...
		// Token: 0x060009FF RID: 2559 RVA: 0x00061D38 File Offset: 0x00060D38
		...
		// Token: 0x06000A00 RID: 2560 RVA: 0x00061F20 File Offset: 0x00060F20
		...
		// Token: 0x06000A01 RID: 2561 RVA: 0x0006202C File Offset: 0x0006102C
		...
		// Token: 0x06000A02 RID: 2562 RVA: 0x000620B0 File Offset: 0x000610B0
		...
		// Token: 0x06000A03 RID: 2563 RVA: 0x000620BC File Offset: 0x000610BC
		...
		// Token: 0x06000A04 RID: 2564 RVA: 0x00062130 File Offset: 0x00061130
		...
		// Token: 0x06000A05 RID: 2565 RVA: 0x000621D4 File Offset: 0x000611D4
		...
		// Token: 0x06000A06 RID: 2566 RVA: 0x000621E4 File Offset: 0x000611E4
		...
		// Token: 0x06000A07 RID: 2567 RVA: 0x000622B6 File Offset: 0x000612B6
		private static string EscapeSingleQuote(string s, bool isUnicode)
		{
			return (isUnicode ? "N'" : "'") + s.Replace("'", "''") + "'";
		}

		// Token: 0x06000A08 RID: 2568 RVA: 0x000622E1 File Offset: 0x000612E1
		...
		// Token: 0x06000A09 RID: 2569 RVA: 0x000622F8 File Offset: 0x000612F8
		...
		// Token: 0x06000A0A RID: 2570 RVA: 0x000624B8 File Offset: 0x000614B8
		...
		// Token: 0x06000A0B RID: 2571 RVA: 0x000624F7 File Offset: 0x000614F7
		...
		// Token: 0x06000A0C RID: 2572 RVA: 0x0006250E File Offset: 0x0006150E
		...
		// Token: 0x06000A0D RID: 2573 RVA: 0x0006253C File Offset: 0x0006153C
		...
		// Token: 0x06000A0E RID: 2574 RVA: 0x00062564 File Offset: 0x00061564
		...
		// Token: 0x06000A0F RID: 2575 RVA: 0x000626DE File Offset: 0x000616DE
		internal static string QuoteIdentifier(string name)
		{
			return "\"" + name.Replace("\"", "\"\"") + "\"";
		}

		// Token: 0x06000A10 RID: 2576 RVA: 0x00062700 File Offset: 0x00061700
		...
		// Token: 0x06000A11 RID: 2577 RVA: 0x000627C3 File Offset: 0x000617C3
		...
		// Token: 0x06000A12 RID: 2578 RVA: 0x000627D0 File Offset: 0x000617D0
		...
		// Token: 0x06000A13 RID: 2579 RVA: 0x000628C4 File Offset: 0x000618C4
		...
		// Token: 0x06000A14 RID: 2580 RVA: 0x00062984 File Offset: 0x00061984
		...
		// Token: 0x06000A15 RID: 2581 RVA: 0x000629D4 File Offset: 0x000619D4
		...
		// Token: 0x06000A16 RID: 2582 RVA: 0x000629FC File Offset: 0x000619FC
		...
		// Token: 0x06000A17 RID: 2583 RVA: 0x00062A54 File Offset: 0x00061A54
		...
		// Token: 0x06000A18 RID: 2584 RVA: 0x00062AB0 File Offset: 0x00061AB0
		...
		// Token: 0x06000A19 RID: 2585 RVA: 0x00062B10 File Offset: 0x00061B10
		...
		// Token: 0x06000A1A RID: 2586 RVA: 0x00062B64 File Offset: 0x00061B64
		...
		// Token: 0x06000A1B RID: 2587 RVA: 0x00062BCE File Offset: 0x00061BCE
		...
		// Token: 0x06000A1C RID: 2588 RVA: 0x00062BDC File Offset: 0x00061BDC
		private static void Assert10gOrNewer(EFOracleVersion _sqlVersion, PrimitiveTypeKind primitiveTypeKind)
		{
			...
			{
				throw new NotSupportedException(OpoErrResManager.GetErrorMesg(ErrRes.ODP_INVALID_VALUE, new string[]
				{
					primitiveTypeKind.ToString()
				}));
			}
		...
		// Token: 0x06000A1D RID: 2589 RVA: 0x00062C14 File Offset: 0x00061C14
