...
namespace MS.Internal.Xml.XPath
{
	...
	{
		// Token: 0x060012CA RID: 4810 RVA: 0x000516A4 File Offset: 0x000506A4
		private void Reset()
		{
			this.needContext = false;
		}

		// Token: 0x060012CB RID: 4811 RVA: 0x000516B0 File Offset: 0x000506B0
		...
		// Token: 0x060012CC RID: 4812 RVA: 0x00051A73 File Offset: 0x00050A73
		private bool CanBeNumber(Query q)
		{
			return q.StaticType == XPathResultType.Any || q.StaticType == XPathResultType.Number;
		}

		// Token: 0x060012CD RID: 4813 RVA: 0x00051A8C File Offset: 0x00050A8C
		...
		// Token: 0x060012CE RID: 4814 RVA: 0x00051C34 File Offset: 0x00050C34
		...
		// Token: 0x060012CF RID: 4815 RVA: 0x00051CE8 File Offset: 0x00050CE8
		...
		// Token: 0x060012D0 RID: 4816 RVA: 0x00051D1C File Offset: 0x00050D1C
		private Query ProcessFunction(Function root, out QueryBuilder.Props props)
		{
			...
			{
				Query result = new IDQuery(this.ProcessNode((AstNode)root.ArgumentList[0], QueryBuilder.Flags.None, out props));
				props |= QueryBuilder.Props.NonFlat;
				return result;
			}
			...
			case Function.FunctionType.FuncUserDefined:
			{
				...
				Query result = new FunctionQuery(root.Prefix, root.Name, this.ProcessArguments(root.ArgumentList, out props));
				props |= QueryBuilder.Props.NonFlat;
				return result;
			}
			default:
		...
		// Token: 0x060012D1 RID: 4817 RVA: 0x00051FA0 File Offset: 0x00050FA0
		...
		// Token: 0x060012D2 RID: 4818 RVA: 0x00051FF4 File Offset: 0x00050FF4
		...
		// Token: 0x060012D3 RID: 4819 RVA: 0x000520C0 File Offset: 0x000510C0
		...
		// Token: 0x060012D4 RID: 4820 RVA: 0x000520E6 File Offset: 0x000510E6
		...
		// Token: 0x060012D5 RID: 4821 RVA: 0x0005210C File Offset: 0x0005110C
		...
		// Token: 0x060012D6 RID: 4822 RVA: 0x0005212C File Offset: 0x0005112C
		...
		// Token: 0x060012D7 RID: 4823 RVA: 0x00052150 File Offset: 0x00051150
