...
namespace System.Xml
{
	...
	{
		// Token: 0x0600054E RID: 1358 RVA: 0x00016172 File Offset: 0x00015172
		...
		// Token: 0x0600054F RID: 1359 RVA: 0x00016188 File Offset: 0x00015188
		...
		// (get) Token: 0x06000550 RID: 1360 RVA: 0x0001619E File Offset: 0x0001519E
		...
		// (get) Token: 0x06000551 RID: 1361 RVA: 0x000161A6 File Offset: 0x000151A6
		...
		// Token: 0x06000552 RID: 1362 RVA: 0x000161B0 File Offset: 0x000151B0
		...
		// Token: 0x06000553 RID: 1363 RVA: 0x000165C8 File Offset: 0x000155C8
		...
		// (get) Token: 0x06000554 RID: 1364 RVA: 0x000166A3 File Offset: 0x000156A3
		...
		// Token: 0x06000555 RID: 1365 RVA: 0x000166A6 File Offset: 0x000156A6
		...
		// Token: 0x06000557 RID: 1367 RVA: 0x000166C0 File Offset: 0x000156C0
		public override void WriteStartAttribute(string prefix, string localName, string ns)
		{
			this.AddEvent(XmlEventCache.XmlEventType.StartAttr, prefix, localName, ns);
		}

		// Token: 0x06000558 RID: 1368 RVA: 0x000166CC File Offset: 0x000156CC
		public override void WriteEndAttribute()
		{
			this.AddEvent(XmlEventCache.XmlEventType.EndAttr);
		}

		// Token: 0x06000559 RID: 1369 RVA: 0x000166D5 File Offset: 0x000156D5
		public override void WriteCData(string text)
		{
			this.AddEvent(XmlEventCache.XmlEventType.CData, text);
		}

		// Token: 0x0600055A RID: 1370 RVA: 0x000166DF File Offset: 0x000156DF
		public override void WriteComment(string text)
		{
			this.AddEvent(XmlEventCache.XmlEventType.Comment, text);
		}

		// Token: 0x0600055B RID: 1371 RVA: 0x000166E9 File Offset: 0x000156E9
		public override void WriteProcessingInstruction(string name, string text)
		{
			this.AddEvent(XmlEventCache.XmlEventType.PI, name, text);
		}

		// Token: 0x0600055C RID: 1372 RVA: 0x000166F4 File Offset: 0x000156F4
		public override void WriteWhitespace(string ws)
		{
			this.AddEvent(XmlEventCache.XmlEventType.Whitespace, ws);
		}

		// Token: 0x0600055D RID: 1373 RVA: 0x000166FE File Offset: 0x000156FE
		...
		// Token: 0x0600055E RID: 1374 RVA: 0x0001671E File Offset: 0x0001571E
		public override void WriteChars(char[] buffer, int index, int count)
		{
			this.WriteString(new string(buffer, index, count));
		}

		// Token: 0x0600055F RID: 1375 RVA: 0x0001672E File Offset: 0x0001572E
		public override void WriteRaw(char[] buffer, int index, int count)
		{
			this.WriteRaw(new string(buffer, index, count));
		}

		// Token: 0x06000560 RID: 1376 RVA: 0x0001673E File Offset: 0x0001573E
		public override void WriteRaw(string data)
		{
			this.AddEvent(XmlEventCache.XmlEventType.Raw, data);
		}

		// Token: 0x06000561 RID: 1377 RVA: 0x00016749 File Offset: 0x00015749
		public override void WriteEntityRef(string name)
		{
			this.AddEvent(XmlEventCache.XmlEventType.EntRef, name);
		}

		// Token: 0x06000562 RID: 1378 RVA: 0x00016754 File Offset: 0x00015754
		public override void WriteCharEntity(char ch)
		{
			this.AddEvent(XmlEventCache.XmlEventType.CharEnt, ch);
		}

		// Token: 0x06000563 RID: 1379 RVA: 0x00016764 File Offset: 0x00015764
		...
		// Token: 0x06000564 RID: 1380 RVA: 0x0001678B File Offset: 0x0001578B
		public override void WriteBase64(byte[] buffer, int index, int count)
		{
			this.AddEvent(XmlEventCache.XmlEventType.Base64, XmlEventCache.ToBytes(buffer, index, count));
		}

		// Token: 0x06000565 RID: 1381 RVA: 0x0001679D File Offset: 0x0001579D
		public override void WriteBinHex(byte[] buffer, int index, int count)
		{
			this.AddEvent(XmlEventCache.XmlEventType.BinHex, XmlEventCache.ToBytes(buffer, index, count));
		}

		// Token: 0x06000566 RID: 1382 RVA: 0x000167AF File Offset: 0x000157AF
		public override void Close()
		{
			this.AddEvent(XmlEventCache.XmlEventType.Close);
		}

		// Token: 0x06000567 RID: 1383 RVA: 0x000167B9 File Offset: 0x000157B9
		public override void Flush()
		{
			this.AddEvent(XmlEventCache.XmlEventType.Flush);
		}

		// Token: 0x06000568 RID: 1384 RVA: 0x000167C3 File Offset: 0x000157C3
		public override void WriteValue(object value)
		{
			this.WriteString(XmlUntypedConverter.Untyped.ToString(value, this.resolver));
		}

		// Token: 0x06000569 RID: 1385 RVA: 0x000167DC File Offset: 0x000157DC
		public override void WriteValue(string value)
		{
			this.WriteString(value);
		}

		// Token: 0x0600056A RID: 1386 RVA: 0x000167E8 File Offset: 0x000157E8
		...
		// Token: 0x06000573 RID: 1395 RVA: 0x00016898 File Offset: 0x00015898
		...
		// Token: 0x06000574 RID: 1396 RVA: 0x000168C0 File Offset: 0x000158C0
		...
		// Token: 0x06000575 RID: 1397 RVA: 0x000168E8 File Offset: 0x000158E8
		...
		// Token: 0x06000576 RID: 1398 RVA: 0x00016914 File Offset: 0x00015914
		...
		// Token: 0x06000577 RID: 1399 RVA: 0x00016940 File Offset: 0x00015940
		...
		// Token: 0x06000578 RID: 1400 RVA: 0x00016968 File Offset: 0x00015968
		...
		// Token: 0x06000579 RID: 1401 RVA: 0x00016A3C File Offset: 0x00015A3C
		...
		{
			// Token: 0x0600057A RID: 1402 RVA: 0x00016A75 File Offset: 0x00015A75
			public void InitEvent(XmlEventCache.XmlEventType eventType)
			{
				this.eventType = eventType;
			}

			// Token: 0x0600057B RID: 1403 RVA: 0x00016A7E File Offset: 0x00015A7E
			...
			// Token: 0x0600057C RID: 1404 RVA: 0x00016A8E File Offset: 0x00015A8E
			...
			// Token: 0x0600057D RID: 1405 RVA: 0x00016AA5 File Offset: 0x00015AA5
			...
			// Token: 0x0600057E RID: 1406 RVA: 0x00016AC4 File Offset: 0x00015AC4
			...
			// Token: 0x0600057F RID: 1407 RVA: 0x00016AEB File Offset: 0x00015AEB
			...
			// (get) Token: 0x06000580 RID: 1408 RVA: 0x00016AFB File Offset: 0x00015AFB
			...
			// (get) Token: 0x06000581 RID: 1409 RVA: 0x00016B03 File Offset: 0x00015B03
			...
			// (get) Token: 0x06000582 RID: 1410 RVA: 0x00016B0B File Offset: 0x00015B0B
			...
			// (get) Token: 0x06000583 RID: 1411 RVA: 0x00016B13 File Offset: 0x00015B13
			...
			// (get) Token: 0x06000584 RID: 1412 RVA: 0x00016B1B File Offset: 0x00015B1B
