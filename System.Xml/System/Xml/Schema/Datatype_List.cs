...
namespace System.Xml.Schema
{
	...
	{
		// Token: 0x06001629 RID: 5673 RVA: 0x000626CC File Offset: 0x000616CC
		...
		// Token: 0x0600162A RID: 5674 RVA: 0x00062765 File Offset: 0x00061765
		internal Datatype_List(DatatypeImplementation type) : this(type, 0)
		{
		}

		// Token: 0x0600162B RID: 5675 RVA: 0x0006276F File Offset: 0x0006176F
		...
		// Token: 0x0600162C RID: 5676 RVA: 0x00062788 File Offset: 0x00061788
		...
		// (get) Token: 0x0600162D RID: 5677 RVA: 0x0006284C File Offset: 0x0006184C
		...
		// (get) Token: 0x0600162E RID: 5678 RVA: 0x00062854 File Offset: 0x00061854
		...
		// (get) Token: 0x0600162F RID: 5679 RVA: 0x00062861 File Offset: 0x00061861
		...
		// (get) Token: 0x06001630 RID: 5680 RVA: 0x0006286E File Offset: 0x0006186E
		...
		// (get) Token: 0x06001631 RID: 5681 RVA: 0x00062875 File Offset: 0x00061875
		...
		// (get) Token: 0x06001632 RID: 5682 RVA: 0x00062882 File Offset: 0x00061882
		...
		// (get) Token: 0x06001633 RID: 5683 RVA: 0x00062886 File Offset: 0x00061886
		...
		// Token: 0x06001634 RID: 5684 RVA: 0x00062890 File Offset: 0x00061890
		...
		// Token: 0x06001635 RID: 5685 RVA: 0x00062A68 File Offset: 0x00061A68
		internal override Exception TryParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
		{
			...
			if (ex == null)
			{
				...
				{
					foreach (string s2 in XmlConvert.SplitString(s))
					{
						object obj;
						ex = this.itemType.TryParseValue(s2, nameTable, nsmgr, out obj);
						if (ex != null)
						{
							return ex;
						}
				...
				{
					foreach (string s3 in XmlConvert.SplitString(s))
					{
						ex = this.itemType.TryParseValue(s3, nameTable, nsmgr, out typedValue);
						if (ex != null)
						{
							return ex;
						}
