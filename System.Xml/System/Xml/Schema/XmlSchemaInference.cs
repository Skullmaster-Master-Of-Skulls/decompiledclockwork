...
namespace System.Xml.Schema
{
	...
	public sealed class XmlSchemaInference
	{
		...
		// (get) Token: 0x060020B8 RID: 8376 RVA: 0x0009790A File Offset: 0x0009690A
		// (set) Token: 0x060020B7 RID: 8375 RVA: 0x00097901 File Offset: 0x00096901
		...
		// (get) Token: 0x060020BA RID: 8378 RVA: 0x0009791B File Offset: 0x0009691B
		// (set) Token: 0x060020B9 RID: 8377 RVA: 0x00097912 File Offset: 0x00096912
		...
		// Token: 0x060020BB RID: 8379 RVA: 0x00097924 File Offset: 0x00096924
		...
		// Token: 0x060020BC RID: 8380 RVA: 0x00097973 File Offset: 0x00096973
		public XmlSchemaSet InferSchema(XmlReader instanceDocument)
		{
			return this.InferSchema1(instanceDocument, new XmlSchemaSet(this.nametable));
		}

		// Token: 0x060020BD RID: 8381 RVA: 0x00097987 File Offset: 0x00096987
		...
		// Token: 0x060020BE RID: 8382 RVA: 0x000979A4 File Offset: 0x000969A4
		...
		// Token: 0x060020BF RID: 8383 RVA: 0x00097BD4 File Offset: 0x00096BD4
		private XmlSchemaAttribute AddAttribute(string localName, string prefix, string childURI, string attrValue, bool bCreatingNewType, XmlSchema parentSchema, XmlSchemaObjectCollection addLocation, XmlSchemaObjectTable compiledAttributes)
		{
			...
			int lineNumber = -1;
			XmlSchemaAttribute result = null;
		...
		// Token: 0x060020C0 RID: 8384 RVA: 0x00097F78 File Offset: 0x00096F78
		...
		// Token: 0x060020C1 RID: 8385 RVA: 0x00097FB0 File Offset: 0x00096FB0
		...
		// Token: 0x060020C2 RID: 8386 RVA: 0x00098230 File Offset: 0x00097230
		...
		// Token: 0x060020C3 RID: 8387 RVA: 0x00098B04 File Offset: 0x00097B04
		...
		// Token: 0x060020C4 RID: 8388 RVA: 0x00098B4C File Offset: 0x00097B4C
		...
		// Token: 0x060020C5 RID: 8389 RVA: 0x00098BD0 File Offset: 0x00097BD0
		internal XmlSchemaElement FindMatchingElement(bool bCreatingNewType, XmlReader xtr, XmlSchemaComplexType ct, ref int lastUsedSeqItem, ref bool bParticleChanged, XmlSchema parentSchema, bool setMaxoccurs)
		{
			...
			for (i++; i < xmlSchemaSequence.Items.Count; i++)
			{
				...
				if (xmlSchemaElement4.Name == xtr.LocalName && parentSchema.TargetNamespace == text)
				{
					...
					{
						XmlSchemaElement xmlSchemaElement5 = (XmlSchemaElement)xmlSchemaObject2;
				...
				if (xmlSchemaElement4.RefName.Name == xtr.LocalName && xmlSchemaElement4.RefName.Namespace == xtr.NamespaceURI)
				{
					...
					{
						XmlSchemaElement xmlSchemaElement6 = (XmlSchemaElement)xmlSchemaObject3;
						xmlSchemaElement6.MinOccurs = 0m;
					}
					XmlSchemaElement xmlSchemaElement7 = this.FindGlobalElement(text, xtr.LocalName, out parentSchema);
			...
			XmlSchemaElement xmlSchemaElement8 = null;
			...
			if (xmlSchemaElement8 != null)
			{
				...
				{
					XmlSchemaElement copyElement = (XmlSchemaElement)xmlSchemaObject4;
					xmlSchemaChoice2.Items.Add(this.CreateNewElementforChoice(copyElement));
				}
				xmlSchemaSequence.Items.Clear();
				xmlSchemaSequence.Items.Add(xmlSchemaChoice2);
				return xmlSchemaElement8;
			}
			xmlSchemaElement8 = this.AddElement(xtr.LocalName, xtr.Prefix, xtr.NamespaceURI, parentSchema, xmlSchemaSequence.Items, ++lastUsedSeqItem);
			if (!bCreatingNewType)
			{
		...
		// Token: 0x060020C6 RID: 8390 RVA: 0x00099214 File Offset: 0x00098214
		...
		// Token: 0x060020C7 RID: 8391 RVA: 0x00099468 File Offset: 0x00098468
		private void MoveAttributes(XmlSchemaSimpleContentExtension scExtension, XmlSchemaComplexType ct)
		{
			...
			{
				XmlSchemaAttribute item = (XmlSchemaAttribute)xmlSchemaObject;
				ct.Attributes.Add(item);
			}
		}

		// Token: 0x060020C8 RID: 8392 RVA: 0x000994C8 File Offset: 0x000984C8
		...
		// Token: 0x060020C9 RID: 8393 RVA: 0x00099554 File Offset: 0x00098554
		...
		// Token: 0x060020CA RID: 8394 RVA: 0x000995C4 File Offset: 0x000985C4
		...
		// Token: 0x060020CB RID: 8395 RVA: 0x00099648 File Offset: 0x00098648
		...
		// Token: 0x060020CC RID: 8396 RVA: 0x000996C0 File Offset: 0x000986C0
		...
		// Token: 0x060020CD RID: 8397 RVA: 0x00099748 File Offset: 0x00098748
		...
		// Token: 0x060020CE RID: 8398 RVA: 0x000997D8 File Offset: 0x000987D8
		...
		// Token: 0x060020CF RID: 8399 RVA: 0x00099820 File Offset: 0x00098820
		...
		// Token: 0x060020D0 RID: 8400 RVA: 0x000998D4 File Offset: 0x000988D4
		...
		// Token: 0x060020D1 RID: 8401 RVA: 0x0009A01C File Offset: 0x0009901C
		...
		// Token: 0x060020D2 RID: 8402 RVA: 0x0009AEDC File Offset: 0x00099EDC
		...
		// Token: 0x060020D3 RID: 8403 RVA: 0x0009AF34 File Offset: 0x00099F34
		...
		// Token: 0x060020D4 RID: 8404 RVA: 0x0009B070 File Offset: 0x0009A070
		...
		// Token: 0x060020D5 RID: 8405 RVA: 0x0009B238 File Offset: 0x0009A238
