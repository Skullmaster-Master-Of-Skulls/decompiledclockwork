...
namespace System.Xml
{
	...
	{
		// Token: 0x060001EC RID: 492 RVA: 0x00008D90 File Offset: 0x00007D90
		public XmlQualifiedName() : this(string.Empty, string.Empty)
		{
		}

		// Token: 0x060001ED RID: 493 RVA: 0x00008DA2 File Offset: 0x00007DA2
		public XmlQualifiedName(string name) : this(name, string.Empty)
		{
		}

		// Token: 0x060001EE RID: 494 RVA: 0x00008DB0 File Offset: 0x00007DB0
		...
		// (get) Token: 0x060001EF RID: 495 RVA: 0x00008DDA File Offset: 0x00007DDA
		...
		// (get) Token: 0x060001F0 RID: 496 RVA: 0x00008DE2 File Offset: 0x00007DE2
		public string Name
		{
			get
			{
		...
		// Token: 0x060001F1 RID: 497 RVA: 0x00008DEC File Offset: 0x00007DEC
		...
		// (get) Token: 0x060001F2 RID: 498 RVA: 0x00008E3B File Offset: 0x00007E3B
		public bool IsEmpty
		{
			get
			{
		...
		// Token: 0x060001F3 RID: 499 RVA: 0x00008E5A File Offset: 0x00007E5A
		...
		// Token: 0x060001F4 RID: 500 RVA: 0x00008E88 File Offset: 0x00007E88
		...
		// Token: 0x060001F5 RID: 501 RVA: 0x00008ED3 File Offset: 0x00007ED3
		public static bool operator ==(XmlQualifiedName a, XmlQualifiedName b)
		{
			return a == b || (a != null && b != null && a.Name == b.Name && a.Namespace == b.Namespace);
		}

		// Token: 0x060001F6 RID: 502 RVA: 0x00008F09 File Offset: 0x00007F09
		public static bool operator !=(XmlQualifiedName a, XmlQualifiedName b)
		{
			return !(a == b);
		}

		// Token: 0x060001F7 RID: 503 RVA: 0x00008F15 File Offset: 0x00007F15
		...
		// Token: 0x060001F8 RID: 504 RVA: 0x00008F30 File Offset: 0x00007F30
		...
		// Token: 0x060001F9 RID: 505 RVA: 0x00008F80 File Offset: 0x00007F80
		[SecuritySafeCritical]
		...
		// Token: 0x060001FA RID: 506 RVA: 0x00008FB8 File Offset: 0x00007FB8
		[SecurityCritical]
		...
		// Token: 0x060001FB RID: 507 RVA: 0x00009024 File Offset: 0x00008024
		private static int GetHashCodeOfString(string s, int length, long additionalEntropy)
		{
			return s.GetHashCode();
		}

		// Token: 0x060001FC RID: 508 RVA: 0x0000902C File Offset: 0x0000802C
		...
		// Token: 0x060001FD RID: 509 RVA: 0x00009043 File Offset: 0x00008043
		internal void SetNamespace(string ns)
		{
			this.ns = ns;
		}

		// Token: 0x060001FE RID: 510 RVA: 0x0000904C File Offset: 0x0000804C
		...
		// Token: 0x060001FF RID: 511 RVA: 0x00009073 File Offset: 0x00008073
		...
		// Token: 0x06000200 RID: 512 RVA: 0x0000909C File Offset: 0x0000809C
		...
		// Token: 0x06000201 RID: 513 RVA: 0x000090E1 File Offset: 0x000080E1
		internal XmlQualifiedName Clone()
		{
			return (XmlQualifiedName)base.MemberwiseClone();
		}

		// Token: 0x06000202 RID: 514 RVA: 0x000090F0 File Offset: 0x000080F0
