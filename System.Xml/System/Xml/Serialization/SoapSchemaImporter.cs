...
namespace System.Xml.Serialization
{
	...
	{
		// Token: 0x06002344 RID: 9028 RVA: 0x000A6A7F File Offset: 0x000A5A7F
		...
		// Token: 0x06002345 RID: 9029 RVA: 0x000A6A8F File Offset: 0x000A5A8F
		...
		// Token: 0x06002346 RID: 9030 RVA: 0x000A6AA1 File Offset: 0x000A5AA1
		...
		// Token: 0x06002347 RID: 9031 RVA: 0x000A6AB3 File Offset: 0x000A5AB3
		...
		// Token: 0x06002348 RID: 9032 RVA: 0x000A6ABF File Offset: 0x000A5ABF
		...
		// Token: 0x06002349 RID: 9033 RVA: 0x000A6ACC File Offset: 0x000A5ACC
		public XmlTypeMapping ImportDerivedTypeMapping(XmlQualifiedName name, Type baseType, bool baseTypeCanBeIndirect)
		{
			...
			{
				throw new InvalidOperationException(Res.GetString("XmlPrimitiveBaseType", new object[]
				{
					name.Name,
					name.Namespace,
					baseType.FullName
		...
		// Token: 0x0600234A RID: 9034 RVA: 0x000A6B78 File Offset: 0x000A5B78
		...
		// Token: 0x0600234B RID: 9035 RVA: 0x000A6C36 File Offset: 0x000A5C36
		public XmlMembersMapping ImportMembersMapping(string name, string ns, SoapSchemaMember[] members)
		{
			return this.ImportMembersMapping(name, ns, members, true);
		}

		// Token: 0x0600234C RID: 9036 RVA: 0x000A6C42 File Offset: 0x000A5C42
		...
		// Token: 0x0600234D RID: 9037 RVA: 0x000A6C54 File Offset: 0x000A5C54
		...
		// Token: 0x0600234E RID: 9038 RVA: 0x000A6DA4 File Offset: 0x000A5DA4
		...
		// Token: 0x0600234F RID: 9039 RVA: 0x000A6E78 File Offset: 0x000A5E78
		private TypeMapping ImportElementType(XmlSchemaElement element, string ns)
		{
			...
			else if (element.SchemaType != null)
			{
				...
				{
					throw new InvalidOperationException(Res.GetString("XmlInvalidSchemaElementType", new object[]
					{
						parentName.Name,
						parentName.Namespace,
						element.Name
			...
			else
			{
				if (!element.SubstitutionGroup.IsEmpty)
				{
					...
					throw new InvalidOperationException(Res.GetString("XmlInvalidSubstitutionGroupUse", new object[]
					{
						parentName2.Name,
				...
				throw new InvalidOperationException(Res.GetString("XmlElementMissingType", new object[]
				{
					parentName3.Name,
		...
		// Token: 0x06002350 RID: 9040 RVA: 0x000A6FDC File Offset: 0x000A5FDC
		...
		// Token: 0x06002351 RID: 9041 RVA: 0x000A70C8 File Offset: 0x000A60C8
		...
		// Token: 0x06002352 RID: 9042 RVA: 0x000A717C File Offset: 0x000A617C
		...
		// Token: 0x06002353 RID: 9043 RVA: 0x000A71DC File Offset: 0x000A61DC
		...
		// Token: 0x06002354 RID: 9044 RVA: 0x000A7244 File Offset: 0x000A6244
		...
		// Token: 0x06002355 RID: 9045 RVA: 0x000A73DC File Offset: 0x000A63DC
		...
		// Token: 0x06002356 RID: 9046 RVA: 0x000A75A0 File Offset: 0x000A65A0
		private void ImportGroup(XmlSchemaParticle group, CodeIdentifiers members, string ns)
		{
			if (group is XmlSchemaChoice)
			{
				...
				throw new InvalidOperationException(Res.GetString("XmlSoapInvalidChoice", new object[]
				{
					parentName.Name,
					parentName.Namespace
				}));
		...
		// Token: 0x06002357 RID: 9047 RVA: 0x000A75F0 File Offset: 0x000A65F0
		private void ImportGroupMembers(XmlSchemaParticle particle, CodeIdentifiers members, string ns)
		{
			...
			{
				throw new InvalidOperationException(Res.GetString("XmlSoapUnsupportedGroupRef", new object[]
				{
					parentName.Name,
					parentName.Namespace
				}));
			...
			if (particle is XmlSchemaGroupBase)
			{
				...
				{
					throw new InvalidOperationException(Res.GetString("XmlSoapUnsupportedGroupRepeat", new object[]
					{
						parentName.Name,
						parentName.Namespace
					}));
				...
				for (int i = 0; i < xmlSchemaGroupBase.Items.Count; i++)
				{
					...
					{
						throw new InvalidOperationException(Res.GetString("XmlSoapUnsupportedGroupNested", new object[]
						{
							parentName.Name,
							parentName.Namespace
						}));
					...
					{
						throw new InvalidOperationException(Res.GetString("XmlSoapUnsupportedGroupAny", new object[]
						{
							parentName.Name,
							parentName.Namespace
						}));
		...
		// Token: 0x06002358 RID: 9048 RVA: 0x000A7738 File Offset: 0x000A6738
		...
		// Token: 0x06002359 RID: 9049 RVA: 0x000A77A4 File Offset: 0x000A67A4
		...
		// Token: 0x0600235A RID: 9050 RVA: 0x000A7B38 File Offset: 0x000A6B38
		...
		// Token: 0x0600235B RID: 9051 RVA: 0x000A7C30 File Offset: 0x000A6C30
		...
		// Token: 0x0600235C RID: 9052 RVA: 0x000A7D5C File Offset: 0x000A6D5C
		...
		// Token: 0x0600235D RID: 9053 RVA: 0x000A7F74 File Offset: 0x000A6F74
		...
		// Token: 0x0600235E RID: 9054 RVA: 0x000A7FA8 File Offset: 0x000A6FA8
		...
		// Token: 0x0600235F RID: 9055 RVA: 0x000A8004 File Offset: 0x000A7004
		...
		// Token: 0x06002360 RID: 9056 RVA: 0x000A8070 File Offset: 0x000A7070
		...
		// Token: 0x06002361 RID: 9057 RVA: 0x000A8124 File Offset: 0x000A7124
