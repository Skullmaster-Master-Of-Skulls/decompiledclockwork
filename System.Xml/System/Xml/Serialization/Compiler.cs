...
namespace System.Xml.Serialization
{
	...
	internal class Compiler
	{
		...
		// (get) Token: 0x06002145 RID: 8517 RVA: 0x0009D99C File Offset: 0x0009C99C
		...
		// Token: 0x06002146 RID: 8518 RVA: 0x0009D9D4 File Offset: 0x0009C9D4
		...
		// Token: 0x06002147 RID: 8519 RVA: 0x0009DB03 File Offset: 0x0009CB03
		...
		// (get) Token: 0x06002148 RID: 8520 RVA: 0x0009DB21 File Offset: 0x0009CB21
		...
		// Token: 0x06002149 RID: 8521 RVA: 0x0009DB29 File Offset: 0x0009CB29
		internal void Close()
		{
		}

		// Token: 0x0600214A RID: 8522 RVA: 0x0009DB2C File Offset: 0x0009CB2C
		internal static string GetTempAssemblyPath(string baseDir, Assembly assembly, string defaultNamespace)
		{
			...
			{
				throw new InvalidOperationException(Res.GetString("XmlPregenAssemblyDynamic", new object[]
				{
					assembly.Location
				}));
			}
		...
		// Token: 0x0600214B RID: 8523 RVA: 0x0009DC48 File Offset: 0x0009CC48
		internal static string GetTempAssemblyName(AssemblyName parent, string ns)
		{
			return parent.Name + ".XmlSerializers" + ((ns == null || ns.Length == 0) ? "" : ("." + ns.GetHashCode()));
		}

		// Token: 0x0600214C RID: 8524 RVA: 0x0009DC84 File Offset: 0x0009CC84
		...
		// Token: 0x0600214D RID: 8525 RVA: 0x0009DF9C File Offset: 0x0009CF9C
		...
		// Token: 0x0600214E RID: 8526 RVA: 0x0009DFF8 File Offset: 0x0009CFF8
