...
namespace System.Xml.Serialization
{
	...
	{
		// Token: 0x06002164 RID: 8548 RVA: 0x0009E4E0 File Offset: 0x0009D4E0
		...
		// Token: 0x06002165 RID: 8549 RVA: 0x0009E5C0 File Offset: 0x0009D5C0
		internal ArrayList GetItems()
		{
			return new ArrayList(this.scope.Keys);
		}

		// Token: 0x06002166 RID: 8550 RVA: 0x0009E5D4 File Offset: 0x0009D5D4
		...
		// Token: 0x06002167 RID: 8551 RVA: 0x0009E634 File Offset: 0x0009D634
		...
		// Token: 0x06002168 RID: 8552 RVA: 0x0009E694 File Offset: 0x0009D694
				...
				else
				{
					if (type == typeof(XmlSchemaAttributeGroup))
					{
						using (XmlSchemaObjectEnumerator enumerator2 = ((XmlSchemaAttributeGroup)item).Attributes.GetEnumerator())
						{
							...
							{
								XmlSchemaObject item3 = enumerator2.Current;
