...
namespace TechnoPro.Common.UI.Web.ClockWork.Properties
{
	...
	internal class Resources
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				if (flag)
				{
					ResourceManager resourceManager = new ResourceManager("TechnoPro.Common.UI.Web.ClockWork.Properties.Resources", typeof(Resources).Assembly);
