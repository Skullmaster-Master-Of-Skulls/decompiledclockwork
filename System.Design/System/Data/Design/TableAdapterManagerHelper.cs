		...
		internal static DataTable[] GetUpdateOrder(DataSet ds)
		{
			...
			for (int j = 0; j < array.Length; j++)
			{
				...
				foreach (object obj in dataTable.Constraints)
				{
					...
					if (foreignKeyConstraint != null && !object.ReferenceEquals(foreignKeyConstraint.RelatedTable, dataTable))
					{
				...
				foreach (object obj2 in dataTable.ParentRelations)
				{
					...
					if (!object.ReferenceEquals(dataRelation.ParentTable, dataTable))
					{
