...
namespace System.Web.UI.Design
{
	...
	public class ControlDesigner : HtmlControlDesigner
	{
		...
		{
			Control ownerControl = (Control)base.Component;
			Control control = this.CreateViewControl();
			((IControlDesignerAccessor)control).SetOwnerControl(ownerControl);
			this.UpdateExpressionValues(control);
			return control;
		}
