...
namespace System.Web.UI.Design
{
	...
	internal sealed partial class DataBindingsDialog : DesignerForm
	{
		...
		{
			DataBindingsDialog.FormatItem[] items = DataBindingsDialog.FormatItem.DefaultFormats;
			...
			if (fieldItem != null && fieldItem.Type != null)
			{
				...
				case TypeCode.UInt64:
					items = DataBindingsDialog.FormatItem.NumericFormats;
					this._formatSampleObject = 1;
					break;
				case TypeCode.Single:
				case TypeCode.Double:
				case TypeCode.Decimal:
					items = DataBindingsDialog.FormatItem.DecimalFormats;
					this._formatSampleObject = 1;
					break;
				case TypeCode.DateTime:
					items = DataBindingsDialog.FormatItem.DateTimeFormats;
			...
			this._formatCombo.Items.AddRange(items);
		}
