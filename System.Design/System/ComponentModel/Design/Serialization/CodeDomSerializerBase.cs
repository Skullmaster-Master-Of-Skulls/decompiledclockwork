...
namespace System.ComponentModel.Design.Serialization
{
	...
	{
		// Token: 0x06000918 RID: 2328 RVA: 0x0001ECCF File Offset: 0x0001DCCF
		internal CodeDomSerializerBase()
		{
		}

		// Token: 0x06000919 RID: 2329 RVA: 0x0001ECD7 File Offset: 0x0001DCD7
		...
		// Token: 0x0600091A RID: 2330 RVA: 0x0001ED01 File Offset: 0x0001DD01
		...
		// Token: 0x0600091B RID: 2331 RVA: 0x0001ED28 File Offset: 0x0001DD28
		...
		// Token: 0x0600091C RID: 2332 RVA: 0x0001EE48 File Offset: 0x0001DE48
		...
		// Token: 0x0600091D RID: 2333 RVA: 0x0001EF58 File Offset: 0x0001DF58
			...
			using (CodeDomSerializerBase.TraceScope("CodeDomSerializerBase::DeserializeExpression"))
			{
				if (obj != null)
				{
					...
					else if ((codeObjectCreateExpression = (obj as CodeObjectCreateExpression)) != null)
					{
						...
						{
							this.Error(manager, SR.GetString("SerializerTypeNotFound", new object[]
							{
					...
					else if ((codeArgumentReferenceExpression = (obj as CodeArgumentReferenceExpression)) != null)
					{
						...
						if (obj == null)
						{
							this.Error(manager, SR.GetString("SerializerUndeclaredName", new object[]
							{
					...
					else if ((codeFieldReferenceExpression = (obj as CodeFieldReferenceExpression)) != null)
					{
						...
						if (obj3 != null && !(obj3 is CodeExpression))
						{
							...
							else
							{
								...
								{
									obj4 = null;
									field = TypeDescriptor.GetReflectionType(type2).GetField(codeFieldReferenceExpression.FieldName, BindingFlags.Static | BindingFlags.Public | BindingFlags.GetField);
								}
								else
								{
									obj4 = obj3;
									field = TypeDescriptor.GetReflectionType(obj3).GetField(codeFieldReferenceExpression.FieldName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.GetField);
								}
								if (field != null)
								{
						...
						{
							this.Error(manager, SR.GetString("SerializerFieldTargetEvalFailed", new object[]
							{
								codeFieldReferenceExpression.FieldName
		...
		// Token: 0x0600091E RID: 2334 RVA: 0x0001FC1C File Offset: 0x0001EC1C
		...
		// Token: 0x0600091F RID: 2335 RVA: 0x0001FDA4 File Offset: 0x0001EDA4
		...
		// Token: 0x06000920 RID: 2336 RVA: 0x0001FF44 File Offset: 0x0001EF44
		...
		// Token: 0x06000921 RID: 2337 RVA: 0x00020144 File Offset: 0x0001F144
				...
				else if ((codeFieldReferenceExpression = (left as CodeFieldReferenceExpression)) != null)
				{
					...
					if (obj != null)
					{
						...
						else
						{
							...
							{
								obj3 = null;
								field = TypeDescriptor.GetReflectionType(type).GetField(codeFieldReferenceExpression.FieldName, BindingFlags.Static | BindingFlags.Public | BindingFlags.GetField);
							}
							else
							{
								obj3 = obj;
								field = TypeDescriptor.GetReflectionType(obj).GetField(codeFieldReferenceExpression.FieldName, BindingFlags.Instance | BindingFlags.Public | BindingFlags.GetField);
							}
							if (field != null)
							{
								...
								if (!(obj4 is CodeExpression))
								{
									...
									if (convertible != null && field.FieldType != obj4.GetType())
									{
										try
										{
											obj4 = convertible.ToType(field.FieldType, null);
										}
										catch
										{
										}
		...
		// Token: 0x06000922 RID: 2338 RVA: 0x00020454 File Offset: 0x0001F454
		...
		// Token: 0x06000923 RID: 2339 RVA: 0x0002060C File Offset: 0x0001F60C
		...
		// Token: 0x06000924 RID: 2340 RVA: 0x00020764 File Offset: 0x0001F764
		...
		// Token: 0x06000925 RID: 2341 RVA: 0x000207B4 File Offset: 0x0001F7B4
		...
		// Token: 0x06000926 RID: 2342 RVA: 0x00020814 File Offset: 0x0001F814
		...
		// Token: 0x06000927 RID: 2343 RVA: 0x000208FC File Offset: 0x0001F8FC
		...
		// Token: 0x06000928 RID: 2344 RVA: 0x00020BA8 File Offset: 0x0001FBA8
		...
		// Token: 0x06000929 RID: 2345 RVA: 0x00020C3C File Offset: 0x0001FC3C
		...
		// Token: 0x0600092A RID: 2346 RVA: 0x00020C94 File Offset: 0x0001FC94
		...
		// Token: 0x0600092B RID: 2347 RVA: 0x00020E78 File Offset: 0x0001FE78
		...
		// Token: 0x0600092C RID: 2348 RVA: 0x00020EEC File Offset: 0x0001FEEC
		...
		// Token: 0x0600092D RID: 2349 RVA: 0x00021048 File Offset: 0x00020048
		...
		// Token: 0x0600092E RID: 2350 RVA: 0x000211C8 File Offset: 0x000201C8
		...
		// Token: 0x0600092F RID: 2351 RVA: 0x000211E0 File Offset: 0x000201E0
		...
		// Token: 0x06000930 RID: 2352 RVA: 0x000211EC File Offset: 0x000201EC
		...
		// Token: 0x06000931 RID: 2353 RVA: 0x00021250 File Offset: 0x00020250
		...
		// Token: 0x06000932 RID: 2354 RVA: 0x000213A8 File Offset: 0x000203A8
		...
		// Token: 0x06000933 RID: 2355 RVA: 0x000214B8 File Offset: 0x000204B8
		...
		// Token: 0x06000934 RID: 2356 RVA: 0x0002159C File Offset: 0x0002059C
		...
		// Token: 0x06000935 RID: 2357 RVA: 0x00021604 File Offset: 0x00020604
		...
		// Token: 0x06000936 RID: 2358 RVA: 0x000218A4 File Offset: 0x000208A4
		...
		// Token: 0x06000937 RID: 2359 RVA: 0x00021994 File Offset: 0x00020994
		...
		// Token: 0x06000938 RID: 2360 RVA: 0x00021B44 File Offset: 0x00020B44
		...
		// Token: 0x06000939 RID: 2361 RVA: 0x00021C08 File Offset: 0x00020C08
		...
		// Token: 0x0600093A RID: 2362 RVA: 0x00021C17 File Offset: 0x00020C17
		...
		// Token: 0x0600093B RID: 2363 RVA: 0x00021C28 File Offset: 0x00020C28
		...
		// Token: 0x0600093C RID: 2364 RVA: 0x00021E14 File Offset: 0x00020E14
		...
		// Token: 0x0600093D RID: 2365 RVA: 0x00021E20 File Offset: 0x00020E20
		...
		// Token: 0x0600093E RID: 2366 RVA: 0x00021EB8 File Offset: 0x00020EB8
		...
		// Token: 0x0600093F RID: 2367 RVA: 0x00021EC4 File Offset: 0x00020EC4
		...
		// Token: 0x06000940 RID: 2368 RVA: 0x00021F38 File Offset: 0x00020F38
		...
		// Token: 0x06000941 RID: 2369 RVA: 0x00021F88 File Offset: 0x00020F88
		[Conditional("DEBUG")]
		...
		// Token: 0x06000942 RID: 2370 RVA: 0x00021FDC File Offset: 0x00020FDC
		[Conditional("DEBUG")]
		...
		// Token: 0x06000943 RID: 2371 RVA: 0x00022014 File Offset: 0x00021014
		[Conditional("DEBUG")]
		...
		// Token: 0x06000948 RID: 2376 RVA: 0x00022148 File Offset: 0x00021148
		[Conditional("DEBUG")]
		internal static void TraceWarningIf(bool condition, string message, params object[] values)
		{
		}

		// Token: 0x06000949 RID: 2377 RVA: 0x0002214C File Offset: 0x0002114C
		...
		// Token: 0x0600094A RID: 2378 RVA: 0x0002219C File Offset: 0x0002119C
		internal static Type GetType(ITypeResolutionService trs, string name, Dictionary<string, string> names)
		{
			...
			if (names != null && names.ContainsKey(name))
			{
				...
				{
					result = trs.GetType(text, false);
				}
			}
			return result;
		}

		// Token: 0x0600094B RID: 2379 RVA: 0x000221D4 File Offset: 0x000211D4
		...
		// Token: 0x0600094C RID: 2380 RVA: 0x000221E0 File Offset: 0x000211E0
			...
			using (CodeDomSerializerBase.TraceScope("CodeDomSerializerBase::FillStatementTable"))
			{
				...
				foreach (object obj in statements)
				{
					...
					if (codeExpression != null)
					{
						...
						Type type = CodeDomSerializerBase.GetType(trs, codeFieldReferenceExpression.FieldName, names);
						if (type != null)
						{
						...
						if ((codeVariableReferenceExpression = (codeExpression as CodeVariableReferenceExpression)) != null)
						{
							...
							if (names != null)
							{
								Type type2 = CodeDomSerializerBase.GetType(trs, codeVariableReferenceExpression.VariableName, names);
								if (type2 != null)
								{
		...
		{
			// Token: 0x0600094F RID: 2383 RVA: 0x00022618 File Offset: 0x00021618
			public void Dispose()
			{
				if (CodeDomSerializerBase.traceScope != null)
				{
