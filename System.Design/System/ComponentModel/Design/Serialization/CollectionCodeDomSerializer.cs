...
namespace System.ComponentModel.Design.Serialization
{
	...
	public class CollectionCodeDomSerializer : CodeDomSerializer
	{
		...
		// (get) Token: 0x06000CCC RID: 3276 RVA: 0x0003108C File Offset: 0x0003008C
		...
		// Token: 0x06000CCD RID: 3277 RVA: 0x000310A4 File Offset: 0x000300A4
		...
		// Token: 0x06000CCE RID: 3278 RVA: 0x0003120C File Offset: 0x0003020C
		...
		// Token: 0x06000CCF RID: 3279 RVA: 0x00031258 File Offset: 0x00030258
		...
		// Token: 0x06000CD0 RID: 3280 RVA: 0x00031440 File Offset: 0x00030440
		private static MethodInfo ChooseMethodByType(List<MethodInfo> methods, ICollection values)
		{
			...
			{
				Type reflectionType = TypeDescriptor.GetReflectionType(instance);
		...
		// Token: 0x06000CD1 RID: 3281 RVA: 0x000315A4 File Offset: 0x000305A4
		protected virtual object SerializeCollection(IDesignerSerializationManager manager, CodeExpression targetExpression, Type targetType, ICollection originalCollection, ICollection valuesToSerialize)
		{
			...
			else if (valuesToSerialize.Count > 0)
			{
				...
				if (methodInfo2 != null)
				{
					result = this.SerializeViaAddRange(manager, targetExpression, targetType, methodInfo2.GetParameters()[0], valuesToSerialize);
					flag = true;
				}
				else
				{
					...
					if (methodInfo3 != null)
					{
						result = this.SerializeViaAdd(manager, targetExpression, targetType, methodInfo3.GetParameters()[0], valuesToSerialize);
						flag = true;
					}
				}
		...
		// Token: 0x06000CD2 RID: 3282 RVA: 0x00031760 File Offset: 0x00030760
		...
		// Token: 0x06000CD3 RID: 3283 RVA: 0x0003193C File Offset: 0x0003093C
		...
		// Token: 0x06000CD4 RID: 3284 RVA: 0x00031B1C File Offset: 0x00030B1C
		...
		// Token: 0x06000CD5 RID: 3285 RVA: 0x00031D90 File Offset: 0x00030D90
