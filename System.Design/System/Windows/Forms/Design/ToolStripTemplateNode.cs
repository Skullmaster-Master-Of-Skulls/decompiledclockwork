	...
	internal class ToolStripTemplateNode : IMenuStatusHandler
	{
		...
		private void EnterInSituEdit()
		{
			if (!this.inSituMode)
			{
				...
				try
				{
					...
					this.centerTextBox.Width = width;
		...
		public class MiniToolStripRenderer : ToolStripSystemRenderer
		{
			...
			protected override void OnRenderLabelBackground(ToolStripItemRenderEventArgs e)
			{
				...
				if (this.state == 1)
				{
					graphics.FillRectangle(new SolidBrush(this.toolStripBorderColor), rect);
			...
			protected override void OnRenderSplitButtonBackground(ToolStripItemRenderEventArgs e)
			{
				...
				if (toolStripSplitButton != null)
				{
					...
					if (toolStripSplitButton.DropDownButtonPressed)
					{
						...
						graphics.FillRectangle(new SolidBrush(this.dropDownMouseDownColor), rect);
						flag = true;
					}
					...
					else if (this.state == 3)
					{
						...
						graphics.FillRectangle(new SolidBrush(this.dropDownMouseOverColor), rect2);
						flag = true;
					}
