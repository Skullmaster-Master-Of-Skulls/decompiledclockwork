...
namespace System.Windows.Forms.Design
{
	...
	public class ControlDesigner : ComponentDesigner
	{
		...
		{
			Point p = new Point(NativeMethods.Util.SignedLOWORD((int)lParam), NativeMethods.Util.SignedHIWORD((int)lParam));
			...
			public void OnMessage(ref Message m)
			{
				...
				if (controlDesigner != null)
				{
					...
					try
					{
						...
						{
							this.designer.SetUnhandledException(this.designer.Control, exception);
						}
						catch
						{
						}
