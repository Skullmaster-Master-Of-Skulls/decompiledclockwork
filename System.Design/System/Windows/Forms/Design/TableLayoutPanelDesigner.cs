...
namespace System.Windows.Forms.Design
{
	...
	internal class TableLayoutPanelDesigner : FlowPanelDesigner
	{
		...
		{
			bool isRow = ((DesignerVerb)sender).Text.Equals(SR.GetString("TableLayoutPanelDesignerRemoveRow"));
			this.OnRemove(isRow);
		}
		...
		{
			bool isRow = ((DesignerVerb)sender).Text.Equals(SR.GetString("TableLayoutPanelDesignerAddRow"));
			this.OnAdd(isRow);
		}
