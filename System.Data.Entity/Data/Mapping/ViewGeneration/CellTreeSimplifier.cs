...
namespace System.Data.Mapping.ViewGeneration
{
	...
	{
		// Token: 0x060025F3 RID: 9715 RVA: 0x0008F771 File Offset: 0x0008D971
		private CellTreeSimplifier(ViewgenContext context)
		{
			this.m_viewgenContext = context;
		}

		// Token: 0x060025F4 RID: 9716 RVA: 0x0008F780 File Offset: 0x0008D980
		...
		// Token: 0x060025F5 RID: 9717 RVA: 0x0008F7A0 File Offset: 0x0008D9A0
		...
		// Token: 0x060025F6 RID: 9718 RVA: 0x0008F8BC File Offset: 0x0008DABC
		...
		// Token: 0x060025F7 RID: 9719 RVA: 0x0008FA38 File Offset: 0x0008DC38
		...
		// Token: 0x060025F8 RID: 9720 RVA: 0x0008FB50 File Offset: 0x0008DD50
		...
		// Token: 0x060025F9 RID: 9721 RVA: 0x0008FBE4 File Offset: 0x0008DDE4
		...
		// Token: 0x060025FA RID: 9722 RVA: 0x0008FCBC File Offset: 0x0008DEBC
		private bool TryMergeCellQueries(CellTreeOpType opType, ref CellTreeNode node1, CellTreeNode node2)
		{
			...
			if (!this.TryMergeTwoCellQueries(leafCellTreeNode.LeftCellWrapper.RightCellQuery, leafCellTreeNode2.LeftCellWrapper.RightCellQuery, opType, this.m_viewgenContext.MemberMaps.RightDomainMap, out rightCellQuery))
			{
				return false;
			}
			CellQuery leftCellQuery;
			if (!this.TryMergeTwoCellQueries(leafCellTreeNode.LeftCellWrapper.LeftCellQuery, leafCellTreeNode2.LeftCellWrapper.LeftCellQuery, opType, this.m_viewgenContext.MemberMaps.LeftDomainMap, out leftCellQuery))
			{
				return false;
			}
		...
		// Token: 0x060025FB RID: 9723 RVA: 0x0008FDCC File Offset: 0x0008DFCC
		internal bool TryMergeTwoCellQueries(CellQuery query1, CellQuery query2, CellTreeOpType opType, MemberDomainMap memberDomainMap, out CellQuery mergedQuery)
		{
			mergedQuery = null;
		...
		// Token: 0x060025FC RID: 9724 RVA: 0x0008FFC5 File Offset: 0x0008E1C5
		...
		// Token: 0x060025FD RID: 9725 RVA: 0x0008FFD0 File Offset: 0x0008E1D0
		...
		// Token: 0x060025FE RID: 9726 RVA: 0x000900E5 File Offset: 0x0008E2E5
