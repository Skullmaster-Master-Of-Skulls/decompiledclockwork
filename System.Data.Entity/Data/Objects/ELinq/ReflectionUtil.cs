...
namespace System.Data.Objects.ELinq
{
	...
	{
		// Token: 0x06001E62 RID: 7778 RVA: 0x00068BC4 File Offset: 0x00066DC4
		static ReflectionUtil()
		{
			...
			dictionary.Add("ToList(IEnumerable`1<T0>)->List`1<T0>", SequenceMethod.NotSupported);
			...
			ReflectionUtil.s_methodMap = new Dictionary<MethodInfo, SequenceMethod>();
			ReflectionUtil.s_inverseMap = new Dictionary<SequenceMethod, MethodInfo>();
			foreach (MethodInfo methodInfo in ReflectionUtil.GetAllLinqOperators())
			{
				...
				{
					ReflectionUtil.s_methodMap.Add(methodInfo, sequenceMethod);
					ReflectionUtil.s_inverseMap[sequenceMethod] = methodInfo;
				}
			}
		}

		// Token: 0x06001E63 RID: 7779 RVA: 0x00069C58 File Offset: 0x00067E58
		internal static bool TryIdentifySequenceMethod(MethodInfo method, out SequenceMethod sequenceMethod)
		{
			...
			return ReflectionUtil.s_methodMap.TryGetValue(method, out sequenceMethod);
		}

		// Token: 0x06001E64 RID: 7780 RVA: 0x00069C7C File Offset: 0x00067E7C
		internal static bool TryIdentifySequenceMethod(Expression expression, bool unwrapLambda, out SequenceMethod sequenceMethod)
		{
			...
			if (expression.NodeType == ExpressionType.Call)
			{
				...
				return ReflectionUtil.TryIdentifySequenceMethod(methodCallExpression.Method, out sequenceMethod);
			}
			sequenceMethod = SequenceMethod.Where;
			return false;
		}

		// Token: 0x06001E65 RID: 7781 RVA: 0x00069CC5 File Offset: 0x00067EC5
		internal static bool TryLookupMethod(SequenceMethod sequenceMethod, out MethodInfo method)
		{
			return ReflectionUtil.s_inverseMap.TryGetValue(sequenceMethod, out method);
		}

		// Token: 0x06001E66 RID: 7782 RVA: 0x00069CD4 File Offset: 0x00067ED4
		...
		// Token: 0x06001E67 RID: 7783 RVA: 0x00069E24 File Offset: 0x00068024
		...
		// Token: 0x06001E68 RID: 7784 RVA: 0x00069EC2 File Offset: 0x000680C2
