...
namespace System.Web.Caching
{
	...
	{
		// Token: 0x06006711 RID: 26385 RVA: 0x0016BBF0 File Offset: 0x00169DF0
		internal static void SetupNotifications(int flags, string table, string connectionString)
		{
			...
			catch (Exception ex)
			{
				...
				if (ex2 != null)
				{
					...
					else if (ex2.Number == 229 || ex2.Number == 262 || ex2.Number == 2760 || ex2.Number == 4613)
					{
						...
						if (!flag2)
						{
							if (table != null)
							{
								name = "Permission_denied_table_enable_notification";
							}
							else
							{
								name = "Permission_denied_database_enable_notification";
							}
						}
						else if (table != null)
						{
							name = "Permission_denied_table_disable_notification";
						}
						else
						{
							name = "Permission_denied_database_disable_notification";
						}
						if (table != null)
						{
						...
						throw new HttpException(SR.GetString(name));
					}
					else if (ex2.Number == 50000 && ex2.Message == "00000001")
					{
						throw new HttpException(SR.GetString("Cache_dep_table_not_found", new object[]
						{
							table
						}));
					}
				...
				{
					@string = SR.GetString("Cant_connect_sql_cache_dep_database_admin_cmdtxt", new object[]
					{
				...
				{
					@string = SR.GetString("Cant_connect_sql_cache_dep_database_admin");
				}
				if (flag4)
				{
					throw new HttpException(@string, ex);
				}
			}
			finally
			{
		...
		// Token: 0x06006712 RID: 26386 RVA: 0x0016BF68 File Offset: 0x0016A168
		...
		// Token: 0x06006713 RID: 26387 RVA: 0x0016BF72 File Offset: 0x0016A172
		...
		// Token: 0x06006714 RID: 26388 RVA: 0x0016BF7C File Offset: 0x0016A17C
		...
		// Token: 0x06006715 RID: 26389 RVA: 0x0016BF88 File Offset: 0x0016A188
		public static void EnableTableForNotifications(string connectionString, string[] tables)
		{
			...
			{
				SqlCacheDependencyAdmin.SetupNotifications(8, table, connectionString);
			}
		}

		// Token: 0x06006716 RID: 26390 RVA: 0x0016BFBF File Offset: 0x0016A1BF
		...
		// Token: 0x06006717 RID: 26391 RVA: 0x0016BFCC File Offset: 0x0016A1CC
		public static void DisableTableForNotifications(string connectionString, string[] tables)
		{
			...
			foreach (string table in tables)
			{
				SqlCacheDependencyAdmin.SetupNotifications(10, table, connectionString);
			}
		}

		// Token: 0x06006718 RID: 26392 RVA: 0x0016C004 File Offset: 0x0016A204
		...
		// Token: 0x06006719 RID: 26393 RVA: 0x0016C104 File Offset: 0x0016A304
