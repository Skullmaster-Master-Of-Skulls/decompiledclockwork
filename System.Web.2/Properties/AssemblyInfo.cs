...
[assembly: WebResource("WebForms.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/WebForms.js")]
[assembly: WebResource("Focus.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/Focus.js", LoadSuccessExpression = "window.WebForm_FindFirstFocusableChild")]
[assembly: WebResource("SmartNav.htm", "text/html")]
[assembly: WebResource("SmartNav.js", "application/x-javascript")]
[assembly: WebResource("WebUIValidation.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/WebUIValidation.js", LoadSuccessExpression = "window.Page_ValidationVer")]
[assembly: WebResource("TreeView.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/TreeView.js", LoadSuccessExpression = "window.TreeView_HoverNode")]
[assembly: WebResource("Menu.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/Menu.js", LoadSuccessExpression = "window.Menu_ClearInterval")]
[assembly: WebResource("MenuStandards.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/MenuStandards.js", LoadSuccessExpression = "window.Sys && Sys.WebForms && Sys.WebForms.Menu")]
[assembly: WebResource("WebParts.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/WebParts.js", LoadSuccessExpression = "window.WebPart")]
[assembly: WebResource("GridView.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/GridView.js", LoadSuccessExpression = "window.GridView")]
[assembly: WebResource("DetailsView.js", "application/x-javascript", CdnSupportsSecureConnection = true, CdnPath = "http://ajax.aspnetcdn.com/ajax/4.6/1/DetailsView.js", LoadSuccessExpression = "window.DetailsView")]
