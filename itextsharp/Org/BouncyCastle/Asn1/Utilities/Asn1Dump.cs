...
namespace Org.BouncyCastle.Asn1.Utilities
{
	...
	{
		// Token: 0x060016D8 RID: 5848 RVA: 0x00083BAA File Offset: 0x00082BAA
		private Asn1Dump()
		{
		}

		// Token: 0x060016D9 RID: 5849 RVA: 0x00083BB4 File Offset: 0x00082BB4
		private static void AsString(string indent, bool verbose, Asn1Object obj, StringBuilder buf)
		{
			...
			else
			{
				...
				if (obj is DerUnknownTag)
				{
					string text8 = Hex.ToHexString(((DerUnknownTag)obj).GetData());
					buf.Append(string.Concat(new string[]
					{
						indent,
						"Unknown ",
						((DerUnknownTag)obj).Tag.ToString("X"),
						" ",
						text8,
						Asn1Dump.NewLine
					}));
				...
				if (obj is DerExternal)
				{
					...
					{
						buf.Append(text9 + "Direct Reference: " + derExternal.DirectReference.Id + Asn1Dump.NewLine);
					}
					if (derExternal.IndirectReference != null)
					{
						buf.Append(text9 + "Indirect Reference: " + derExternal.IndirectReference.ToString() + Asn1Dump.NewLine);
					}
					if (derExternal.DataValueDescriptor != null)
					{
						Asn1Dump.AsString(text9, verbose, derExternal.DataValueDescriptor, buf);
					}
					buf.Append(string.Concat(new object[]
					{
						text9,
					...
					Asn1Dump.AsString(text9, verbose, derExternal.ExternalContent, buf);
					return;
				}
		...
		// Token: 0x060016DA RID: 5850 RVA: 0x000845D8 File Offset: 0x000835D8
		...
		// Token: 0x060016DB RID: 5851 RVA: 0x00084728 File Offset: 0x00083728
		...
		// Token: 0x060016DC RID: 5852 RVA: 0x00084771 File Offset: 0x00083771
		public static string DumpAsString(Asn1Encodable obj)
		{
			return Asn1Dump.DumpAsString(obj, false);
		}

		// Token: 0x060016DD RID: 5853 RVA: 0x0008477C File Offset: 0x0008377C
		...
		// Token: 0x060016DE RID: 5854 RVA: 0x000847A8 File Offset: 0x000837A8
		...
		// Token: 0x060016DF RID: 5855 RVA: 0x00084898 File Offset: 0x00083898
