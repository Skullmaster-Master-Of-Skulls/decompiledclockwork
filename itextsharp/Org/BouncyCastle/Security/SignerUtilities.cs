...
namespace Org.BouncyCastle.Security
{
	...
	{
		// Token: 0x06003161 RID: 12641 RVA: 0x001339D7 File Offset: 0x001329D7
		private SignerUtilities()
		{
		}

		// Token: 0x06003162 RID: 12642 RVA: 0x001339E0 File Offset: 0x001329E0
		static SignerUtilities()
		{
			...
			SignerUtilities.algorithms["SHA-512/ECDSA"] = "RIPEMD160withECDSA";
		...
		// Token: 0x06003163 RID: 12643 RVA: 0x00134920 File Offset: 0x00133920
		...
		// (get) Token: 0x06003164 RID: 12644 RVA: 0x0013496F File Offset: 0x0013396F
		...
		// Token: 0x06003165 RID: 12645 RVA: 0x0013497B File Offset: 0x0013397B
		...
		// Token: 0x06003166 RID: 12646 RVA: 0x00134988 File Offset: 0x00133988
		public static Asn1Encodable GetDefaultX509Parameters(string algorithm)
		{
			...
			case "SHA-224withRSAandMGF1":
				return SignerUtilities.GetPssX509Parameters("SHA-224");
			case "SHA-256withRSAandMGF1":
				return SignerUtilities.GetPssX509Parameters("SHA-256");
			case "SHA-384withRSAandMGF1":
				return SignerUtilities.GetPssX509Parameters("SHA-384");
			case "SHA-512withRSAandMGF1":
				return SignerUtilities.GetPssX509Parameters("SHA-512");
			}
			return DerNull.Instance;
		}

		// Token: 0x06003167 RID: 12647 RVA: 0x00134AA4 File Offset: 0x00133AA4
		...
		// Token: 0x06003168 RID: 12648 RVA: 0x00134AED File Offset: 0x00133AED
		public static ISigner GetSigner(DerObjectIdentifier id)
		{
			return SignerUtilities.GetSigner(id.Id);
		}

		// Token: 0x06003169 RID: 12649 RVA: 0x00134AFC File Offset: 0x00133AFC
		public static ISigner GetSigner(string algorithm)
		{
			...
			if (text.Equals("RAWRSASSA-PSS"))
			{
				...
				return new PssSigner(new RsaBlindedEngine(), contentDigest, digest, digestSize, 188);
			}
		...
		// Token: 0x0600316A RID: 12650 RVA: 0x00134FEE File Offset: 0x00133FEE
