...
namespace Org.BouncyCastle.Security
{
	...
	{
		// Token: 0x060028AD RID: 10413 RVA: 0x000F68A6 File Offset: 0x000F58A6
		private PbeUtilities()
		{
		}

		// Token: 0x060028AE RID: 10414 RVA: 0x000F68B0 File Offset: 0x000F58B0
		static PbeUtilities()
		{
		...
		// Token: 0x060028AF RID: 10415 RVA: 0x000F7454 File Offset: 0x000F6454
		...
		// Token: 0x060028B0 RID: 10416 RVA: 0x000F74D8 File Offset: 0x000F64D8
		public static DerObjectIdentifier GetObjectIdentifier(string mechanism)
		{
			mechanism = (string)PbeUtilities.algorithms[mechanism.ToUpper(CultureInfo.InvariantCulture)];
			if (mechanism != null)
			{
		...
		// (get) Token: 0x060028B1 RID: 10417 RVA: 0x000F750B File Offset: 0x000F650B
		...
		// Token: 0x060028B2 RID: 10418 RVA: 0x000F7518 File Offset: 0x000F6518
		public static bool IsPkcs12(string algorithm)
		{
			string text = (string)PbeUtilities.algorithms[algorithm.ToUpper(CultureInfo.InvariantCulture)];
			return text != null && "Pkcs12".Equals(PbeUtilities.algorithmType[text]);
		}

		// Token: 0x060028B3 RID: 10419 RVA: 0x000F755C File Offset: 0x000F655C
		...
		// Token: 0x060028B4 RID: 10420 RVA: 0x000F75A0 File Offset: 0x000F65A0
		...
		// Token: 0x060028B5 RID: 10421 RVA: 0x000F75E4 File Offset: 0x000F65E4
		...
		// Token: 0x060028B6 RID: 10422 RVA: 0x000F7628 File Offset: 0x000F6628
		...
		// Token: 0x060028B7 RID: 10423 RVA: 0x000F7666 File Offset: 0x000F6666
		...
		// Token: 0x060028B8 RID: 10424 RVA: 0x000F7675 File Offset: 0x000F6675
		...
		// Token: 0x060028B9 RID: 10425 RVA: 0x000F769E File Offset: 0x000F669E
		...
		// Token: 0x060028BA RID: 10426 RVA: 0x000F76AE File Offset: 0x000F66AE
		...
		// Token: 0x060028BB RID: 10427 RVA: 0x000F76BE File Offset: 0x000F66BE
		...
		// Token: 0x060028BC RID: 10428 RVA: 0x000F76D8 File Offset: 0x000F66D8
		...
		// Token: 0x060028BD RID: 10429 RVA: 0x000F76F2 File Offset: 0x000F66F2
		...
		// Token: 0x060028BE RID: 10430 RVA: 0x000F7700 File Offset: 0x000F6700
		public static ICipherParameters GenerateCipherParameters(string algorithm, char[] password, bool wrongPkcs12Zero, Asn1Encodable pbeParameters)
		{
			...
			if (PbeUtilities.IsPkcs5Scheme2(text))
			{
				...
				cipherParameters = pbeParametersGenerator.GenerateDerivedParameters(objectID.Id, keySize);
				if (array2 != null && !Arrays.AreEqual(array2, new byte[array2.Length]))
				{
					cipherParameters = new ParametersWithIV(cipherParameters, array2);
				}
			}
			else if (text.StartsWith("PBEwithSHA-1"))
			{
				...
				if (text.Equals("PBEwithSHA-1and128bitRC4"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("RC4", 128);
				}
				else if (text.Equals("PBEwithSHA-1and40bitRC4"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("RC4", 40);
				}
				else if (text.Equals("PBEwithSHA-1and3-keyDESEDE-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("DESEDE", 192, 64);
				}
				else if (text.Equals("PBEwithSHA-1and2-keyDESEDE-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("DESEDE", 128, 64);
				}
				else if (text.Equals("PBEwithSHA-1and128bitRC2-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("RC2", 128, 64);
				}
				else if (text.Equals("PBEwithSHA-1and40bitRC2-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("RC2", 40, 64);
				}
				else if (text.Equals("PBEwithSHA-1andDES-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("DES", 64, 64);
				}
				else if (text.Equals("PBEwithSHA-1andRC2-CBC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("RC2", 64, 64);
				}
				else if (text.Equals("PBEwithSHA-1and128bitAES-CBC-BC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("AES", 128, 128);
				}
				else if (text.Equals("PBEwithSHA-1and192bitAES-CBC-BC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("AES", 192, 128);
				}
				else if (text.Equals("PBEwithSHA-1and256bitAES-CBC-BC"))
				{
					cipherParameters = pbeParametersGenerator2.GenerateDerivedParameters("AES", 256, 128);
				}
			}
			else if (text.StartsWith("PBEwithSHA-256"))
			{
				...
				{
					cipherParameters = pbeParametersGenerator3.GenerateDerivedParameters("AES", 128, 128);
				}
				else if (text.Equals("PBEwithSHA-256and192bitAES-CBC-BC"))
				{
					cipherParameters = pbeParametersGenerator3.GenerateDerivedParameters("AES", 192, 128);
				}
				else if (text.Equals("PBEwithSHA-256and256bitAES-CBC-BC"))
				{
					cipherParameters = pbeParametersGenerator3.GenerateDerivedParameters("AES", 256, 128);
				}
			}
			else if (text.StartsWith("PBEwithMD5"))
			{
				...
				{
					cipherParameters = pbeParametersGenerator4.GenerateDerivedParameters("DES", 64, 64);
				}
				else if (text.Equals("PBEwithMD5andRC2-CBC"))
				{
					cipherParameters = pbeParametersGenerator4.GenerateDerivedParameters("RC2", 64, 64);
				}
				else if (text.Equals("PBEwithMD5and128bitAES-CBC-OpenSSL"))
				{
					cipherParameters = pbeParametersGenerator4.GenerateDerivedParameters("AES", 128, 128);
				}
				else if (text.Equals("PBEwithMD5and192bitAES-CBC-OpenSSL"))
				{
					cipherParameters = pbeParametersGenerator4.GenerateDerivedParameters("AES", 192, 128);
				}
				else if (text.Equals("PBEwithMD5and256bitAES-CBC-OpenSSL"))
				{
					cipherParameters = pbeParametersGenerator4.GenerateDerivedParameters("AES", 256, 128);
				}
			}
			else if (text.StartsWith("PBEwithMD2"))
			{
				...
				{
					cipherParameters = pbeParametersGenerator5.GenerateDerivedParameters("DES", 64, 64);
				}
				else if (text.Equals("PBEwithMD2andRC2-CBC"))
				{
					cipherParameters = pbeParametersGenerator5.GenerateDerivedParameters("RC2", 64, 64);
				}
			}
			else if (text.StartsWith("PBEwithHmac"))
			{
				...
				cipherParameters = pbeParametersGenerator6.GenerateDerivedMacParameters(keySize2);
			}
			Array.Clear(array, 0, array.Length);
			return cipherParameters;
		}

		// Token: 0x060028BF RID: 10431 RVA: 0x000F7CF7 File Offset: 0x000F6CF7
		public static object CreateEngine(DerObjectIdentifier algorithmOid)
		{
			return PbeUtilities.CreateEngine(algorithmOid.Id);
		}

		// Token: 0x060028C0 RID: 10432 RVA: 0x000F7D04 File Offset: 0x000F6D04
		...
		// Token: 0x060028C1 RID: 10433 RVA: 0x000F7D50 File Offset: 0x000F6D50
		private static bool EndsWith(string s, string ending)
		{
			int num = s.Length - ending.Length;
			return num >= 0 && s.Substring(num) == ending;
		}

		// Token: 0x060028C2 RID: 10434 RVA: 0x000F7D80 File Offset: 0x000F6D80
		public static object CreateEngine(string algorithm)
		{
			...
			if (text.StartsWith("PBEwithMD2") || text.StartsWith("PBEwithMD5") || text.StartsWith("PBEwithSHA-1"))
			{
				if (PbeUtilities.EndsWith(text, "RC2-CBC"))
				{
					return CipherUtilities.GetCipher("RC2/CBC");
				}
				if (PbeUtilities.EndsWith(text, "RC4"))
				{
					return CipherUtilities.GetCipher("RC4");
				}
				if (PbeUtilities.EndsWith(text, "DES-CBC"))
				{
					return CipherUtilities.GetCipher("DES/CBC");
				}
				if (PbeUtilities.EndsWith(text, "DESEDE-CBC"))
				{
		...
		// Token: 0x060028C3 RID: 10435 RVA: 0x000F7E5F File Offset: 0x000F6E5F
