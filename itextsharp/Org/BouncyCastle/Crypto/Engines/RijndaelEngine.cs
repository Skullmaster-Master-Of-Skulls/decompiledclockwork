...
namespace Org.BouncyCastle.Crypto.Engines
{
	...
	{
		// Token: 0x06002EB9 RID: 11961 RVA: 0x0012022D File Offset: 0x0011F22D
		...
		// Token: 0x06002EBA RID: 11962 RVA: 0x0012024A File Offset: 0x0011F24A
		...
		// Token: 0x06002EBB RID: 11963 RVA: 0x00120266 File Offset: 0x0011F266
		...
		// Token: 0x06002EBC RID: 11964 RVA: 0x0012027B File Offset: 0x0011F27B
		...
		// Token: 0x06002EBD RID: 11965 RVA: 0x0012028D File Offset: 0x0011F28D
		...
		// Token: 0x06002EBE RID: 11966 RVA: 0x001202A2 File Offset: 0x0011F2A2
		...
		// Token: 0x06002EBF RID: 11967 RVA: 0x001202B8 File Offset: 0x0011F2B8
		...
		// Token: 0x06002EC0 RID: 11968 RVA: 0x00120308 File Offset: 0x0011F308
		...
		// Token: 0x06002EC1 RID: 11969 RVA: 0x0012033C File Offset: 0x0011F33C
		...
		// Token: 0x06002EC2 RID: 11970 RVA: 0x00120388 File Offset: 0x0011F388
		...
		// Token: 0x06002EC3 RID: 11971 RVA: 0x001203CC File Offset: 0x0011F3CC
		...
		// Token: 0x06002EC4 RID: 11972 RVA: 0x00120428 File Offset: 0x0011F428
		...
		// Token: 0x06002EC5 RID: 11973 RVA: 0x0012056C File Offset: 0x0011F56C
		...
		// Token: 0x06002EC6 RID: 11974 RVA: 0x00120754 File Offset: 0x0011F754
		private long[][] GenerateWorkingKey(byte[] key)
		{
			...
			while (k < (this.ROUNDS + 1) * (this.BC / 8))
			{
				for (int n = 0; n < 4; n++)
				{
					...
					ptr ^= RijndaelEngine.S[(int)(array[(n + 1) % 4, num4 - 1] & byte.MaxValue)];
				}
				...
				if (num4 <= 6)
				{
					for (int num6 = 1; num6 < num4; num6++)
					{
						...
						{
							ref byte ptr3 = ref array[num7, num6];
							ptr3 ^= array[num7, num6 - 1];
						}
					}
				}
				else
				{
					for (int num8 = 1; num8 < 4; num8++)
					{
						...
						{
							ref byte ptr4 = ref array[num9, num8];
							ptr4 ^= array[num9, num8 - 1];
						}
					}
					for (int num10 = 0; num10 < 4; num10++)
					{
						ref byte ptr5 = ref array[num10, 4];
						ptr5 ^= RijndaelEngine.S[(int)(array[num10, 3] & byte.MaxValue)];
					}
					for (int num11 = 5; num11 < num4; num11++)
					{
						for (int num12 = 0; num12 < 4; num12++)
						{
							ref byte ptr6 = ref array[num12, num11];
							ptr6 ^= array[num12, num11 - 1];
						}
					}
				}
				int num13 = 0;
				while (num13 < num4 && k < (this.ROUNDS + 1) * (this.BC / 8))
				{
					...
					{
						array2[k / (this.BC / 8)][num14] |= (long)(array[num14, num13] & byte.MaxValue) << k * 8 % this.BC;
					}
					num13++;
					k++;
				}
		...
		// Token: 0x06002EC7 RID: 11975 RVA: 0x00120ADE File Offset: 0x0011FADE
		public RijndaelEngine() : this(128)
		{
		}

		// Token: 0x06002EC8 RID: 11976 RVA: 0x00120AEC File Offset: 0x0011FAEC
		...
		// Token: 0x06002EC9 RID: 11977 RVA: 0x00120C50 File Offset: 0x0011FC50
		...
		// (get) Token: 0x06002ECA RID: 11978 RVA: 0x00120CA8 File Offset: 0x0011FCA8
		...
		// (get) Token: 0x06002ECB RID: 11979 RVA: 0x00120CAF File Offset: 0x0011FCAF
		...
		// Token: 0x06002ECC RID: 11980 RVA: 0x00120CB2 File Offset: 0x0011FCB2
		public int GetBlockSize()
		{
			return this.BC / 2;
		}

		// Token: 0x06002ECD RID: 11981 RVA: 0x00120CBC File Offset: 0x0011FCBC
		public int ProcessBlock(byte[] input, int inOff, byte[] output, int outOff)
		{
			...
			if (inOff + this.BC / 2 > input.Length)
			{
				throw new DataLengthException("input buffer too short");
			}
			if (outOff + this.BC / 2 > output.Length)
			{
		...
		// Token: 0x06002ECE RID: 11982 RVA: 0x00120D4C File Offset: 0x0011FD4C
		public void Reset()
		{
		}

		// Token: 0x06002ECF RID: 11983 RVA: 0x00120D50 File Offset: 0x0011FD50
		...
		// Token: 0x06002ED0 RID: 11984 RVA: 0x00120E48 File Offset: 0x0011FE48
		...
		// Token: 0x06002ED1 RID: 11985 RVA: 0x00120EB4 File Offset: 0x0011FEB4
		...
		// Token: 0x06002ED2 RID: 11986 RVA: 0x00120F28 File Offset: 0x0011FF28
