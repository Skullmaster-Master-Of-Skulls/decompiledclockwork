...
namespace System.Deployment.Internal.CodeSigning
{
	...
	{
		// Token: 0x06000078 RID: 120 RVA: 0x00002843 File Offset: 0x00000A43
		private SignedCmiManifest2()
		{
		}

		// Token: 0x06000079 RID: 121 RVA: 0x000040D3 File Offset: 0x000022D3
		internal SignedCmiManifest2(XmlDocument manifestDom, bool useSha256OrHigher)
		{
			...
			this.m_useSha256OrHigher = useSha256OrHigher;
		}

		// Token: 0x0600007A RID: 122 RVA: 0x000040F7 File Offset: 0x000022F7
		internal void Sign(CmiManifestSigner2 signer)
		{
			this.Sign(signer, null);
		}

		// Token: 0x0600007B RID: 123 RVA: 0x00004104 File Offset: 0x00002304
		internal void Sign(CmiManifestSigner2 signer, string timeStampUrl)
		{
			...
			{
				SignedCmiManifest2.ReplacePublicKeyToken(this.m_manifestDom, signer.StrongNameKey, this.m_useSha256OrHigher);
			}
			XmlDocument licenseDom = null;
			if (signer.Certificate != null)
			{
				SignedCmiManifest2.InsertPublisherIdentity(this.m_manifestDom, signer.Certificate);
				SupportedHashAlgorithm supportedHashAlgorithm = this.m_useSha256OrHigher ? SupportedHashAlgorithm.SHA256 : SupportedHashAlgorithm.SHA1;
				licenseDom = SignedCmiManifest2.CreateLicenseDom(signer, this.ExtractPrincipalFromManifest(), SignedCmiManifest2.ComputeHashFromManifest(this.m_manifestDom, supportedHashAlgorithm));
				SignedCmiManifest2.AuthenticodeSignLicenseDom(licenseDom, signer, timeStampUrl, this.m_useSha256OrHigher);
			}
			SignedCmiManifest2.StrongNameSignManifestDom(this.m_manifestDom, licenseDom, signer, this.m_useSha256OrHigher);
		}

		// Token: 0x0600007C RID: 124 RVA: 0x000041C4 File Offset: 0x000023C4
		internal void Verify(CmiManifestVerifyFlags verifyFlags)
		{
			...
			SupportedHashAlgorithm supportedHashAlgorithm = SupportedHashAlgorithm.SHA512;
			if (this.m_useSha256OrHigher)
			{
				supportedHashAlgorithm = ManifestUtilities.GetSupportedHashAlgorithmFromSignatureMethod(manifestSignedXml.SignedInfo.SignatureMethod, this.m_useSha256OrHigher, delegate
				{
			...
			if ((verifyFlags & CmiManifestVerifyFlags.StrongNameOnly) != CmiManifestVerifyFlags.StrongNameOnly)
			{
				if (this.m_useSha256OrHigher)
				{
					this.VerifyLicenseNew(verifyFlags, supportedHashAlgorithm);
					return;
				}
		...
		// (get) Token: 0x0600007D RID: 125 RVA: 0x000042ED File Offset: 0x000024ED
		...
		// (get) Token: 0x0600007E RID: 126 RVA: 0x000042F5 File Offset: 0x000024F5
		...
		// Token: 0x0600007F RID: 127 RVA: 0x00004300 File Offset: 0x00002500
		private unsafe void VerifyLicense(CmiManifestVerifyFlags verifyFlags)
		{
			...
			this.VerifyAssemblyIdentity(xmlNamespaceManager, SupportedHashAlgorithm.SHA1);
			...
			IntPtr pbData = new IntPtr((void*)value);
		...
		private void VerifyLicenseNew(CmiManifestVerifyFlags verifyFlags, SupportedHashAlgorithm supportedHashAlgorithm)
		{
			XmlNamespaceManager xmlNamespaceManager = new XmlNamespaceManager(this.m_manifestDom.NameTable);
			xmlNamespaceManager.AddNamespace("asm", "urn:schemas-microsoft-com:asm.v1");
			xmlNamespaceManager.AddNamespace("asm2", "urn:schemas-microsoft-com:asm.v2");
			...
			this.VerifyAssemblyIdentity(xmlNamespaceManager, supportedHashAlgorithm);
			this.m_authenticodeSignerInfo = new CmiAuthenticodeSignerInfo(-2146762485);
			...
			if (this.m_useSha256OrHigher)
			{
				manifestSignedXml.SignedInfo.SignatureMethod = ManifestUtilities.GetSignatureMethodUri(supportedHashAlgorithm, this.m_useSha256OrHigher, -2146869232);
			}
			...
			X509Certificate2 signingCertificate = this.GetSigningCertificate(manifestSignedXml, xmlNamespaceManager, out x509Certificate2Collection);
			...
			x509Chain.ChainPolicy.ApplicationPolicy.Add(new Oid("1.3.6.1.5.5.7.3.3"));
		...
		// Token: 0x06000081 RID: 129 RVA: 0x0000494C File Offset: 0x00002B4C
		private X509Certificate2 GetSigningCertificate(ManifestSignedXml2 signedXml, XmlNamespaceManager nsm, out X509Certificate2Collection intermediateCertificates)
		{
			...
			foreach (object obj2 in keyInfoX509Data.Certificates)
			{
				...
				{
					intermediateCertificates.Add(x509Certificate2);
		...
		// Token: 0x06000082 RID: 130 RVA: 0x00004B40 File Offset: 0x00002D40
		...
		// Token: 0x06000083 RID: 131 RVA: 0x00004D14 File Offset: 0x00002F14
		...
		// Token: 0x06000084 RID: 132 RVA: 0x00004DD8 File Offset: 0x00002FD8
		...
		// Token: 0x06000085 RID: 133 RVA: 0x00004F18 File Offset: 0x00003118
		private bool VerifySignatureTimestampNew(XmlElement signatureNode, XmlNamespaceManager nsm, out DateTime verificationTime)
		{
			...
			catch (Exception ex)
			{
				if ((!(ex is CryptographicException) || ex.HResult != -2146893822) && array != null)
				{
					...
					if (a == "2.16.840.1.101.3.4.2.3")
					{
						hashAlgorithm = SHA512.Create();
					}
					else if (a == "2.16.840.1.101.3.4.2.2")
					{
						hashAlgorithm = SHA384.Create();
					}
					else if (a == "2.16.840.1.101.3.4.2.1")
					{
			...
			try
			{
				using (X509Chain x509Chain = new X509Chain())
				{
					...
					uint authenticodePolicies = this.GetAuthenticodePolicies();
					if ((131072U & authenticodePolicies) == 131072U)
					{
		...
		// Token: 0x06000086 RID: 134 RVA: 0x00005454 File Offset: 0x00003654
		...
		// Token: 0x06000087 RID: 135 RVA: 0x0000551C File Offset: 0x0000371C
		...
		// Token: 0x06000088 RID: 136 RVA: 0x00005584 File Offset: 0x00003784
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00005648 File Offset: 0x00003848
		...
		// Token: 0x0600008A RID: 138 RVA: 0x000056B8 File Offset: 0x000038B8
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00005750 File Offset: 0x00003950
		...
		// Token: 0x0600008C RID: 140 RVA: 0x000057A4 File Offset: 0x000039A4
		private void VerifyAssemblyIdentity(XmlNamespaceManager nsm, SupportedHashAlgorithm hashAlgorithm)
		{
			...
			this.VerifyHash(nsm, hashAlgorithm);
		}
		...
		// Token: 0x0600008E RID: 142 RVA: 0x000059BC File Offset: 0x00003BBC
		private void VerifyHash(XmlNamespaceManager nsm, SupportedHashAlgorithm hashAlgorithm)
		{
			XmlDocument xmlDocument = new XmlDocument();
			...
			byte[] array2 = SignedCmiManifest2.ComputeHashFromManifest(xmlDocument, hashAlgorithm);
		...
		private unsafe string VerifyPublicKeyToken()
		{
			...
			IntPtr intPtr = 0;
			crypt_DATA_BLOB.cbData = (uint)bytes.Length;
			crypt_DATA_BLOB.pbData = new IntPtr((void*)value);
			crypt_DATA_BLOB2.cbData = (uint)bytes2.Length;
			crypt_DATA_BLOB2.pbData = new IntPtr((void*)value2);
			int num = Win32._AxlRSAKeyValueToPublicKeyToken(ref crypt_DATA_BLOB, ref crypt_DATA_BLOB2, ref intPtr);
			if (num != 0)
			{
				throw new CryptographicException(num);
			}
			byte[] array4 = SignedCmiManifest2.HexStringToBytes(Marshal.PtrToStringUni(intPtr));
			Win32.HeapFree(Win32.GetProcessHeap(), 0U, intPtr);
			array3 = null;
			array2 = null;
		...
		// Token: 0x06000090 RID: 144 RVA: 0x00005C8C File Offset: 0x00003E8C
		...
		// Token: 0x06000091 RID: 145 RVA: 0x00005DB4 File Offset: 0x00003FB4
		...
		// Token: 0x06000092 RID: 146 RVA: 0x00005E0C File Offset: 0x0000400C
		...
		// Token: 0x06000093 RID: 147 RVA: 0x00005E84 File Offset: 0x00004084
		private unsafe static void ReplacePublicKeyToken(XmlDocument manifestDom, AsymmetricAlgorithm snKey, bool useSha256)
		{
			...
			string value2 = Marshal.PtrToStringUni(intPtr);
			Win32.HeapFree(Win32.GetProcessHeap(), 0U, intPtr);
			xmlElement.SetAttribute("publicKeyToken", value2);
			array2 = null;
		}

		// Token: 0x06000094 RID: 148 RVA: 0x00005FD4 File Offset: 0x000041D4
		...
		// Token: 0x06000095 RID: 149 RVA: 0x00006048 File Offset: 0x00004248
		private static byte[] ComputeHashFromManifest(XmlDocument manifestDom, SupportedHashAlgorithm supportedHashAlgorithm)
		{
			XmlDocument xmlDocument = new XmlDocument();
			xmlDocument.PreserveWhitespace = true;
			...
			if (supportedHashAlgorithm != SupportedHashAlgorithm.SHA1)
			{
				using (HashAlgorithm hashAlgorithm = ManifestUtilities.CreateHashAlgorithmInstance(supportedHashAlgorithm))
				{
					byte[] array = hashAlgorithm.ComputeHash(xmlDsigExcC14NTransform.GetOutput() as MemoryStream);
					if (array == null)
					{
						throw new CryptographicException(-2146869232);
					}
		...
		// Token: 0x06000096 RID: 150 RVA: 0x00006154 File Offset: 0x00004354
		...
		// Token: 0x06000097 RID: 151 RVA: 0x000062BC File Offset: 0x000044BC
		...
		// Token: 0x06000098 RID: 152 RVA: 0x00006444 File Offset: 0x00004644
		private unsafe static string ObtainRFC3161Timestamp(string timeStampUrl, string signatureValue, bool useSha256)
		{
			...
			try
			{
				...
				try
				{
					...
					crypt_TIMESTAMP_PARA.Nonce.pbData = (IntPtr)((void*)value);
				...
				byte[] array4 = new byte[crypt_TIMESTAMP_CONTEXT.cbEncoded];
				Marshal.Copy(crypt_TIMESTAMP_CONTEXT.pbEncoded, array4, 0, (int)crypt_TIMESTAMP_CONTEXT.cbEncoded);
				result = Convert.ToBase64String(array4);
			}
			finally
			{
				if (zero != IntPtr.Zero)
		...
		// Token: 0x06000099 RID: 153 RVA: 0x000065E8 File Offset: 0x000047E8
		private unsafe static void TimestampSignedLicenseDom(XmlDocument licenseDom, string timeStampUrl, bool useSha256)
		{
			...
			catch
			{
				...
				innerText = Encoding.UTF8.GetString(array2);
			}
		...
		// Token: 0x0600009C RID: 156 RVA: 0x00006964 File Offset: 0x00004B64
		...
		// Token: 0x0600009D RID: 157 RVA: 0x00003C1A File Offset: 0x00001E1A
		...
		// Token: 0x0600009E RID: 158 RVA: 0x000069C0 File Offset: 0x00004BC0
		...
		private bool m_useSha256OrHigher;
