...
namespace System
{
	...
	internal static class AccessibilityImprovements
	{
		...
		internal static bool Level5
		{
			...
			get
			{
				if (AccessibilityImprovements.useLegacyAccessibilityFeatures5 < 0)
				{
					return true;
				}
				if (AccessibilityImprovements.useLegacyAccessibilityFeatures5 > 0)
				...
				AccessibilityImprovements.ValidateLevels();
				return AccessibilityImprovements.useLegacyAccessibilityFeatures5 < 0;
			}
		}
		...
		internal static void ValidateLevels()
		{
			...
			array[4] = Tuple.Create<string, Action<int>>("Switch.UseLegacyAccessibilityFeatures.5", delegate(int switchValue)
			{
				AccessibilityImprovements.useLegacyAccessibilityFeatures5 = switchValue;
			});
