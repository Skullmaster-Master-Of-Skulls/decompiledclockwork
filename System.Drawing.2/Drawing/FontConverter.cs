...
namespace System.Drawing
{
	...
	{
		// Token: 0x060001CF RID: 463 RVA: 0x000084B0 File Offset: 0x000066B0
		~FontConverter()
		{
		...
		// Token: 0x060001D0 RID: 464 RVA: 0x00007C88 File Offset: 0x00005E88
		public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
		{
			return sourceType == typeof(string) || base.CanConvertFrom(context, sourceType);
		}

		// Token: 0x060001D1 RID: 465 RVA: 0x00007CA6 File Offset: 0x00005EA6
		public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType)
		{
			return destinationType == typeof(InstanceDescriptor) || base.CanConvertTo(context, destinationType);
		}

		// Token: 0x060001D2 RID: 466 RVA: 0x000084EC File Offset: 0x000066EC
		...
		// Token: 0x060001D3 RID: 467 RVA: 0x00008748 File Offset: 0x00006948
		...
		// Token: 0x060001D4 RID: 468 RVA: 0x000089C0 File Offset: 0x00006BC0
		...
		// Token: 0x060001D5 RID: 469 RVA: 0x0000848C File Offset: 0x0000668C
		public override bool GetCreateInstanceSupported(ITypeDescriptorContext context)
		{
			return true;
		}

		// Token: 0x060001D6 RID: 470 RVA: 0x00008B84 File Offset: 0x00006D84
		...
		// Token: 0x060001D7 RID: 471 RVA: 0x00008BD0 File Offset: 0x00006DD0
		...
		// Token: 0x060001D8 RID: 472 RVA: 0x00008C14 File Offset: 0x00006E14
		...
		// Token: 0x060001D9 RID: 473 RVA: 0x0000848C File Offset: 0x0000668C
		public override bool GetPropertiesSupported(ITypeDescriptorContext context)
		{
			return true;
		}

		// Token: 0x060001DA RID: 474 RVA: 0x00008C60 File Offset: 0x00006E60
		...
		// Token: 0x060001DB RID: 475 RVA: 0x00008CE8 File Offset: 0x00006EE8
		...
		{
			// Token: 0x06000C92 RID: 3218 RVA: 0x0002C4C4 File Offset: 0x0002A6C4
		...
		{
			// Token: 0x06000C94 RID: 3220 RVA: 0x0002C556 File Offset: 0x0002A756
			public FontNameConverter()
			{
				SystemEvents.InstalledFontsChanged += this.OnInstalledFontsChanged;
			}

			// Token: 0x06000C95 RID: 3221 RVA: 0x00007C88 File Offset: 0x00005E88
			public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
			{
				return sourceType == typeof(string) || base.CanConvertFrom(context, sourceType);
			}

			// Token: 0x06000C96 RID: 3222 RVA: 0x0002C56F File Offset: 0x0002A76F
			public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
			{
				if (value is string)
				{
			...
			// Token: 0x06000C97 RID: 3223 RVA: 0x0002C590 File Offset: 0x0002A790
			void IDisposable.Dispose()
			{
				SystemEvents.InstalledFontsChanged -= this.OnInstalledFontsChanged;
			}

			// Token: 0x06000C98 RID: 3224 RVA: 0x0002C5A4 File Offset: 0x0002A7A4
			...
			// Token: 0x06000C99 RID: 3225 RVA: 0x0001E380 File Offset: 0x0001C580
			public override bool GetStandardValuesExclusive(ITypeDescriptorContext context)
			{
				return false;
			}

			// Token: 0x06000C9A RID: 3226 RVA: 0x0000848C File Offset: 0x0000668C
			public override bool GetStandardValuesSupported(ITypeDescriptorContext context)
			{
				return true;
			}

			// Token: 0x06000C9B RID: 3227 RVA: 0x0002C62C File Offset: 0x0002A82C
			...
			// Token: 0x06000C9C RID: 3228 RVA: 0x0002C6B6 File Offset: 0x0002A8B6
		...
		{
			// Token: 0x06000C9D RID: 3229 RVA: 0x0002C6BF File Offset: 0x0002A8BF
			public FontUnitConverter() : base(typeof(GraphicsUnit))
			{
			}

			// Token: 0x06000C9E RID: 3230 RVA: 0x0002C6D4 File Offset: 0x0002A8D4
			public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
			{
				if (base.Values == null)
				{
