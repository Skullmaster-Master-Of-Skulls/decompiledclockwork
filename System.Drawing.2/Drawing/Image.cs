...
namespace System.Drawing
{
	...
	public abstract class Image : MarshalByRefObject, ISerializable, ICloneable, IDisposable
	{
		...
		// Token: 0x0600031F RID: 799 RVA: 0x0000EB4C File Offset: 0x0000CD4C
		...
		// (get) Token: 0x06000320 RID: 800 RVA: 0x0000EC04 File Offset: 0x0000CE04
		// (set) Token: 0x06000321 RID: 801 RVA: 0x0000EC0C File Offset: 0x0000CE0C
		[Localizable(false)]
		[Bindable(true)]
		[DefaultValue(null)]
		...
		// Token: 0x06000322 RID: 802 RVA: 0x0000EC15 File Offset: 0x0000CE15
		public static Image FromFile(string filename)
		{
			return Image.FromFile(filename, false);
		}

		// Token: 0x06000323 RID: 803 RVA: 0x0000EC20 File Offset: 0x0000CE20
		...
		// Token: 0x06000324 RID: 804 RVA: 0x0000ECA5 File Offset: 0x0000CEA5
		public static Image FromStream(Stream stream)
		{
			return Image.FromStream(stream, false);
		}

		// Token: 0x06000325 RID: 805 RVA: 0x0000ECAE File Offset: 0x0000CEAE
		public static Image FromStream(Stream stream, bool useEmbeddedColorManagement)
		{
			return Image.FromStream(stream, useEmbeddedColorManagement, true);
		}

		// Token: 0x06000326 RID: 806 RVA: 0x0000ECB8 File Offset: 0x0000CEB8
		...
		// Token: 0x06000327 RID: 807 RVA: 0x0000ED64 File Offset: 0x0000CF64
		...
		// Token: 0x06000328 RID: 808 RVA: 0x0000EDE2 File Offset: 0x0000CFE2
		internal Image(IntPtr nativeImage)
		{
			this.SetNativeImage(nativeImage);
		}

		// Token: 0x06000329 RID: 809 RVA: 0x0000EDF4 File Offset: 0x0000CFF4
		public object Clone()
		{
			IntPtr zero = IntPtr.Zero;
		...
		// Token: 0x0600032A RID: 810 RVA: 0x0000EE4F File Offset: 0x0000D04F
		public void Dispose()
		{
			this.Dispose(true);
		...
		// Token: 0x0600032B RID: 811 RVA: 0x0000EE60 File Offset: 0x0000D060
		...
		// Token: 0x0600032C RID: 812 RVA: 0x0000EEC8 File Offset: 0x0000D0C8
		~Image()
		{
			this.Dispose(false);
		}

		// Token: 0x0600032D RID: 813 RVA: 0x0000EEF8 File Offset: 0x0000D0F8
		...
		// Token: 0x0600032E RID: 814 RVA: 0x0000F03C File Offset: 0x0000D23C
		...
		// Token: 0x0600032F RID: 815 RVA: 0x0000F094 File Offset: 0x0000D294
		...
		// Token: 0x06000330 RID: 816 RVA: 0x0000F0E8 File Offset: 0x0000D2E8
		...
		// Token: 0x06000331 RID: 817 RVA: 0x0000F164 File Offset: 0x0000D364
		public void Save(string filename)
		{
			this.Save(filename, this.RawFormat);
		}

		// Token: 0x06000332 RID: 818 RVA: 0x0000F174 File Offset: 0x0000D374
		...
		// Token: 0x06000333 RID: 819 RVA: 0x0000F1B0 File Offset: 0x0000D3B0
		...
		// Token: 0x06000334 RID: 820 RVA: 0x0000F2B4 File Offset: 0x0000D4B4
		...
		// Token: 0x06000335 RID: 821 RVA: 0x0000F2F4 File Offset: 0x0000D4F4
		...
		// Token: 0x06000336 RID: 822 RVA: 0x0000F320 File Offset: 0x0000D520
		...
		// Token: 0x06000337 RID: 823 RVA: 0x0000F400 File Offset: 0x0000D600
		...
		// Token: 0x06000338 RID: 824 RVA: 0x0000F45C File Offset: 0x0000D65C
		...
		// Token: 0x06000339 RID: 825 RVA: 0x0000F4D0 File Offset: 0x0000D6D0
		...
		// (get) Token: 0x0600033A RID: 826 RVA: 0x0000F504 File Offset: 0x0000D704
		...
		// (get) Token: 0x0600033B RID: 827 RVA: 0x0000F50C File Offset: 0x0000D70C
		public Size Size
		{
			get
			{
		...
		// (get) Token: 0x0600033C RID: 828 RVA: 0x0000F520 File Offset: 0x0000D720
		[DefaultValue(false)]
		[Browsable(false)]
		...
		// (get) Token: 0x0600033D RID: 829 RVA: 0x0000F54C File Offset: 0x0000D74C
		[DefaultValue(false)]
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public int Height
		...
		// (get) Token: 0x0600033E RID: 830 RVA: 0x0000F578 File Offset: 0x0000D778
		...
		// (get) Token: 0x0600033F RID: 831 RVA: 0x0000F5A4 File Offset: 0x0000D7A4
		...
		// (get) Token: 0x06000340 RID: 832 RVA: 0x0000F5D0 File Offset: 0x0000D7D0
		[Browsable(false)]
		public int Flags
		{
			get
		...
		// (get) Token: 0x06000341 RID: 833 RVA: 0x0000F5FC File Offset: 0x0000D7FC
		...
		// (get) Token: 0x06000342 RID: 834 RVA: 0x0000F638 File Offset: 0x0000D838
		...
		// Token: 0x06000343 RID: 835 RVA: 0x0000F660 File Offset: 0x0000D860
		...
		// Token: 0x06000344 RID: 836 RVA: 0x0000F69C File Offset: 0x0000D89C
		...
		// Token: 0x06000345 RID: 837 RVA: 0x0000F718 File Offset: 0x0000D918
		...
		// (get) Token: 0x06000346 RID: 838 RVA: 0x0000F75C File Offset: 0x0000D95C
		// (set) Token: 0x06000347 RID: 839 RVA: 0x0000F764 File Offset: 0x0000D964
		[Browsable(false)]
		...
		// Token: 0x06000348 RID: 840 RVA: 0x0000F770 File Offset: 0x0000D970
		...
		// (get) Token: 0x06000349 RID: 841 RVA: 0x0000F7AC File Offset: 0x0000D9AC
		[Browsable(false)]
		...
		// Token: 0x0600034A RID: 842 RVA: 0x0000F894 File Offset: 0x0000DA94
		...
		// Token: 0x0600034B RID: 843 RVA: 0x0000F8D4 File Offset: 0x0000DAD4
		...
		// (get) Token: 0x0600034D RID: 845 RVA: 0x0000F940 File Offset: 0x0000DB40
		[Browsable(false)]
		...
		// Token: 0x0600034E RID: 846 RVA: 0x0000F998 File Offset: 0x0000DB98
		...
		// Token: 0x0600034F RID: 847 RVA: 0x0000FA28 File Offset: 0x0000DC28
		...
		// Token: 0x06000350 RID: 848 RVA: 0x0000FA54 File Offset: 0x0000DC54
		...
		// (get) Token: 0x06000351 RID: 849 RVA: 0x0000FAA4 File Offset: 0x0000DCA4
		[Browsable(false)]
		...
		// Token: 0x06000352 RID: 850 RVA: 0x0000FB4C File Offset: 0x0000DD4C
		...
		// Token: 0x06000353 RID: 851 RVA: 0x0000FB77 File Offset: 0x0000DD77
		...
		// Token: 0x06000354 RID: 852 RVA: 0x0000FB90 File Offset: 0x0000DD90
		...
		// Token: 0x06000355 RID: 853 RVA: 0x0000FBD3 File Offset: 0x0000DDD3
		public static int GetPixelFormatSize(PixelFormat pixfmt)
		{
			return (int)(pixfmt >> 8 & (PixelFormat)255);
		}

		// Token: 0x06000356 RID: 854 RVA: 0x0000FBDE File Offset: 0x0000DDDE
		public static bool IsAlphaPixelFormat(PixelFormat pixfmt)
		{
			return (pixfmt & PixelFormat.Alpha) > PixelFormat.Undefined;
		}

		// Token: 0x06000357 RID: 855 RVA: 0x0000FBEA File Offset: 0x0000DDEA
		public static bool IsExtendedPixelFormat(PixelFormat pixfmt)
		{
			return (pixfmt & PixelFormat.Extended) > PixelFormat.Undefined;
		}

		// Token: 0x06000358 RID: 856 RVA: 0x0000FBF6 File Offset: 0x0000DDF6
