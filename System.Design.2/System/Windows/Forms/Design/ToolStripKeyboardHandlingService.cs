...
namespace System.Windows.Forms.Design
{
	...
	{
		// Token: 0x060022D1 RID: 8913 RVA: 0x000D6C38 File Offset: 0x000D4E38
		...
		// (get) Token: 0x060022D2 RID: 8914 RVA: 0x000D6D20 File Offset: 0x000D4F20
		// (set) Token: 0x060022D3 RID: 8915 RVA: 0x000D6D28 File Offset: 0x000D4F28
		...
		// (get) Token: 0x060022D4 RID: 8916 RVA: 0x000D6D37 File Offset: 0x000D4F37
		// (set) Token: 0x060022D5 RID: 8917 RVA: 0x000D6D3F File Offset: 0x000D4F3F
		...
		// (get) Token: 0x060022D6 RID: 8918 RVA: 0x000D6D48 File Offset: 0x000D4F48
		// (set) Token: 0x060022D7 RID: 8919 RVA: 0x000D6D50 File Offset: 0x000D4F50
		...
		// (get) Token: 0x060022D8 RID: 8920 RVA: 0x000D6D62 File Offset: 0x000D4F62
		// (set) Token: 0x060022D9 RID: 8921 RVA: 0x000D6D6A File Offset: 0x000D4F6A
		...
		// (get) Token: 0x060022DA RID: 8922 RVA: 0x000D6D7C File Offset: 0x000D4F7C
		...
		// (get) Token: 0x060022DB RID: 8923 RVA: 0x000D6D84 File Offset: 0x000D4F84
		...
		// (get) Token: 0x060022DC RID: 8924 RVA: 0x000D6DBC File Offset: 0x000D4FBC
		// (set) Token: 0x060022DD RID: 8925 RVA: 0x000D6DC4 File Offset: 0x000D4FC4
		...
		// (get) Token: 0x060022DE RID: 8926 RVA: 0x000D6E7F File Offset: 0x000D507F
		// (set) Token: 0x060022DF RID: 8927 RVA: 0x000D6E87 File Offset: 0x000D5087
		...
		// (get) Token: 0x060022E1 RID: 8929 RVA: 0x000D6E99 File Offset: 0x000D5099
		// (set) Token: 0x060022E0 RID: 8928 RVA: 0x000D6E90 File Offset: 0x000D5090
		...
		// (get) Token: 0x060022E2 RID: 8930 RVA: 0x000D6EA1 File Offset: 0x000D50A1
		...
		// (get) Token: 0x060022E3 RID: 8931 RVA: 0x000D6EA9 File Offset: 0x000D50A9
		// (set) Token: 0x060022E4 RID: 8932 RVA: 0x000D6EB4 File Offset: 0x000D50B4
		...
		// (get) Token: 0x060022E5 RID: 8933 RVA: 0x000D6F24 File Offset: 0x000D5124
		// (set) Token: 0x060022E6 RID: 8934 RVA: 0x000D6F2C File Offset: 0x000D512C
		...
		// Token: 0x060022E7 RID: 8935 RVA: 0x000D6F9C File Offset: 0x000D519C
		...
		// Token: 0x060022E8 RID: 8936 RVA: 0x000D7098 File Offset: 0x000D5298
		...
		// Token: 0x060022E9 RID: 8937 RVA: 0x000D70C4 File Offset: 0x000D52C4
		...
		// Token: 0x060022EA RID: 8938 RVA: 0x000D7268 File Offset: 0x000D5468
		...
		// Token: 0x060022EB RID: 8939 RVA: 0x000D72DC File Offset: 0x000D54DC
		...
		// Token: 0x060022EC RID: 8940 RVA: 0x000D7394 File Offset: 0x000D5594
		...
		// Token: 0x060022ED RID: 8941 RVA: 0x000D742C File Offset: 0x000D562C
				...
				if (flag)
				{
					...
					if (toolStripDropDownItem != null)
					{
						...
						if (toolStripDropDownDesigner != null)
						{
							...
							{
								toolStripDropDownDesigner.Component
		...
		// Token: 0x060022EE RID: 8942 RVA: 0x000D75A4 File Offset: 0x000D57A4
		...
		// Token: 0x060022EF RID: 8943 RVA: 0x000D75DC File Offset: 0x000D57DC
		...
		// Token: 0x060022F0 RID: 8944 RVA: 0x000D776C File Offset: 0x000D596C
		...
		// Token: 0x060022F1 RID: 8945 RVA: 0x000D7848 File Offset: 0x000D5A48
		...
		// Token: 0x060022F2 RID: 8946 RVA: 0x000D7928 File Offset: 0x000D5B28
		...
		// Token: 0x060022F3 RID: 8947 RVA: 0x000D79D8 File Offset: 0x000D5BD8
		...
		// Token: 0x060022F4 RID: 8948 RVA: 0x000D7A30 File Offset: 0x000D5C30
			...
			if (selectionService != null)
			{
				...
				if (component == null)
				{
					...
					if (designerToolStripControlHost != null && host != null)
					{
						...
						{
							ToolStripDropDownItem component2 = (ToolStripDropDownItem)((ToolStripDropDown)designerToolStripControlHost.Owner).OwnerItem;
							ToolStripMenuItemDesigner toolStripMenuItemDesigner = host.GetDesigner(component2) as ToolStripMenuItemDesigner;
		...
		// Token: 0x060022F5 RID: 8949 RVA: 0x000D7B74 File Offset: 0x000D5D74
				...
				if (toolStripItem != null && host != null)
				{
					...
					if (commandID.Equals(MenuCommands.EditLabel))
					{
						...
						if (component is DesignerToolStripControlHost)
						{
							...
							{
								ToolStripDropDownItem component2 = (ToolStripDropDownItem)((ToolStripDropDown)designerToolStripControlHost.Owner).OwnerItem;
								ToolStripMenuItemDesigner toolStripMenuItemDesigner2 = host.GetDesigner(component2) as ToolStripMenuItemDesigner;
		...
		// Token: 0x060022F6 RID: 8950 RVA: 0x000D7C84 File Offset: 0x000D5E84
		...
		// Token: 0x060022F7 RID: 8951 RVA: 0x000D7E58 File Offset: 0x000D6058
		...
		// Token: 0x060022F8 RID: 8952 RVA: 0x000D7EEC File Offset: 0x000D60EC
		private void OnKeySelect(object sender, EventArgs e)
		{
			MenuCommand menuCommand = (MenuCommand)sender;
			bool reverse = menuCommand.CommandID.Equals(MenuCommands.KeySelectPrevious);
			this.ProcessKeySelect(reverse, menuCommand);
		}

		// Token: 0x060022F9 RID: 8953 RVA: 0x000D7F1C File Offset: 0x000D611C
		...
		// Token: 0x060022FA RID: 8954 RVA: 0x000D7F9C File Offset: 0x000D619C
		...
		// Token: 0x060022FB RID: 8955 RVA: 0x000D8048 File Offset: 0x000D6248
		public void ProcessKeySelect(bool reverse, MenuCommand cmd)
		{
			...
			if (selectionService != null)
			{
				...
				else if (toolStripItem == null && selectionService.PrimarySelection is ToolStrip)
				{
					this.RotateTab(reverse);
				}
			}
		...
		// Token: 0x060022FC RID: 8956 RVA: 0x000D80AC File Offset: 0x000D62AC
		...
		// Token: 0x060022FD RID: 8957 RVA: 0x000D82A8 File Offset: 0x000D64A8
		...
		// Token: 0x060022FE RID: 8958 RVA: 0x000D8670 File Offset: 0x000D6870
		...
		// Token: 0x060022FF RID: 8959 RVA: 0x000D8898 File Offset: 0x000D6A98
		...
		// Token: 0x06002300 RID: 8960 RVA: 0x000D8C50 File Offset: 0x000D6E50
			...
			if (menuService != null & this.commandsAdded)
			{
				...
				if (this.oldCommands != null)
				{
					foreach (object obj2 in this.oldCommands)
					{
						...
						if (menuCommand != null && menuService.FindCommand(menuCommand.CommandID) == null)
						{
		...
		// Token: 0x06002301 RID: 8961 RVA: 0x000D8D84 File Offset: 0x000D6F84
		...
		// Token: 0x06002302 RID: 8962 RVA: 0x000D8DB0 File Offset: 0x000D6FB0
		...
		// Token: 0x06002303 RID: 8963 RVA: 0x000D8F08 File Offset: 0x000D7108
		...
		// Token: 0x06002304 RID: 8964 RVA: 0x000D90A8 File Offset: 0x000D72A8
		...
		// Token: 0x06002305 RID: 8965 RVA: 0x000D9680 File Offset: 0x000D7880
		...
		// Token: 0x06002306 RID: 8966 RVA: 0x000D96E8 File Offset: 0x000D78E8
