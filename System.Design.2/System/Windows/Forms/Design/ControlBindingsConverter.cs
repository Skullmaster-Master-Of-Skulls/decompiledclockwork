...
namespace System.Windows.Forms.Design
{
	...
	{
		// Token: 0x06001AC7 RID: 6855 RVA: 0x0009C4BE File Offset: 0x0009A6BE
		...
		// Token: 0x06001AC8 RID: 6856 RVA: 0x0009C4E4 File Offset: 0x0009A6E4
		public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
		{
			if (value is ControlBindingsCollection)
			{
				...
				for (int i = 0; i < properties.Count; i++)
				{
					...
					DesignBindingPropertyDescriptor designBindingPropertyDescriptor = new DesignBindingPropertyDescriptor(properties[i], null, readOnly);
		...
		// Token: 0x06001AC9 RID: 6857 RVA: 0x00003B0F File Offset: 0x00001D0F
