...
namespace System.Windows.Forms.Design
{
	...
	internal class ToolStripItemBehavior : Behavior
	{
		...
		// (get) Token: 0x06002276 RID: 8822 RVA: 0x000D3A8B File Offset: 0x000D1C8B
		...
		// Token: 0x06002277 RID: 8823 RVA: 0x000D3AA8 File Offset: 0x000D1CA8
		...
		// Token: 0x06002278 RID: 8824 RVA: 0x000D3AC8 File Offset: 0x000D1CC8
		...
		// Token: 0x06002279 RID: 8825 RVA: 0x000D3BA4 File Offset: 0x000D1DA4
		...
		// Token: 0x0600227A RID: 8826 RVA: 0x000D3BC8 File Offset: 0x000D1DC8
		...
		// Token: 0x0600227B RID: 8827 RVA: 0x000D3BFC File Offset: 0x000D1DFC
		...
		// Token: 0x0600227C RID: 8828 RVA: 0x000D3C30 File Offset: 0x000D1E30
		...
		// Token: 0x0600227D RID: 8829 RVA: 0x000D3C64 File Offset: 0x000D1E64
		private static Rectangle GetPaintingBounds(IDesignerHost designerHost, ToolStripItem item)
		{
			...
			{
				result = toolStripItemDesigner.GetGlyphBounds();
				ToolStripDesignerUtils.GetAdjustedBounds(item, ref result);
				result.Inflate(1, 1);
		...
		// Token: 0x0600227E RID: 8830 RVA: 0x000D3CC4 File Offset: 0x000D1EC4
		...
		// Token: 0x0600227F RID: 8831 RVA: 0x000D3D24 File Offset: 0x000D1F24
		...
		// Token: 0x06002280 RID: 8832 RVA: 0x000D3D94 File Offset: 0x000D1F94
		...
		// Token: 0x06002281 RID: 8833 RVA: 0x000D3DA8 File Offset: 0x000D1FA8
		...
		// Token: 0x06002282 RID: 8834 RVA: 0x000D3E8C File Offset: 0x000D208C
		...
		// Token: 0x06002283 RID: 8835 RVA: 0x000D4224 File Offset: 0x000D2424
		...
		// Token: 0x06002284 RID: 8836 RVA: 0x000D426C File Offset: 0x000D246C
		...
		// Token: 0x06002285 RID: 8837 RVA: 0x000D42B4 File Offset: 0x000D24B4
				...
				if (empty != Rectangle.Empty && !empty.Contains(mouseLoc.X, mouseLoc.Y))
				{
					...
					try
					{
						...
						if (toolStripItem2 != null)
						{
							...
							ToolStripItemDataObject data = new ToolStripItemDataObject(arrayList, toolStripItem2, owner);
							...
							else if (item.IsOnDropDown && !item.IsOnOverflow)
							{
								...
								selectionService.SetSelectedComponents(new IComponent[]
								{
									toolStripDropDownItem2
								}, SelectionTypes.Replace);
							}
							this.DropSource.DoDragDrop(data, DragDropEffects.All);
						}
					}
					finally
					{
		...
		// Token: 0x06002286 RID: 8838 RVA: 0x000D45D0 File Offset: 0x000D27D0
				...
				if (dragItem != toolStripItem && designerHost != null)
				{
					...
					try
					{
							...
							if (selectionService != null)
							{
								...
								if (num2 != -1)
								{
									...
									foreach (object obj in arrayList)
									{
										...
										toolStrip.Items.Insert(num2, value);
									}
								}
								selectionService.SetSelectedComponents(new IComponent[]
								{
						...
						foreach (object obj2 in arrayList)
						{
							...
							if (toolStripItem2 is ToolStripDropDownItem)
							{
								ToolStripMenuItemDesigner toolStripMenuItemDesigner = designerHost.GetDesigner(toolStripItem2) as ToolStripMenuItemDesigner;
								if (toolStripMenuItemDesigner != null)
								{
									toolStripMenuItemDesigner.InitializeDropDown();
								}
							}
							ToolStripDropDown toolStripDropDown3 = toolStripItem2.GetCurrentParent() as ToolStripDropDown;
		...
		// Token: 0x06002287 RID: 8839 RVA: 0x000D4AB8 File Offset: 0x000D2CB8
		...
		// Token: 0x06002288 RID: 8840 RVA: 0x000D4B14 File Offset: 0x000D2D14
		...
		// Token: 0x06002289 RID: 8841 RVA: 0x000D4B34 File Offset: 0x000D2D34
		...
		// Token: 0x0600228A RID: 8842 RVA: 0x000D4B84 File Offset: 0x000D2D84
		...
		// Token: 0x0600228B RID: 8843 RVA: 0x000D4C70 File Offset: 0x000D2E70
		...
		// Token: 0x0600228C RID: 8844 RVA: 0x000D4CCC File Offset: 0x000D2ECC
