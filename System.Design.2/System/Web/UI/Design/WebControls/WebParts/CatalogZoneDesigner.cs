...
namespace System.Web.UI.Design.WebControls.WebParts
{
	...
	public class CatalogZoneDesigner : ToolZoneDesigner
	{
		...
		// Token: 0x06000B9C RID: 2972 RVA: 0x0001895C File Offset: 0x00016B5C
		public override string GetDesignTimeHtml()
		{
			return this.GetDesignTimeHtml(null);
		}

		// Token: 0x06000B9D RID: 2973 RVA: 0x0004A8B8 File Offset: 0x00048AB8
		public override string GetDesignTimeHtml(DesignerRegionCollection regions)
		{
			string result;
			try
			{
				CatalogZone catalogZone = (CatalogZone)base.ViewControl;
				bool flag = base.UseRegions(regions, this._zone.ZoneTemplate, catalogZone.ZoneTemplate);
				if (catalogZone.ZoneTemplate == null && !flag)
				{
					result = this.GetEmptyDesignTimeHtml();
				}
				else
				{
					((ICompositeControlDesignerAccessor)catalogZone).RecreateChildControls();
					if (flag)
					{
						catalogZone.Controls.Clear();
						CatalogZoneDesigner.CatalogPartEditableDesignerRegion catalogPartEditableDesignerRegion = new CatalogZoneDesigner.CatalogPartEditableDesignerRegion(catalogZone, base.TemplateDefinition);
						catalogPartEditableDesignerRegion.Properties[typeof(Control)] = catalogZone;
						catalogPartEditableDesignerRegion.IsSingleInstanceTemplate = true;
						catalogPartEditableDesignerRegion.Description = SR.GetString("ContainerControlDesigner_RegionWatermark");
						regions.Add(catalogPartEditableDesignerRegion);
					}
					result = base.GetDesignTimeHtml();
				}
				if (base.ViewInBrowseMode && catalogZone.ID != "AutoFormatPreviewControl")
				{
		...
		// Token: 0x06000B9E RID: 2974 RVA: 0x0004A99C File Offset: 0x00048B9C
		...
		// Token: 0x06000B9F RID: 2975 RVA: 0x0004A9CD File Offset: 0x00048BCD
		protected override string GetEmptyDesignTimeHtml()
		{
			return base.CreatePlaceHolderDesignTimeHtml(SR.GetString("CatalogZoneDesigner_Empty"));
		}

		// Token: 0x06000BA0 RID: 2976 RVA: 0x0004A9DF File Offset: 0x00048BDF
		...
		// Token: 0x06000BA1 RID: 2977 RVA: 0x0004AA04 File Offset: 0x00048C04
		...
		{
			// Token: 0x06002979 RID: 10617 RVA: 0x000FAA39 File Offset: 0x000F8C39
			public CatalogPartEditableDesignerRegion(CatalogZone zone, TemplateDefinition templateDefinition) : base(templateDefinition)
			{
				this._zone = zone;
			}

			// Token: 0x0600297A RID: 10618 RVA: 0x000FAA4C File Offset: 0x000F8C4C
			public override ViewRendering GetChildViewRendering(Control control)
			{
				...
				DesignerCatalogPartChrome designerCatalogPartChrome = new DesignerCatalogPartChrome(this._zone);
				return designerCatalogPartChrome.GetViewRendering(control);
			}
