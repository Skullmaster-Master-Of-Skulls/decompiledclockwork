...
namespace System.Web.UI.Design.WebControls
{
	...
	{
		// Token: 0x060005F1 RID: 1521 RVA: 0x0001F8AF File Offset: 0x0001DAAF
		...
		// (get) Token: 0x060005F2 RID: 1522 RVA: 0x0001F8BE File Offset: 0x0001DABE
		...
		protected override ITemplateEditingFrame CreateTemplateEditingFrame(TemplateEditingVerb verb)
		{
			...
			Style[] templateStyles = new Style[]
			{
				dataGrid.ItemStyle,
			...
			return templateEditingService.CreateFrame(this, verb.Text, DataGridDesigner.ColumnTemplateNames, dataGrid.ControlStyle, templateStyles);
		}

		// Token: 0x060005F4 RID: 1524 RVA: 0x0001F971 File Offset: 0x0001DB71
		...
		// Token: 0x060005F5 RID: 1525 RVA: 0x0001F984 File Offset: 0x0001DB84
		...
		// Token: 0x060005F6 RID: 1526 RVA: 0x0001F9C8 File Offset: 0x0001DBC8
		[Obsolete("Use of this method is not recommended because template editing is handled in ControlDesigner. To support template editing expose template data in the TemplateGroups property and call SetViewFlags(ViewFlags.TemplateEditing, true). http://go.microsoft.com/fwlink/?linkid=14202")]
		...
		// Token: 0x060005F7 RID: 1527 RVA: 0x0001FAC4 File Offset: 0x0001DCC4
		public override string GetDesignTimeHtml()
		{
			...
			{
				minimumRows = Math.Min(dataGrid.PageSize, 100) + 1;
			}
			bool flag = false;
			...
			{
				enumerable = base.GetDesignTimeDataSource(minimumRows, out flag);
			}
			else
			{
				try
				{
					enumerable = designerView.GetDesignTimeData(minimumRows, out flag);
				}
				catch (Exception ex)
				{
			...
			finally
			{
				...
				if (flag4)
				{
					dataGrid.DataSourceID = dataSourceID;
				}
			}
			return result;
		}

		// Token: 0x060005F8 RID: 1528 RVA: 0x00004782 File Offset: 0x00002982
		protected override string GetEmptyDesignTimeHtml()
		{
			return base.CreatePlaceHolderDesignTimeHtml(null);
		}

		// Token: 0x060005F9 RID: 1529 RVA: 0x0001FC84 File Offset: 0x0001DE84
		protected override string GetErrorDesignTimeHtml(Exception e)
		{
			return base.CreatePlaceHolderDesignTimeHtml(SR.GetString("Control_ErrorRendering"));
		}

		// Token: 0x060005FA RID: 1530 RVA: 0x0001FC96 File Offset: 0x0001DE96
		[Obsolete("Use of this method is not recommended because template editing is handled in ControlDesigner. To support template editing expose template data in the TemplateGroups property and call SetViewFlags(ViewFlags.TemplateEditing, true). http://go.microsoft.com/fwlink/?linkid=14202")]
		...
		// Token: 0x060005FB RID: 1531 RVA: 0x0001FCA0 File Offset: 0x0001DEA0
		[Obsolete("Use of this method is not recommended because template editing is handled in ControlDesigner. To support template editing expose template data in the TemplateGroups property and call SetViewFlags(ViewFlags.TemplateEditing, true). http://go.microsoft.com/fwlink/?linkid=14202")]
		...
		// Token: 0x060005FC RID: 1532 RVA: 0x0001FD4F File Offset: 0x0001DF4F
		[Obsolete("Use of this method is not recommended because template editing is handled in ControlDesigner. To support template editing expose template data in the TemplateGroups property and call SetViewFlags(ViewFlags.TemplateEditing, true). http://go.microsoft.com/fwlink/?linkid=14202")]
		...
		// Token: 0x060005FD RID: 1533 RVA: 0x000169CA File Offset: 0x00014BCA
		public virtual void OnColumnsChanged()
		{
			this.OnTemplateEditingVerbsChanged();
		}

		// Token: 0x060005FE RID: 1534 RVA: 0x0001FD5B File Offset: 0x0001DF5B
		protected override void OnTemplateEditingVerbsChanged()
		{
			this.templateVerbsDirty = true;
		}

		// Token: 0x060005FF RID: 1535 RVA: 0x0001FD64 File Offset: 0x0001DF64
		...
		// Token: 0x06000600 RID: 1536 RVA: 0x0001FD80 File Offset: 0x0001DF80
		[Obsolete("Use of this method is not recommended because template editing is handled in ControlDesigner. To support template editing expose template data in the TemplateGroups property and call SetViewFlags(ViewFlags.TemplateEditing, true). http://go.microsoft.com/fwlink/?linkid=14202")]
		public override void SetTemplateContent(ITemplateEditingFrame editingFrame, string templateName, string templateContent)
		{
			...
			if (templateContent != null && templateContent.Length != 0)
			{
				...
				if (templateName.Equals(DataGridDesigner.ColumnTemplateNames[2]))
				{
					currentTemplate = templateColumn.HeaderTemplate;
				}
				else if (templateName.Equals(DataGridDesigner.ColumnTemplateNames[0]))
				{
					currentTemplate = templateColumn.ItemTemplate;
				}
				else if (templateName.Equals(DataGridDesigner.ColumnTemplateNames[1]))
				{
					currentTemplate = templateColumn.EditItemTemplate;
				}
				else if (templateName.Equals(DataGridDesigner.ColumnTemplateNames[3]))
				{
					currentTemplate = templateColumn.FooterTemplate;
				}
		...
		private static string[] ColumnTemplateNames = new string[]
		{
			"ItemTemplate",
			"EditItemTemplate",
			"HeaderTemplate",
