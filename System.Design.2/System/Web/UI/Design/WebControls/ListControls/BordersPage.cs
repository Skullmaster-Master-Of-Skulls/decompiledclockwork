...
namespace System.Web.UI.Design.WebControls.ListControls
{
	...
	internal sealed class BordersPage : BaseDataListPage
	{
		...
		// (get) Token: 0x06000BFC RID: 3068 RVA: 0x0004B93C File Offset: 0x00049B3C
		...
		// Token: 0x06000BFD RID: 3069 RVA: 0x0004B954 File Offset: 0x00049B54
		private void InitForm()
		{
			...
			base.Icon = BitmapSelector.CreateIcon(base.GetType(), "BordersPage.ico");
			base.Controls.Clear();
			base.Controls.AddRange(new Control[]
			{
				this.borderWidthUnit,
				label5,
				this.borderColorPickerButton,
				this.borderColorCombo,
				label4,
				this.gridLinesCombo,
				label3,
				groupLabel2,
				this.cellSpacingEdit,
				label2,
				this.cellPaddingEdit,
				label,
				groupLabel
			});
		}

		// Token: 0x06000BFE RID: 3070 RVA: 0x0004BEB5 File Offset: 0x0004A0B5
		...
		// Token: 0x06000BFF RID: 3071 RVA: 0x0004BEF4 File Offset: 0x0004A0F4
		...
		// Token: 0x06000C00 RID: 3072 RVA: 0x0004BFDC File Offset: 0x0004A1DC
		...
		// Token: 0x06000C01 RID: 3073 RVA: 0x0004BFF0 File Offset: 0x0004A1F0
		...
		// Token: 0x06000C02 RID: 3074 RVA: 0x0004C038 File Offset: 0x0004A238
		protected override void SaveComponent()
		{
			...
			try
			{
				...
				if (value != null)
				{
					borderWidth = Unit.Parse(value, CultureInfo.CurrentCulture);
				}
				baseControl.BorderWidth = borderWidth;
			}
			catch
			{
				this.borderWidthUnit.Value = baseControl.BorderWidth.ToString(CultureInfo.CurrentCulture);
		...
		// Token: 0x06000C03 RID: 3075 RVA: 0x0004C22C File Offset: 0x0004A42C
