...
namespace System.ComponentModel.Design.Serialization
{
	...
	internal sealed class RootCodeDomSerializer : ComponentCodeDomSerializer
	{
		...
		// (get) Token: 0x0600124B RID: 4683 RVA: 0x00068F04 File Offset: 0x00067104
		...
		// (get) Token: 0x0600124C RID: 4684 RVA: 0x00068F0B File Offset: 0x0006710B
		// (set) Token: 0x0600124D RID: 4685 RVA: 0x00068F13 File Offset: 0x00067113
		...
		// (get) Token: 0x0600124E RID: 4686 RVA: 0x00068F1C File Offset: 0x0006711C
		...
		// Token: 0x0600124F RID: 4687 RVA: 0x00068F24 File Offset: 0x00067124
		...
		// Token: 0x06001250 RID: 4688 RVA: 0x00068F7C File Offset: 0x0006717C
		public override object Deserialize(IDesignerSerializationManager manager, object codeObject)
		{
			...
			using (CodeDomSerializerBase.TraceScope("RootCodeDomSerializer::Deserialize"))
			{
				...
				{
					throw new ArgumentException(SR.GetString("SerializerBadElementType", new object[]
					{
						typeof(CodeTypeDeclaration).FullName
					}));
				}
				bool flag = false;
				...
				if (type == null)
				{
					throw new SerializationException(SR.GetString("SerializerTypeNotFound", new object[]
					{
				...
				if (type.IsAbstract)
				{
					throw new SerializationException(SR.GetString("SerializerTypeAbstract", new object[]
					{
						type.FullName
					}))
					{
				...
				try
				{
					...
					if (propertyDescriptor != null && propertyDescriptor.PropertyType == typeof(bool) && (bool)propertyDescriptor.GetValue(manager))
					{
						foreach (object obj5 in this.nameTable.Keys)
						{
							...
							CodeDomSerializerBase.OrderedCodeStatementCollection orderedCodeStatementCollection = (CodeDomSerializerBase.OrderedCodeStatementCollection)this.statementTable[key];
							if (orderedCodeStatementCollection != null)
							{
								bool flag2 = false;
								...
								if (!flag2)
								{
									this.statementTable.Remove(key);
								}
							}
						}
					}
					...
					if (container != null)
					{
						foreach (object value2 in container.Components)
						{
							base.DeserializePropertiesFromResources(manager, value2, RootCodeDomSerializer.designTimeProperties);
						}
					}
					...
					{
						foreach (object obj8 in codeStatementCollection)
						{
							CodeStatement statement = (CodeStatement)obj8;
		...
		// Token: 0x06001251 RID: 4689 RVA: 0x00069674 File Offset: 0x00067874
		private object DeserializeName(IDesignerSerializationManager manager, string name)
		{
			...
			using (CodeDomSerializerBase.TraceScope("RootCodeDomSerializer::DeserializeName"))
			{
				...
				else if (text != null)
				{
					...
					if (type == null)
					{
						manager.ReportError(new SerializationException(SR.GetString("SerializerTypeNotFound", new object[]
						{
							text
						})));
					}
		...
		// Token: 0x06001252 RID: 4690 RVA: 0x000698E4 File Offset: 0x00067AE4
		...
		// Token: 0x06001253 RID: 4691 RVA: 0x00069BAC File Offset: 0x00067DAC
		...
		// Token: 0x06001254 RID: 4692 RVA: 0x00069C04 File Offset: 0x00067E04
		private void OnResolveName(object sender, ResolveNameEventArgs e)
		{
			using (CodeDomSerializerBase.TraceScope("RootCodeDomSerializer::OnResolveName"))
			{
				if (e.Value == null)
				{
					...
					object value = this.DeserializeName(manager, e.Name);
					e.Value = value;
				}
			}
		}

		// Token: 0x06001255 RID: 4693 RVA: 0x00069C60 File Offset: 0x00067E60
		...
		// Token: 0x06001256 RID: 4694 RVA: 0x00069FD8 File Offset: 0x000681D8
		private void SerializeContainerDeclaration(IDesignerSerializationManager manager, CodeStatementCollection statements)
		{
			...
			Type typeFromHandle = typeof(IContainer);
			CodeTypeReference codeTypeReference = new CodeTypeReference(typeFromHandle);
			CodeMemberField codeMemberField = new CodeMemberField(codeTypeReference, this.ContainerName);
			codeMemberField.Attributes = MemberAttributes.Private;
			codeTypeDeclaration.Members.Add(codeMemberField);
			typeFromHandle = typeof(Container);
			codeTypeReference = new CodeTypeReference(typeFromHandle);
			...
			CodeAssignStatement value = new CodeAssignStatement(left, codeObjectCreateExpression);
			statements.Add(value);
		}

		// Token: 0x06001257 RID: 4695 RVA: 0x0006A084 File Offset: 0x00068284
		...
		// Token: 0x06001258 RID: 4696 RVA: 0x0006A380 File Offset: 0x00068580
		...
		private static readonly Attribute[] designTimeProperties = new Attribute[]
		{
		...
		{
			// Token: 0x06002BCE RID: 11214 RVA: 0x0000362F File Offset: 0x0000182F
			private StatementOrderComparer()
			{
			}

			// Token: 0x06002BCF RID: 11215 RVA: 0x00105828 File Offset: 0x00103A28
		...
		{
			// Token: 0x06002BD1 RID: 11217 RVA: 0x0000362F File Offset: 0x0000182F
			private ComponentComparer()
			{
			}

			// Token: 0x06002BD2 RID: 11218 RVA: 0x0010586C File Offset: 0x00103A6C
			public int Compare(object left, object right)
			{
