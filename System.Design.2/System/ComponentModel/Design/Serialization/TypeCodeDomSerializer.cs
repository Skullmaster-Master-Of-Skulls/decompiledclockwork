...
namespace System.ComponentModel.Design.Serialization
{
	...
	public class TypeCodeDomSerializer : CodeDomSerializerBase
	{
		...
		// (get) Token: 0x0600126C RID: 4716 RVA: 0x0006A6F4 File Offset: 0x000688F4
		...
		// Token: 0x0600126D RID: 4717 RVA: 0x0006A70C File Offset: 0x0006890C
		public virtual object Deserialize(IDesignerSerializationManager manager, CodeTypeDeclaration declaration)
		{
			...
			using (CodeDomSerializerBase.TraceScope("TypeCodeDomSerializer::Deserialize"))
			{
				...
				{
					CodeDomSerializerBase.Error(manager, SR.GetString("SerializerTypeAbstract", new object[]
					{
						type.FullName
				...
				this._nameTable = new HybridDictionary(count, flag);
				...
				try
				{
					...
					foreach (object obj3 in declaration.Members)
					{
						...
						if (codeMemberField != null && !string.Equals(codeMemberField.Name, declaration.Name, comparisonType))
						{
					...
					if (propertyDescriptor != null && propertyDescriptor.PropertyType == typeof(bool) && (bool)propertyDescriptor.GetValue(manager))
					{
						foreach (object obj5 in this._nameTable.Keys)
						{
							...
							if (!text2.Equals(declaration.Name) && this._statementTable.ContainsKey(text2))
							{
		...
		// Token: 0x0600126E RID: 4718 RVA: 0x0006AD04 File Offset: 0x00068F04
		...
		// Token: 0x0600126F RID: 4719 RVA: 0x0006AF84 File Offset: 0x00069184
		...
		// Token: 0x06001270 RID: 4720 RVA: 0x0006AFEC File Offset: 0x000691EC
		...
		// Token: 0x06001271 RID: 4721 RVA: 0x0006B08C File Offset: 0x0006928C
		...
		// Token: 0x06001272 RID: 4722 RVA: 0x0006B0E8 File Offset: 0x000692E8
		...
		// Token: 0x06001273 RID: 4723 RVA: 0x0006B220 File Offset: 0x00069420
		private void IntegrateStatements(IDesignerSerializationManager manager, object root, ICollection members, StatementContext statementCxt, CodeTypeDeclaration typeDecl)
		{
				...
				foreach (object obj in members)
				{
					if (obj != root)
					{
						...
						if (codeStatementCollection != null)
						{
							...
							if (dictionary.TryGetValue(initializeMethod.Name, out index))
							{
								codeMethodMap = list[index];
							}
							else
							{
			...
			if (codeStatementCollection2 != null)
			{
				...
				if (dictionary.TryGetValue(initializeMethod2.Name, out index2))
				{
					codeMethodMap2 = list[index2];
				}
				else
				{
		...
		{
			// Token: 0x06002BDC RID: 11228 RVA: 0x0000362F File Offset: 0x0000182F
			private StatementOrderComparer()
			{
			}

			// Token: 0x06002BDD RID: 11229 RVA: 0x00105A78 File Offset: 0x00103C78
