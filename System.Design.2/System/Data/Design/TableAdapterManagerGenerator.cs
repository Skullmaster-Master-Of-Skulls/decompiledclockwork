...
namespace System.Data.Design
{
	...
	{
		// Token: 0x060017A8 RID: 6056 RVA: 0x00081CF9 File Offset: 0x0007FEF9
		internal TableAdapterManagerGenerator(TypedDataSourceCodeGenerator codeGenerator)
		{
			this.dataSourceGenerator = codeGenerator;
		}

		// Token: 0x060017A9 RID: 6057 RVA: 0x00081D08 File Offset: 0x0007FF08
		internal CodeTypeDeclaration GenerateAdapterManager(DesignDataSource dataSource, CodeTypeDeclaration dataSourceClass)
		{
			...
			codeTypeDeclaration.CustomAttributes.Add(CodeGenHelper.AttributeDecl("System.ComponentModel.DesignerAttribute", CodeGenHelper.Str("Microsoft.VSDesigner.DataSource.Design.TableAdapterManagerDesigner, Microsoft.VSDesigner, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")));
