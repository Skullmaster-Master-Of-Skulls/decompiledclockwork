...
namespace Novell.Directory.Ldap.Extensions
{
	...
	{
		// Token: 0x060004BC RID: 1212 RVA: 0x00016998 File Offset: 0x00015998
		public LdapRestoreRequest(string objectDN, byte[] passwd, int bufferLength, string chunkSizesString, byte[] returnedBuffer) : base("2.16.840.1.113719.1.27.100.98", null)
		{
			try
			{
