...
namespace Microsoft.Owin.Security.OAuth
{
	...
	{
		// Token: 0x06000072 RID: 114 RVA: 0x00005F74 File Offset: 0x00004174
		public OAuthAuthorizationServerMiddleware(OwinMiddleware next, IAppBuilder app, OAuthAuthorizationServerOptions options) : base(next, options)
		{
			...
			{
				IDataProtector protector2 = app.CreateDataProtector(new string[]
				{
			...
			{
				IDataProtector protector3 = app.CreateDataProtector(new string[]
				{
					typeof(OAuthAuthorizationServerMiddleware).Namespace,
					"Refresh_Token",
					"v1"
		...
		// Token: 0x06000073 RID: 115 RVA: 0x00006100 File Offset: 0x00004300
