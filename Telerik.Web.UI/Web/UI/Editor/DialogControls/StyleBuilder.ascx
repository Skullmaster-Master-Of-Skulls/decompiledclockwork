...
<style type="text/css">
	.reLightweightDialog.redStyleBuilder body,
	...
	.RadForm_Material #styleBuilderTabs {
		width: 130px;
	}
	...
	* html #borderColorPane ul li, *+html #borderColorPane ul li
	...
	fieldset.reStyleBuilderBoxPadding,
	fieldset.reStyleBuilderBoxMargin {
		float: left;
		width: 190px;
	}
	...
	.reLightweightDialog.redStyleBuilder fieldset.reStyleBuilderClipping {
		padding-left: 0.5em;
		padding-right: 0.5em;
	}

	.reLightweightDialog.redStyleBuilder fieldset.reStyleBuilderBoxPadding,
	.reLightweightDialog.redStyleBuilder fieldset.reStyleBuilderBoxMargin {
		width: 43%;
		padding-left: 3%;
		padding-right: 3%;
	}

	.reLightweightDialog.redStyleBuilder #BorderContent fieldset {
		height: auto;
	}
	.reLightweightDialog.redStyleBuilder #BorderContent .Labels {
		padding-top: 3.15em;
	}
	.reLightweightDialog.redStyleBuilder #borderStylePane {
		width: 25%;
	}
	.reLightweightDialog.redStyleBuilder #borderWidthPane {
		width: 30%;
	}
	.reLightweightDialog.redStyleBuilder #borderColorPane {
		width: 25%;
	}

	.reLightweightDialog.redStyleBuilder #sbMainPane {
		width: 445px;
	}
</style>
...
<telerik:RadTabStrip ID="styleBuilderTabs" runat="server" Orientation="VerticalLeft" MultiPageID="styleBuilderContents" SelectedIndex="0">
	<Tabs>
		<telerik:RadTab Value="Font" />
		<telerik:RadTab Value="Background" />
		<telerik:RadTab Value="Text" />
		<telerik:RadTab Value="Layout" />
		<telerik:RadTab Value="Box" />
		<telerik:RadTab Value="Border" />
		<telerik:RadTab Value="Lists" />
	</Tabs>
</telerik:RadTabStrip>
<div class="redWrapper">
<div id="sbMainPane">
	<telerik:RadMultiPage ID="styleBuilderContents" runat="server" SelectedIndex="0" RenderMode="Lightweight">
			...
			<fieldset class="reStyleBuilderSize">
				...
				<ul class="rows">
					<li>
						...
						<div class="reInlineBlock reMetroTouchFix"><telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="fontSizeValue" Width="135px" MinValue="0" MaxValue="999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox></div>
						<div class="reInlineBlock"><telerik:RadComboBox ID="fontSizeMetric" runat="server" Width="100">
							<Items>
					...
					<li>
						...
						<telerik:RadComboBox ID="fontSizeRelative" runat="server" Width="190" Label="Relative:"></telerik:RadComboBox>
					</li>
				</ul>
			</fieldset>
		...
		<telerik:RadPageView ID="BackgroundContent" runat="server">
			<fieldset class="reStyleBuilderBgColor">
				...
				<div>
					...
					<div class="reInlineBlock"><script type="text/javascript">document.write(localization["or"]);</script></div>
			...
			<fieldset class="reStyleBuilderBgImg">
				...
				<fieldset>
					...
					<ul class="rows" id="backgroundPosition">
						<li>
							...
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="positionHorizontalValue" Width="75px">
								<NumberFormat DecimalDigits="0" />
						...
						<li>
							...
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="positionVerticalValue" Width="75px">
								<NumberFormat DecimalDigits="0" />
							</telerik:RadNumericTextBox>
			...
			<fieldset class="reStyleBuilderTextSpacing">
				...
				<ul class="rows">
					<li id="letterSpacingContainer">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="letterSpacingValue" Width="55px" MinValue="0" MaxValue="999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li id="wordSpacingContainer">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="wordSpacingValue" Width="55px" MinValue="0" MaxValue="999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li id="lineHeightContainer">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="lineHeightValue" Width="55px" MinValue="0" MaxValue="999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
			...
			<fieldset class="reStyleBuilderTextFlow">
				...
				<ul class="rows">
					<li id="textIndent">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="textIndentValue" Width="75px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
		...
		<telerik:RadPageView ID="LayoutContent" runat="server">
				...
				<ul class="rows">
					...
					<li id="floatContainer">
						<label for="float" class="sLabel">
							<script type="text/javascript">document.write(localization["Float"]);</script>
						</label>
						<telerik:RadComboBox ID="float" runat="server" />
					</li>
					<li id="clearContainer">
						<label for="clear" class="sLabel">
							<script type="text/javascript">document.write(localization["Clear"]);</script>
						</label>
			...
			<fieldset class="reStyleBuilderLayoutContent">
				...
				<fieldset class="reStyleBuilderClipping">
					<legend>
						<script type="text/javascript">document.write(localization["Clipping"]);</script>
					</legend>
					<ul class="rows" id="clip">
						<li>
							<label for="" class="columnLabel">
								<script type="text/javascript">document.write(localization["Top"]);</script>
							</label>
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="clipTop" Width="60px" MinValue="0" MaxValue="99999">
								<NumberFormat DecimalDigits="0" />
							</telerik:RadNumericTextBox>
						...
						<li>
							...
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="clipBottom" Width="60px" MinValue="0" MaxValue="99999">
								<NumberFormat DecimalDigits="0" />
							</telerik:RadNumericTextBox>
						...
						<li>
							...
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="clipLeft" Width="60px" MinValue="0" MaxValue="99999">
								<NumberFormat DecimalDigits="0" />
							</telerik:RadNumericTextBox>
						...
						<li>
							...
							<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="clipRight" Width="60px" MinValue="0" MaxValue="99999">
								<NumberFormat DecimalDigits="0" />
							</telerik:RadNumericTextBox>
		...
		<fieldset class="reStyleBuilderBoxSize">
			...
			<div id="BoxWidthContainer">
				...
				<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="width" Width="70px" MinValue="0">
					<NumberFormat DecimalDigits="0" />
				</telerik:RadNumericTextBox>
			...
			<div id="BoxHeightContainer">
				...
				<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="height" Width="70px" MinValue="0">
					<NumberFormat DecimalDigits="0" />
				</telerik:RadNumericTextBox>
			...
			<fieldset class="reStyleBuilderBoxPadding">
				<legend>
				...
				<ul class="rows">
					<li id="Li1">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="paddingTop" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li id="Li2">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="paddingBottom" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li id="Li3">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="paddingLeft" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li id="Li4">
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="paddingRight" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
			...
			<fieldset class="reStyleBuilderBoxMargin">
				<legend>
				...
				<ul class="rows">
					<li>
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="marginTop" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="marginBottom" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="marginLeft" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						...
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="marginRight" Width="65px">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
		...
		<telerik:RadPageView ID="BorderContent" runat="server">
			...
			<fieldset id="borderStylePane">
				<legend>
					<script type="text/javascript">document.write(localization["BorderStyle"]);</script>
				</legend>
				<div style="text-align: center;">
			...
			<fieldset id="borderWidthPane">
				<legend>
					<script type="text/javascript">document.write(localization["BorderWidth"]);</script>
				</legend>
				<div style="text-align: center;">
				...
				<ul class="rows">
					<li>
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="borderWidthTop" Width="60px" MinValue="0" MaxValue="99999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="borderWidthBottom" Width="60px" MinValue="0" MaxValue="99999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="borderWidthLeft" Width="60px" MinValue="0" MaxValue="99999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
					...
					<li>
						<telerik:RadNumericTextBox ShouldResetWidthInPixels="false" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true" IncrementSettings-InterceptMouseWheel="true" runat="server" ID="borderWidthRight" Width="60px" MinValue="0" MaxValue="99999">
							<NumberFormat DecimalDigits="0" />
						</telerik:RadNumericTextBox>
			...
			<fieldset id="borderColorPane">
				<legend>
					<script type="text/javascript">document.write(localization["BorderColor"]);</script>
				</legend>
				<div style="text-align: center;">
	...
	<div class="radECtrlButtonsList">
		...
		<button type="button" id="cancelButton" onclick="Telerik.Web.UI.Dialogs.CommonDialogScript.get_windowReference().close()" class="rfdFlatButton">
