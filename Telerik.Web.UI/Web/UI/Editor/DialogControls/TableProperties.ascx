...
<script type="text/javascript">
	...
	Telerik.Web.UI.Widgets.TableProperties.prototype = {
		...
		clientInit: function (clientParameters) {
            ...
            var tableCellSpacing = table.getAttribute("cellspacing");
            var tableCellPadding = table.getAttribute("cellpadding");
            this._spinBoxCellSpacing.set_value(tableCellSpacing);
            this._spinBoxCellPadding.set_value(tableCellPadding);
