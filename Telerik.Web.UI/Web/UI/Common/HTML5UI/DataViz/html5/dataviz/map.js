...
function b(j){return d.format('<button class="k-button k-navigator-{0}" aria-label="move {0}"><span class="k-icon k-i-arrow-60-{0}"></span></button>',j);
}var c=b("up")+b("right")+b("down")+b("left");
var f=i.extend({init:function(j,k){i.fn.init.call(this,j,k);
this._initOptions(k);
this.element.addClass("k-widget k-navigator").append(c).on("click"+g,".k-button",h(this,"_click"));
...
var g=f.keys;
var k=a.proxy;
function b(n,o){return f.format('<button class="k-button k-button-icon k-zoom-{0}" title="zoom-{0}" aria-label="zoom-{0}"><span class="k-icon {1}"></span></button>',n,o);
...
this._initOptions(o);
this.element.addClass("k-widget k-zoom-control k-button-group k-group-horizontal").append(c).on("click"+i,".k-button",k(this,"_click"));
