...
<table id="Table" class="rieDialogsTable" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td class="rieClearRightSpace">
			...
			<asp:TextBox ID="TxtFileName" runat="server" CssClass="rieInputCombo" EnableViewState="false" ToolTip="Enter File Name" />
			<telerik:RadDropDownList ID="fileExtension" runat="server" CssClass="rieComboCombo" EnableViewState="false">
				<Items>
	...
	<tr>
		...
		<td class="rieOverwriteFile rieClearRightSpace">
	...
	<tr>
		<td class="rieRightAligned rieClearRightSpace" colspan="2">
			<telerik:RadButton ID="btnOk" runat="server" Text="OK" ToolTip="OK" AutoPostBack="false"
				CommandName="OK" CausesValidation="false" EnableViewState="false" Primary="true" CssClass="rbFlatButton">
			</telerik:RadButton>
			<telerik:RadButton ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel" AutoPostBack="false"
				CommandName="Cancel" CausesValidation="false" EnableViewState="false" CssClass="rbFlatButton">
			</telerik:RadButton>
		</td>
	</tr>
</table>
