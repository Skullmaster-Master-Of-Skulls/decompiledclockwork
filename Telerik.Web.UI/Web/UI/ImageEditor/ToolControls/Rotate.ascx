...
<table id="Table" class="rieDialogsTable rieRotateTable" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td>
			<div class="rieRotateButtons">
				<telerik:RadButton ID="RotateRight" runat="server" ToolTip="Rotate Right" AutoPostBack="false"
					CausesValidation="false" EnableViewState="false" CommandName="RotateRight"
					CssClass="rieZIndex_IE9">
					<Icon PrimaryIconCssClass="rieRotateRight" />
				</telerik:RadButton>
				<telerik:RadButton ID="RotateLeft" runat="server" ToolTip="Rotate Left" AutoPostBack="false"
					CausesValidation="false" EnableViewState="false" CommandName="RotateLeft"
					Style="margin-right: 20px;" CssClass="rieZIndex_IE9">
					<Icon PrimaryIconCssClass="rieRotateLeft" />
				</telerik:RadButton>
			</div>
		...
		(function ($, $T, $IE)
		{
			...
			$IE.Rotate.prototype =
			{
				...
				dispose: function ()
				{
					...
					this._ddlDegrees.dispose();
					this._rotateLeftBtn.dispose();
					this._rotateRightBtn.dispose();
