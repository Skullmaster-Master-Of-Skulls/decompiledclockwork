	...
	<tr>
		...
		<td colspan="2" class="rieClearRightSpace">
			<telerik:RadComboBox ID="rieAspectRatio" runat="server" AutoPostBack="false" EnableViewState="false"
				CausesValidation="false" CssClass="rieCombo" Width="100%">
				<Items>
	...
	<tr>
		<td class="rieRightAligned rieClearRightSpace" colspan="3">
			<telerik:RadButton ID="btnApply" runat="server" Text="Crop" ToolTip="Crop" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="Crop" Primary="true" CssClass="rbFlatButton">
			</telerik:RadButton>
		...
		(function ($, $T, $IE)
		{
			...
			$IE.Crop.prototype =
			{
				...
				dispose: function ()
				{
					...
					this._presetDD.dispose();
					this._cropBtn.dispose();
				...
				_createCropBox: function ()
				{
					...
					this._cropBox = new $IE.DraggableResizeBox(imageEditor.get_viewport(), { offsetElement: imageEditor.getEditableElement() });
