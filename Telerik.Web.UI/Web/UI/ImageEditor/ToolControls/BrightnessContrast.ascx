...
<table id="Table" class="rieDialogsTable rieBrightnessContrastTable" border="0" cellpadding="0" cellspacing="0"
	runat="server">
	<tr>
		<td class="rieClearRightSpace">
			<span class="rfdAspLabel"><asp:Literal ID="brightnessLiteral" runat="server">B</asp:Literal>:</span>
		</td>
		<td>
		...
		<td class="rieClearRightSpace">
			<asp:TextBox ID="brightnessTxt" runat="server" Text="0" ToolTip="Brightness" CssClass="rieInputDigits" EnableViewState="false" />
		</td>
	</tr>
	<tr>
		<td class="rieClearRightSpace">
			<span class="rfdAspLabel"><asp:Literal ID="contrastLiteral" runat="server">C</asp:Literal>:</span>
		</td>
		<td>
		...
		<td class="rieClearRightSpace">
			<asp:TextBox ID="contrastTxt" runat="server" Text="0" ToolTip="Contrast" CssClass="rieInputDigits" EnableViewState="false" />
		</td>
	</tr>
	<tr>
		<td colspan="3" class="rieRightAligned rieClearRightSpace">
			<telerik:RadButton ID="applyBtn" runat="server" ToolTip="Apply" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="Apply" Text="Apply" Primary="true" CssClass="rbFlatButton" />
			
			<telerik:RadButton ID="resetBtn" runat="server" ToolTip="Reset" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="Reset" Text="Reset" CssClass="rbFlatButton" />
		</td>
	</tr>
</table>
		...
		(function ($, $T, $IE)
		{
			...
			$IE.BrightnessContrast.prototype =
			{
				...
				dispose: function()
				{
					...
					this._brightnessSlider.dispose();
					this._contrastSlider.dispose();
