...
<table id="Table" class="rieDialogsTable" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td class="rieRightAligned">
			<asp:Label ID="lblUrl" Text="URL:" runat="server" AssociatedControlID="Url" />
		</td>
		<td colspan="2" class="rieClearRightSpace">
			<asp:TextBox ID="Url" runat="server" CssClass="rieDialogInputBtn" ToolTip="URL of an Image to Insert (example http://domain.com/img.png" />
	...
	<tr>
		...
		<td class="rieInputDimension">
			<asp:TextBox ID="txtWidth" runat="server" ToolTip="Width" CssClass="rieInputDigits" />
		...
		<td rowspan="2">
			<div class="rieResizeButtons">
				<telerik:RadButton ID="btnConstraint" runat="server" ToolTip="Constrain Proportions"
					ToggleType="CheckBox" Checked="true" EnableViewState="false" AutoPostBack="false"
					CausesValidation="false">
					<ToggleStates>
				...
				<telerik:RadButton ID="btnSwap" runat="server" ToolTip="Swap Values" AutoPostBack="false"
					...
					<Icon PrimaryIconCssClass="rieSwapValues"/>
				</telerik:RadButton>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td class="rieInputDimension">
			<asp:TextBox ID="txtHeight" runat="server" ToolTip="Height" CssClass="rieInputDigits" />
			<span class="riePxLabel"><asp:Literal ID="Literal4" Text=" px" runat="server" /></span>
		</td>
	</tr>
	<tr>
		<td class="rieRightAligned">
		...
		<td colspan="2">
			...
			<span class="riePxLabel"><asp:Literal ID="Literal9" Text=" px" runat="server" /></span>
		</td>
	</tr>
	<tr>
		<td class="rieRightAligned rieClearRightSpace" colspan="3">
			<telerik:RadButton ID="btnInsert" runat="server" Text="Insert" ToolTip="Insert" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="Insert" Primary="true" CssClass="rbFlatButton">
			</telerik:RadButton>
			<telerik:RadButton ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="Cancel" CssClass="rbFlatButton">
			</telerik:RadButton>
		</td>
	</tr>
</table>
		...
		(function ($, $T, $IE)
		{
			...
			$IE.InsertImage.prototype =
			{
				...
				dispose: function ()
				{
					...
					this._insertBtn.dispose();
					this._cancelBtn.dispose();
					this._constraintBtn.dispose();
					this._swapBtn.dispose();
					this._okBtn.dispose();
				...
				_createImageBox: function () {
					var imageEditor = this._imageEditor;

					if (this._imageBox)
						this._disposeImageBox();

					this._imageBox = new $IE.DraggableImageResizeBox(imageEditor.get_viewport(), { offsetElement: imageEditor.getEditableElement() });
