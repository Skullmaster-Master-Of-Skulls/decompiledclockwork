...
<table id="Table" class="rieDialogsTable rieZoomTable" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td class="rieClearRightSpace">
			<asp:TextBox ID="TxtZoom" runat="server" Text="100" ToolTip="Zoom" CssClass="rieInputDigits" EnableViewState="false" />
			<asp:Label ID="lblPercent" Text="%" runat="server" AssociatedControlID="TxtZoom" CssClass="riePositionLabel" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<telerik:RadButton ID="btnActualSize" runat="server" ToolTip="Actual Size" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="ActualSize"
				CssClass="rieZIndex_IE9">
				<Icon PrimaryIconCssClass="rieActualSize" />
			</telerik:RadButton>
			<label id="lblActualSize" runat="server" class="riePositionLabel">
				Actual Size</label>
			<telerik:RadButton ID="btnFitImage" runat="server" ToolTip="Best Fit" AutoPostBack="false"
				CausesValidation="false" EnableViewState="false" CommandName="BestFit"
				Style="margin-left: 7px;" CssClass="rieZIndex_IE9">
				<Icon PrimaryIconCssClass="rieBestFit" />
			</telerik:RadButton>
			<label id="lblBestFit" runat="server" class="riePositionLabel">
				Best Fit</label>
		</td>
	</tr>
</table>
		...
		(function ($, $T, $IE)
		{
			...
			$IE.Zoom.prototype =
			{
				...
				dispose: function ()
				{
					...
					this._actualSizeBtn.dispose();
					this._fitImageBtn.dispose();
					this._zoomSlider.dispose();
