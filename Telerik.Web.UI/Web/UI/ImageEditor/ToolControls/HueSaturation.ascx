...
<table id="Table" class="rieDialogsTable rieHueSaturationTable" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td>
			<asp:TextBox ID="hueTxt" runat="server" Text="0" ToolTip="Hue" CssClass="rieInputDigits" EnableViewState="false" />
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<asp:TextBox ID="saturationTxt" runat="server" Text="0" ToolTip="Saturation" CssClass="rieInputDigits" EnableViewState="false" />
		</td>
	</tr>
		...
		(function ($, $T, $IE) {
			...
			$IE.HueSaturation.prototype =
			{
				...
				dispose: function () {
					...
					this._hueSlider.dispose();
					this._saturationSlider.dispose();
