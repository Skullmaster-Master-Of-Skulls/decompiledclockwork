...
namespace System.Web.Services.Protocols
{
	...
	internal class RuntimeUtils
	{
		...
		internal static void OnUnknownElement(object sender, XmlElementEventArgs e)
		{
			...
			{
				throw new InvalidOperationException(Res.GetString("WebUnknownElement", new object[]
				{
					text
				}));
			}
			...
			{
				throw new InvalidOperationException(Res.GetString("WebUnknownElement1", new object[]
				{
					text
				}));
			}
			throw new InvalidOperationException(Res.GetString("WebUnknownElement2", new object[]
			{
				text,
				e.ExpectedElements
			}));
