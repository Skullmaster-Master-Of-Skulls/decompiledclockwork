	...
	public abstract class SoapHeader
	{
		...
		public string EncodedMustUnderstand
		{
			...
			set
			{
				...
				throw new ArgumentException(Res.GetString("WebHeaderInvalidMustUnderstand", new object[]
				{
					value
				}));
			}
		...
		public string EncodedRelay
		{
			...
			set
			{
				...
				throw new ArgumentException(Res.GetString("WebHeaderInvalidRelay", new object[]
				{
					value
				}));
			}
