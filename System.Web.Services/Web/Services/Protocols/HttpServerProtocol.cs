	...
	internal abstract class HttpServerProtocol : ServerProtocol
	{
		...
		internal override bool Initialize()
		{
			...
			if (this.serverMethod == null)
			{
				...
				if (this.serverMethod == null)
				{
					throw new InvalidOperationException(Res.GetString("WebInvalidMethodName", new object[]
					{
						text
					}));
				}
		...
		internal override object[] ReadParameters()
		{
			...
			throw new InvalidOperationException(Res.GetString("WebInvalidRequestFormatDetails", new object[]
			{
