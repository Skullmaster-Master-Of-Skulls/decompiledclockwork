	...
	public sealed class SoapUnknownHeader : SoapHeader
	{
		...
		internal override bool InternalMustUnderstand
		{
			get
			{
				...
				string elementAttribute = this.GetElementAttribute("mustUnderstand", "http://schemas.xmlsoap.org/soap/envelope/", this.element);
				if (elementAttribute == null)
				{
					elementAttribute = this.GetElementAttribute("mustUnderstand", "http://www.w3.org/2003/05/soap-envelope", this.element);
					if (elementAttribute == null)
					{
						return false;
					}
		...
		internal override string InternalActor
		{
			get
			{
				...
				string elementAttribute = this.GetElementAttribute("actor", "http://schemas.xmlsoap.org/soap/envelope/", this.element);
				if (elementAttribute == null)
				{
					elementAttribute = this.GetElementAttribute("role", "http://www.w3.org/2003/05/soap-envelope", this.element);
					if (elementAttribute == null)
					{
						return "";
					}
