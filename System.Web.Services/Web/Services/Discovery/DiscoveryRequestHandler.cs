		...
		public void ProcessRequest(HttpContext context)
		{
			...
			if (File.Exists(physicalPath))
			{
				...
				if (dynamicDiscoveryDocument != null)
				{
					...
					string dirPartOfPath = DiscoveryRequestHandler.GetDirPartOfPath(str);
					...
					{
						fileToSkipAtBegin = DiscoveryRequestHandler.GetFilePartOfPath(str);
					...
					StreamWriter writer = new StreamWriter(memoryStream, new UTF8Encoding(false));
			...
			throw new HttpException(404, Res.GetString("WebPathNotFound", new object[]
			{
