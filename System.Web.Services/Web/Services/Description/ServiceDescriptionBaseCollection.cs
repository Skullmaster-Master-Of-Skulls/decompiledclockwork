...
namespace System.Web.Services.Description
{
	...
	public abstract class ServiceDescriptionBaseCollection : CollectionBase
	{
		...
		private static string GetDuplicateMessage(Type type, string elemName)
		{
			...
			{
				@string = Res.GetString("WebDuplicateFormatExtension", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateOperationMessage", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateImport", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateMessage", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicatePort", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicatePortType", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateBinding", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateService", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateMessagePart", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateOperationBinding", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateFaultBinding", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateOperation", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateOperationFault", new object[]
				{
					elemName
				});
			}
			...
			{
				@string = Res.GetString("WebDuplicateUnknownElement", new object[]
				{
					type,
					elemName
				});
