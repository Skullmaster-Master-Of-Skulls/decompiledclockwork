	...
	internal class SoapParameters
	{
		...
		internal SoapParameters(XmlMembersMapping request, XmlMembersMapping response, string[] parameterOrder, CodeIdentifiers identifiers)
		{
			...
			if (parameterOrder != null)
			{
				...
				{
					XmlMemberMapping xmlMemberMapping = SoapParameters.FindMapping(arrayList, elementName);
					...
					{
						XmlMemberMapping xmlMemberMapping2 = SoapParameters.FindMapping(arrayList2, elementName);
			...
			if (arrayList2.Count > 0)
			{
				...
				{
					XmlMemberMapping mapping = (XmlMemberMapping)obj2;
