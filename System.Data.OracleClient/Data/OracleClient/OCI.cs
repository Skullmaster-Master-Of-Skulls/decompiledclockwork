...
namespace System.Data.OracleClient
{
	...
	{
		// Token: 0x060001C9 RID: 457 RVA: 0x0005B7D4 File Offset: 0x0005ABD4
		private OCI()
		{
		}

		// Token: 0x060001CA RID: 458 RVA: 0x0005B7F4 File Offset: 0x0005ABF4
		internal static int DetermineClientVersion()
		{
			...
			{
				ADP.TraceException(e5);
				num = 73;
			}
			catch (BadImageFormatException e6)
			{
				throw ADP.BadOracleClientImageFormat(e6);
			}
			if (81 > num)
			{
		...
		// (get) Token: 0x060001CB RID: 459 RVA: 0x0005B984 File Offset: 0x0005AD84
