...
namespace System.Data.OracleClient
{
	...
	{
		// Token: 0x060002E2 RID: 738 RVA: 0x00060D94 File Offset: 0x00060194
		public OracleCommandBuilder()
		{
			GC.SuppressFinalize(this);
		}

		// Token: 0x060002E3 RID: 739 RVA: 0x00060DB4 File Offset: 0x000601B4
		...
		// (get) Token: 0x060002E4 RID: 740 RVA: 0x00060DD4 File Offset: 0x000601D4
		// (set) Token: 0x060002E5 RID: 741 RVA: 0x00060DE4 File Offset: 0x000601E4
		[Browsable(false)]
		...
		// (get) Token: 0x060002E6 RID: 742 RVA: 0x00060E04 File Offset: 0x00060204
		// (set) Token: 0x060002E7 RID: 743 RVA: 0x00060E24 File Offset: 0x00060224
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		// (get) Token: 0x060002E8 RID: 744 RVA: 0x00060E44 File Offset: 0x00060244
		// (set) Token: 0x060002E9 RID: 745 RVA: 0x00060E64 File Offset: 0x00060264
		...
		// (get) Token: 0x060002EA RID: 746 RVA: 0x00060E84 File Offset: 0x00060284
		// (set) Token: 0x060002EB RID: 747 RVA: 0x00060EA4 File Offset: 0x000602A4
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		[Browsable(false)]
		...
		// Token: 0x060002EC RID: 748 RVA: 0x00060EC4 File Offset: 0x000602C4
		...
		// Token: 0x060002ED RID: 749 RVA: 0x00060F14 File Offset: 0x00060314
		...
		// Token: 0x060002EE RID: 750 RVA: 0x00060FF4 File Offset: 0x000603F4
		private static ArrayList DeriveParametersFromStoredProcedure(OracleConnection connection, OracleCommand command)
		{
			...
			string text2;
			if (OracleCommandBuilder.ResolveName(oracleCommand, command.CommandText, out unquotedIdentifier, out text, out unquotedIdentifier2, out text2) != 0U)
			{
				StringBuilder stringBuilder = new StringBuilder();
				stringBuilder.Append(OracleCommandBuilder.DeriveParameterCommand_Part1);
				stringBuilder.Append(OracleCommandBuilder.QuoteIdentifier(unquotedIdentifier, "'", "''"));
				...
				stringBuilder.Append(OracleCommandBuilder.QuoteIdentifier(unquotedIdentifier2, "'", "''"));
				...
				using (OracleDataReader oracleDataReader = oracleCommand.ExecuteReader())
				{
					while (oracleDataReader.Read())
					{
						...
						OracleParameter value = new OracleParameter(@string, oracleType, size, direction, true, precision, scale, "", DataRowVersion.Current, null);
						arrayList.Add(value);
					}
				}
			}
		...
		// Token: 0x060002EF RID: 751 RVA: 0x000611D4 File Offset: 0x000605D4
		public new OracleCommand GetInsertCommand()
		{
			return (OracleCommand)base.GetInsertCommand();
		}

		// Token: 0x060002F0 RID: 752 RVA: 0x000611F4 File Offset: 0x000605F4
		...
		// Token: 0x060002F1 RID: 753 RVA: 0x00061214 File Offset: 0x00060614
		public new OracleCommand GetUpdateCommand()
		{
			return (OracleCommand)base.GetUpdateCommand();
		}

		// Token: 0x060002F2 RID: 754 RVA: 0x00061234 File Offset: 0x00060634
		...
		// Token: 0x060002F3 RID: 755 RVA: 0x00061254 File Offset: 0x00060654
		public new OracleCommand GetDeleteCommand()
		{
			return (OracleCommand)base.GetDeleteCommand();
		}

		// Token: 0x060002F4 RID: 756 RVA: 0x00061274 File Offset: 0x00060674
		...
		// Token: 0x060002F5 RID: 757 RVA: 0x00061294 File Offset: 0x00060694
		protected override string GetParameterName(int parameterOrdinal)
		{
			return "p" + parameterOrdinal.ToString(CultureInfo.CurrentCulture);
		}

		// Token: 0x060002F6 RID: 758 RVA: 0x000612C4 File Offset: 0x000606C4
		protected override string GetParameterName(string parameterName)
		{
			return parameterName;
		}

		// Token: 0x060002F7 RID: 759 RVA: 0x000612D4 File Offset: 0x000606D4
		protected override string GetParameterPlaceholder(int parameterOrdinal)
		{
			return ":" + this.GetParameterName(parameterOrdinal);
		}

		// Token: 0x060002F8 RID: 760 RVA: 0x000612F4 File Offset: 0x000606F4
		public override string QuoteIdentifier(string unquotedIdentifier)
		{
			return OracleCommandBuilder.QuoteIdentifier(unquotedIdentifier, "\"", "\"\"");
		}

		// Token: 0x060002F9 RID: 761 RVA: 0x00061314 File Offset: 0x00060714
		...
		// Token: 0x060002FA RID: 762 RVA: 0x00061364 File Offset: 0x00060764
		...
		// Token: 0x060002FB RID: 763 RVA: 0x000615C4 File Offset: 0x000609C4
		private void RowUpdatingHandler(object sender, OracleRowUpdatingEventArgs ruevent)
		{
			base.RowUpdatingHandler(ruevent);
		}

		// Token: 0x060002FC RID: 764 RVA: 0x000615E4 File Offset: 0x000609E4
		...
		// Token: 0x060002FD RID: 765 RVA: 0x00061634 File Offset: 0x00060A34
