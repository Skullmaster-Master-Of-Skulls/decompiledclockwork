...
namespace System.Data.OracleClient
{
	...
	{
		// Token: 0x0600068D RID: 1677 RVA: 0x00071C94 File Offset: 0x00071094
		internal OracleSqlParser() : base(OracleSqlParser._quoteCharacter, OracleSqlParser._quoteCharacter, OracleSqlParser._regexPattern)
		{
		}

		// Token: 0x0600068E RID: 1678 RVA: 0x00071CC4 File Offset: 0x000710C4
		...
		// Token: 0x0600068F RID: 1679 RVA: 0x00071D14 File Offset: 0x00071114
		...
		// Token: 0x06000690 RID: 1680 RVA: 0x00071DC4 File Offset: 0x000711C4
		...
		// Token: 0x06000691 RID: 1681 RVA: 0x00071E24 File Offset: 0x00071224
		protected override void GatherKeyColumns(DbSqlParserTable table)
		{
			using (OracleCommand oracleCommand = this._connection.CreateCommand())
			{
				...
				oracleCommand.Parameters.Add(new OracleParameter(OracleSqlParser.ConstraintTableParameterName, DbType.String)).Value = value;
				...
				foreach (string commandText in array)
				{
		...
		// Token: 0x06000692 RID: 1682 RVA: 0x00072134 File Offset: 0x00071534
		protected override DbSqlParserColumnCollection GatherTableColumns(DbSqlParserTable table)
		{
			...
			if (TracedNativeMethods.OCIStmtPrepare(ociStatementHandle, errorHandle, stmt, OCI.SYNTAX.OCI_NTV_SYNTAX, OCI.MODE.OCI_DEFAULT, this._connection) == 0 && TracedNativeMethods.OCIStmtExecute(this._connection.ServiceContextHandle, ociStatementHandle, errorHandle, 0, OCI.MODE.OCI_SHARED) == 0)
			{
				int num;
				...
				for (int i = 0; i < num; i++)
				{
					...
					string text;
					descriptor.GetAttribute(OCI.ATTR.OCI_ATTR_SQLCODE, out text, errorHandle, this._connection);
					OciHandle.SafeDispose(ref descriptor);
					text = this.QuotePrefixCharacter + text + this.QuoteSuffixCharacter;
					dbSqlParserColumnCollection.Add(null, schemaName, tableName, text, null);
				}
			}
		...
		// Token: 0x06000693 RID: 1683 RVA: 0x00072254 File Offset: 0x00071654
		...
		// Token: 0x06000694 RID: 1684 RVA: 0x000722D4 File Offset: 0x000716D4
