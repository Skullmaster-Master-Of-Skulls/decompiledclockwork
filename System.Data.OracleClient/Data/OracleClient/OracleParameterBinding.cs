...
namespace System.Data.OracleClient
{
	...
	{
		// Token: 0x06000622 RID: 1570 RVA: 0x0006F7B4 File Offset: 0x0006EBB4
		...
		// (get) Token: 0x06000623 RID: 1571 RVA: 0x0006F7E4 File Offset: 0x0006EBE4
		...
		// Token: 0x06000624 RID: 1572 RVA: 0x0006F804 File Offset: 0x0006EC04
		internal void Bind(OciStatementHandle statementHandle, NativeBuffer parameterBuffer, OracleConnection connection, ref bool mustRelease, ref SafeHandle handleToBind)
		{
			...
			IntPtr indp = parameterBuffer.DangerousGetDataPtr(this._indicatorOffset);
			...
			case OCI.DATATYPE.INT_TIMESTAMP_TZ:
				...
				break;
			default:
				if (datatype3 == OCI.DATATYPE.INT_TIMESTAMP_LTZ)
				{
			...
			IntPtr value;
			int num3 = TracedNativeMethods.OCIBindByName(statementHandle, out value, errorHandle, parameterName, parameterName.Length, valuep, num2, dty, indp, alenp, OCI.MODE.OCI_DEFAULT);
			if (num3 != 0)
			{
				this._command.Connection.CheckError(errorHandle, num3);
			}
			this._bindHandle = new OciBindHandle(statementHandle, value);
		...
		// Token: 0x06000625 RID: 1573 RVA: 0x0006FBA4 File Offset: 0x0006EFA4
		...
		// Token: 0x06000626 RID: 1574 RVA: 0x0006FC34 File Offset: 0x0006F034
		...
		// Token: 0x06000627 RID: 1575 RVA: 0x0006FF44 File Offset: 0x0006F344
		...
		// Token: 0x06000628 RID: 1576 RVA: 0x0006FF84 File Offset: 0x0006F384
		...
		// Token: 0x06000629 RID: 1577 RVA: 0x0006FFA4 File Offset: 0x0006F3A4
		...
		// Token: 0x0600062A RID: 1578 RVA: 0x00070034 File Offset: 0x0006F434
		...
		// Token: 0x0600062B RID: 1579 RVA: 0x00070094 File Offset: 0x0006F494
		...
		// Token: 0x0600062C RID: 1580 RVA: 0x00070374 File Offset: 0x0006F774
