...
namespace System.Data.OracleClient
{
	...
	{
		// Token: 0x060004F3 RID: 1267 RVA: 0x0006A2B4 File Offset: 0x000696B4
		...
		// (get) Token: 0x060004F4 RID: 1268 RVA: 0x0006A394 File Offset: 0x00069794
		...
		// (get) Token: 0x060004F5 RID: 1269 RVA: 0x0006A3B4 File Offset: 0x000697B4
		...
		// (get) Token: 0x060004F6 RID: 1270 RVA: 0x0006A3D4 File Offset: 0x000697D4
		...
		// (get) Token: 0x060004F7 RID: 1271 RVA: 0x0006A404 File Offset: 0x00069804
		...
		// (get) Token: 0x060004F8 RID: 1272 RVA: 0x0006A5C4 File Offset: 0x000699C4
		...
		// (get) Token: 0x060004F9 RID: 1273 RVA: 0x0006A5F4 File Offset: 0x000699F4
		...
		// (get) Token: 0x060004FA RID: 1274 RVA: 0x0006A624 File Offset: 0x00069A24
		...
		// (get) Token: 0x060004FB RID: 1275 RVA: 0x0006A654 File Offset: 0x00069A54
		...
		// (get) Token: 0x060004FC RID: 1276 RVA: 0x0006A684 File Offset: 0x00069A84
		...
		// (get) Token: 0x060004FD RID: 1277 RVA: 0x0006A6B4 File Offset: 0x00069AB4
		...
		// (get) Token: 0x060004FE RID: 1278 RVA: 0x0006A6D4 File Offset: 0x00069AD4
		...
		// (get) Token: 0x060004FF RID: 1279 RVA: 0x0006A6F4 File Offset: 0x00069AF4
		// (set) Token: 0x06000500 RID: 1280 RVA: 0x0006A754 File Offset: 0x00069B54
		...
		// (get) Token: 0x06000501 RID: 1281 RVA: 0x0006A794 File Offset: 0x00069B94
		// (set) Token: 0x06000502 RID: 1282 RVA: 0x0006A7B4 File Offset: 0x00069BB4
		...
		// (get) Token: 0x06000503 RID: 1283 RVA: 0x0006A7D4 File Offset: 0x00069BD4
		...
		// Token: 0x06000504 RID: 1284 RVA: 0x0006A804 File Offset: 0x00069C04
		...
		// Token: 0x06000505 RID: 1285 RVA: 0x0006A874 File Offset: 0x00069C74
		public override DbTransaction BeginTransaction(IsolationLevel il)
		{
			return this.BeginOracleTransaction(il);
		}

		// Token: 0x06000506 RID: 1286 RVA: 0x0006A894 File Offset: 0x00069C94
		...
		// Token: 0x06000507 RID: 1287 RVA: 0x0006A8D4 File Offset: 0x00069CD4
		...
		// Token: 0x06000508 RID: 1288 RVA: 0x0006A914 File Offset: 0x00069D14
		...
		// Token: 0x06000509 RID: 1289 RVA: 0x0006A944 File Offset: 0x00069D44
		...
		// Token: 0x0600050A RID: 1290 RVA: 0x0006A984 File Offset: 0x00069D84
		...
		// Token: 0x0600050B RID: 1291 RVA: 0x0006AA04 File Offset: 0x00069E04
		...
		// Token: 0x0600050C RID: 1292 RVA: 0x0006AAA4 File Offset: 0x00069EA4
		...
		// Token: 0x0600050D RID: 1293 RVA: 0x0006AB44 File Offset: 0x00069F44
		...
		// Token: 0x0600050E RID: 1294 RVA: 0x0006AB84 File Offset: 0x00069F84
		...
		// Token: 0x0600050F RID: 1295 RVA: 0x0006ABF4 File Offset: 0x00069FF4
		internal byte[] GetBytes(string value, bool useNationalCharacterSet)
		{
			byte[] bytes;
			if (useNationalCharacterSet)
			{
				bytes = this._encodingNational.GetBytes(value);
			}
			else
			{
				bytes = this._encodingDatabase.GetBytes(value);
			}
			return bytes;
		}

		// Token: 0x06000510 RID: 1296 RVA: 0x0006AC24 File Offset: 0x0006A024
		...
		// Token: 0x06000511 RID: 1297 RVA: 0x0006AC64 File Offset: 0x0006A064
		internal string GetString(byte[] bytearray)
		{
			return this._encodingDatabase.GetString(bytearray);
		}

		// Token: 0x06000512 RID: 1298 RVA: 0x0006AC84 File Offset: 0x0006A084
		...
		// Token: 0x06000513 RID: 1299 RVA: 0x0006ACB4 File Offset: 0x0006A0B4
		...
		// Token: 0x06000514 RID: 1300 RVA: 0x0006AD64 File Offset: 0x0006A164
		private bool OpenOnLocalTransaction(string userName, string password, string serverName, bool integratedSecurity, bool unicode, bool omitOracleConnectionName)
		{
			...
			try
			{
				...
				num = TracedNativeMethods.OCISessionBegin(this._serviceContextHandle, this._errorHandle, this._sessionHandle, credt, OCI.MODE.OCI_DEFAULT);
				if (num != 0)
				{
					if (1 == num)
					{
		...
		// Token: 0x06000515 RID: 1301 RVA: 0x0006AF94 File Offset: 0x0006A394
		...
		// Token: 0x06000516 RID: 1302 RVA: 0x0006B074 File Offset: 0x0006A474
		...
		// Token: 0x06000517 RID: 1303 RVA: 0x0006B0A4 File Offset: 0x0006A4A4
		...
		// Token: 0x06000518 RID: 1304 RVA: 0x0006B0F4 File Offset: 0x0006A4F4
		...
		// Token: 0x06000519 RID: 1305 RVA: 0x0006B124 File Offset: 0x0006A524
