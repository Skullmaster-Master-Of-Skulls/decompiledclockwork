...
namespace mshtml
{
	...
	public interface DispIHTMLInputFileElement
	{
		...
		[DispId(2002)]
		int size { [TypeLibFunc(20)] [DispId(2002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(2002)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x170079A2 RID: 31138
		// (get) Token: 0x06016CCC RID: 93388
		// (set) Token: 0x06016CCB RID: 93387
		[DispId(2003)]
		int maxLength { [TypeLibFunc(20)] [DispId(2003)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(2003)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }
