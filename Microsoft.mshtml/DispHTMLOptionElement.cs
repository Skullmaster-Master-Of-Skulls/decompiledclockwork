...
namespace mshtml
{
	...
	public interface DispHTMLOptionElement
	{
		...
		[DispId(1001)]
		bool selected { [DispId(1001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(1001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17002D86 RID: 11654
		// (get) Token: 0x0600871E RID: 34590
		// (set) Token: 0x0600871D RID: 34589
		[DispId(1002)]
		string value { [DispId(1002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(1002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17002D87 RID: 11655
		// (get) Token: 0x06008720 RID: 34592
		// (set) Token: 0x0600871F RID: 34591
		[DispId(1003)]
		bool defaultSelected { [DispId(1003)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(1003)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17002D88 RID: 11656
		// (get) Token: 0x06008722 RID: 34594
		// (set) Token: 0x06008721 RID: 34593
		[DispId(1005)]
		int index { [DispId(1005)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(1005)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17002D89 RID: 11657
		// (get) Token: 0x06008724 RID: 34596
		// (set) Token: 0x06008723 RID: 34595
		[DispId(1004)]
		string text { [DispId(1004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(1004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17002D8A RID: 11658
		// (get) Token: 0x06008725 RID: 34597
		[DispId(1006)]
		IHTMLFormElement form { [DispId(1006)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Interface)] get; }

		// Token: 0x17002D8B RID: 11659
		// (get) Token: 0x06008727 RID: 34599
		// (set) Token: 0x06008726 RID: 34598
		[DispId(1007)]
		string label { [DispId(1007)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [TypeLibFunc(20)] [DispId(1007)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }
	}
}
