...
namespace mshtml
{
	...
	public interface DispHTMLNoShowElement
	{
		...
		// (get) Token: 0x06012313 RID: 74515
		// (set) Token: 0x06012312 RID: 74514
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06012314 RID: 74516
		[DispId(-2147417108)]
		...
		// (get) Token: 0x06012315 RID: 74517
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06012316 RID: 74518
		[DispId(-2147418038)]
		...
		// (get) Token: 0x06012318 RID: 74520
		// (set) Token: 0x06012317 RID: 74519
		[DispId(-2147412099)]
		...
		// (get) Token: 0x0601231A RID: 74522
		// (set) Token: 0x06012319 RID: 74521
		[DispId(-2147412104)]
		...
		// (get) Token: 0x0601231C RID: 74524
		// (set) Token: 0x0601231B RID: 74523
		[DispId(-2147412103)]
		...
		// (get) Token: 0x0601231E RID: 74526
		// (set) Token: 0x0601231D RID: 74525
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06012320 RID: 74528
		// (set) Token: 0x0601231F RID: 74527
		[DispId(-2147412106)]
		...
		// (set) Token: 0x06012321 RID: 74529
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06012328 RID: 74536
		...
		// (get) Token: 0x0601232A RID: 74538
		// (set) Token: 0x06012329 RID: 74537
		[DispId(-2147412110)]
		...
		// (get) Token: 0x0601232C RID: 74540
		// (set) Token: 0x0601232B RID: 74539
		[DispId(-2147412109)]
		...
		// (get) Token: 0x0601232D RID: 74541
		[DispId(-2147417094)]
		...
		// (get) Token: 0x0601232F RID: 74543
		// (set) Token: 0x0601232E RID: 74542
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06012331 RID: 74545
		// (set) Token: 0x06012330 RID: 74544
		[DispId(-2147413012)]
		...
		// (get) Token: 0x06012333 RID: 74547
		// (set) Token: 0x06012332 RID: 74546
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06012337 RID: 74551
		[DispId(-2147417087)]
		...
		// (get) Token: 0x06012339 RID: 74553
		// (set) Token: 0x06012338 RID: 74552
		[DispId(-2147413103)]
		...
		// (get) Token: 0x0601233A RID: 74554
		[DispId(-2147417104)]
		...
		// (get) Token: 0x0601233B RID: 74555
		[DispId(-2147417103)]
		...
		// (get) Token: 0x0601233C RID: 74556
		[DispId(-2147417102)]
		...
		// (get) Token: 0x0601233D RID: 74557
		[DispId(-2147417101)]
		...
		// (get) Token: 0x0601233E RID: 74558
		[DispId(-2147417100)]
		...
		// (get) Token: 0x06012340 RID: 74560
		// (set) Token: 0x0601233F RID: 74559
		[DispId(-2147417086)]
		...
		// (get) Token: 0x06012342 RID: 74562
		// (set) Token: 0x06012341 RID: 74561
		[DispId(-2147417085)]
		...
		// (get) Token: 0x06012344 RID: 74564
		// (set) Token: 0x06012343 RID: 74563
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06012346 RID: 74566
		// (set) Token: 0x06012345 RID: 74565
		[DispId(-2147417083)]
		...
		// (get) Token: 0x06012349 RID: 74569
		[DispId(-2147417080)]
		...
		// (get) Token: 0x0601234E RID: 74574
		// (set) Token: 0x0601234D RID: 74573
		[DispId(-2147412077)]
		...
		// (get) Token: 0x06012351 RID: 74577
		// (set) Token: 0x06012350 RID: 74576
		[DispId(-2147412091)]
		...
		// (get) Token: 0x06012353 RID: 74579
		// (set) Token: 0x06012352 RID: 74578
		[DispId(-2147412090)]
		...
		// (get) Token: 0x06012355 RID: 74581
		// (set) Token: 0x06012354 RID: 74580
		[DispId(-2147412074)]
		...
		// (get) Token: 0x06012357 RID: 74583
		// (set) Token: 0x06012356 RID: 74582
		[DispId(-2147412094)]
		...
		// (get) Token: 0x06012359 RID: 74585
		// (set) Token: 0x06012358 RID: 74584
		[DispId(-2147412093)]
		...
		// (get) Token: 0x0601235B RID: 74587
		// (set) Token: 0x0601235A RID: 74586
		[DispId(-2147412072)]
		...
		// (get) Token: 0x0601235D RID: 74589
		// (set) Token: 0x0601235C RID: 74588
		[DispId(-2147412071)]
		object ondataavailable { [DispId(-2147412071)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412071)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x17005FE7 RID: 24551
		// (get) Token: 0x0601235F RID: 74591
		// (set) Token: 0x0601235E RID: 74590
		[DispId(-2147412070)]
		...
		// (get) Token: 0x06012361 RID: 74593
		// (set) Token: 0x06012360 RID: 74592
		[DispId(-2147412069)]
		...
		// (get) Token: 0x06012362 RID: 74594
		[DispId(-2147417075)]
		...
		// (get) Token: 0x06012363 RID: 74595
		[DispId(-2147417074)]
		...
		// (get) Token: 0x06012364 RID: 74596
		[DispId(-2147417073)]
		...
		// (get) Token: 0x06012368 RID: 74600
		// (set) Token: 0x06012367 RID: 74599
		[DispId(-2147412066)]
		...
		// (get) Token: 0x0601236C RID: 74604
		// (set) Token: 0x0601236B RID: 74603
		[DispId(-2147412081)]
		...
		// (get) Token: 0x0601236E RID: 74606
		// (set) Token: 0x0601236D RID: 74605
		[DispId(-2147412063)]
		...
		// (get) Token: 0x06012370 RID: 74608
		// (set) Token: 0x0601236F RID: 74607
		[DispId(-2147412062)]
		...
		// (get) Token: 0x06012372 RID: 74610
		// (set) Token: 0x06012371 RID: 74609
		[DispId(-2147412061)]
		...
		// (get) Token: 0x06012374 RID: 74612
		// (set) Token: 0x06012373 RID: 74611
		[DispId(-2147412060)]
		...
		// (get) Token: 0x06012376 RID: 74614
		// (set) Token: 0x06012375 RID: 74613
		[DispId(-2147412059)]
		...
		// (get) Token: 0x06012378 RID: 74616
		// (set) Token: 0x06012377 RID: 74615
		[DispId(-2147412058)]
		...
		// (get) Token: 0x0601237A RID: 74618
		// (set) Token: 0x06012379 RID: 74617
		[DispId(-2147412054)]
		...
		// (get) Token: 0x0601237C RID: 74620
		// (set) Token: 0x0601237B RID: 74619
		[DispId(-2147412057)]
		...
		// (get) Token: 0x0601237E RID: 74622
		// (set) Token: 0x0601237D RID: 74621
		[DispId(-2147412053)]
		...
		// (get) Token: 0x06012380 RID: 74624
		// (set) Token: 0x0601237F RID: 74623
		[DispId(-2147412056)]
		...
		// (get) Token: 0x06012382 RID: 74626
		// (set) Token: 0x06012381 RID: 74625
		[DispId(-2147412052)]
		...
		// (get) Token: 0x06012384 RID: 74628
		// (set) Token: 0x06012383 RID: 74627
		[DispId(-2147412055)]
		...
		// (get) Token: 0x06012385 RID: 74629
		[DispId(-2147417105)]
		...
		// (get) Token: 0x06012387 RID: 74631
		// (set) Token: 0x06012386 RID: 74630
		[DispId(-2147412065)]
		...
		// Token: 0x06012388 RID: 74632
		[DispId(-2147417068)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		IHTMLRectCollection getClientRects();

		// Token: 0x06012389 RID: 74633
		[DispId(-2147417067)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		...
		// (get) Token: 0x0601238E RID: 74638
		// (set) Token: 0x0601238D RID: 74637
		[DispId(-2147418097)]
		...
		// Token: 0x0601238F RID: 74639
		[DispId(-2147416112)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void focus();

		// Token: 0x17005FFD RID: 24573
		// (get) Token: 0x06012391 RID: 74641
		// (set) Token: 0x06012390 RID: 74640
		[DispId(-2147416107)]
		...
		// (get) Token: 0x06012393 RID: 74643
		// (set) Token: 0x06012392 RID: 74642
		[DispId(-2147412097)]
		...
		// (get) Token: 0x06012395 RID: 74645
		// (set) Token: 0x06012394 RID: 74644
		[DispId(-2147412098)]
		...
		// (get) Token: 0x06012397 RID: 74647
		// (set) Token: 0x06012396 RID: 74646
		[DispId(-2147412076)]
		...
		// (get) Token: 0x0601239B RID: 74651
		[DispId(-2147416093)]
		...
		// (get) Token: 0x0601239C RID: 74652
		[DispId(-2147416092)]
		...
		// (get) Token: 0x0601239D RID: 74653
		[DispId(-2147416091)]
		...
		// (get) Token: 0x0601239E RID: 74654
		[DispId(-2147416090)]
		...
		// (set) Token: 0x060123A2 RID: 74658
		[DispId(-2147412087)]
		...
		// (set) Token: 0x060123A4 RID: 74660
		[DispId(-2147412050)]
		...
		// (set) Token: 0x060123A6 RID: 74662
		[DispId(-2147412049)]
		...
		// (set) Token: 0x060123A8 RID: 74664
		[DispId(-2147412048)]
		...
		// (set) Token: 0x060123AA RID: 74666
		[DispId(-2147412995)]
		...
		// (get) Token: 0x060123AE RID: 74670
		[DispId(-2147417054)]
		...
		// (get) Token: 0x060123B0 RID: 74672
		// (set) Token: 0x060123AF RID: 74671
		[DispId(-2147417053)]
		...
		// (get) Token: 0x060123B2 RID: 74674
		// (set) Token: 0x060123B1 RID: 74673
		[DispId(-2147417052)]
		...
		// Token: 0x060123B3 RID: 74675
		[DispId(-2147417050)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void clearAttributes();

		// Token: 0x1700600F RID: 24591
		// (get) Token: 0x060123B5 RID: 74677
		// (set) Token: 0x060123B4 RID: 74676
		[DispId(-2147412047)]
		...
		// (get) Token: 0x060123BD RID: 74685
		[DispId(-2147417048)]
		...
		// (get) Token: 0x060123BE RID: 74686
		[DispId(-2147417030)]
		...
		// (get) Token: 0x060123C0 RID: 74688
		// (set) Token: 0x060123BF RID: 74687
		[DispId(-2147417029)]
		...
		// (get) Token: 0x060123C2 RID: 74690
		// (set) Token: 0x060123C1 RID: 74689
		[DispId(-2147412043)]
		...
		// (get) Token: 0x060123C3 RID: 74691
		[DispId(-2147417028)]
		...
		// (get) Token: 0x060123C6 RID: 74694
		[DispId(-2147417015)]
		...
		// (get) Token: 0x060123C7 RID: 74695
		[DispId(-2147417014)]
		...
		// (get) Token: 0x060123C9 RID: 74697
		// (set) Token: 0x060123C8 RID: 74696
		[DispId(-2147412039)]
		...
		// (get) Token: 0x060123CB RID: 74699
		// (set) Token: 0x060123CA RID: 74698
		[DispId(-2147412038)]
		...
		// (get) Token: 0x060123CD RID: 74701
		// (set) Token: 0x060123CC RID: 74700
		[DispId(-2147417012)]
		...
		// (get) Token: 0x060123CF RID: 74703
		// (set) Token: 0x060123CE RID: 74702
		[DispId(-2147412035)]
		...
		// Token: 0x060123D0 RID: 74704
		[DispId(-2147417011)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void setActive();

		// Token: 0x1700601C RID: 24604
		// (get) Token: 0x060123D2 RID: 74706
		// (set) Token: 0x060123D1 RID: 74705
		[DispId(-2147412950)]
		...
		// (get) Token: 0x060123D3 RID: 74707
		[DispId(-2147417010)]
		...
		// (get) Token: 0x060123D5 RID: 74709
		// (set) Token: 0x060123D4 RID: 74708
		[DispId(-2147412949)]
		...
		// (get) Token: 0x060123D7 RID: 74711
		// (set) Token: 0x060123D6 RID: 74710
		[DispId(-2147418036)]
		...
		// (get) Token: 0x060123D8 RID: 74712
		[DispId(-2147417007)]
		...
		// (get) Token: 0x060123DA RID: 74714
		// (set) Token: 0x060123D9 RID: 74713
		[DispId(-2147412034)]
		...
		// (get) Token: 0x060123DC RID: 74716
		// (set) Token: 0x060123DB RID: 74715
		[DispId(-2147412033)]
		object oncontrolselect { [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x060123DD RID: 74717
		[DispId(-2147417006)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		...
		// (get) Token: 0x060123DF RID: 74719
		// (set) Token: 0x060123DE RID: 74718
		[DispId(-2147412029)]
		...
		// (get) Token: 0x060123E1 RID: 74721
		// (set) Token: 0x060123E0 RID: 74720
		[DispId(-2147412028)]
		...
		// (get) Token: 0x060123E3 RID: 74723
		// (set) Token: 0x060123E2 RID: 74722
		[DispId(-2147412031)]
		...
		// (get) Token: 0x060123E5 RID: 74725
		// (set) Token: 0x060123E4 RID: 74724
		[DispId(-2147412030)]
		...
		// (get) Token: 0x060123E7 RID: 74727
		// (set) Token: 0x060123E6 RID: 74726
		[DispId(-2147412027)]
		...
		// (get) Token: 0x060123E9 RID: 74729
		// (set) Token: 0x060123E8 RID: 74728
		[DispId(-2147412026)]
		...
		// (get) Token: 0x060123EB RID: 74731
		// (set) Token: 0x060123EA RID: 74730
		[DispId(-2147412025)]
		...
		// (get) Token: 0x060123ED RID: 74733
		// (set) Token: 0x060123EC RID: 74732
		[DispId(-2147412024)]
		...
		// (get) Token: 0x060123EF RID: 74735
		[DispId(-2147417004)]
		...
		// (get) Token: 0x060123F1 RID: 74737
		// (set) Token: 0x060123F0 RID: 74736
		[DispId(-2147412036)]
		...
		// (get) Token: 0x060123F7 RID: 74743
		// (set) Token: 0x060123F6 RID: 74742
		[DispId(-2147412022)]
		...
		// (get) Token: 0x060123F9 RID: 74745
		// (set) Token: 0x060123F8 RID: 74744
		[DispId(-2147412021)]
		...
		// (get) Token: 0x060123FB RID: 74747
		// (set) Token: 0x060123FA RID: 74746
		[DispId(-2147412020)]
		...
		// (get) Token: 0x060123FC RID: 74748
		[DispId(-2147417058)]
		...
		// (get) Token: 0x060123FD RID: 74749
		[DispId(-2147417057)]
		...
		// (get) Token: 0x060123FE RID: 74750
		[DispId(-2147417066)]
		...
		// (get) Token: 0x060123FF RID: 74751
		[DispId(-2147417065)]
		...
		// (get) Token: 0x06012401 RID: 74753
		[DispId(-2147417063)]
		...
		// (get) Token: 0x06012402 RID: 74754
		[DispId(-2147417062)]
		...
		// (get) Token: 0x0601240B RID: 74763
		[DispId(-2147417038)]
		...
		// (get) Token: 0x0601240D RID: 74765
		// (set) Token: 0x0601240C RID: 74764
		[DispId(-2147417037)]
		...
		// (get) Token: 0x0601240E RID: 74766
		[DispId(-2147417036)]
		...
		// (get) Token: 0x0601240F RID: 74767
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06012410 RID: 74768
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06012411 RID: 74769
		[DispId(-2147417033)]
		...
		// (get) Token: 0x06012412 RID: 74770
		[DispId(-2147416999)]
