...
namespace mshtml
{
	...
	public interface DispHTMLRichtextElement
	{
		...
		[DispId(7004)]
		bool readOnly { [TypeLibFunc(20)] [DispId(7004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [TypeLibFunc(20)] [DispId(7004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x1700339A RID: 13210
		// (get) Token: 0x06009F36 RID: 40758
		// (set) Token: 0x06009F35 RID: 40757
		[DispId(7001)]
		int rows { [TypeLibFunc(20)] [DispId(7001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [TypeLibFunc(20)] [DispId(7001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x1700339B RID: 13211
		// (get) Token: 0x06009F38 RID: 40760
		// (set) Token: 0x06009F37 RID: 40759
		[DispId(7002)]
		int cols { [TypeLibFunc(20)] [DispId(7002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(7002)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x1700339C RID: 13212
		// (get) Token: 0x06009F3A RID: 40762
		// (set) Token: 0x06009F39 RID: 40761
		[DispId(7003)]
		string wrap { [DispId(7003)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(7003)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }
