...
namespace mshtml
{
	...
	public interface DispHTMLEmbed
	{
		...
		[DispId(-2147415102)]
		string hidden { [DispId(-2147415102)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(-2147415102)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17004A9E RID: 19102
		// (get) Token: 0x0600E056 RID: 57430
		[DispId(-2147415108)]
		string palette { [DispId(-2147415108)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; }

		// Token: 0x17004A9F RID: 19103
		// (get) Token: 0x0600E057 RID: 57431
		[DispId(-2147415107)]
		string pluginspage { [DispId(-2147415107)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; }

		// Token: 0x17004AA0 RID: 19104
		// (get) Token: 0x0600E059 RID: 57433
		// (set) Token: 0x0600E058 RID: 57432
		[DispId(-2147415106)]
		string src { [DispId(-2147415106)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(-2147415106)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17004AA1 RID: 19105
		// (get) Token: 0x0600E05B RID: 57435
		// (set) Token: 0x0600E05A RID: 57434
		[DispId(-2147415104)]
		string units { [DispId(-2147415104)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(-2147415104)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }
