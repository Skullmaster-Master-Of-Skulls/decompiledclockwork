...
namespace mshtml
{
	...
	public interface DispHTMLTableRow
	{
		...
		[DispId(1000)]
		int rowIndex { [DispId(1000)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; }

		// Token: 0x17005B2A RID: 23338
		// (get) Token: 0x0601145A RID: 70746
		[DispId(1001)]
		int sectionRowIndex { [DispId(1001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; }

		// Token: 0x17005B2B RID: 23339
		// (get) Token: 0x0601145B RID: 70747
		[DispId(1002)]
		IHTMLElementCollection cells { [DispId(1002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Interface)] get; }
		...
		[DispId(1009)]
		string ch { [DispId(1009)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [TypeLibFunc(20)] [DispId(1009)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17005B2E RID: 23342
		// (get) Token: 0x06011463 RID: 70755
		// (set) Token: 0x06011462 RID: 70754
		[DispId(1010)]
		string chOff { [DispId(1010)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [TypeLibFunc(20)] [DispId(1010)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }
	}
}
