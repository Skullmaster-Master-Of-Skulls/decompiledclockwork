...
namespace mshtml
{
	...
	[ComImport]
	public interface DispHTMLDDElement
	{
		...
		// (set) Token: 0x06006208 RID: 25096
		[DispId(-2147417111)]
		...
		// (set) Token: 0x0600620A RID: 25098
		[DispId(-2147417110)]
		...
		// (get) Token: 0x0600620C RID: 25100
		[DispId(-2147417108)]
		...
		// (get) Token: 0x0600620D RID: 25101
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06006210 RID: 25104
		// (set) Token: 0x0600620F RID: 25103
		[DispId(-2147412099)]
		...
		// (get) Token: 0x06006212 RID: 25106
		// (set) Token: 0x06006211 RID: 25105
		[DispId(-2147412104)]
		...
		// (get) Token: 0x06006214 RID: 25108
		// (set) Token: 0x06006213 RID: 25107
		[DispId(-2147412103)]
		...
		// (get) Token: 0x06006216 RID: 25110
		// (set) Token: 0x06006215 RID: 25109
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06006218 RID: 25112
		// (set) Token: 0x06006217 RID: 25111
		[DispId(-2147412106)]
		...
		// (get) Token: 0x0600621A RID: 25114
		// (set) Token: 0x06006219 RID: 25113
		[DispId(-2147412105)]
		...
		// (get) Token: 0x0600621C RID: 25116
		// (set) Token: 0x0600621B RID: 25115
		[DispId(-2147412111)]
		...
		// (get) Token: 0x0600621E RID: 25118
		// (set) Token: 0x0600621D RID: 25117
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06006220 RID: 25120
		// (set) Token: 0x0600621F RID: 25119
		[DispId(-2147412108)]
		...
		// (get) Token: 0x06006222 RID: 25122
		// (set) Token: 0x06006221 RID: 25121
		[DispId(-2147412110)]
		...
		// (get) Token: 0x06006224 RID: 25124
		// (set) Token: 0x06006223 RID: 25123
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06006225 RID: 25125
		[DispId(-2147417094)]
		...
		// (get) Token: 0x06006227 RID: 25127
		// (set) Token: 0x06006226 RID: 25126
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06006229 RID: 25129
		// (set) Token: 0x06006228 RID: 25128
		[DispId(-2147413012)]
		...
		// (get) Token: 0x0600622B RID: 25131
		// (set) Token: 0x0600622A RID: 25130
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06006231 RID: 25137
		// (set) Token: 0x06006230 RID: 25136
		[DispId(-2147413103)]
		...
		// (get) Token: 0x06006233 RID: 25139
		[DispId(-2147417103)]
		...
		// (get) Token: 0x06006235 RID: 25141
		[DispId(-2147417101)]
		...
		// (get) Token: 0x06006246 RID: 25158
		...
		// (get) Token: 0x06006249 RID: 25161
		// (set) Token: 0x06006248 RID: 25160
		[DispId(-2147412091)]
		...
		// (get) Token: 0x0600624B RID: 25163
		// (set) Token: 0x0600624A RID: 25162
		[DispId(-2147412090)]
		...
		// (set) Token: 0x0600624C RID: 25164
		[DispId(-2147412074)]
		...
		// (get) Token: 0x0600624F RID: 25167
		// (set) Token: 0x0600624E RID: 25166
		[DispId(-2147412094)]
		...
		// (get) Token: 0x06006251 RID: 25169
		// (set) Token: 0x06006250 RID: 25168
		[DispId(-2147412093)]
		...
		// (get) Token: 0x06006253 RID: 25171
		// (set) Token: 0x06006252 RID: 25170
		[DispId(-2147412072)]
		...
		// (set) Token: 0x06006254 RID: 25172
		[DispId(-2147412071)]
		...
		// (set) Token: 0x06006256 RID: 25174
		[DispId(-2147412070)]
		...
		// (get) Token: 0x06006259 RID: 25177
		// (set) Token: 0x06006258 RID: 25176
		[DispId(-2147412069)]
		...
		// (get) Token: 0x0600625A RID: 25178
		[DispId(-2147417075)]
		...
		// (get) Token: 0x0600625B RID: 25179
		[DispId(-2147417074)]
		...
		// (get) Token: 0x06006260 RID: 25184
		// (set) Token: 0x0600625F RID: 25183
		[DispId(-2147412066)]
		...
		// (get) Token: 0x06006264 RID: 25188
		// (set) Token: 0x06006263 RID: 25187
		[DispId(-2147412081)]
		...
		// (get) Token: 0x06006266 RID: 25190
		// (set) Token: 0x06006265 RID: 25189
		[DispId(-2147412063)]
		...
		// (set) Token: 0x06006267 RID: 25191
		[DispId(-2147412062)]
		...
		// (get) Token: 0x0600626A RID: 25194
		// (set) Token: 0x06006269 RID: 25193
		[DispId(-2147412061)]
		...
		// (set) Token: 0x0600626B RID: 25195
		[DispId(-2147412060)]
		...
		// (get) Token: 0x0600626E RID: 25198
		// (set) Token: 0x0600626D RID: 25197
		[DispId(-2147412059)]
		...
		// (set) Token: 0x0600626F RID: 25199
		[DispId(-2147412058)]
		...
		// (get) Token: 0x06006272 RID: 25202
		...
		// (get) Token: 0x06006274 RID: 25204
		// (set) Token: 0x06006273 RID: 25203
		[DispId(-2147412057)]
		...
		// (get) Token: 0x06006276 RID: 25206
		// (set) Token: 0x06006275 RID: 25205
		[DispId(-2147412053)]
		...
		// (get) Token: 0x06006278 RID: 25208
		// (set) Token: 0x06006277 RID: 25207
		[DispId(-2147412056)]
		...
		// (get) Token: 0x0600627A RID: 25210
		// (set) Token: 0x06006279 RID: 25209
		[DispId(-2147412052)]
		...
		// (get) Token: 0x0600627C RID: 25212
		// (set) Token: 0x0600627B RID: 25211
		[DispId(-2147412055)]
		...
		// (get) Token: 0x0600627D RID: 25213
		[DispId(-2147417105)]
		...
		// (get) Token: 0x0600627F RID: 25215
		// (set) Token: 0x0600627E RID: 25214
		[DispId(-2147412065)]
		...
		// (set) Token: 0x06006288 RID: 25224
		[DispId(-2147416107)]
		...
		// (get) Token: 0x0600628B RID: 25227
		// (set) Token: 0x0600628A RID: 25226
		[DispId(-2147412097)]
		...
		// (get) Token: 0x0600628D RID: 25229
		// (set) Token: 0x0600628C RID: 25228
		[DispId(-2147412098)]
		...
		// (get) Token: 0x0600628F RID: 25231
		// (set) Token: 0x0600628E RID: 25230
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06006293 RID: 25235
		[DispId(-2147416093)]
		...
		// (get) Token: 0x06006294 RID: 25236
		[DispId(-2147416092)]
		...
		// (get) Token: 0x06006295 RID: 25237
		[DispId(-2147416091)]
		...
		// (get) Token: 0x06006296 RID: 25238
		[DispId(-2147416090)]
		...
		// (set) Token: 0x0600629A RID: 25242
		[DispId(-2147412087)]
		...
		// (set) Token: 0x0600629C RID: 25244
		[DispId(-2147412050)]
		...
		// (set) Token: 0x0600629E RID: 25246
		[DispId(-2147412049)]
		...
		// (set) Token: 0x060062A7 RID: 25255
		[DispId(-2147417053)]
		...
		// (set) Token: 0x060062A9 RID: 25257
		[DispId(-2147417052)]
		...
		// (set) Token: 0x060062AC RID: 25260
		[DispId(-2147412047)]
		...
		// (get) Token: 0x060062BB RID: 25275
		[DispId(-2147417028)]
		...
		// (set) Token: 0x060062C0 RID: 25280
		[DispId(-2147412039)]
		...
		// (set) Token: 0x060062C2 RID: 25282
		[DispId(-2147412038)]
		...
		// (get) Token: 0x060062CA RID: 25290
		...
		// (set) Token: 0x060062D1 RID: 25297
		[DispId(-2147412034)]
		...
		// (set) Token: 0x060062D3 RID: 25299
		[DispId(-2147412033)]
		...
		// (set) Token: 0x060062D8 RID: 25304
		[DispId(-2147412028)]
		...
		// (set) Token: 0x060062DA RID: 25306
		[DispId(-2147412031)]
		...
		// (set) Token: 0x060062DC RID: 25308
		[DispId(-2147412030)]
		...
		// (get) Token: 0x060062DF RID: 25311
		// (set) Token: 0x060062DE RID: 25310
		[DispId(-2147412027)]
		...
		// (get) Token: 0x060062E1 RID: 25313
		// (set) Token: 0x060062E0 RID: 25312
		[DispId(-2147412026)]
		...
		// (get) Token: 0x060062E3 RID: 25315
		// (set) Token: 0x060062E2 RID: 25314
		[DispId(-2147412025)]
		...
		// (get) Token: 0x060062E5 RID: 25317
		// (set) Token: 0x060062E4 RID: 25316
		[DispId(-2147412024)]
		...
		// (get) Token: 0x060062E7 RID: 25319
		[DispId(-2147417004)]
		...
		// (set) Token: 0x060062E8 RID: 25320
		[DispId(-2147412036)]
		...
		// (get) Token: 0x060062EF RID: 25327
		// (set) Token: 0x060062EE RID: 25326
		[DispId(-2147412022)]
		...
		// (get) Token: 0x060062F1 RID: 25329
		// (set) Token: 0x060062F0 RID: 25328
		[DispId(-2147412021)]
		...
		// (get) Token: 0x060062F3 RID: 25331
		// (set) Token: 0x060062F2 RID: 25330
		[DispId(-2147412020)]
		...
		// (get) Token: 0x060062F4 RID: 25332
		[DispId(-2147417058)]
		...
		// (get) Token: 0x060062F5 RID: 25333
		[DispId(-2147417057)]
		...
		// (get) Token: 0x060062F6 RID: 25334
		[DispId(-2147417066)]
		...
		// (get) Token: 0x060062F9 RID: 25337
		[DispId(-2147417063)]
		...
		// (get) Token: 0x060062FA RID: 25338
		[DispId(-2147417062)]
		...
		// (get) Token: 0x06006303 RID: 25347
		[DispId(-2147417038)]
		...
		// (get) Token: 0x06006305 RID: 25349
		// (set) Token: 0x06006304 RID: 25348
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06006306 RID: 25350
		[DispId(-2147417036)]
		...
		// (get) Token: 0x06006307 RID: 25351
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06006308 RID: 25352
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06006309 RID: 25353
		[DispId(-2147417033)]
		...
		// (get) Token: 0x0600630A RID: 25354
		[DispId(-2147416999)]
		...
		// (get) Token: 0x0600630C RID: 25356
		// (set) Token: 0x0600630B RID: 25355
		[DispId(-2147413107)]
		bool noWrap { [TypeLibFunc(20)] [DispId(-2147413107)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [TypeLibFunc(20)] [DispId(-2147413107)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }
	}
}
