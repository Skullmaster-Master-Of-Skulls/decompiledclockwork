...
namespace mshtml
{
	...
	[InterfaceType(2)]
	[ComImport]
	public interface DispHTMLDivElement
	{
		...
		// (get) Token: 0x06005CBE RID: 23742
		// (set) Token: 0x06005CBD RID: 23741
		[DispId(-2147417111)]
		...
		// (get) Token: 0x06005CC0 RID: 23744
		// (set) Token: 0x06005CBF RID: 23743
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06005CC1 RID: 23745
		[DispId(-2147417108)]
		...
		// (get) Token: 0x06005CC2 RID: 23746
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06005CC3 RID: 23747
		[DispId(-2147418038)]
		...
		// (get) Token: 0x06005CC5 RID: 23749
		// (set) Token: 0x06005CC4 RID: 23748
		[DispId(-2147412099)]
		...
		// (get) Token: 0x06005CC7 RID: 23751
		// (set) Token: 0x06005CC6 RID: 23750
		[DispId(-2147412104)]
		...
		// (get) Token: 0x06005CC9 RID: 23753
		// (set) Token: 0x06005CC8 RID: 23752
		[DispId(-2147412103)]
		...
		// (get) Token: 0x06005CCB RID: 23755
		// (set) Token: 0x06005CCA RID: 23754
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06005CCD RID: 23757
		// (set) Token: 0x06005CCC RID: 23756
		[DispId(-2147412106)]
		...
		// (get) Token: 0x06005CCF RID: 23759
		// (set) Token: 0x06005CCE RID: 23758
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06005CD1 RID: 23761
		// (set) Token: 0x06005CD0 RID: 23760
		[DispId(-2147412111)]
		...
		// (set) Token: 0x06005CD2 RID: 23762
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06005CD5 RID: 23765
		// (set) Token: 0x06005CD4 RID: 23764
		[DispId(-2147412108)]
		...
		// (get) Token: 0x06005CD7 RID: 23767
		// (set) Token: 0x06005CD6 RID: 23766
		[DispId(-2147412110)]
		...
		// (get) Token: 0x06005CD9 RID: 23769
		// (set) Token: 0x06005CD8 RID: 23768
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06005CDA RID: 23770
		[DispId(-2147417094)]
		...
		// (get) Token: 0x06005CDC RID: 23772
		// (set) Token: 0x06005CDB RID: 23771
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06005CDE RID: 23774
		// (set) Token: 0x06005CDD RID: 23773
		[DispId(-2147413012)]
		...
		// (get) Token: 0x06005CE0 RID: 23776
		// (set) Token: 0x06005CDF RID: 23775
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06005CE3 RID: 23779
		[DispId(-2147417088)]
		...
		// (set) Token: 0x06005CEC RID: 23788
		[DispId(-2147417086)]
		...
		// (set) Token: 0x06005CEE RID: 23790
		[DispId(-2147417085)]
		...
		// (set) Token: 0x06005CF0 RID: 23792
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06005CF3 RID: 23795
		// (set) Token: 0x06005CF2 RID: 23794
		[DispId(-2147417083)]
		...
		// (get) Token: 0x06005CFB RID: 23803
		// (set) Token: 0x06005CFA RID: 23802
		[DispId(-2147412077)]
		...
		// (get) Token: 0x06005CFE RID: 23806
		// (set) Token: 0x06005CFD RID: 23805
		[DispId(-2147412091)]
		...
		// (set) Token: 0x06005CFF RID: 23807
		[DispId(-2147412090)]
		...
		// (set) Token: 0x06005D01 RID: 23809
		[DispId(-2147412074)]
		...
		// (set) Token: 0x06005D09 RID: 23817
		[DispId(-2147412071)]
		...
		// (get) Token: 0x06005D0C RID: 23820
		...
		// (get) Token: 0x06005D0E RID: 23822
		// (set) Token: 0x06005D0D RID: 23821
		[DispId(-2147412069)]
		...
		// (get) Token: 0x06005D0F RID: 23823
		[DispId(-2147417075)]
		...
		// (get) Token: 0x06005D10 RID: 23824
		[DispId(-2147417074)]
		...
		// (set) Token: 0x06005D14 RID: 23828
		[DispId(-2147412066)]
		...
		// (get) Token: 0x06005D19 RID: 23833
		// (set) Token: 0x06005D18 RID: 23832
		[DispId(-2147412081)]
		...
		// (get) Token: 0x06005D1B RID: 23835
		// (set) Token: 0x06005D1A RID: 23834
		[DispId(-2147412063)]
		...
		// (get) Token: 0x06005D1D RID: 23837
		// (set) Token: 0x06005D1C RID: 23836
		[DispId(-2147412062)]
		...
		// (get) Token: 0x06005D1F RID: 23839
		// (set) Token: 0x06005D1E RID: 23838
		[DispId(-2147412061)]
		...
		// (get) Token: 0x06005D21 RID: 23841
		// (set) Token: 0x06005D20 RID: 23840
		[DispId(-2147412060)]
		...
		// (set) Token: 0x06005D22 RID: 23842
		[DispId(-2147412059)]
		...
		// (get) Token: 0x06005D25 RID: 23845
		...
		// (set) Token: 0x06005D26 RID: 23846
		[DispId(-2147412054)]
		...
		// (set) Token: 0x06005D2C RID: 23852
		[DispId(-2147412056)]
		...
		// (get) Token: 0x06005D3B RID: 23867
		// (set) Token: 0x06005D3A RID: 23866
		[DispId(-2147418097)]
		...
		// (get) Token: 0x06005D3E RID: 23870
		// (set) Token: 0x06005D3D RID: 23869
		[DispId(-2147416107)]
		...
		// (set) Token: 0x06005D3F RID: 23871
		[DispId(-2147412097)]
		...
		// (set) Token: 0x06005D43 RID: 23875
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06005D4A RID: 23882
		[DispId(-2147416091)]
		...
		// (get) Token: 0x06005D4B RID: 23883
		[DispId(-2147416090)]
		...
		// (set) Token: 0x06005D4F RID: 23887
		[DispId(-2147412087)]
		...
		// (set) Token: 0x06005D51 RID: 23889
		[DispId(-2147412050)]
		...
		// (get) Token: 0x06005D54 RID: 23892
		// (set) Token: 0x06005D53 RID: 23891
		[DispId(-2147412049)]
		...
		// (set) Token: 0x06005D5C RID: 23900
		[DispId(-2147417053)]
		...
		// (get) Token: 0x06005D5F RID: 23903
		// (set) Token: 0x06005D5E RID: 23902
		[DispId(-2147417052)]
		...
		// (get) Token: 0x06005D67 RID: 23911
		[DispId(-2147417040)]
		...
		// (get) Token: 0x06005D6A RID: 23914
		[DispId(-2147417048)]
		...
		// (get) Token: 0x06005D6B RID: 23915
		[DispId(-2147417030)]
		...
		// (get) Token: 0x06005D6D RID: 23917
		// (set) Token: 0x06005D6C RID: 23916
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06005D6F RID: 23919
		// (set) Token: 0x06005D6E RID: 23918
		[DispId(-2147412043)]
		...
		// (get) Token: 0x06005D70 RID: 23920
		[DispId(-2147417028)]
		...
		// (set) Token: 0x06005D75 RID: 23925
		[DispId(-2147412039)]
		...
		// (get) Token: 0x06005D78 RID: 23928
		// (set) Token: 0x06005D77 RID: 23927
		[DispId(-2147412038)]
		...
		// (set) Token: 0x06005D79 RID: 23929
		[DispId(-2147417012)]
		...
		// (set) Token: 0x06005D7B RID: 23931
		[DispId(-2147412035)]
		...
		// (get) Token: 0x06005D7F RID: 23935
		// (set) Token: 0x06005D7E RID: 23934
		[DispId(-2147412950)]
		...
		// (set) Token: 0x06005D81 RID: 23937
		[DispId(-2147412949)]
		...
		// (get) Token: 0x06005D84 RID: 23940
		// (set) Token: 0x06005D83 RID: 23939
		[DispId(-2147418036)]
		...
		// (get) Token: 0x06005D85 RID: 23941
		[DispId(-2147417007)]
		...
		// (get) Token: 0x06005D87 RID: 23943
		// (set) Token: 0x06005D86 RID: 23942
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06005D89 RID: 23945
		// (set) Token: 0x06005D88 RID: 23944
		[DispId(-2147412033)]
		...
		// (get) Token: 0x06005D8C RID: 23948
		// (set) Token: 0x06005D8B RID: 23947
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06005D8E RID: 23950
		// (set) Token: 0x06005D8D RID: 23949
		[DispId(-2147412028)]
		...
		// (get) Token: 0x06005D90 RID: 23952
		// (set) Token: 0x06005D8F RID: 23951
		[DispId(-2147412031)]
		...
		// (get) Token: 0x06005D92 RID: 23954
		// (set) Token: 0x06005D91 RID: 23953
		[DispId(-2147412030)]
		...
		// (get) Token: 0x06005D94 RID: 23956
		// (set) Token: 0x06005D93 RID: 23955
		[DispId(-2147412027)]
		...
		// (set) Token: 0x06005D95 RID: 23957
		[DispId(-2147412026)]
		...
		// (set) Token: 0x06005D97 RID: 23959
		[DispId(-2147412025)]
		...
		// (set) Token: 0x06005D99 RID: 23961
		[DispId(-2147412024)]
		...
		// (set) Token: 0x06005D9D RID: 23965
		[DispId(-2147412036)]
		...
		// (set) Token: 0x06005DA3 RID: 23971
		[DispId(-2147412022)]
		...
		// (set) Token: 0x06005DA5 RID: 23973
		[DispId(-2147412021)]
		...
		// (set) Token: 0x06005DA7 RID: 23975
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06005DB8 RID: 23992
		[DispId(-2147417038)]
		...
		// (set) Token: 0x06005DB9 RID: 23993
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06005DBD RID: 23997
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06005DC1 RID: 24001
		// (set) Token: 0x06005DC0 RID: 24000
		[DispId(-2147417091)]
		...
		// (get) Token: 0x06005DC3 RID: 24003
		// (set) Token: 0x06005DC2 RID: 24002
		[DispId(-2147417090)]
		...
		// (get) Token: 0x06005DC5 RID: 24005
		// (set) Token: 0x06005DC4 RID: 24004
		[DispId(-2147417089)]
		...
		// (get) Token: 0x06005DC7 RID: 24007
		// (set) Token: 0x06005DC6 RID: 24006
		[DispId(-2147418040)]
		string align { [DispId(-2147418040)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(-2147418040)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17001F53 RID: 8019
		// (get) Token: 0x06005DC9 RID: 24009
		// (set) Token: 0x06005DC8 RID: 24008
		[DispId(-2147413107)]
