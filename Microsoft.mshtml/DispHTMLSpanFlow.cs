...
namespace mshtml
{
	...
	[TypeLibType(4112)]
	[ComImport]
	public interface DispHTMLSpanFlow
	{
		// Token: 0x06014E03 RID: 85507
		[DispId(-2147417611)]
		...
		// (get) Token: 0x06014E09 RID: 85513
		// (set) Token: 0x06014E08 RID: 85512
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06014E0A RID: 85514
		[DispId(-2147417108)]
		...
		// (get) Token: 0x06014E0B RID: 85515
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06014E0C RID: 85516
		[DispId(-2147418038)]
		...
		// (get) Token: 0x06014E0E RID: 85518
		// (set) Token: 0x06014E0D RID: 85517
		[DispId(-2147412099)]
		...
		// (get) Token: 0x06014E10 RID: 85520
		// (set) Token: 0x06014E0F RID: 85519
		[DispId(-2147412104)]
		...
		// (get) Token: 0x06014E12 RID: 85522
		// (set) Token: 0x06014E11 RID: 85521
		[DispId(-2147412103)]
		...
		// (get) Token: 0x06014E14 RID: 85524
		// (set) Token: 0x06014E13 RID: 85523
		[DispId(-2147412107)]
		...
		// (set) Token: 0x06014E15 RID: 85525
		[DispId(-2147412106)]
		...
		// (get) Token: 0x06014E18 RID: 85528
		// (set) Token: 0x06014E17 RID: 85527
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06014E1A RID: 85530
		// (set) Token: 0x06014E19 RID: 85529
		[DispId(-2147412111)]
		...
		// (get) Token: 0x06014E1C RID: 85532
		// (set) Token: 0x06014E1B RID: 85531
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06014E1E RID: 85534
		// (set) Token: 0x06014E1D RID: 85533
		[DispId(-2147412108)]
		...
		// (get) Token: 0x06014E20 RID: 85536
		// (set) Token: 0x06014E1F RID: 85535
		[DispId(-2147412110)]
		...
		// (get) Token: 0x06014E22 RID: 85538
		// (set) Token: 0x06014E21 RID: 85537
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06014E23 RID: 85539
		[DispId(-2147417094)]
		...
		// (get) Token: 0x06014E25 RID: 85541
		// (set) Token: 0x06014E24 RID: 85540
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06014E27 RID: 85543
		// (set) Token: 0x06014E26 RID: 85542
		[DispId(-2147413012)]
		...
		// (get) Token: 0x06014E29 RID: 85545
		// (set) Token: 0x06014E28 RID: 85544
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06014E2D RID: 85549
		[DispId(-2147417087)]
		...
		// (get) Token: 0x06014E2F RID: 85551
		// (set) Token: 0x06014E2E RID: 85550
		[DispId(-2147413103)]
		...
		// (get) Token: 0x06014E30 RID: 85552
		[DispId(-2147417104)]
		...
		// (get) Token: 0x06014E31 RID: 85553
		[DispId(-2147417103)]
		...
		// (get) Token: 0x06014E32 RID: 85554
		[DispId(-2147417102)]
		...
		// (get) Token: 0x06014E33 RID: 85555
		[DispId(-2147417101)]
		...
		// (get) Token: 0x06014E34 RID: 85556
		[DispId(-2147417100)]
		...
		// (get) Token: 0x06014E36 RID: 85558
		// (set) Token: 0x06014E35 RID: 85557
		[DispId(-2147417086)]
		...
		// (get) Token: 0x06014E38 RID: 85560
		// (set) Token: 0x06014E37 RID: 85559
		[DispId(-2147417085)]
		...
		// (get) Token: 0x06014E3A RID: 85562
		// (set) Token: 0x06014E39 RID: 85561
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06014E3C RID: 85564
		// (set) Token: 0x06014E3B RID: 85563
		[DispId(-2147417083)]
		...
		// (get) Token: 0x06014E3F RID: 85567
		[DispId(-2147417080)]
		...
		// (get) Token: 0x06014E44 RID: 85572
		// (set) Token: 0x06014E43 RID: 85571
		[DispId(-2147412077)]
		...
		// (get) Token: 0x06014E47 RID: 85575
		// (set) Token: 0x06014E46 RID: 85574
		[DispId(-2147412091)]
		...
		// (get) Token: 0x06014E49 RID: 85577
		// (set) Token: 0x06014E48 RID: 85576
		[DispId(-2147412090)]
		...
		// (get) Token: 0x06014E4B RID: 85579
		// (set) Token: 0x06014E4A RID: 85578
		[DispId(-2147412074)]
		...
		// (get) Token: 0x06014E4D RID: 85581
		// (set) Token: 0x06014E4C RID: 85580
		[DispId(-2147412094)]
		...
		// (get) Token: 0x06014E4F RID: 85583
		// (set) Token: 0x06014E4E RID: 85582
		[DispId(-2147412093)]
		...
		// (get) Token: 0x06014E51 RID: 85585
		// (set) Token: 0x06014E50 RID: 85584
		[DispId(-2147412072)]
		...
		// (get) Token: 0x06014E53 RID: 85587
		// (set) Token: 0x06014E52 RID: 85586
		[DispId(-2147412071)]
		...
		// (get) Token: 0x06014E55 RID: 85589
		// (set) Token: 0x06014E54 RID: 85588
		[DispId(-2147412070)]
		...
		// (get) Token: 0x06014E57 RID: 85591
		// (set) Token: 0x06014E56 RID: 85590
		[DispId(-2147412069)]
		...
		// (get) Token: 0x06014E58 RID: 85592
		[DispId(-2147417075)]
		...
		// (get) Token: 0x06014E59 RID: 85593
		[DispId(-2147417074)]
		...
		// (get) Token: 0x06014E5A RID: 85594
		[DispId(-2147417073)]
		...
		// (get) Token: 0x06014E5E RID: 85598
		// (set) Token: 0x06014E5D RID: 85597
		[DispId(-2147412066)]
		...
		// (get) Token: 0x06014E62 RID: 85602
		// (set) Token: 0x06014E61 RID: 85601
		[DispId(-2147412081)]
		...
		// (get) Token: 0x06014E64 RID: 85604
		// (set) Token: 0x06014E63 RID: 85603
		[DispId(-2147412063)]
		...
		// (get) Token: 0x06014E66 RID: 85606
		// (set) Token: 0x06014E65 RID: 85605
		[DispId(-2147412062)]
		...
		// (get) Token: 0x06014E68 RID: 85608
		// (set) Token: 0x06014E67 RID: 85607
		[DispId(-2147412061)]
		...
		// (get) Token: 0x06014E6A RID: 85610
		// (set) Token: 0x06014E69 RID: 85609
		[DispId(-2147412060)]
		...
		// (get) Token: 0x06014E6C RID: 85612
		// (set) Token: 0x06014E6B RID: 85611
		[DispId(-2147412059)]
		...
		// (get) Token: 0x06014E6E RID: 85614
		// (set) Token: 0x06014E6D RID: 85613
		[DispId(-2147412058)]
		...
		// (get) Token: 0x06014E70 RID: 85616
		// (set) Token: 0x06014E6F RID: 85615
		[DispId(-2147412054)]
		...
		// (get) Token: 0x06014E72 RID: 85618
		// (set) Token: 0x06014E71 RID: 85617
		[DispId(-2147412057)]
		...
		// (get) Token: 0x06014E74 RID: 85620
		// (set) Token: 0x06014E73 RID: 85619
		[DispId(-2147412053)]
		...
		// (get) Token: 0x06014E76 RID: 85622
		// (set) Token: 0x06014E75 RID: 85621
		[DispId(-2147412056)]
		...
		// (get) Token: 0x06014E78 RID: 85624
		// (set) Token: 0x06014E77 RID: 85623
		[DispId(-2147412052)]
		...
		// (get) Token: 0x06014E7A RID: 85626
		// (set) Token: 0x06014E79 RID: 85625
		[DispId(-2147412055)]
		...
		// (get) Token: 0x06014E7B RID: 85627
		[DispId(-2147417105)]
		...
		// (get) Token: 0x06014E7D RID: 85629
		// (set) Token: 0x06014E7C RID: 85628
		[DispId(-2147412065)]
		...
		// (get) Token: 0x06014E84 RID: 85636
		// (set) Token: 0x06014E83 RID: 85635
		[DispId(-2147418097)]
		...
		// Token: 0x06014E85 RID: 85637
		[DispId(-2147416112)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void focus();

		// Token: 0x17006F41 RID: 28481
		// (get) Token: 0x06014E87 RID: 85639
		// (set) Token: 0x06014E86 RID: 85638
		[DispId(-2147416107)]
		...
		// (get) Token: 0x06014E89 RID: 85641
		// (set) Token: 0x06014E88 RID: 85640
		[DispId(-2147412097)]
		...
		// (get) Token: 0x06014E8B RID: 85643
		// (set) Token: 0x06014E8A RID: 85642
		[DispId(-2147412098)]
		...
		// (get) Token: 0x06014E8D RID: 85645
		// (set) Token: 0x06014E8C RID: 85644
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06014E91 RID: 85649
		[DispId(-2147416093)]
		...
		// (get) Token: 0x06014E92 RID: 85650
		[DispId(-2147416092)]
		...
		// (get) Token: 0x06014E93 RID: 85651
		[DispId(-2147416091)]
		...
		// (get) Token: 0x06014E94 RID: 85652
		[DispId(-2147416090)]
		...
		// (get) Token: 0x06014E97 RID: 85655
		[DispId(-2147412996)]
		...
		// (get) Token: 0x06014E99 RID: 85657
		// (set) Token: 0x06014E98 RID: 85656
		[DispId(-2147412087)]
		...
		// (get) Token: 0x06014E9B RID: 85659
		// (set) Token: 0x06014E9A RID: 85658
		[DispId(-2147412050)]
		...
		// (get) Token: 0x06014E9D RID: 85661
		// (set) Token: 0x06014E9C RID: 85660
		[DispId(-2147412049)]
		...
		// (get) Token: 0x06014E9F RID: 85663
		// (set) Token: 0x06014E9E RID: 85662
		[DispId(-2147412048)]
		object oncellchange { [TypeLibFunc(20)] [DispId(-2147412048)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [TypeLibFunc(20)] [DispId(-2147412048)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x17006F4E RID: 28494
		// (get) Token: 0x06014EA1 RID: 85665
		// (set) Token: 0x06014EA0 RID: 85664
		[DispId(-2147412995)]
		...
		// (get) Token: 0x06014EA3 RID: 85667
		[DispId(-2147417055)]
		...
		// (get) Token: 0x06014EA4 RID: 85668
		[DispId(-2147417054)]
		...
		// (get) Token: 0x06014EA6 RID: 85670
		// (set) Token: 0x06014EA5 RID: 85669
		[DispId(-2147417053)]
		...
		// (get) Token: 0x06014EA8 RID: 85672
		// (set) Token: 0x06014EA7 RID: 85671
		[DispId(-2147417052)]
		...
		// Token: 0x06014EA9 RID: 85673
		[DispId(-2147417050)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void clearAttributes();

		// Token: 0x17006F53 RID: 28499
		// (get) Token: 0x06014EAB RID: 85675
		// (set) Token: 0x06014EAA RID: 85674
		[DispId(-2147412047)]
		...
		// (get) Token: 0x06014EB4 RID: 85684
		[DispId(-2147417030)]
		...
		// (get) Token: 0x06014EB6 RID: 85686
		// (set) Token: 0x06014EB5 RID: 85685
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06014EB8 RID: 85688
		// (set) Token: 0x06014EB7 RID: 85687
		[DispId(-2147412043)]
		...
		// (get) Token: 0x06014EB9 RID: 85689
		[DispId(-2147417028)]
		...
		// (get) Token: 0x06014EBC RID: 85692
		[DispId(-2147417015)]
		...
		// (get) Token: 0x06014EBD RID: 85693
		[DispId(-2147417014)]
		...
		// (get) Token: 0x06014EBF RID: 85695
		// (set) Token: 0x06014EBE RID: 85694
		[DispId(-2147412039)]
		...
		// (get) Token: 0x06014EC1 RID: 85697
		// (set) Token: 0x06014EC0 RID: 85696
		[DispId(-2147412038)]
		...
		// (get) Token: 0x06014EC3 RID: 85699
		// (set) Token: 0x06014EC2 RID: 85698
		[DispId(-2147417012)]
		...
		// (get) Token: 0x06014EC5 RID: 85701
		// (set) Token: 0x06014EC4 RID: 85700
		[DispId(-2147412035)]
		...
		// (get) Token: 0x06014EC8 RID: 85704
		// (set) Token: 0x06014EC7 RID: 85703
		[DispId(-2147412950)]
		...
		// (get) Token: 0x06014EC9 RID: 85705
		[DispId(-2147417010)]
		...
		// (get) Token: 0x06014ECB RID: 85707
		// (set) Token: 0x06014ECA RID: 85706
		[DispId(-2147412949)]
		...
		// (get) Token: 0x06014ECD RID: 85709
		// (set) Token: 0x06014ECC RID: 85708
		[DispId(-2147418036)]
		...
		// (get) Token: 0x06014ECE RID: 85710
		[DispId(-2147417007)]
		...
		// (get) Token: 0x06014ED0 RID: 85712
		// (set) Token: 0x06014ECF RID: 85711
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06014ED5 RID: 85717
		// (set) Token: 0x06014ED4 RID: 85716
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06014ED7 RID: 85719
		// (set) Token: 0x06014ED6 RID: 85718
		[DispId(-2147412028)]
		...
		// (get) Token: 0x06014ED9 RID: 85721
		// (set) Token: 0x06014ED8 RID: 85720
		[DispId(-2147412031)]
		...
		// (get) Token: 0x06014EDB RID: 85723
		// (set) Token: 0x06014EDA RID: 85722
		[DispId(-2147412030)]
		...
		// (get) Token: 0x06014EDD RID: 85725
		// (set) Token: 0x06014EDC RID: 85724
		[DispId(-2147412027)]
		...
		// (get) Token: 0x06014EDF RID: 85727
		// (set) Token: 0x06014EDE RID: 85726
		[DispId(-2147412026)]
		...
		// (get) Token: 0x06014EE1 RID: 85729
		// (set) Token: 0x06014EE0 RID: 85728
		[DispId(-2147412025)]
		...
		// (get) Token: 0x06014EE3 RID: 85731
		// (set) Token: 0x06014EE2 RID: 85730
		[DispId(-2147412024)]
		...
		// (get) Token: 0x06014EE5 RID: 85733
		[DispId(-2147417004)]
		...
		// (get) Token: 0x06014EE7 RID: 85735
		// (set) Token: 0x06014EE6 RID: 85734
		[DispId(-2147412036)]
		...
		// (get) Token: 0x06014EED RID: 85741
		// (set) Token: 0x06014EEC RID: 85740
		[DispId(-2147412022)]
		...
		// (get) Token: 0x06014EEF RID: 85743
		// (set) Token: 0x06014EEE RID: 85742
		[DispId(-2147412021)]
		...
		// (get) Token: 0x06014EF1 RID: 85745
		// (set) Token: 0x06014EF0 RID: 85744
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06014EF2 RID: 85746
		[DispId(-2147417058)]
		...
		// (get) Token: 0x06014EF3 RID: 85747
		[DispId(-2147417057)]
		...
		// (get) Token: 0x06014EF4 RID: 85748
		[DispId(-2147417066)]
		...
		// (get) Token: 0x06014EF5 RID: 85749
		[DispId(-2147417065)]
		...
		// (get) Token: 0x06014EF7 RID: 85751
		[DispId(-2147417063)]
		...
		// (get) Token: 0x06014EF8 RID: 85752
		[DispId(-2147417062)]
		...
		// (get) Token: 0x06014F01 RID: 85761
		[DispId(-2147417038)]
		...
		// (get) Token: 0x06014F03 RID: 85763
		// (set) Token: 0x06014F02 RID: 85762
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06014F04 RID: 85764
		[DispId(-2147417036)]
		...
		// (get) Token: 0x06014F05 RID: 85765
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06014F06 RID: 85766
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06014F07 RID: 85767
		[DispId(-2147417033)]
		...
		// (get) Token: 0x06014F08 RID: 85768
		[DispId(-2147416999)]
		...
		// (get) Token: 0x06014F0A RID: 85770
		// (set) Token: 0x06014F09 RID: 85769
		[DispId(-2147417091)]
		...
		// (get) Token: 0x06014F0C RID: 85772
		// (set) Token: 0x06014F0B RID: 85771
		[DispId(-2147417090)]
		...
		// (get) Token: 0x06014F0E RID: 85774
		// (set) Token: 0x06014F0D RID: 85773
		[DispId(-2147417089)]
		...
		// (get) Token: 0x06014F10 RID: 85776
		// (set) Token: 0x06014F0F RID: 85775
		[DispId(-2147418039)]
