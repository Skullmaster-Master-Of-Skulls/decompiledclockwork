...
namespace mshtml
{
	...
	[TypeLibType(4112)]
	[ComImport]
	public interface DispHTMLFontElement
	{
		...
		// (set) Token: 0x0600360D RID: 13837
		[DispId(-2147417111)]
		...
		// (set) Token: 0x0600360F RID: 13839
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06003613 RID: 13843
		[DispId(-2147418038)]
		...
		// (set) Token: 0x06003614 RID: 13844
		[DispId(-2147412099)]
		...
		// (set) Token: 0x06003618 RID: 13848
		[DispId(-2147412103)]
		...
		// (set) Token: 0x0600361A RID: 13850
		[DispId(-2147412107)]
		...
		// (set) Token: 0x0600361C RID: 13852
		[DispId(-2147412106)]
		...
		// (set) Token: 0x0600361E RID: 13854
		[DispId(-2147412105)]
		...
		// (set) Token: 0x06003620 RID: 13856
		[DispId(-2147412111)]
		...
		// (set) Token: 0x06003622 RID: 13858
		[DispId(-2147412112)]
		...
		// (set) Token: 0x06003624 RID: 13860
		[DispId(-2147412108)]
		...
		// (set) Token: 0x0600362B RID: 13867
		[DispId(-2147418043)]
		...
		// (set) Token: 0x06003635 RID: 13877
		[DispId(-2147413103)]
		...
		// (set) Token: 0x0600364D RID: 13901
		[DispId(-2147412091)]
		...
		// (set) Token: 0x06003651 RID: 13905
		[DispId(-2147412074)]
		...
		// (get) Token: 0x06003654 RID: 13908
		// (set) Token: 0x06003653 RID: 13907
		[DispId(-2147412094)]
		...
		// (set) Token: 0x06003655 RID: 13909
		[DispId(-2147412093)]
		...
		// (set) Token: 0x06003657 RID: 13911
		[DispId(-2147412072)]
		...
		// (set) Token: 0x06003659 RID: 13913
		[DispId(-2147412071)]
		...
		// (set) Token: 0x0600365D RID: 13917
		[DispId(-2147412069)]
		...
		// (set) Token: 0x0600366A RID: 13930
		[DispId(-2147412063)]
		...
		// (set) Token: 0x06003672 RID: 13938
		[DispId(-2147412059)]
		...
		// (set) Token: 0x06003674 RID: 13940
		[DispId(-2147412058)]
		...
		// (set) Token: 0x06003676 RID: 13942
		[DispId(-2147412054)]
		...
		// (set) Token: 0x06003678 RID: 13944
		[DispId(-2147412057)]
		...
		// (set) Token: 0x06003691 RID: 13969
		[DispId(-2147412098)]
		...
		// (set) Token: 0x06003693 RID: 13971
		[DispId(-2147412076)]
		...
		// (set) Token: 0x0600369F RID: 13983
		[DispId(-2147412087)]
		...
		// (set) Token: 0x060036A1 RID: 13985
		[DispId(-2147412050)]
		...
		// (get) Token: 0x060036A4 RID: 13988
		// (set) Token: 0x060036A3 RID: 13987
		[DispId(-2147412049)]
		...
		// (set) Token: 0x060036A5 RID: 13989
		[DispId(-2147412048)]
		...
		// (set) Token: 0x060036B1 RID: 14001
		[DispId(-2147412047)]
		...
		// (set) Token: 0x060036C9 RID: 14025
		[DispId(-2147417012)]
		...
		// (set) Token: 0x060036CE RID: 14030
		[DispId(-2147412950)]
		...
		// (set) Token: 0x060036D6 RID: 14038
		[DispId(-2147412034)]
		...
		// (get) Token: 0x060036D9 RID: 14041
		// (set) Token: 0x060036D8 RID: 14040
		[DispId(-2147412033)]
		...
		[DispId(-2147413094)]
		string face { [TypeLibFunc(20)] [DispId(-2147413094)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [TypeLibFunc(20)] [DispId(-2147413094)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17001284 RID: 4740
		// (get) Token: 0x06003715 RID: 14101
		// (set) Token: 0x06003714 RID: 14100
		[DispId(-2147413093)]
		object size { [DispId(-2147413093)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [TypeLibFunc(20)] [DispId(-2147413093)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }
	}
}
