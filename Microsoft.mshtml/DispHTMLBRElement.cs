...
namespace mshtml
{
	...
	[TypeLibType(4112)]
	[ComImport]
	public interface DispHTMLBRElement
	{
		...
		// (get) Token: 0x06006A35 RID: 27189
		// (set) Token: 0x06006A34 RID: 27188
		[DispId(-2147417111)]
		...
		// (get) Token: 0x06006A37 RID: 27191
		// (set) Token: 0x06006A36 RID: 27190
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06006A39 RID: 27193
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06006A40 RID: 27200
		...
		// (get) Token: 0x06006A42 RID: 27202
		// (set) Token: 0x06006A41 RID: 27201
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06006A44 RID: 27204
		// (set) Token: 0x06006A43 RID: 27203
		[DispId(-2147412106)]
		...
		// (get) Token: 0x06006A46 RID: 27206
		// (set) Token: 0x06006A45 RID: 27205
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06006A48 RID: 27208
		// (set) Token: 0x06006A47 RID: 27207
		[DispId(-2147412111)]
		...
		// (get) Token: 0x06006A4A RID: 27210
		// (set) Token: 0x06006A49 RID: 27209
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06006A4C RID: 27212
		// (set) Token: 0x06006A4B RID: 27211
		[DispId(-2147412108)]
		...
		// (set) Token: 0x06006A4D RID: 27213
		[DispId(-2147412110)]
		...
		// (set) Token: 0x06006A4F RID: 27215
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06006A53 RID: 27219
		// (set) Token: 0x06006A52 RID: 27218
		[DispId(-2147418043)]
		...
		// (set) Token: 0x06006A54 RID: 27220
		[DispId(-2147413012)]
		...
		// (set) Token: 0x06006A56 RID: 27222
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06006A5A RID: 27226
		[DispId(-2147417088)]
		...
		// (get) Token: 0x06006A5B RID: 27227
		[DispId(-2147417087)]
		...
		// (get) Token: 0x06006A5D RID: 27229
		// (set) Token: 0x06006A5C RID: 27228
		[DispId(-2147413103)]
		...
		// (get) Token: 0x06006A5E RID: 27230
		[DispId(-2147417104)]
		...
		// (get) Token: 0x06006A5F RID: 27231
		[DispId(-2147417103)]
		...
		// (get) Token: 0x06006A61 RID: 27233
		[DispId(-2147417101)]
		...
		// (get) Token: 0x06006A62 RID: 27234
		[DispId(-2147417100)]
		...
		// (set) Token: 0x06006A63 RID: 27235
		[DispId(-2147417086)]
		...
		// (get) Token: 0x06006A68 RID: 27240
		// (set) Token: 0x06006A67 RID: 27239
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06006A6A RID: 27242
		// (set) Token: 0x06006A69 RID: 27241
		[DispId(-2147417083)]
		...
		// (set) Token: 0x06006A71 RID: 27249
		[DispId(-2147412077)]
		...
		// (set) Token: 0x06006A74 RID: 27252
		[DispId(-2147412091)]
		...
		// (get) Token: 0x06006A77 RID: 27255
		// (set) Token: 0x06006A76 RID: 27254
		[DispId(-2147412090)]
		...
		// (set) Token: 0x06006A78 RID: 27256
		[DispId(-2147412074)]
		...
		// (get) Token: 0x06006A7B RID: 27259
		// (set) Token: 0x06006A7A RID: 27258
		[DispId(-2147412094)]
		...
		// (set) Token: 0x06006A7C RID: 27260
		[DispId(-2147412093)]
		...
		// (get) Token: 0x06006A7F RID: 27263
		// (set) Token: 0x06006A7E RID: 27262
		[DispId(-2147412072)]
		...
		// (get) Token: 0x06006A81 RID: 27265
		// (set) Token: 0x06006A80 RID: 27264
		[DispId(-2147412071)]
		...
		// (get) Token: 0x06006A83 RID: 27267
		// (set) Token: 0x06006A82 RID: 27266
		[DispId(-2147412070)]
		...
		// (get) Token: 0x06006A85 RID: 27269
		// (set) Token: 0x06006A84 RID: 27268
		[DispId(-2147412069)]
		...
		// (get) Token: 0x06006A86 RID: 27270
		[DispId(-2147417075)]
		...
		// (get) Token: 0x06006A87 RID: 27271
		[DispId(-2147417074)]
		...
		// (get) Token: 0x06006A88 RID: 27272
		[DispId(-2147417073)]
		...
		// (get) Token: 0x06006A8C RID: 27276
		// (set) Token: 0x06006A8B RID: 27275
		[DispId(-2147412066)]
		...
		// (get) Token: 0x06006A90 RID: 27280
		// (set) Token: 0x06006A8F RID: 27279
		[DispId(-2147412081)]
		...
		// (get) Token: 0x06006A92 RID: 27282
		// (set) Token: 0x06006A91 RID: 27281
		[DispId(-2147412063)]
		...
		// (set) Token: 0x06006A93 RID: 27283
		[DispId(-2147412062)]
		...
		// (get) Token: 0x06006A96 RID: 27286
		// (set) Token: 0x06006A95 RID: 27285
		[DispId(-2147412061)]
		...
		// (get) Token: 0x06006A98 RID: 27288
		// (set) Token: 0x06006A97 RID: 27287
		[DispId(-2147412060)]
		...
		// (get) Token: 0x06006A9A RID: 27290
		// (set) Token: 0x06006A99 RID: 27289
		[DispId(-2147412059)]
		...
		// (get) Token: 0x06006A9C RID: 27292
		// (set) Token: 0x06006A9B RID: 27291
		[DispId(-2147412058)]
		...
		// (get) Token: 0x06006A9E RID: 27294
		// (set) Token: 0x06006A9D RID: 27293
		[DispId(-2147412054)]
		...
		// (get) Token: 0x06006AA0 RID: 27296
		// (set) Token: 0x06006A9F RID: 27295
		[DispId(-2147412057)]
		...
		// (get) Token: 0x06006AA2 RID: 27298
		// (set) Token: 0x06006AA1 RID: 27297
		[DispId(-2147412053)]
		...
		// (get) Token: 0x06006AA4 RID: 27300
		// (set) Token: 0x06006AA3 RID: 27299
		[DispId(-2147412056)]
		...
		// (get) Token: 0x06006AA6 RID: 27302
		// (set) Token: 0x06006AA5 RID: 27301
		[DispId(-2147412052)]
		...
		// (get) Token: 0x06006AA8 RID: 27304
		// (set) Token: 0x06006AA7 RID: 27303
		[DispId(-2147412055)]
		...
		// (set) Token: 0x06006AAA RID: 27306
		[DispId(-2147412065)]
		...
		// (get) Token: 0x06006AB2 RID: 27314
		// (set) Token: 0x06006AB1 RID: 27313
		[DispId(-2147418097)]
		...
		// (set) Token: 0x06006AB6 RID: 27318
		[DispId(-2147412097)]
		...
		// (set) Token: 0x06006AB8 RID: 27320
		[DispId(-2147412098)]
		...
		// (set) Token: 0x06006ABA RID: 27322
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06006ABF RID: 27327
		[DispId(-2147416093)]
		...
		// (get) Token: 0x06006AC0 RID: 27328
		[DispId(-2147416092)]
		...
		// (get) Token: 0x06006AC1 RID: 27329
		[DispId(-2147416091)]
		...
		// (get) Token: 0x06006AC2 RID: 27330
		[DispId(-2147416090)]
		...
		// (get) Token: 0x06006AC5 RID: 27333
		[DispId(-2147412996)]
		...
		// (get) Token: 0x06006AC7 RID: 27335
		// (set) Token: 0x06006AC6 RID: 27334
		[DispId(-2147412087)]
		...
		// (get) Token: 0x06006AC9 RID: 27337
		// (set) Token: 0x06006AC8 RID: 27336
		[DispId(-2147412050)]
		...
		// (get) Token: 0x06006ACB RID: 27339
		// (set) Token: 0x06006ACA RID: 27338
		[DispId(-2147412049)]
		...
		// (get) Token: 0x06006ACD RID: 27341
		// (set) Token: 0x06006ACC RID: 27340
		[DispId(-2147412048)]
		object oncellchange { [TypeLibFunc(20)] [DispId(-2147412048)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [TypeLibFunc(20)] [DispId(-2147412048)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x170023CB RID: 9163
		// (get) Token: 0x06006ACF RID: 27343
		// (set) Token: 0x06006ACE RID: 27342
		[DispId(-2147412995)]
		...
		// (get) Token: 0x06006AD1 RID: 27345
		[DispId(-2147417055)]
		...
		// (get) Token: 0x06006AD2 RID: 27346
		[DispId(-2147417054)]
		...
		// (get) Token: 0x06006AD4 RID: 27348
		// (set) Token: 0x06006AD3 RID: 27347
		[DispId(-2147417053)]
		...
		// (get) Token: 0x06006AD6 RID: 27350
		// (set) Token: 0x06006AD5 RID: 27349
		[DispId(-2147417052)]
		...
		// (get) Token: 0x06006AD9 RID: 27353
		// (set) Token: 0x06006AD8 RID: 27352
		[DispId(-2147412047)]
		...
		// (get) Token: 0x06006ADE RID: 27358
		[DispId(-2147417040)]
		...
		// (get) Token: 0x06006AE1 RID: 27361
		[DispId(-2147417048)]
		...
		// (get) Token: 0x06006AE4 RID: 27364
		// (set) Token: 0x06006AE3 RID: 27363
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06006AE6 RID: 27366
		// (set) Token: 0x06006AE5 RID: 27365
		[DispId(-2147412043)]
		...
		// (get) Token: 0x06006AE7 RID: 27367
		[DispId(-2147417028)]
		...
		// (get) Token: 0x06006AEA RID: 27370
		[DispId(-2147417015)]
		...
		// (get) Token: 0x06006AEB RID: 27371
		[DispId(-2147417014)]
		...
		// (get) Token: 0x06006AED RID: 27373
		// (set) Token: 0x06006AEC RID: 27372
		[DispId(-2147412039)]
		...
		// (get) Token: 0x06006AEF RID: 27375
		// (set) Token: 0x06006AEE RID: 27374
		[DispId(-2147412038)]
		...
		// (get) Token: 0x06006AF1 RID: 27377
		// (set) Token: 0x06006AF0 RID: 27376
		[DispId(-2147417012)]
		...
		// (get) Token: 0x06006AF3 RID: 27379
		// (set) Token: 0x06006AF2 RID: 27378
		[DispId(-2147412035)]
		...
		// (get) Token: 0x06006AF6 RID: 27382
		// (set) Token: 0x06006AF5 RID: 27381
		[DispId(-2147412950)]
		...
		// (get) Token: 0x06006AF7 RID: 27383
		[DispId(-2147417010)]
		...
		// (get) Token: 0x06006AF9 RID: 27385
		// (set) Token: 0x06006AF8 RID: 27384
		[DispId(-2147412949)]
		...
		// (set) Token: 0x06006AFA RID: 27386
		[DispId(-2147418036)]
		...
		// (set) Token: 0x06006AFD RID: 27389
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06006B00 RID: 27392
		// (set) Token: 0x06006AFF RID: 27391
		[DispId(-2147412033)]
		...
		// (get) Token: 0x06006B03 RID: 27395
		// (set) Token: 0x06006B02 RID: 27394
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06006B05 RID: 27397
		// (set) Token: 0x06006B04 RID: 27396
		[DispId(-2147412028)]
		...
		// (get) Token: 0x06006B07 RID: 27399
		// (set) Token: 0x06006B06 RID: 27398
		[DispId(-2147412031)]
		...
		// (get) Token: 0x06006B09 RID: 27401
		// (set) Token: 0x06006B08 RID: 27400
		[DispId(-2147412030)]
		...
		// (get) Token: 0x06006B0B RID: 27403
		// (set) Token: 0x06006B0A RID: 27402
		[DispId(-2147412027)]
		...
		// (set) Token: 0x06006B0C RID: 27404
		[DispId(-2147412026)]
		...
		// (get) Token: 0x06006B0F RID: 27407
		// (set) Token: 0x06006B0E RID: 27406
		[DispId(-2147412025)]
		...
		// (get) Token: 0x06006B11 RID: 27409
		// (set) Token: 0x06006B10 RID: 27408
		[DispId(-2147412024)]
		...
		// (get) Token: 0x06006B15 RID: 27413
		// (set) Token: 0x06006B14 RID: 27412
		[DispId(-2147412036)]
		...
		// (set) Token: 0x06006B1A RID: 27418
		[DispId(-2147412022)]
		...
		// (get) Token: 0x06006B1D RID: 27421
		// (set) Token: 0x06006B1C RID: 27420
		[DispId(-2147412021)]
		...
		// (get) Token: 0x06006B1F RID: 27423
		// (set) Token: 0x06006B1E RID: 27422
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06006B21 RID: 27425
		[DispId(-2147417057)]
		...
		// (get) Token: 0x06006B23 RID: 27427
		[DispId(-2147417065)]
		...
		// (get) Token: 0x06006B25 RID: 27429
		[DispId(-2147417063)]
		...
		// (get) Token: 0x06006B2F RID: 27439
		[DispId(-2147417038)]
		...
		// (get) Token: 0x06006B31 RID: 27441
		// (set) Token: 0x06006B30 RID: 27440
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06006B33 RID: 27443
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06006B35 RID: 27445
		[DispId(-2147417033)]
		...
		// (get) Token: 0x06006B36 RID: 27446
		[DispId(-2147416999)]
		...
		// (get) Token: 0x06006B38 RID: 27448
		// (set) Token: 0x06006B37 RID: 27447
		[DispId(-2147413096)]
