...
namespace mshtml
{
	...
	[InterfaceType(2)]
	[ComImport]
	public interface DispHTMLButtonElement
	{
		...
		// (get) Token: 0x0600A2C3 RID: 41667
		[DispId(-2147417108)]
		...
		// (get) Token: 0x0600A2C4 RID: 41668
		[DispId(-2147418104)]
		...
		// (get) Token: 0x0600A2C5 RID: 41669
		[DispId(-2147418038)]
		...
		// (get) Token: 0x0600A2C7 RID: 41671
		// (set) Token: 0x0600A2C6 RID: 41670
		[DispId(-2147412099)]
		...
		// (get) Token: 0x0600A2C9 RID: 41673
		// (set) Token: 0x0600A2C8 RID: 41672
		[DispId(-2147412104)]
		...
		// (get) Token: 0x0600A2CB RID: 41675
		// (set) Token: 0x0600A2CA RID: 41674
		[DispId(-2147412103)]
		...
		// (set) Token: 0x0600A2CC RID: 41676
		[DispId(-2147412107)]
		...
		// (set) Token: 0x0600A2CE RID: 41678
		[DispId(-2147412106)]
		...
		// (set) Token: 0x0600A2D0 RID: 41680
		[DispId(-2147412105)]
		...
		// (get) Token: 0x0600A2D3 RID: 41683
		// (set) Token: 0x0600A2D2 RID: 41682
		[DispId(-2147412111)]
		...
		// (get) Token: 0x0600A2D5 RID: 41685
		// (set) Token: 0x0600A2D4 RID: 41684
		[DispId(-2147412112)]
		...
		// (get) Token: 0x0600A2D7 RID: 41687
		// (set) Token: 0x0600A2D6 RID: 41686
		[DispId(-2147412108)]
		...
		// (get) Token: 0x0600A2D9 RID: 41689
		// (set) Token: 0x0600A2D8 RID: 41688
		[DispId(-2147412110)]
		...
		// (get) Token: 0x0600A2DB RID: 41691
		// (set) Token: 0x0600A2DA RID: 41690
		[DispId(-2147412109)]
		...
		// (get) Token: 0x0600A2DC RID: 41692
		[DispId(-2147417094)]
		...
		// (get) Token: 0x0600A2DE RID: 41694
		// (set) Token: 0x0600A2DD RID: 41693
		[DispId(-2147418043)]
		...
		// (set) Token: 0x0600A2DF RID: 41695
		[DispId(-2147413012)]
		...
		// (set) Token: 0x0600A2E1 RID: 41697
		[DispId(-2147412075)]
		...
		// (get) Token: 0x0600A2E6 RID: 41702
		[DispId(-2147417087)]
		...
		// (get) Token: 0x0600A2E8 RID: 41704
		// (set) Token: 0x0600A2E7 RID: 41703
		[DispId(-2147413103)]
		...
		// (get) Token: 0x0600A2E9 RID: 41705
		[DispId(-2147417104)]
		...
		// (get) Token: 0x0600A2EA RID: 41706
		[DispId(-2147417103)]
		...
		// (get) Token: 0x0600A2EB RID: 41707
		[DispId(-2147417102)]
		...
		// (get) Token: 0x0600A2ED RID: 41709
		[DispId(-2147417100)]
		...
		// (get) Token: 0x0600A2EF RID: 41711
		// (set) Token: 0x0600A2EE RID: 41710
		[DispId(-2147417086)]
		...
		// (get) Token: 0x0600A2F1 RID: 41713
		// (set) Token: 0x0600A2F0 RID: 41712
		[DispId(-2147417085)]
		...
		// (get) Token: 0x0600A2F3 RID: 41715
		// (set) Token: 0x0600A2F2 RID: 41714
		[DispId(-2147417084)]
		...
		// (get) Token: 0x0600A2F5 RID: 41717
		// (set) Token: 0x0600A2F4 RID: 41716
		[DispId(-2147417083)]
		...
		// (get) Token: 0x0600A2F8 RID: 41720
		[DispId(-2147417080)]
		...
		// (get) Token: 0x0600A2F9 RID: 41721
		[DispId(-2147417078)]
		...
		// (get) Token: 0x0600A2FB RID: 41723
		[DispId(-2147417077)]
		...
		// (get) Token: 0x0600A2FD RID: 41725
		// (set) Token: 0x0600A2FC RID: 41724
		[DispId(-2147412077)]
		...
		// (get) Token: 0x0600A300 RID: 41728
		// (set) Token: 0x0600A2FF RID: 41727
		[DispId(-2147412091)]
		...
		// (get) Token: 0x0600A302 RID: 41730
		// (set) Token: 0x0600A301 RID: 41729
		[DispId(-2147412090)]
		...
		// (get) Token: 0x0600A304 RID: 41732
		// (set) Token: 0x0600A303 RID: 41731
		[DispId(-2147412074)]
		...
		// (get) Token: 0x0600A306 RID: 41734
		// (set) Token: 0x0600A305 RID: 41733
		[DispId(-2147412094)]
		...
		// (get) Token: 0x0600A308 RID: 41736
		// (set) Token: 0x0600A307 RID: 41735
		[DispId(-2147412093)]
		...
		// (get) Token: 0x0600A30A RID: 41738
		// (set) Token: 0x0600A309 RID: 41737
		[DispId(-2147412072)]
		...
		// (get) Token: 0x0600A30C RID: 41740
		// (set) Token: 0x0600A30B RID: 41739
		[DispId(-2147412071)]
		...
		// (set) Token: 0x0600A30D RID: 41741
		[DispId(-2147412070)]
		...
		// (set) Token: 0x0600A30F RID: 41743
		[DispId(-2147412069)]
		...
		// (get) Token: 0x0600A317 RID: 41751
		// (set) Token: 0x0600A316 RID: 41750
		[DispId(-2147412066)]
		...
		// (get) Token: 0x0600A31B RID: 41755
		// (set) Token: 0x0600A31A RID: 41754
		[DispId(-2147412081)]
		...
		// (get) Token: 0x0600A31D RID: 41757
		// (set) Token: 0x0600A31C RID: 41756
		[DispId(-2147412063)]
		...
		// (get) Token: 0x0600A31F RID: 41759
		// (set) Token: 0x0600A31E RID: 41758
		[DispId(-2147412062)]
		...
		// (get) Token: 0x0600A321 RID: 41761
		// (set) Token: 0x0600A320 RID: 41760
		[DispId(-2147412061)]
		...
		// (get) Token: 0x0600A323 RID: 41763
		// (set) Token: 0x0600A322 RID: 41762
		[DispId(-2147412060)]
		...
		// (get) Token: 0x0600A325 RID: 41765
		// (set) Token: 0x0600A324 RID: 41764
		[DispId(-2147412059)]
		...
		// (get) Token: 0x0600A327 RID: 41767
		// (set) Token: 0x0600A326 RID: 41766
		[DispId(-2147412058)]
		...
		// (get) Token: 0x0600A329 RID: 41769
		// (set) Token: 0x0600A328 RID: 41768
		[DispId(-2147412054)]
		...
		// (get) Token: 0x0600A32B RID: 41771
		// (set) Token: 0x0600A32A RID: 41770
		[DispId(-2147412057)]
		...
		// (get) Token: 0x0600A32D RID: 41773
		// (set) Token: 0x0600A32C RID: 41772
		[DispId(-2147412053)]
		...
		// (get) Token: 0x0600A32F RID: 41775
		// (set) Token: 0x0600A32E RID: 41774
		[DispId(-2147412056)]
		...
		// (set) Token: 0x0600A330 RID: 41776
		[DispId(-2147412052)]
		...
		// (get) Token: 0x0600A333 RID: 41779
		// (set) Token: 0x0600A332 RID: 41778
		[DispId(-2147412055)]
		...
		// (get) Token: 0x0600A334 RID: 41780
		[DispId(-2147417105)]
		...
		// (get) Token: 0x0600A336 RID: 41782
		// (set) Token: 0x0600A335 RID: 41781
		[DispId(-2147412065)]
		...
		// (get) Token: 0x0600A33D RID: 41789
		// (set) Token: 0x0600A33C RID: 41788
		[DispId(-2147418097)]
		...
		// Token: 0x0600A33E RID: 41790
		[DispId(-2147416112)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void focus();

		// Token: 0x17003513 RID: 13587
		// (get) Token: 0x0600A340 RID: 41792
		// (set) Token: 0x0600A33F RID: 41791
		[DispId(-2147416107)]
		...
		// (get) Token: 0x0600A342 RID: 41794
		// (set) Token: 0x0600A341 RID: 41793
		[DispId(-2147412097)]
		...
		// (get) Token: 0x0600A344 RID: 41796
		// (set) Token: 0x0600A343 RID: 41795
		[DispId(-2147412098)]
		...
		// (get) Token: 0x0600A346 RID: 41798
		// (set) Token: 0x0600A345 RID: 41797
		[DispId(-2147412076)]
		...
		// (get) Token: 0x0600A34A RID: 41802
		[DispId(-2147416093)]
		...
		// (get) Token: 0x0600A34B RID: 41803
		[DispId(-2147416092)]
		...
		// (get) Token: 0x0600A34C RID: 41804
		[DispId(-2147416091)]
		...
		// (get) Token: 0x0600A34D RID: 41805
		[DispId(-2147416090)]
		...
		// (get) Token: 0x0600A350 RID: 41808
		[DispId(-2147412996)]
		...
		// (get) Token: 0x0600A352 RID: 41810
		// (set) Token: 0x0600A351 RID: 41809
		[DispId(-2147412087)]
		...
		// (get) Token: 0x0600A354 RID: 41812
		// (set) Token: 0x0600A353 RID: 41811
		[DispId(-2147412050)]
		...
		// (get) Token: 0x0600A356 RID: 41814
		// (set) Token: 0x0600A355 RID: 41813
		[DispId(-2147412049)]
		...
		// (get) Token: 0x0600A358 RID: 41816
		// (set) Token: 0x0600A357 RID: 41815
		[DispId(-2147412048)]
		...
		// (get) Token: 0x0600A35A RID: 41818
		// (set) Token: 0x0600A359 RID: 41817
		[DispId(-2147412995)]
		...
		// (get) Token: 0x0600A35C RID: 41820
		[DispId(-2147417055)]
		...
		// (get) Token: 0x0600A35D RID: 41821
		[DispId(-2147417054)]
		...
		// (get) Token: 0x0600A35F RID: 41823
		// (set) Token: 0x0600A35E RID: 41822
		[DispId(-2147417053)]
		...
		// (get) Token: 0x0600A361 RID: 41825
		// (set) Token: 0x0600A360 RID: 41824
		[DispId(-2147417052)]
		...
		// (set) Token: 0x0600A363 RID: 41827
		[DispId(-2147412047)]
		...
		// (get) Token: 0x0600A36C RID: 41836
		[DispId(-2147417048)]
		...
		// (get) Token: 0x0600A36D RID: 41837
		[DispId(-2147417030)]
		...
		// (get) Token: 0x0600A36F RID: 41839
		// (set) Token: 0x0600A36E RID: 41838
		[DispId(-2147417029)]
		...
		// (get) Token: 0x0600A371 RID: 41841
		// (set) Token: 0x0600A370 RID: 41840
		[DispId(-2147412043)]
		...
		// (get) Token: 0x0600A372 RID: 41842
		[DispId(-2147417028)]
		...
		// (get) Token: 0x0600A375 RID: 41845
		[DispId(-2147417015)]
		...
		// (get) Token: 0x0600A376 RID: 41846
		[DispId(-2147417014)]
		...
		// (get) Token: 0x0600A378 RID: 41848
		// (set) Token: 0x0600A377 RID: 41847
		[DispId(-2147412039)]
		...
		// (get) Token: 0x0600A37A RID: 41850
		// (set) Token: 0x0600A379 RID: 41849
		[DispId(-2147412038)]
		...
		// (get) Token: 0x0600A37C RID: 41852
		// (set) Token: 0x0600A37B RID: 41851
		[DispId(-2147417012)]
		...
		// (get) Token: 0x0600A37E RID: 41854
		// (set) Token: 0x0600A37D RID: 41853
		[DispId(-2147412035)]
		...
		// (get) Token: 0x0600A381 RID: 41857
		// (set) Token: 0x0600A380 RID: 41856
		[DispId(-2147412950)]
		...
		// (get) Token: 0x0600A382 RID: 41858
		[DispId(-2147417010)]
		...
		// (get) Token: 0x0600A384 RID: 41860
		// (set) Token: 0x0600A383 RID: 41859
		[DispId(-2147412949)]
		...
		// (get) Token: 0x0600A386 RID: 41862
		// (set) Token: 0x0600A385 RID: 41861
		[DispId(-2147418036)]
		...
		// (get) Token: 0x0600A387 RID: 41863
		[DispId(-2147417007)]
		...
		// (get) Token: 0x0600A389 RID: 41865
		// (set) Token: 0x0600A388 RID: 41864
		[DispId(-2147412034)]
		...
		// (get) Token: 0x0600A38E RID: 41870
		// (set) Token: 0x0600A38D RID: 41869
		[DispId(-2147412029)]
		...
		// (get) Token: 0x0600A390 RID: 41872
		// (set) Token: 0x0600A38F RID: 41871
		[DispId(-2147412028)]
		...
		// (get) Token: 0x0600A392 RID: 41874
		// (set) Token: 0x0600A391 RID: 41873
		[DispId(-2147412031)]
		...
		// (get) Token: 0x0600A394 RID: 41876
		// (set) Token: 0x0600A393 RID: 41875
		[DispId(-2147412030)]
		...
		// (get) Token: 0x0600A396 RID: 41878
		// (set) Token: 0x0600A395 RID: 41877
		[DispId(-2147412027)]
		...
		// (set) Token: 0x0600A397 RID: 41879
		[DispId(-2147412026)]
		...
		// (get) Token: 0x0600A39E RID: 41886
		[DispId(-2147417004)]
		...
		// (get) Token: 0x0600A3A0 RID: 41888
		// (set) Token: 0x0600A39F RID: 41887
		[DispId(-2147412036)]
		...
		// (get) Token: 0x0600A3A6 RID: 41894
		// (set) Token: 0x0600A3A5 RID: 41893
		[DispId(-2147412022)]
		...
		// (get) Token: 0x0600A3A8 RID: 41896
		// (set) Token: 0x0600A3A7 RID: 41895
		[DispId(-2147412021)]
		...
		// (get) Token: 0x0600A3AA RID: 41898
		// (set) Token: 0x0600A3A9 RID: 41897
		[DispId(-2147412020)]
		...
		// (get) Token: 0x0600A3AB RID: 41899
		[DispId(-2147417058)]
		...
		// (get) Token: 0x0600A3AC RID: 41900
		[DispId(-2147417057)]
		...
		// (get) Token: 0x0600A3AD RID: 41901
		[DispId(-2147417066)]
		...
		// (get) Token: 0x0600A3AE RID: 41902
		[DispId(-2147417065)]
		...
		// (get) Token: 0x0600A3B0 RID: 41904
		[DispId(-2147417063)]
		...
		// (get) Token: 0x0600A3B1 RID: 41905
		[DispId(-2147417062)]
		...
		// (get) Token: 0x0600A3BA RID: 41914
		[DispId(-2147417038)]
		...
		// (get) Token: 0x0600A3BC RID: 41916
		// (set) Token: 0x0600A3BB RID: 41915
		[DispId(-2147417037)]
		...
		// (get) Token: 0x0600A3BD RID: 41917
		[DispId(-2147417036)]
		...
		// (get) Token: 0x0600A3BE RID: 41918
		[DispId(-2147417035)]
		...
		// (get) Token: 0x0600A3BF RID: 41919
		[DispId(-2147417034)]
		...
		// (get) Token: 0x0600A3C0 RID: 41920
		[DispId(-2147417033)]
		...
		// (get) Token: 0x0600A3C1 RID: 41921
		[DispId(-2147416999)]
		...
		// (get) Token: 0x0600A3C3 RID: 41923
		// (set) Token: 0x0600A3C2 RID: 41922
		[DispId(-2147417091)]
		...
		// (get) Token: 0x0600A3C5 RID: 41925
		// (set) Token: 0x0600A3C4 RID: 41924
		[DispId(-2147417090)]
		...
		// (get) Token: 0x0600A3C7 RID: 41927
		// (set) Token: 0x0600A3C6 RID: 41926
		[DispId(-2147417089)]
		...
		// (get) Token: 0x0600A3C8 RID: 41928
		[DispId(2000)]
		...
		// (get) Token: 0x0600A3CE RID: 41934
		// (set) Token: 0x0600A3CD RID: 41933
		[DispId(8001)]
		object status { [DispId(8001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(8001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x1700355A RID: 13658
		// (get) Token: 0x0600A3CF RID: 41935
		[DispId(-2147416108)]
