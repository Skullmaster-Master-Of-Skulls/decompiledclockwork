...
namespace mshtml
{
	...
	[TypeLibType(4112)]
	[ComImport]
	public interface DispHTMLHeaderElement
	{
		...
		// (get) Token: 0x06007AD0 RID: 31440
		// (set) Token: 0x06007ACF RID: 31439
		[DispId(-2147417111)]
		...
		// (get) Token: 0x06007AD2 RID: 31442
		// (set) Token: 0x06007AD1 RID: 31441
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06007AD3 RID: 31443
		[DispId(-2147417108)]
		...
		// (get) Token: 0x06007AD4 RID: 31444
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06007AD5 RID: 31445
		[DispId(-2147418038)]
		...
		// (set) Token: 0x06007AD6 RID: 31446
		[DispId(-2147412099)]
		...
		// (get) Token: 0x06007AD9 RID: 31449
		// (set) Token: 0x06007AD8 RID: 31448
		[DispId(-2147412104)]
		...
		// (get) Token: 0x06007ADB RID: 31451
		// (set) Token: 0x06007ADA RID: 31450
		[DispId(-2147412103)]
		...
		// (get) Token: 0x06007ADD RID: 31453
		// (set) Token: 0x06007ADC RID: 31452
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06007ADF RID: 31455
		// (set) Token: 0x06007ADE RID: 31454
		[DispId(-2147412106)]
		...
		// (get) Token: 0x06007AE1 RID: 31457
		// (set) Token: 0x06007AE0 RID: 31456
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06007AE3 RID: 31459
		// (set) Token: 0x06007AE2 RID: 31458
		[DispId(-2147412111)]
		...
		// (get) Token: 0x06007AE5 RID: 31461
		// (set) Token: 0x06007AE4 RID: 31460
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06007AE7 RID: 31463
		// (set) Token: 0x06007AE6 RID: 31462
		[DispId(-2147412108)]
		...
		// (get) Token: 0x06007AE9 RID: 31465
		// (set) Token: 0x06007AE8 RID: 31464
		[DispId(-2147412110)]
		...
		// (get) Token: 0x06007AEB RID: 31467
		// (set) Token: 0x06007AEA RID: 31466
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06007AEC RID: 31468
		[DispId(-2147417094)]
		...
		// (get) Token: 0x06007AEE RID: 31470
		// (set) Token: 0x06007AED RID: 31469
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06007AF0 RID: 31472
		// (set) Token: 0x06007AEF RID: 31471
		[DispId(-2147413012)]
		...
		// (get) Token: 0x06007AF2 RID: 31474
		// (set) Token: 0x06007AF1 RID: 31473
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06007AF5 RID: 31477
		[DispId(-2147417088)]
		...
		// (get) Token: 0x06007AF8 RID: 31480
		// (set) Token: 0x06007AF7 RID: 31479
		[DispId(-2147413103)]
		...
		// (get) Token: 0x06007AF9 RID: 31481
		[DispId(-2147417104)]
		...
		// (get) Token: 0x06007AFA RID: 31482
		[DispId(-2147417103)]
		...
		// (get) Token: 0x06007AFB RID: 31483
		[DispId(-2147417102)]
		...
		// (get) Token: 0x06007AFC RID: 31484
		[DispId(-2147417101)]
		...
		// (get) Token: 0x06007AFD RID: 31485
		[DispId(-2147417100)]
		...
		// (get) Token: 0x06007AFF RID: 31487
		// (set) Token: 0x06007AFE RID: 31486
		[DispId(-2147417086)]
		...
		// (get) Token: 0x06007B01 RID: 31489
		// (set) Token: 0x06007B00 RID: 31488
		[DispId(-2147417085)]
		...
		// (get) Token: 0x06007B03 RID: 31491
		// (set) Token: 0x06007B02 RID: 31490
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06007B05 RID: 31493
		// (set) Token: 0x06007B04 RID: 31492
		[DispId(-2147417083)]
		...
		// (get) Token: 0x06007B0B RID: 31499
		[DispId(-2147417077)]
		...
		// (get) Token: 0x06007B0D RID: 31501
		// (set) Token: 0x06007B0C RID: 31500
		[DispId(-2147412077)]
		...
		// (get) Token: 0x06007B10 RID: 31504
		// (set) Token: 0x06007B0F RID: 31503
		[DispId(-2147412091)]
		...
		// (set) Token: 0x06007B11 RID: 31505
		[DispId(-2147412090)]
		...
		// (get) Token: 0x06007B14 RID: 31508
		// (set) Token: 0x06007B13 RID: 31507
		[DispId(-2147412074)]
		...
		// (get) Token: 0x06007B16 RID: 31510
		// (set) Token: 0x06007B15 RID: 31509
		[DispId(-2147412094)]
		...
		// (get) Token: 0x06007B18 RID: 31512
		// (set) Token: 0x06007B17 RID: 31511
		[DispId(-2147412093)]
		...
		// (get) Token: 0x06007B1A RID: 31514
		// (set) Token: 0x06007B19 RID: 31513
		[DispId(-2147412072)]
		...
		// (get) Token: 0x06007B1C RID: 31516
		// (set) Token: 0x06007B1B RID: 31515
		[DispId(-2147412071)]
		...
		// (get) Token: 0x06007B1E RID: 31518
		// (set) Token: 0x06007B1D RID: 31517
		[DispId(-2147412070)]
		...
		// (get) Token: 0x06007B20 RID: 31520
		// (set) Token: 0x06007B1F RID: 31519
		[DispId(-2147412069)]
		...
		// (get) Token: 0x06007B21 RID: 31521
		[DispId(-2147417075)]
		...
		// (get) Token: 0x06007B22 RID: 31522
		[DispId(-2147417074)]
		...
		// (get) Token: 0x06007B23 RID: 31523
		[DispId(-2147417073)]
		...
		// (get) Token: 0x06007B27 RID: 31527
		// (set) Token: 0x06007B26 RID: 31526
		[DispId(-2147412066)]
		...
		// (get) Token: 0x06007B2B RID: 31531
		// (set) Token: 0x06007B2A RID: 31530
		[DispId(-2147412081)]
		...
		// (set) Token: 0x06007B2C RID: 31532
		[DispId(-2147412063)]
		...
		// (get) Token: 0x06007B2F RID: 31535
		// (set) Token: 0x06007B2E RID: 31534
		[DispId(-2147412062)]
		...
		// (get) Token: 0x06007B31 RID: 31537
		// (set) Token: 0x06007B30 RID: 31536
		[DispId(-2147412061)]
		...
		// (get) Token: 0x06007B33 RID: 31539
		// (set) Token: 0x06007B32 RID: 31538
		[DispId(-2147412060)]
		...
		// (get) Token: 0x06007B35 RID: 31541
		// (set) Token: 0x06007B34 RID: 31540
		[DispId(-2147412059)]
		...
		// (get) Token: 0x06007B37 RID: 31543
		// (set) Token: 0x06007B36 RID: 31542
		[DispId(-2147412058)]
		...
		// (get) Token: 0x06007B39 RID: 31545
		// (set) Token: 0x06007B38 RID: 31544
		[DispId(-2147412054)]
		...
		// (get) Token: 0x06007B3B RID: 31547
		// (set) Token: 0x06007B3A RID: 31546
		[DispId(-2147412057)]
		...
		// (set) Token: 0x06007B3C RID: 31548
		[DispId(-2147412053)]
		...
		// (get) Token: 0x06007B3F RID: 31551
		// (set) Token: 0x06007B3E RID: 31550
		[DispId(-2147412056)]
		...
		// (get) Token: 0x06007B41 RID: 31553
		// (set) Token: 0x06007B40 RID: 31552
		[DispId(-2147412052)]
		...
		// (get) Token: 0x06007B43 RID: 31555
		// (set) Token: 0x06007B42 RID: 31554
		[DispId(-2147412055)]
		...
		// (get) Token: 0x06007B44 RID: 31556
		[DispId(-2147417105)]
		...
		// (get) Token: 0x06007B46 RID: 31558
		// (set) Token: 0x06007B45 RID: 31557
		[DispId(-2147412065)]
		...
		// (get) Token: 0x06007B4D RID: 31565
		// (set) Token: 0x06007B4C RID: 31564
		[DispId(-2147418097)]
		...
		// (get) Token: 0x06007B50 RID: 31568
		// (set) Token: 0x06007B4F RID: 31567
		[DispId(-2147416107)]
		...
		// (get) Token: 0x06007B52 RID: 31570
		// (set) Token: 0x06007B51 RID: 31569
		[DispId(-2147412097)]
		...
		// (get) Token: 0x06007B54 RID: 31572
		// (set) Token: 0x06007B53 RID: 31571
		[DispId(-2147412098)]
		...
		// (get) Token: 0x06007B56 RID: 31574
		// (set) Token: 0x06007B55 RID: 31573
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06007B5A RID: 31578
		[DispId(-2147416093)]
		...
		// (get) Token: 0x06007B5B RID: 31579
		[DispId(-2147416092)]
		...
		// (get) Token: 0x06007B5C RID: 31580
		[DispId(-2147416091)]
		...
		// (get) Token: 0x06007B5D RID: 31581
		[DispId(-2147416090)]
		...
		// (get) Token: 0x06007B60 RID: 31584
		[DispId(-2147412996)]
		...
		// (get) Token: 0x06007B62 RID: 31586
		// (set) Token: 0x06007B61 RID: 31585
		[DispId(-2147412087)]
		...
		// (get) Token: 0x06007B64 RID: 31588
		// (set) Token: 0x06007B63 RID: 31587
		[DispId(-2147412050)]
		...
		// (get) Token: 0x06007B66 RID: 31590
		// (set) Token: 0x06007B65 RID: 31589
		[DispId(-2147412049)]
		...
		// (get) Token: 0x06007B68 RID: 31592
		// (set) Token: 0x06007B67 RID: 31591
		[DispId(-2147412048)]
		...
		// (get) Token: 0x06007B6A RID: 31594
		// (set) Token: 0x06007B69 RID: 31593
		[DispId(-2147412995)]
		...
		// (get) Token: 0x06007B6C RID: 31596
		[DispId(-2147417055)]
		...
		// (get) Token: 0x06007B6F RID: 31599
		// (set) Token: 0x06007B6E RID: 31598
		[DispId(-2147417053)]
		...
		// (get) Token: 0x06007B71 RID: 31601
		// (set) Token: 0x06007B70 RID: 31600
		[DispId(-2147417052)]
		...
		// (get) Token: 0x06007B74 RID: 31604
		// (set) Token: 0x06007B73 RID: 31603
		[DispId(-2147412047)]
		...
		// (get) Token: 0x06007B7C RID: 31612
		[DispId(-2147417048)]
		...
		// (get) Token: 0x06007B7D RID: 31613
		[DispId(-2147417030)]
		...
		// (get) Token: 0x06007B7F RID: 31615
		// (set) Token: 0x06007B7E RID: 31614
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06007B81 RID: 31617
		// (set) Token: 0x06007B80 RID: 31616
		[DispId(-2147412043)]
		...
		// (set) Token: 0x06007B87 RID: 31623
		[DispId(-2147412039)]
		...
		// (set) Token: 0x06007B89 RID: 31625
		[DispId(-2147412038)]
		...
		// (get) Token: 0x06007B8C RID: 31628
		// (set) Token: 0x06007B8B RID: 31627
		[DispId(-2147417012)]
		...
		// (set) Token: 0x06007B8D RID: 31629
		[DispId(-2147412035)]
		...
		// (set) Token: 0x06007B90 RID: 31632
		[DispId(-2147412950)]
		...
		// (get) Token: 0x06007B92 RID: 31634
		[DispId(-2147417010)]
		...
		// (set) Token: 0x06007B93 RID: 31635
		[DispId(-2147412949)]
		...
		// (get) Token: 0x06007B97 RID: 31639
		[DispId(-2147417007)]
		...
		// (get) Token: 0x06007B99 RID: 31641
		// (set) Token: 0x06007B98 RID: 31640
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06007B9B RID: 31643
		// (set) Token: 0x06007B9A RID: 31642
		[DispId(-2147412033)]
		...
		// (get) Token: 0x06007B9E RID: 31646
		// (set) Token: 0x06007B9D RID: 31645
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06007BA0 RID: 31648
		// (set) Token: 0x06007B9F RID: 31647
		[DispId(-2147412028)]
		...
		// (get) Token: 0x06007BA2 RID: 31650
		// (set) Token: 0x06007BA1 RID: 31649
		[DispId(-2147412031)]
		...
		// (get) Token: 0x06007BA4 RID: 31652
		// (set) Token: 0x06007BA3 RID: 31651
		[DispId(-2147412030)]
		...
		// (get) Token: 0x06007BA6 RID: 31654
		// (set) Token: 0x06007BA5 RID: 31653
		[DispId(-2147412027)]
		...
		// (get) Token: 0x06007BA8 RID: 31656
		// (set) Token: 0x06007BA7 RID: 31655
		[DispId(-2147412026)]
		...
		// (get) Token: 0x06007BAA RID: 31658
		// (set) Token: 0x06007BA9 RID: 31657
		[DispId(-2147412025)]
		...
		// (get) Token: 0x06007BAC RID: 31660
		// (set) Token: 0x06007BAB RID: 31659
		[DispId(-2147412024)]
		...
		// (get) Token: 0x06007BAE RID: 31662
		[DispId(-2147417004)]
		...
		// (get) Token: 0x06007BB0 RID: 31664
		// (set) Token: 0x06007BAF RID: 31663
		[DispId(-2147412036)]
		...
		// (get) Token: 0x06007BB6 RID: 31670
		// (set) Token: 0x06007BB5 RID: 31669
		[DispId(-2147412022)]
		...
		// (get) Token: 0x06007BB8 RID: 31672
		// (set) Token: 0x06007BB7 RID: 31671
		[DispId(-2147412021)]
		...
		// (set) Token: 0x06007BB9 RID: 31673
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06007BBB RID: 31675
		[DispId(-2147417058)]
		...
		// (get) Token: 0x06007BBD RID: 31677
		[DispId(-2147417066)]
		...
		// (get) Token: 0x06007BCA RID: 31690
		[DispId(-2147417038)]
		...
		// (get) Token: 0x06007BCC RID: 31692
		// (set) Token: 0x06007BCB RID: 31691
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06007BCD RID: 31693
		[DispId(-2147417036)]
		...
		// (get) Token: 0x06007BCE RID: 31694
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06007BCF RID: 31695
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06007BD0 RID: 31696
		[DispId(-2147417033)]
		...
		// (get) Token: 0x06007BD1 RID: 31697
		[DispId(-2147416999)]
		...
		// (set) Token: 0x06007BD2 RID: 31698
		[DispId(-2147413096)]
		...
		// (get) Token: 0x06007BD5 RID: 31701
		// (set) Token: 0x06007BD4 RID: 31700
		[DispId(-2147418040)]
		string align { [DispId(-2147418040)] [TypeLibFunc(4)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [TypeLibFunc(4)] [DispId(-2147418040)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }
	}
}
