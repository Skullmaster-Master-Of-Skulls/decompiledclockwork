...
namespace mshtml
{
	...
	[ComImport]
	public interface DispHTMLDListElement
	{
		...
		// (set) Token: 0x06006E4C RID: 28236
		[DispId(-2147417110)]
		...
		// (get) Token: 0x06006E4F RID: 28239
		[DispId(-2147418104)]
		...
		// (get) Token: 0x06006E50 RID: 28240
		[DispId(-2147418038)]
		...
		// (get) Token: 0x06006E52 RID: 28242
		// (set) Token: 0x06006E51 RID: 28241
		[DispId(-2147412099)]
		...
		// (get) Token: 0x06006E54 RID: 28244
		// (set) Token: 0x06006E53 RID: 28243
		[DispId(-2147412104)]
		...
		// (get) Token: 0x06006E56 RID: 28246
		// (set) Token: 0x06006E55 RID: 28245
		[DispId(-2147412103)]
		...
		// (get) Token: 0x06006E58 RID: 28248
		// (set) Token: 0x06006E57 RID: 28247
		[DispId(-2147412107)]
		...
		// (get) Token: 0x06006E5A RID: 28250
		// (set) Token: 0x06006E59 RID: 28249
		[DispId(-2147412106)]
		...
		// (get) Token: 0x06006E5C RID: 28252
		// (set) Token: 0x06006E5B RID: 28251
		[DispId(-2147412105)]
		...
		// (get) Token: 0x06006E5E RID: 28254
		// (set) Token: 0x06006E5D RID: 28253
		[DispId(-2147412111)]
		...
		// (get) Token: 0x06006E60 RID: 28256
		// (set) Token: 0x06006E5F RID: 28255
		[DispId(-2147412112)]
		...
		// (get) Token: 0x06006E62 RID: 28258
		// (set) Token: 0x06006E61 RID: 28257
		[DispId(-2147412108)]
		...
		// (get) Token: 0x06006E64 RID: 28260
		// (set) Token: 0x06006E63 RID: 28259
		[DispId(-2147412110)]
		...
		// (get) Token: 0x06006E66 RID: 28262
		// (set) Token: 0x06006E65 RID: 28261
		[DispId(-2147412109)]
		...
		// (get) Token: 0x06006E67 RID: 28263
		[DispId(-2147417094)]
		...
		// (get) Token: 0x06006E69 RID: 28265
		// (set) Token: 0x06006E68 RID: 28264
		[DispId(-2147418043)]
		...
		// (get) Token: 0x06006E6B RID: 28267
		// (set) Token: 0x06006E6A RID: 28266
		[DispId(-2147413012)]
		...
		// (get) Token: 0x06006E6D RID: 28269
		// (set) Token: 0x06006E6C RID: 28268
		[DispId(-2147412075)]
		...
		// (get) Token: 0x06006E71 RID: 28273
		[DispId(-2147417087)]
		...
		// (get) Token: 0x06006E73 RID: 28275
		// (set) Token: 0x06006E72 RID: 28274
		[DispId(-2147413103)]
		...
		// (get) Token: 0x06006E74 RID: 28276
		[DispId(-2147417104)]
		...
		// (get) Token: 0x06006E75 RID: 28277
		[DispId(-2147417103)]
		...
		// (get) Token: 0x06006E77 RID: 28279
		[DispId(-2147417101)]
		...
		// (get) Token: 0x06006E7C RID: 28284
		...
		// (get) Token: 0x06006E7E RID: 28286
		// (set) Token: 0x06006E7D RID: 28285
		[DispId(-2147417084)]
		...
		// (get) Token: 0x06006E80 RID: 28288
		// (set) Token: 0x06006E7F RID: 28287
		[DispId(-2147417083)]
		...
		// (get) Token: 0x06006E86 RID: 28294
		[DispId(-2147417077)]
		...
		// (get) Token: 0x06006E88 RID: 28296
		// (set) Token: 0x06006E87 RID: 28295
		[DispId(-2147412077)]
		...
		// (get) Token: 0x06006E8B RID: 28299
		// (set) Token: 0x06006E8A RID: 28298
		[DispId(-2147412091)]
		...
		// (get) Token: 0x06006E8D RID: 28301
		// (set) Token: 0x06006E8C RID: 28300
		[DispId(-2147412090)]
		...
		// (get) Token: 0x06006E8F RID: 28303
		// (set) Token: 0x06006E8E RID: 28302
		[DispId(-2147412074)]
		...
		// (set) Token: 0x06006E90 RID: 28304
		[DispId(-2147412094)]
		...
		// (set) Token: 0x06006E92 RID: 28306
		[DispId(-2147412093)]
		...
		// (set) Token: 0x06006EA1 RID: 28321
		[DispId(-2147412066)]
		...
		// (set) Token: 0x06006EA5 RID: 28325
		[DispId(-2147412081)]
		...
		// (set) Token: 0x06006EA7 RID: 28327
		[DispId(-2147412063)]
		...
		// (set) Token: 0x06006EA9 RID: 28329
		[DispId(-2147412062)]
		...
		// (set) Token: 0x06006EAB RID: 28331
		[DispId(-2147412061)]
		...
		// (set) Token: 0x06006EAD RID: 28333
		[DispId(-2147412060)]
		...
		// (set) Token: 0x06006EAF RID: 28335
		[DispId(-2147412059)]
		...
		// (set) Token: 0x06006EB9 RID: 28345
		[DispId(-2147412056)]
		...
		// (set) Token: 0x06006EBB RID: 28347
		[DispId(-2147412052)]
		...
		// (set) Token: 0x06006EBD RID: 28349
		[DispId(-2147412055)]
		...
		// (set) Token: 0x06006EC0 RID: 28352
		[DispId(-2147412065)]
		...
		// (set) Token: 0x06006EC7 RID: 28359
		[DispId(-2147418097)]
		...
		// (set) Token: 0x06006ECA RID: 28362
		[DispId(-2147416107)]
		...
		// (get) Token: 0x06006ECD RID: 28365
		// (set) Token: 0x06006ECC RID: 28364
		[DispId(-2147412097)]
		...
		// (set) Token: 0x06006ECE RID: 28366
		[DispId(-2147412098)]
		...
		// (get) Token: 0x06006ED1 RID: 28369
		// (set) Token: 0x06006ED0 RID: 28368
		[DispId(-2147412076)]
		...
		// (get) Token: 0x06006ED8 RID: 28376
		[DispId(-2147416090)]
		...
		// (get) Token: 0x06006EDD RID: 28381
		// (set) Token: 0x06006EDC RID: 28380
		[DispId(-2147412087)]
		...
		// (set) Token: 0x06006EDE RID: 28382
		[DispId(-2147412050)]
		...
		// (get) Token: 0x06006EE1 RID: 28385
		// (set) Token: 0x06006EE0 RID: 28384
		[DispId(-2147412049)]
		...
		// (set) Token: 0x06006EE2 RID: 28386
		[DispId(-2147412048)]
		...
		// (get) Token: 0x06006EEA RID: 28394
		// (set) Token: 0x06006EE9 RID: 28393
		[DispId(-2147417053)]
		...
		// (set) Token: 0x06006EEB RID: 28395
		[DispId(-2147417052)]
		...
		// (get) Token: 0x06006EEF RID: 28399
		// (set) Token: 0x06006EEE RID: 28398
		[DispId(-2147412047)]
		...
		// (get) Token: 0x06006EF4 RID: 28404
		[DispId(-2147417040)]
		...
		// (get) Token: 0x06006EF8 RID: 28408
		[DispId(-2147417030)]
		...
		// (set) Token: 0x06006EF9 RID: 28409
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06006EFC RID: 28412
		// (set) Token: 0x06006EFB RID: 28411
		[DispId(-2147412043)]
		...
		// (get) Token: 0x06006EFD RID: 28413
		[DispId(-2147417028)]
		...
		// (get) Token: 0x06006F00 RID: 28416
		[DispId(-2147417015)]
		...
		// (get) Token: 0x06006F01 RID: 28417
		[DispId(-2147417014)]
		...
		// (get) Token: 0x06006F03 RID: 28419
		// (set) Token: 0x06006F02 RID: 28418
		[DispId(-2147412039)]
		...
		// (set) Token: 0x06006F04 RID: 28420
		[DispId(-2147412038)]
		...
		// (set) Token: 0x06006F06 RID: 28422
		[DispId(-2147417012)]
		...
		// (set) Token: 0x06006F08 RID: 28424
		[DispId(-2147412035)]
		...
		// (set) Token: 0x06006F0B RID: 28427
		[DispId(-2147412950)]
		...
		// (get) Token: 0x06006F0D RID: 28429
		[DispId(-2147417010)]
		...
		// (get) Token: 0x06006F0F RID: 28431
		// (set) Token: 0x06006F0E RID: 28430
		[DispId(-2147412949)]
		...
		// (set) Token: 0x06006F10 RID: 28432
		[DispId(-2147418036)]
		...
		// (get) Token: 0x06006F14 RID: 28436
		// (set) Token: 0x06006F13 RID: 28435
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06006F16 RID: 28438
		// (set) Token: 0x06006F15 RID: 28437
		[DispId(-2147412033)]
		object oncontrolselect { [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x06006F17 RID: 28439
		[DispId(-2147417006)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		...
		// (get) Token: 0x06006F19 RID: 28441
		// (set) Token: 0x06006F18 RID: 28440
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06006F1B RID: 28443
		// (set) Token: 0x06006F1A RID: 28442
		[DispId(-2147412028)]
		...
		// (get) Token: 0x06006F1D RID: 28445
		// (set) Token: 0x06006F1C RID: 28444
		[DispId(-2147412031)]
		...
		// (get) Token: 0x06006F1F RID: 28447
		// (set) Token: 0x06006F1E RID: 28446
		[DispId(-2147412030)]
		...
		// (get) Token: 0x06006F21 RID: 28449
		// (set) Token: 0x06006F20 RID: 28448
		[DispId(-2147412027)]
		...
		// (get) Token: 0x06006F23 RID: 28451
		// (set) Token: 0x06006F22 RID: 28450
		[DispId(-2147412026)]
		...
		// (get) Token: 0x06006F25 RID: 28453
		// (set) Token: 0x06006F24 RID: 28452
		[DispId(-2147412025)]
		...
		// (get) Token: 0x06006F27 RID: 28455
		// (set) Token: 0x06006F26 RID: 28454
		[DispId(-2147412024)]
		...
		// (get) Token: 0x06006F29 RID: 28457
		[DispId(-2147417004)]
		...
		// (get) Token: 0x06006F2B RID: 28459
		// (set) Token: 0x06006F2A RID: 28458
		[DispId(-2147412036)]
		...
		// (get) Token: 0x06006F31 RID: 28465
		// (set) Token: 0x06006F30 RID: 28464
		[DispId(-2147412022)]
		...
		// (get) Token: 0x06006F33 RID: 28467
		// (set) Token: 0x06006F32 RID: 28466
		[DispId(-2147412021)]
		...
		// (get) Token: 0x06006F35 RID: 28469
		// (set) Token: 0x06006F34 RID: 28468
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06006F36 RID: 28470
		[DispId(-2147417058)]
		...
		// (get) Token: 0x06006F37 RID: 28471
		[DispId(-2147417057)]
		...
		// (get) Token: 0x06006F38 RID: 28472
		[DispId(-2147417066)]
		...
		// (get) Token: 0x06006F39 RID: 28473
		[DispId(-2147417065)]
		...
		// (get) Token: 0x06006F3B RID: 28475
		[DispId(-2147417063)]
		...
		// (get) Token: 0x06006F3C RID: 28476
		[DispId(-2147417062)]
		...
		// Token: 0x06006F41 RID: 28481
		[DispId(-2147417046)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		IHTMLDOMNode removeNode([In] bool fDeep = false);

		// Token: 0x06006F42 RID: 28482
		[DispId(-2147417044)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		...
		// (get) Token: 0x06006F45 RID: 28485
		[DispId(-2147417038)]
		...
		// (set) Token: 0x06006F46 RID: 28486
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06006F4A RID: 28490
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06006F4C RID: 28492
		[DispId(-2147416999)]
		...
		// (get) Token: 0x06006F4E RID: 28494
		// (set) Token: 0x06006F4D RID: 28493
		[DispId(1001)]
		bool compact { [TypeLibFunc(4)] [DispId(1001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(1001)] [TypeLibFunc(4)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }
	}
}
