...
namespace mshtml
{
	...
	public interface DispHTMLSpanElement
	{
		...
		// (get) Token: 0x0600FF58 RID: 65368
		// (set) Token: 0x0600FF57 RID: 65367
		[DispId(-2147417111)]
		...
		// (get) Token: 0x0600FF5A RID: 65370
		// (set) Token: 0x0600FF59 RID: 65369
		[DispId(-2147417110)]
		...
		// (get) Token: 0x0600FF5B RID: 65371
		[DispId(-2147417108)]
		...
		// (get) Token: 0x0600FF5D RID: 65373
		[DispId(-2147418038)]
		...
		// (get) Token: 0x0600FF5F RID: 65375
		// (set) Token: 0x0600FF5E RID: 65374
		[DispId(-2147412099)]
		...
		// (get) Token: 0x0600FF61 RID: 65377
		// (set) Token: 0x0600FF60 RID: 65376
		[DispId(-2147412104)]
		...
		// (get) Token: 0x0600FF63 RID: 65379
		// (set) Token: 0x0600FF62 RID: 65378
		[DispId(-2147412103)]
		...
		// (get) Token: 0x0600FF65 RID: 65381
		// (set) Token: 0x0600FF64 RID: 65380
		[DispId(-2147412107)]
		...
		// (get) Token: 0x0600FF67 RID: 65383
		// (set) Token: 0x0600FF66 RID: 65382
		[DispId(-2147412106)]
		...
		// (get) Token: 0x0600FF69 RID: 65385
		// (set) Token: 0x0600FF68 RID: 65384
		[DispId(-2147412105)]
		...
		// (get) Token: 0x0600FF6B RID: 65387
		// (set) Token: 0x0600FF6A RID: 65386
		[DispId(-2147412111)]
		...
		// (get) Token: 0x0600FF6D RID: 65389
		// (set) Token: 0x0600FF6C RID: 65388
		[DispId(-2147412112)]
		...
		// (get) Token: 0x0600FF6F RID: 65391
		// (set) Token: 0x0600FF6E RID: 65390
		[DispId(-2147412108)]
		...
		// (get) Token: 0x0600FF71 RID: 65393
		// (set) Token: 0x0600FF70 RID: 65392
		[DispId(-2147412110)]
		...
		// (get) Token: 0x0600FF73 RID: 65395
		// (set) Token: 0x0600FF72 RID: 65394
		[DispId(-2147412109)]
		...
		// (get) Token: 0x0600FF74 RID: 65396
		[DispId(-2147417094)]
		...
		// (get) Token: 0x0600FF76 RID: 65398
		// (set) Token: 0x0600FF75 RID: 65397
		[DispId(-2147418043)]
		...
		// (get) Token: 0x0600FF78 RID: 65400
		// (set) Token: 0x0600FF77 RID: 65399
		[DispId(-2147413012)]
		...
		// (get) Token: 0x0600FF7A RID: 65402
		// (set) Token: 0x0600FF79 RID: 65401
		[DispId(-2147412075)]
		...
		// (get) Token: 0x0600FF7D RID: 65405
		[DispId(-2147417088)]
		...
		// (get) Token: 0x0600FF7E RID: 65406
		[DispId(-2147417087)]
		...
		// (get) Token: 0x0600FF80 RID: 65408
		// (set) Token: 0x0600FF7F RID: 65407
		[DispId(-2147413103)]
		...
		// (get) Token: 0x0600FF81 RID: 65409
		[DispId(-2147417104)]
		...
		// (get) Token: 0x0600FF82 RID: 65410
		[DispId(-2147417103)]
		...
		// (get) Token: 0x0600FF83 RID: 65411
		[DispId(-2147417102)]
		...
		// (get) Token: 0x0600FF84 RID: 65412
		[DispId(-2147417101)]
		...
		// (get) Token: 0x0600FF85 RID: 65413
		[DispId(-2147417100)]
		...
		// (get) Token: 0x0600FF87 RID: 65415
		// (set) Token: 0x0600FF86 RID: 65414
		[DispId(-2147417086)]
		...
		// (get) Token: 0x0600FF89 RID: 65417
		// (set) Token: 0x0600FF88 RID: 65416
		[DispId(-2147417085)]
		...
		// (get) Token: 0x0600FF8B RID: 65419
		// (set) Token: 0x0600FF8A RID: 65418
		[DispId(-2147417084)]
		...
		// (get) Token: 0x0600FF8D RID: 65421
		// (set) Token: 0x0600FF8C RID: 65420
		[DispId(-2147417083)]
		...
		// (get) Token: 0x0600FF90 RID: 65424
		[DispId(-2147417080)]
		...
		// (get) Token: 0x0600FF91 RID: 65425
		[DispId(-2147417078)]
		...
		// (get) Token: 0x0600FF93 RID: 65427
		[DispId(-2147417077)]
		...
		// (get) Token: 0x0600FF95 RID: 65429
		// (set) Token: 0x0600FF94 RID: 65428
		[DispId(-2147412077)]
		...
		// (get) Token: 0x0600FF98 RID: 65432
		// (set) Token: 0x0600FF97 RID: 65431
		[DispId(-2147412091)]
		...
		// (get) Token: 0x0600FF9A RID: 65434
		// (set) Token: 0x0600FF99 RID: 65433
		[DispId(-2147412090)]
		...
		// (get) Token: 0x0600FF9C RID: 65436
		// (set) Token: 0x0600FF9B RID: 65435
		[DispId(-2147412074)]
		...
		// (get) Token: 0x0600FF9E RID: 65438
		// (set) Token: 0x0600FF9D RID: 65437
		[DispId(-2147412094)]
		...
		// (get) Token: 0x0600FFA0 RID: 65440
		// (set) Token: 0x0600FF9F RID: 65439
		[DispId(-2147412093)]
		...
		// (get) Token: 0x0600FFA2 RID: 65442
		// (set) Token: 0x0600FFA1 RID: 65441
		[DispId(-2147412072)]
		...
		// (get) Token: 0x0600FFA4 RID: 65444
		// (set) Token: 0x0600FFA3 RID: 65443
		[DispId(-2147412071)]
		...
		// (get) Token: 0x0600FFA6 RID: 65446
		// (set) Token: 0x0600FFA5 RID: 65445
		[DispId(-2147412070)]
		...
		// (get) Token: 0x0600FFA8 RID: 65448
		// (set) Token: 0x0600FFA7 RID: 65447
		[DispId(-2147412069)]
		...
		// (get) Token: 0x0600FFA9 RID: 65449
		[DispId(-2147417075)]
		...
		// (get) Token: 0x0600FFAA RID: 65450
		[DispId(-2147417074)]
		...
		// (get) Token: 0x0600FFAB RID: 65451
		[DispId(-2147417073)]
		...
		// Token: 0x0600FFAC RID: 65452
		[DispId(-2147417072)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void setCapture([In] bool containerCapture = true);

		// Token: 0x0600FFAD RID: 65453
		[DispId(-2147417071)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void releaseCapture();

		// Token: 0x170053F3 RID: 21491
		// (get) Token: 0x0600FFAF RID: 65455
		// (set) Token: 0x0600FFAE RID: 65454
		[DispId(-2147412066)]
		...
		// (get) Token: 0x0600FFB3 RID: 65459
		// (set) Token: 0x0600FFB2 RID: 65458
		[DispId(-2147412081)]
		...
		// (get) Token: 0x0600FFB5 RID: 65461
		// (set) Token: 0x0600FFB4 RID: 65460
		[DispId(-2147412063)]
		...
		// (get) Token: 0x0600FFB7 RID: 65463
		// (set) Token: 0x0600FFB6 RID: 65462
		[DispId(-2147412062)]
		...
		// (get) Token: 0x0600FFB9 RID: 65465
		// (set) Token: 0x0600FFB8 RID: 65464
		[DispId(-2147412061)]
		...
		// (get) Token: 0x0600FFBB RID: 65467
		// (set) Token: 0x0600FFBA RID: 65466
		[DispId(-2147412060)]
		...
		// (get) Token: 0x0600FFBD RID: 65469
		// (set) Token: 0x0600FFBC RID: 65468
		[DispId(-2147412059)]
		...
		// (get) Token: 0x0600FFBF RID: 65471
		// (set) Token: 0x0600FFBE RID: 65470
		[DispId(-2147412058)]
		...
		// (get) Token: 0x0600FFC1 RID: 65473
		// (set) Token: 0x0600FFC0 RID: 65472
		[DispId(-2147412054)]
		...
		// (get) Token: 0x0600FFC3 RID: 65475
		// (set) Token: 0x0600FFC2 RID: 65474
		[DispId(-2147412057)]
		...
		// (get) Token: 0x0600FFC5 RID: 65477
		// (set) Token: 0x0600FFC4 RID: 65476
		[DispId(-2147412053)]
		...
		// (get) Token: 0x0600FFC7 RID: 65479
		// (set) Token: 0x0600FFC6 RID: 65478
		[DispId(-2147412056)]
		...
		// (get) Token: 0x0600FFC9 RID: 65481
		// (set) Token: 0x0600FFC8 RID: 65480
		[DispId(-2147412052)]
		...
		// (get) Token: 0x0600FFCB RID: 65483
		// (set) Token: 0x0600FFCA RID: 65482
		[DispId(-2147412055)]
		...
		// (get) Token: 0x0600FFCC RID: 65484
		[DispId(-2147417105)]
		...
		// (get) Token: 0x0600FFCE RID: 65486
		// (set) Token: 0x0600FFCD RID: 65485
		[DispId(-2147412065)]
		...
		// Token: 0x0600FFCF RID: 65487
		[DispId(-2147417068)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		IHTMLRectCollection getClientRects();

		// Token: 0x0600FFD0 RID: 65488
		[DispId(-2147417067)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		[return: MarshalAs(UnmanagedType.Interface)]
		...
		// Token: 0x0600FFD6 RID: 65494
		[DispId(-2147416112)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void focus();

		// Token: 0x17005404 RID: 21508
		// (get) Token: 0x0600FFD8 RID: 65496
		// (set) Token: 0x0600FFD7 RID: 65495
		[DispId(-2147416107)]
		...
		// (get) Token: 0x0600FFDA RID: 65498
		// (set) Token: 0x0600FFD9 RID: 65497
		[DispId(-2147412097)]
		...
		// (get) Token: 0x0600FFDC RID: 65500
		// (set) Token: 0x0600FFDB RID: 65499
		[DispId(-2147412098)]
		...
		// (get) Token: 0x0600FFDE RID: 65502
		// (set) Token: 0x0600FFDD RID: 65501
		[DispId(-2147412076)]
		...
		// (get) Token: 0x0600FFE3 RID: 65507
		[DispId(-2147416092)]
		...
		// (get) Token: 0x0600FFE4 RID: 65508
		[DispId(-2147416091)]
		...
		// (get) Token: 0x0600FFE5 RID: 65509
		[DispId(-2147416090)]
		...
		// (get) Token: 0x0600FFE8 RID: 65512
		[DispId(-2147412996)]
		...
		// (get) Token: 0x0600FFEA RID: 65514
		// (set) Token: 0x0600FFE9 RID: 65513
		[DispId(-2147412087)]
		...
		// (get) Token: 0x0600FFEC RID: 65516
		// (set) Token: 0x0600FFEB RID: 65515
		[DispId(-2147412050)]
		...
		// (get) Token: 0x0600FFEE RID: 65518
		// (set) Token: 0x0600FFED RID: 65517
		[DispId(-2147412049)]
		...
		// (get) Token: 0x0600FFF0 RID: 65520
		// (set) Token: 0x0600FFEF RID: 65519
		[DispId(-2147412048)]
		...
		// (get) Token: 0x0600FFF2 RID: 65522
		// (set) Token: 0x0600FFF1 RID: 65521
		[DispId(-2147412995)]
		...
		// (get) Token: 0x0600FFF4 RID: 65524
		[DispId(-2147417055)]
		...
		// (get) Token: 0x0600FFF5 RID: 65525
		[DispId(-2147417054)]
		...
		// (get) Token: 0x0600FFF7 RID: 65527
		// (set) Token: 0x0600FFF6 RID: 65526
		[DispId(-2147417053)]
		...
		// (get) Token: 0x0600FFF9 RID: 65529
		// (set) Token: 0x0600FFF8 RID: 65528
		[DispId(-2147417052)]
		...
		// Token: 0x0600FFFA RID: 65530
		[DispId(-2147417050)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		void clearAttributes();

		// Token: 0x17005416 RID: 21526
		// (get) Token: 0x0600FFFC RID: 65532
		// (set) Token: 0x0600FFFB RID: 65531
		[DispId(-2147412047)]
		...
		// (get) Token: 0x06010004 RID: 65540
		[DispId(-2147417048)]
		...
		// (get) Token: 0x06010005 RID: 65541
		[DispId(-2147417030)]
		...
		// (get) Token: 0x06010007 RID: 65543
		// (set) Token: 0x06010006 RID: 65542
		[DispId(-2147417029)]
		...
		// (get) Token: 0x06010009 RID: 65545
		// (set) Token: 0x06010008 RID: 65544
		[DispId(-2147412043)]
		...
		// (get) Token: 0x0601000A RID: 65546
		[DispId(-2147417028)]
		...
		// (get) Token: 0x0601000D RID: 65549
		[DispId(-2147417015)]
		...
		// (get) Token: 0x0601000E RID: 65550
		[DispId(-2147417014)]
		...
		// (get) Token: 0x06010010 RID: 65552
		// (set) Token: 0x0601000F RID: 65551
		[DispId(-2147412039)]
		...
		// (get) Token: 0x06010012 RID: 65554
		// (set) Token: 0x06010011 RID: 65553
		[DispId(-2147412038)]
		...
		// (get) Token: 0x06010014 RID: 65556
		// (set) Token: 0x06010013 RID: 65555
		[DispId(-2147417012)]
		...
		// (get) Token: 0x06010016 RID: 65558
		// (set) Token: 0x06010015 RID: 65557
		[DispId(-2147412035)]
		...
		// (get) Token: 0x06010019 RID: 65561
		// (set) Token: 0x06010018 RID: 65560
		[DispId(-2147412950)]
		...
		// (get) Token: 0x0601001A RID: 65562
		[DispId(-2147417010)]
		...
		// (get) Token: 0x0601001C RID: 65564
		// (set) Token: 0x0601001B RID: 65563
		[DispId(-2147412949)]
		...
		// (get) Token: 0x0601001E RID: 65566
		// (set) Token: 0x0601001D RID: 65565
		[DispId(-2147418036)]
		...
		// (get) Token: 0x0601001F RID: 65567
		[DispId(-2147417007)]
		...
		// (get) Token: 0x06010021 RID: 65569
		// (set) Token: 0x06010020 RID: 65568
		[DispId(-2147412034)]
		...
		// (get) Token: 0x06010023 RID: 65571
		// (set) Token: 0x06010022 RID: 65570
		[DispId(-2147412033)]
		object oncontrolselect { [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412033)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x06010024 RID: 65572
		[DispId(-2147417006)]
		[MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)]
		...
		// (get) Token: 0x06010026 RID: 65574
		// (set) Token: 0x06010025 RID: 65573
		[DispId(-2147412029)]
		...
		// (get) Token: 0x06010028 RID: 65576
		// (set) Token: 0x06010027 RID: 65575
		[DispId(-2147412028)]
		...
		// (get) Token: 0x0601002A RID: 65578
		// (set) Token: 0x06010029 RID: 65577
		[DispId(-2147412031)]
		...
		// (get) Token: 0x0601002C RID: 65580
		// (set) Token: 0x0601002B RID: 65579
		[DispId(-2147412030)]
		...
		// (get) Token: 0x0601002E RID: 65582
		// (set) Token: 0x0601002D RID: 65581
		[DispId(-2147412027)]
		...
		// (get) Token: 0x06010030 RID: 65584
		// (set) Token: 0x0601002F RID: 65583
		[DispId(-2147412026)]
		...
		// (get) Token: 0x06010032 RID: 65586
		// (set) Token: 0x06010031 RID: 65585
		[DispId(-2147412025)]
		...
		// (get) Token: 0x06010034 RID: 65588
		// (set) Token: 0x06010033 RID: 65587
		[DispId(-2147412024)]
		...
		// (get) Token: 0x06010036 RID: 65590
		[DispId(-2147417004)]
		...
		// (get) Token: 0x06010038 RID: 65592
		// (set) Token: 0x06010037 RID: 65591
		[DispId(-2147412036)]
		...
		// (get) Token: 0x0601003E RID: 65598
		// (set) Token: 0x0601003D RID: 65597
		[DispId(-2147412022)]
		...
		// (get) Token: 0x06010040 RID: 65600
		// (set) Token: 0x0601003F RID: 65599
		[DispId(-2147412021)]
		...
		// (get) Token: 0x06010042 RID: 65602
		// (set) Token: 0x06010041 RID: 65601
		[DispId(-2147412020)]
		...
		// (get) Token: 0x06010043 RID: 65603
		[DispId(-2147417058)]
		...
		// (get) Token: 0x06010044 RID: 65604
		[DispId(-2147417057)]
		...
		// (get) Token: 0x06010045 RID: 65605
		[DispId(-2147417066)]
		...
		// (get) Token: 0x06010046 RID: 65606
		[DispId(-2147417065)]
		...
		// (get) Token: 0x06010048 RID: 65608
		[DispId(-2147417063)]
		...
		// (get) Token: 0x06010049 RID: 65609
		[DispId(-2147417062)]
		...
		// (get) Token: 0x06010052 RID: 65618
		[DispId(-2147417038)]
		...
		// (get) Token: 0x06010054 RID: 65620
		// (set) Token: 0x06010053 RID: 65619
		[DispId(-2147417037)]
		...
		// (get) Token: 0x06010055 RID: 65621
		[DispId(-2147417036)]
		...
		// (get) Token: 0x06010056 RID: 65622
		[DispId(-2147417035)]
		...
		// (get) Token: 0x06010057 RID: 65623
		[DispId(-2147417034)]
		...
		// (get) Token: 0x06010058 RID: 65624
		[DispId(-2147417033)]
		...
		// (get) Token: 0x06010059 RID: 65625
		[DispId(-2147416999)]
		...
		// (get) Token: 0x0601005B RID: 65627
		// (set) Token: 0x0601005A RID: 65626
		[DispId(-2147417091)]
		...
		// (get) Token: 0x0601005D RID: 65629
		// (set) Token: 0x0601005C RID: 65628
		[DispId(-2147417090)]
		...
		// (get) Token: 0x0601005F RID: 65631
		// (set) Token: 0x0601005E RID: 65630
		[DispId(-2147417089)]
