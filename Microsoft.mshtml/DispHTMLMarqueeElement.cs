...
namespace mshtml
{
	...
	public interface DispHTMLMarqueeElement
	{
		...
		[DispId(6000)]
		int scrollDelay { [DispId(6000)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6000)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17003710 RID: 14096
		// (get) Token: 0x0600A9C2 RID: 43458
		// (set) Token: 0x0600A9C1 RID: 43457
		[DispId(6001)]
		string direction { [DispId(6001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(6001)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17003711 RID: 14097
		// (get) Token: 0x0600A9C4 RID: 43460
		// (set) Token: 0x0600A9C3 RID: 43459
		[DispId(6002)]
		string behavior { [DispId(6002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.BStr)] get; [DispId(6002)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.BStr)] set; }

		// Token: 0x17003712 RID: 14098
		// (get) Token: 0x0600A9C6 RID: 43462
		// (set) Token: 0x0600A9C5 RID: 43461
		[DispId(6003)]
		int scrollAmount { [DispId(6003)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6003)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17003713 RID: 14099
		// (get) Token: 0x0600A9C8 RID: 43464
		// (set) Token: 0x0600A9C7 RID: 43463
		[DispId(6004)]
		int loop { [DispId(6004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6004)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17003714 RID: 14100
		// (get) Token: 0x0600A9CA RID: 43466
		// (set) Token: 0x0600A9C9 RID: 43465
		[DispId(6005)]
		int vspace { [DispId(6005)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6005)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17003715 RID: 14101
		// (get) Token: 0x0600A9CC RID: 43468
		// (set) Token: 0x0600A9CB RID: 43467
		[DispId(6006)]
		int hspace { [DispId(6006)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6006)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }

		// Token: 0x17003716 RID: 14102
		// (get) Token: 0x0600A9CE RID: 43470
		// (set) Token: 0x0600A9CD RID: 43469
		[DispId(-2147412086)]
		object onfinish { [TypeLibFunc(20)] [DispId(-2147412086)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412086)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x17003717 RID: 14103
		// (get) Token: 0x0600A9D0 RID: 43472
		// (set) Token: 0x0600A9CF RID: 43471
		[DispId(-2147412085)]
		object onstart { [DispId(-2147412085)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [DispId(-2147412085)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }

		// Token: 0x17003718 RID: 14104
		// (get) Token: 0x0600A9D2 RID: 43474
		// (set) Token: 0x0600A9D1 RID: 43473
		[DispId(-2147412092)]
		object onbounce { [TypeLibFunc(20)] [DispId(-2147412092)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [return: MarshalAs(UnmanagedType.Struct)] get; [TypeLibFunc(20)] [DispId(-2147412092)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] [param: MarshalAs(UnmanagedType.Struct)] set; }
		...
		[DispId(6007)]
		bool trueSpeed { [DispId(6007)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] get; [DispId(6007)] [TypeLibFunc(20)] [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall)] set; }
