...
namespace System.Transactions.Oletx
{
	...
	internal class OletxEnlistment : OletxBaseEnlistment, IPromotedEnlistment
	{
		...
		// (get) Token: 0x06000391 RID: 913 RVA: 0x00038264 File Offset: 0x00037664
		...
		// Token: 0x06000392 RID: 914 RVA: 0x00038284 File Offset: 0x00037684
		internal OletxEnlistment(bool canDoSinglePhase, IEnlistmentNotificationInternal enlistmentNotification, Guid transactionGuid, EnlistmentOptions enlistmentOptions, OletxResourceManager oletxResourceManager, OletxTransaction oletxTransaction) : base(oletxResourceManager, oletxTransaction)
		{
			...
			{
				EnlistmentTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, EnlistmentType.Durable, enlistmentOptions);
			}
			base.AddToEnlistmentTable();
		}

		// Token: 0x06000393 RID: 915 RVA: 0x00038314 File Offset: 0x00037714
		internal OletxEnlistment(IEnlistmentNotificationInternal enlistmentNotification, OletxTransactionStatus xactStatus, byte[] prepareInfoByteArray, OletxResourceManager oletxResourceManager) : base(oletxResourceManager, null)
		{
			...
			{
				InternalErrorTraceRecord.Trace(SR.GetString("TraceSourceOletx"), SR.GetString("OletxEnlistmentUnexpectedTransactionStatus"));
			}
			...
			if (DiagnosticTrace.Information)
			{
				EnlistmentTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, EnlistmentType.Durable, EnlistmentOptions.None);
			}
			base.AddToEnlistmentTable();
		}

		// Token: 0x17000089 RID: 137
		// (get) Token: 0x06000394 RID: 916 RVA: 0x00038534 File Offset: 0x00037934
		...
		// (get) Token: 0x06000395 RID: 917 RVA: 0x00038554 File Offset: 0x00037954
		// (set) Token: 0x06000396 RID: 918 RVA: 0x00038574 File Offset: 0x00037974
		...
		// (get) Token: 0x06000397 RID: 919 RVA: 0x00038594 File Offset: 0x00037994
		// (set) Token: 0x06000398 RID: 920 RVA: 0x000385B4 File Offset: 0x000379B4
		...
		// (get) Token: 0x06000399 RID: 921 RVA: 0x00038614 File Offset: 0x00037A14
		// (set) Token: 0x0600039A RID: 922 RVA: 0x00038634 File Offset: 0x00037A34
		...
		// (get) Token: 0x0600039B RID: 923 RVA: 0x00038654 File Offset: 0x00037A54
		...
		// Token: 0x0600039C RID: 924 RVA: 0x00038674 File Offset: 0x00037A74
		...
		// Token: 0x0600039D RID: 925 RVA: 0x000386D4 File Offset: 0x00037AD4
		...
		// Token: 0x0600039E RID: 926 RVA: 0x00038734 File Offset: 0x00037B34
		public bool PrepareRequest(bool singlePhase, byte[] prepareInfo)
		{
			...
			{
				OletxRecoveryInformation thingToConvert = new OletxRecoveryInformation(prepareInfo);
				...
				if (this.isSinglePhase && this.canDoSinglePhase)
				{
					...
					if (DiagnosticTrace.Verbose)
					{
						EnlistmentNotificationCallTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, NotificationCall.SinglePhaseCommit);
					}
				...
				else
				{
					...
					this.prepareInfoByteArray = TransactionManager.GetRecoveryInformation(this.oletxResourceManager.oletxTransactionManager.CreationNodeName, resourceManagerRecoveryInformation);
					if (DiagnosticTrace.Verbose)
					{
		...
		// Token: 0x0600039F RID: 927 RVA: 0x00038964 File Offset: 0x00037D64
		...
		// Token: 0x060003A0 RID: 928 RVA: 0x00038A74 File Offset: 0x00037E74
		...
		// Token: 0x060003A1 RID: 929 RVA: 0x00038BA4 File Offset: 0x00037FA4
		public void TMDown()
		{
		...
		// Token: 0x060003A2 RID: 930 RVA: 0x00038C44 File Offset: 0x00038044
		public void Phase0Request(bool abortingHint)
		{
			...
			if (DiagnosticTrace.Verbose)
			{
				MethodEnteredTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxEnlistment.Phase0Request");
			}
			...
			if (enlistmentNotificationInternal != null)
			{
				if (OletxEnlistment.OletxEnlistmentState.Phase0Preparing != oletxEnlistmentState)
				{
					if (DiagnosticTrace.Verbose)
					{
						MethodExitedTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxEnlistment.Phase0Request");
					}
					return;
				}
		...
		// Token: 0x060003A3 RID: 931 RVA: 0x00038E64 File Offset: 0x00038264
		...
		// (get) Token: 0x060003A4 RID: 932 RVA: 0x000390B4 File Offset: 0x000384B4
		public EnlistmentTraceIdentifier EnlistmentTraceId
		{
			get
			{
				if (DiagnosticTrace.Verbose)
				{
					MethodEnteredTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxEnlistment.get_TraceIdentifier");
					MethodExitedTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxEnlistment.get_TraceIdentifier");
				}
				return base.InternalTraceIdentifier;
			}
		}

		// Token: 0x060003A5 RID: 933 RVA: 0x00039104 File Offset: 0x00038504
		...
		// Token: 0x060003A6 RID: 934 RVA: 0x000392B4 File Offset: 0x000386B4
		public void ForceRollback()
		{
			this.ForceRollback(null);
		}

		// Token: 0x060003A7 RID: 935 RVA: 0x000392D4 File Offset: 0x000386D4
		...
		// Token: 0x060003A8 RID: 936 RVA: 0x00039484 File Offset: 0x00038884
		public void Committed()
		{
			IEnlistmentShim enlistmentShim = null;
			if (DiagnosticTrace.Verbose)
			{
				MethodEnteredTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.Committed");
				EnlistmentCallbackPositiveTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, EnlistmentCallback.Committed);
			}
			lock (this)
			{
			...
			if (DiagnosticTrace.Verbose)
			{
				MethodExitedTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.Committed");
			}
		}

		// Token: 0x060003A9 RID: 937 RVA: 0x000395C4 File Offset: 0x000389C4
		public void Aborted()
		{
			this.Aborted(null);
		}

		// Token: 0x060003AA RID: 938 RVA: 0x000395E4 File Offset: 0x000389E4
		public void Aborted(Exception e)
		{
			IEnlistmentShim enlistmentShim = null;
			if (DiagnosticTrace.Verbose)
			{
				MethodEnteredTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.Aborted");
			}
			if (DiagnosticTrace.Warning)
			{
				EnlistmentCallbackNegativeTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, EnlistmentCallback.Aborted);
			}
			lock (this)
			{
				if (!this.isSinglePhase || OletxEnlistment.OletxEnlistmentState.SinglePhaseCommitting != this.state)
			...
			if (DiagnosticTrace.Verbose)
			{
				MethodExitedTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.Aborted");
			}
		}

		// Token: 0x060003AB RID: 939 RVA: 0x00039744 File Offset: 0x00038B44
		public void InDoubt()
		{
			this.InDoubt(null);
		}

		// Token: 0x060003AC RID: 940 RVA: 0x00039764 File Offset: 0x00038B64
		public void InDoubt(Exception e)
		{
			IEnlistmentShim enlistmentShim = null;
			if (DiagnosticTrace.Verbose)
			{
				MethodEnteredTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.InDoubt");
			}
			if (DiagnosticTrace.Warning)
			{
				EnlistmentCallbackNegativeTraceRecord.Trace(SR.GetString("TraceSourceOletx"), base.InternalTraceIdentifier, EnlistmentCallback.InDoubt);
			}
			lock (this)
			{
				if (!this.isSinglePhase || OletxEnlistment.OletxEnlistmentState.SinglePhaseCommitting != this.state)
			...
			if (DiagnosticTrace.Verbose)
			{
				MethodExitedTraceRecord.Trace(SR.GetString("TraceSourceOletx"), "OletxSinglePhaseEnlistment.InDoubt");
			}
		}

		// Token: 0x060003AD RID: 941 RVA: 0x00039904 File Offset: 0x00038D04
		...
		// (get) Token: 0x060003AE RID: 942 RVA: 0x00039934 File Offset: 0x00038D34
		// (set) Token: 0x060003AF RID: 943 RVA: 0x00039954 File Offset: 0x00038D54
