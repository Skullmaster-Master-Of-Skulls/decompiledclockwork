...
namespace System.Transactions
{
	...
	internal sealed class SR
	{
		...
		// (get) Token: 0x06000005 RID: 5 RVA: 0x00029284 File Offset: 0x00028684
		private static object InternalSyncObject
		{
			get
			{
				if (SR.s_InternalSyncObject == null)
				{
					...
					Interlocked.CompareExchange(ref SR.s_InternalSyncObject, value, null);
				}
				return SR.s_InternalSyncObject;
			}
		}

		// Token: 0x06000006 RID: 6 RVA: 0x000292B4 File Offset: 0x000286B4
		internal SR()
		{
			this.resources = new ResourceManager("Resources", base.GetType().Assembly);
		}

		// Token: 0x06000007 RID: 7 RVA: 0x000292E4 File Offset: 0x000286E4
		...
		// (get) Token: 0x06000008 RID: 8 RVA: 0x00029344 File Offset: 0x00028744
		...
		// (get) Token: 0x06000009 RID: 9 RVA: 0x00029354 File Offset: 0x00028754
		...
		// Token: 0x0600000A RID: 10 RVA: 0x00029374 File Offset: 0x00028774
		...
		// Token: 0x0600000B RID: 11 RVA: 0x00029404 File Offset: 0x00028804
		...
		// Token: 0x0600000C RID: 12 RVA: 0x00029434 File Offset: 0x00028834
