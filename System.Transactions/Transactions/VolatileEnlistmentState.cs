...
namespace System.Transactions
{
	...
	internal abstract class VolatileEnlistmentState : EnlistmentState
	{
		...
		// (get) Token: 0x06000234 RID: 564 RVA: 0x00031C04 File Offset: 0x00031004
		...
		// (get) Token: 0x06000235 RID: 565 RVA: 0x00031C74 File Offset: 0x00031074
		...
		// (get) Token: 0x06000236 RID: 566 RVA: 0x00031CE4 File Offset: 0x000310E4
		...
		// (get) Token: 0x06000237 RID: 567 RVA: 0x00031D54 File Offset: 0x00031154
		...
		// (get) Token: 0x06000238 RID: 568 RVA: 0x00031DC4 File Offset: 0x000311C4
		...
		// (get) Token: 0x06000239 RID: 569 RVA: 0x00031E34 File Offset: 0x00031234
		...
		// (get) Token: 0x0600023A RID: 570 RVA: 0x00031EA4 File Offset: 0x000312A4
		...
		// (get) Token: 0x0600023B RID: 571 RVA: 0x00031F14 File Offset: 0x00031314
		...
		// (get) Token: 0x0600023C RID: 572 RVA: 0x00031F84 File Offset: 0x00031384
		...
		// (get) Token: 0x0600023D RID: 573 RVA: 0x00031FF4 File Offset: 0x000313F4
		...
		// (get) Token: 0x0600023E RID: 574 RVA: 0x00032064 File Offset: 0x00031464
		private static object ClassSyncObject
		{
			get
			{
				if (VolatileEnlistmentState.classSyncObject == null)
				{
					...
					Interlocked.CompareExchange(ref VolatileEnlistmentState.classSyncObject, value, null);
				}
				return VolatileEnlistmentState.classSyncObject;
			}
		}

		// Token: 0x0600023F RID: 575 RVA: 0x00032094 File Offset: 0x00031494
