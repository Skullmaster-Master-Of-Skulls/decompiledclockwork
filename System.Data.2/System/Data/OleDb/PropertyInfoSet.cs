...
namespace System.Data.OleDb
{
	...
	{
		// Token: 0x060026DF RID: 9951 RVA: 0x00107634 File Offset: 0x00106A34
		...
		// (get) Token: 0x060026E0 RID: 9952 RVA: 0x001076C4 File Offset: 0x00106AC4
		...
		// Token: 0x060026E1 RID: 9953 RVA: 0x001076F8 File Offset: 0x00106AF8
		...
		// Token: 0x060026E2 RID: 9954 RVA: 0x00107878 File Offset: 0x00106C78
			...
			if (IntPtr.Zero != handle)
			{
				...
				for (int i = 0; i < num; i++)
				{
					...
					if (IntPtr.Zero != intPtr)
					{
						...
						{
							IntPtr pObject = ADP.IntPtrOffset(intPtr, j * ODB.SizeOf_tagDBPROPINFO + ODB.OffsetOf_tagDBPROPINFO_Value);
		...
		// Token: 0x060026E3 RID: 9955 RVA: 0x00107948 File Offset: 0x00106D48
